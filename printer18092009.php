...
// print_r($_REQUEST['printer']);
	...
	{ 
		...
		{
			PrinterGetHead('','#DDDDDD','El Reporte fue enviado a la cola de impresión : ' . $_REQUEST['printer']);
...
//si existe $_REQUEST['ruta'] es por q la llamamos de fpdf.
	...
	function PrinterVerReporte($report_html,$report_pdf,$sw='')
	{
		...
		if($sw !=1)
		{
			$Salida.="<TD class='modulo_list_claro' align='center' colspan='2'><input type=\"button\" value=\"HTML\" onclick=\"javascript:VerReporteHTML()\"></TD>\n";
		}
