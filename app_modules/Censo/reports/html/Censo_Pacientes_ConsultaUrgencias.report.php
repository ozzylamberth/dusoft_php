<?php
/**
 * $Id: Censo_Pacientes_ConsultaUrgencias.report.php,v 1.2 2007/01/30 14:07:07 luis Exp $
 ...
 * @package   IPSOFT-SIIS-CENSO
 */
class Censo_Pacientes_ConsultaUrgencias_report extends app_Censo_userclasses_HTML
{
	//var $datos;
	var $title       = '';
	var $author      = '';
	 ...
	 * Constructor
	 */
	function Censo_Pacientes_ConsultaUrgencias_report($datos=array())
	{
	...
	function CrearReporte()
	{
		...
		$this->salida .= "	<table width=\"100%\"><tr align=\"center\"><td>LISTADO DE PACIENTES EN CONSULTA DE URGENCIAS</td></tr></table>";
		$this->salida .= "		<br>";
		$this->FrmListadoPacientesEnConsultaUrgencias();//Este metodo está en la clase app_Censo_userclasses_HTML
		$this->salida .= "	</font>\n";
