<?php
/**
 * $Id: Censo_Pacientes.report.php,v 1.7 2007/01/30 14:07:07 luis Exp $
 ...
 * @package   IPSOFT-SIIS-CENSO
 */
class Censo_Pacientes_report extends app_Censo_userclasses_HTML
{
	//var $datos;
	var $title       = '';
	var $author      = '';
	...
	function CrearReporte()
	{
		...
		$this->salida .= "		<br>";
		$this->FrmListadoPacientesHospitalizados();//Este metodo está en la clase app_Censo_userclasses_HTML
		$this->salida .= "	</font>\n";
