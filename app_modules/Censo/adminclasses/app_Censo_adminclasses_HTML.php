...
/**
 * $Id: app_Censo_adminclasses_HTML.php,v 1.2 2005/06/02 16:36:39 leydi Exp $
...
class app_Censo_adminclasses_HTML extends app_Censo_admin
{
	/**
  ...
  function app_Censo_admin_HTML()
	{
		$this->salida='';
		$this->app_Censo_admin();
		return true;
	}
...
*/
	function Menu()
 {
			$this->salida.= ThemeAbrirTabla('MENU ADMINISTRADOR CENSO SIIS V1.0 ALFA');
