...
/**
 * $Id: app_Censo_admin.php,v 1.2 2005/06/02 16:36:39 leydi Exp $
...
class app_Censo_admin extends classModulo
{


	function app_Censo_admin()
	{
...
{
	$this->ReturnMetodoExterno($_SESSION['USER_ADMIN_MOD']['CONTENEDOR'], $_SESSION['USER_ADMIN_MOD']['MOD'], $_SESSION['USER_ADMIN_MOD']['TIPO'], 'TraerDatos',array("tabla"=>'userpermisos_censo'));
	return true;
}
