<?php
  ...
  function Buscar_ActasTecnicas($Formulario,$offset)
    {
            ...
            $sql="select
                      ...
                      where
                      a.codigo_producto!=''   ";
           if($Formulario['acta_tecnica_id'])
            $sql .= " AND a.acta_tecnica_id = ".$Formulario['acta_tecnica_id']." ";
                      
          if($Formulario['fecha_inicio'])
            {
            $sql .= " AND     a.fecha_registro::date >= '".$this->DividirFecha($Formulario['fecha_inicio'])."'::date ";
            }
          
          if($Formulario['fecha_final'])
            {
            $sql .= " AND     a.fecha_registro::date <= '".$this->DividirFecha($Formulario['fecha_final'])."'::date ";
            }
