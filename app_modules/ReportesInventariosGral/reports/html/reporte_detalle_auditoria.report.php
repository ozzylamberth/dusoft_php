      ...
      if(!empty($detl))
      {
        ...
        for($i=1;$i<55;$i++)
        {
          ...
          $html .= "			<td colspan=\"2\" ><u><b>".$detl[0]['campo_'.$i]."</b></u></td>\n";
  				if($detl[0]['campo_'.$i]=="empresa_id" || $detl[0]['campo_'.$i]=="empresa_id_registro" || $detl[0]['campo_'.$i]=="farmacia_id")
            {
            $nombre_empresa_a=$nc->NombreEmpresa($detl[0]['antiguo_valor_'.$i]);
            $nombre_empresa_d=$nc->NombreEmpresa($detl[0]['nuevo_valor_'.$i]);
            }
            else{
                $nombre_empresa_a="";
                $nombre_empresa_d="";
          ...
          $html .= "		</tr>\n";
          $html .= "		<tr>\n";
          $html .= "			<td width=\"50%\"><b>Antiguo Valor: </b>(".$detl[0]['antiguo_valor_'.$i]."):".$nombre_empresa_a['razon_social']."</td>\n";
          $html .= "			<td width=\"50%\"><b>Nuevo Valor: </b>(".$detl[0]['nuevo_valor_'.$i]."):".$nombre_empresa_d['razon_social']."</td>\n";
