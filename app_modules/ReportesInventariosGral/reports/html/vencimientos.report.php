  ...
  IncludeClass('AutoCarga');
    ...
    */
		...
		function CrearReporte()
	  {
			...
			$detl = $nc->ObtenerListadoProductosVencimiento($this->datos['empresa_id'],$this->datos['centro_utilidad'],$this->datos['bodega'],$this->datos,$this->datos['dias_vencimiento'],0,0);
