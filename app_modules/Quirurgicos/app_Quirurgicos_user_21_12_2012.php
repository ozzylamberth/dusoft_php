...
/**
 * $Id: app_Quirurgicos_user.php,v 1.35 2007/07/12 18:52:24 tizziano Exp $
...
//si no va vacia y se realiza el query comun y corriente.
  function TraerOrdenesServicio($TipoId,$PacienteId,$spia=''){
    ...
    $query="SELECT c.plan_id,c.plan_descripcion,h.servicio,h.descripcion as serv_des, sw_cargo_multidpto as switche,
