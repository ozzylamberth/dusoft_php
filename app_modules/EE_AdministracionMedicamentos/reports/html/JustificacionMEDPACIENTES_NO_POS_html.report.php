<?php
  /**
  * $Id: JustificacionMEDPACIENTES_NO_POS_html.report.php,v 1.3 2011/04/26 15:14:17 hugo Exp $
  * @copyright (C) 2005 IPSOFT - SA (www.ipsoft-sa.com)
  * @package IPSOFT-SIIS
  *
  * Reporte de prueba formato HTML
  */
  class JustificacionMEDPACIENTES_NO_POS_html_report
  {
    ...
    function JustificacionMEDPACIENTES_NO_POS_html_report($datos=array())
    {
     	$this->datos = $datos;
      return true;
    }
    ...
    */
    ...
    function CrearReporte()
    {
      ...
      $cantidad = $DatosMed['cantidad'] * ($DatosMed['dias_tratamiento']*1);
      ...
      $html .= "  </tr>\n";
	  $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\"><b>RESUMA BREVEMENTE SU EXPERIENCIA EN EL USO DEL MEDICAMENTO</b><td>\n";
      $html .= "	</tr>\n";    		
      $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\">".$Datos['justificacion']."</td>\n";
      $html .= "	</tr>\n";
	  $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\"><b>VENTAJAS DE ESTE MEDICAMENTO SOBRE LOS OTROS DE LA MISMA CLASIFICACION FARMACEUTICA EN EL TRATAMIENTO DE LA ENTIDAD PATOLOGICA</b><td>\n";
      $html .= "	</tr>\n";    		
      $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\">".$Datos['ventajas_medicamento']."</td>\n";
      $html .= "	</tr>\n";
	  $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\"><b>SE�ALE PRECAUCIONES, CONTRAINDICACIONES, EFECTOS SECUNDARIOS Y TOXICIDAD ASOCIADA AL USO O ABUSO DE ESTE MEDICAMENTO</b><td>\n";
      $html .= "	</tr>\n";    		
      $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\">".$Datos['precauciones']."</td>\n";
      $html .= "	</tr>\n";
	  $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\"><b>CITE ESTUDIOS CLINICOS QUE PERMITAN DETERMINAR EL BALANCE BENEFICIO / RIESGO DEL MEDICAMENTO Y REFERENCIA BIBLIOGRAFICA</b><td>\n";
      $html .= "	</tr>\n";    		
      $html .= "	<tr>\n";
      $html .= "		<td colspan=\"4\">".$Datos['controles_evaluacion_efectividad']."</td>\n";
      $html .= "	</tr>\n";
      $html .= "</table>\n";
    ...
    */
      ...
      $style =" style=\"border-bottom-width: 1px ;border-bottom: thin solid; border-color: #000000;\" ";
		...
		{
		    $datosTercero=$this->ObtenerDatosTercero($_SESSION['entidad']);
	  ...
	  $html .= "<table width=\"100%\" align=\"left\" class=\"normal_10\" border=\"1\">\n";
  		...
  		$html .= "    <td><b>FECHA: </b></td>\n";
                if($datos_justificacion['fecha_modificacion_formulacion']!='')
		{
			$html .= "    <td  colspan=\"11\">".$datos_justificacion['fecha_modificacion_formulacion']."</td>\n";
		}
		else
		{
      ...
      $html .= "    </td>\n";
      $html .= "  </tr>\n";
	 if(!empty($datosTercero))
      {
        $html .= "  <tr>\n";
      $html .= "    <td><b>DIRECCION:</b></td>\n";
      $html .= "    <td colspan=\"5\">\n";
      $html .= "      ".$datosTercero['direccion']."\n";
      $html .= "    </td>\n";
	  $html .= "    <td><b>TELEFONO :</b></td>\n";
      $html .= "    <td colspan=\"5\">\n";
      $html .= "      ".$datosTercero['telefono']."\n";
      $html .= "    </td>\n";
	  $html .= "  </tr>\n";	
      $html .= "  <tr>\n";
      $html .= "    <td><b>CLIENTE:</b></td>\n";
      $html .= "    <td colspan=\"2\">\n";
      $html .= "      ".$datosTercero['nombre_tercero']."\n";
      $html .= "    </td>\n";
	  $html .= "    <td><b>PLAN :</b></td>\n";
      $html .= "    <td colspan=\"2\">\n";
      $html .= "      ".strtoupper($datosTercero['nombre_entidad'])."\n";
      $html .= "    </td>\n";
    ...
    */
    function ObtenerDatosJustificaciones($justificacion)
    {
      ...
      $sql .= "	        TO_CHAR(fecha_modificacion_formulacion,'DD/MM/YYYY') AS fecha_modificacion_formulacion, ";
    ...
    */
	...
	function ObtenerDatosTercero($entidad)
	{
	  $sql  = "SELECT
		  t.direccion,
		  t.telefono,
		  ...
		  INNER JOIN terceros t 
			  ON e.tercero_id=t.tercero_id AND e.tipo_id_tercero=t.tipo_id_tercero 
