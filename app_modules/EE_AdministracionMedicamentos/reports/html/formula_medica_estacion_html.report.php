...
/**
 * $Id: formula_medica_estacion_html.report.php,v 1.2 2011/04/26 15:14:17 hugo Exp $
...
class formula_medica_estacion_html_report
{
    ...
    function GetMembrete()
    {
     ...
     function CrearReporte()
     {
          ...
          $Salida.= "<TD ALIGN=\"JUSTIFY\" class=\"Normal_10N\" WIDTH=\"30%\">FECHA IMPRESION:&nbsp;&nbsp;".$fechaEvolucion."</TD>";
          $Salida.= "</TR>";
          $Salida.= "</TABLE>\n";
          ...
          $Salida.="<tr><td class=\"Normal_10N\" align=\"left\" width=\"100%\">USUARIO:</td></tr>";
          ...
          foreach($vectorOriginal as $k => $vector1)
          {
               for($i=0;$i<sizeof($vector1);$i++)
               {
                    ...
                    if($vector1[$i]['tipo_solicitud'] == "M")
                    {
                         ...
                         $salida.="<tr>";
                         $salida.="<td colspan = 3 align=\"left\" width=\"9%\" class=\"Normal_10N\"><b>Via de Administracion:</b> <label class=\"Normal_10\">".$vector1[$i][via_administracion]."</label></td>";
                         $salida.="</tr>";
                         ...
                         if($e==1)
                         {
                              $salida.="  <td align=\"left\" width=\"10%\" class=\"Normal_10\">".floor($vector1[$i][dosis])."  ".$vector1[$i][unidad_dosificacion]."</td>";
                         }
                         else
                         {
