...
class app_ParametrosHC_userclasses_HTML extends app_ParametrosHC_user
{
	function app_ParametrosHC_user_HTML()
	{
		$this->app_ParametrosHC_user(); //Constructor del padre 'modulo'
		$this->salida='';
		return true;
	}
