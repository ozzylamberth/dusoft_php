...
/**
 * $Id: app_Os_Entrega_Apoyod_adminclasses_HTML.php,v 1.2 2005/06/07 13:09:26 leydi Exp $
...
class app_Os_Entrega_Apoyod_adminclasses_HTML extends app_Os_Entrega_Apoyod_admin
{
	/**
  ...
  function app_Os_Entrega_Apoyod_admin_HTML()
	{
		$this->salida='';
		$this->app_Os_Entrega_Apoyod_admin();
		return true;
	}
