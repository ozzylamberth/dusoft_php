...
* @version 1.0
* @package SIIS
* $Id: hc_Epicrisis_GeneracionEpicrisis_HTML.class.php,v 1.9 2007/01/15 18:54:27 luis Exp $
*/
class GeneracionEpicrisis_HTML
{
  function GeneracionEpicrisis_HTML()
	{
		return true;
	}
  ...
  function SetStyle($campo)
	...
	function frmForma($vector,$motivo_consulta,$enfermedad,$antecedentes,$ex_fisico,$ex_fisico_hallazgo,$apoyod,$diagI,$datos_evolucion,$medicamentos,$plan_seg,$diagE,$tipos_salida,$datos_salida)
	{
		$this->salida.= ThemeAbrirTablaSubModulo('RESUMEN DE EGRESO');
		
		$this->salida.= "	<table border=\"0\" width=\"100%\" align=\"center\">";
		$this->salida.= 		$this->SetStyle("MensajeError");
		$this->salida.= "	</table><br>";
		
		IncludeFile("hc_modules/Epicrisis/RemoteXajax/EpicrisisX.php");
				...
				switch("$i$j")
				{
						...
						case "10":
							if(!$datos_evolucion)
							{
								...
								$salida.="		<td id=\"capa_error$i$j\"></td>";
								$salida.="	</tr>";
								$salida.="	<tr align=\"center\">";
								$salida.="		<td class=\"label\"><textarea name=\"desc_evolucion\" id=\"desc_evolucion\" class=\"input-text\" cols=\"100%\" rows=\"5\"></textarea></td>";
								$salida.="	</tr>";
								$salida.="	<tr>";
								$salida.="		<td class=\"label\" align=\"center\"><input type=\"button\" name=\"Guardar\" class=\"input-submit\" value=\"GUARDAR\" onclick=\"xajax_DatosEvolucion(document.getElementById('desc_evolucion').value,'$i$j');ValorOk('ok$i$j','$i$j',$ok);\"></td>";
								$salida.="	</tr>";
								$salida.="</table>";
							}
							else
							{
								...
								foreach($datos_evolucion as $de)
									$evo.="<label class=\"label\">".strtoupper($de['descripcion_evolucion'])."</label>\n";
						...
						case "11":
								if($medicamentos)
								{
									...
									foreach($medicamentos as $med)
									{
										...
										$c=",  ";
										if(sizeof($medicamentos)==$l+1)
											$c="";
										
										$medicamentosD.=strtoupper($med['descripcion'])."$c";
										$l++;
									}
										
									$salida.="<table align=\"center\" border=\"0\" width=\"100%\" class=\"modulo_table_list\">";
									$salida.="	<tr>";
									$salida.="		<td><label class=\"label\">$medicamentosD</label><td>";
									$salida.="	</tr>";
									$salida.="</table>";
								}
								else
						...
						case "20":
							if(!$plan_seg)
							{
								...
								$salida.="	</tr>";
								$salida.="	<tr align=\"center\">";
								$salida.="		<td class=\"label\"><textarea name=\"desc_plan_seg\" id=\"desc_plan_seg\" class=\"input-text\" cols=\"100%\" rows=\"5\"></textarea></td>";
								$salida.="	</tr>";
								$salida.="	<tr>";
								$salida.="		<td class=\"label\" align=\"center\"><input type=\"button\" name=\"Guardar\" class=\"input-submit\" value=\"GUARDAR\" onclick=\"xajax_PlanSeguimiento(document.getElementById('desc_plan_seg').value,'$i$j');ValorOk('ok$i$j','$i$j',$ok);\"></td>";
								$salida.="	</tr>";
								$salida.="</table>";
							}
							else
							{
								...
								foreach($plan_seg as $de)
									$plan_s.="<label class=\"label\">".strtoupper($de['plan_seguimiento'])."</label>\n";
						...
						case "22":
							...
							if(!$_SESSION['EPICRISIS_OK']["$ingreso"]["$i$j"])
							{
								...
								$salida.="<tr>";
								$salida.="	<td class=\"label\" colspan=\"2\">TIPO CAUSA</td>";
								...
								$salida.="	<tr>";
								$salida.="		<td class=\"label\" align=\"center\" colspan=\"3\"><input type=\"button\" name=\"Guardar\" class=\"input-submit\" value=\"GUARDAR\" onclick=\"DatosSalida(this.form,'$i$j');ValorOk('ok$i$j','$i$j',$ok);\"></td>";
								$salida.="	</tr>";
								$salida.="</table>";
								$salida.="</form>";
							}
		...
		$mostrarT=$reporte->GetJavaReport('hc','Epicrisis','ReporteEpicrisis',array(),array('rpt_name'=>'Epicrisis'.$ingreso,'rpt_dir'=>'cache','rpt_rewrite'=>TRUE));
		$funcionT=$reporte->GetJavaFunction();
		$this->salida.="		<center><label class=\"label\"><a href=\"javascript:$funcionT\">IMPRIMIR EPICRISIS</a></label> <IMG src=\"".GetThemePath()."/images/imprimir.png\"> </center>";	
