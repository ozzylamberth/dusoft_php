...
/**
 * $Id: ReporteEpicrisis.report.php,v 1.5 2007/02/23 14:21:25 luis Exp $
...
class ReporteEpicrisis_report
{
	...
	function CrearReporte()
	{
		...
		$antecedentes=$epicrisis->GetDatosAntecedentesPersonales($ingreso,$evolucion,$paciente,$tipoidpaciente);
    ...
    $this->imprimir.= "<TR>";
		...
		$this->imprimir.= "<TD ALIGN=\"JUSTIFY\" WIDTH=\"35%\"><FONT SIZE='$size' FACE='arial'><B>FECHA EGRESO:</B>&nbsp;&nbsp;".$FechaS." - ".$HoraS."</FONT></TD>";
