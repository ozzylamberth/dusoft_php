	...
	{ 
	   ...
	   /*Constructor de la clase- Metodo Privado No Modificar*/
		...
		function CrearReporte()
		{
			...
			IncludeClass('Tickets_DispensacionSQL','','app','DispensacionESM');
      ...
      $medicamentos=$sql->Medicamentos_Dispensados_Esm_x_lote_ESM($this->datos['formula_id']);
      $Dx=$ods->Diagnostico_Real($this->datos['formula_id']);
      $pendientes_dis=$ods->pendientes_dispensados_ent_esm($this->datos['formula_id']);
