<?php
  ...
  */
    ...
    * @return string
    */
    function Forma($action,$request,$lista,$Tipo_Id_paciente,$conteo, $pagina)
    {
      ...
      if(!empty($lista))
      {
        ...
        $html .= "		<tr class=\"formulacion_table_list\" >\n";
  			...
  			$html .= "			<td width=\"2%\">DISPENSADOS</td>\n";
        ...
        foreach($lista as $k1 => $dtl)
        {
                ...
                if(!empty($dtl['tipo_formula']))
                {
                      
                    $mostrar = $reporte->GetJavaReport('app','DispensacionESM','MedicamentoDispensadosESM',
                    ...
                    $mostrar_ = $reporte->GetJavaReport('app','DispensacionESM','MedicamentoPendiente_ESM',
              ...
              }else
              {
                    ...
                    $mostrar = $reporte->GetJavaReport('app','DispensacionESM','MedicamentoDispensadosFormulacionExterna',
                    array("formula_id"=>$dtl['formula_id'],"paciente_id"=>$dtl['paciente_id'],"opc"=>"1"),
                    array('rpt_name'=>'','rpt_dir'=>'cache','rpt_rewrite'=>TRUE));
                    $funcion = $reporte->GetJavaFunction();
                    
                    $mostrar_ = $reporte->GetJavaReport('app','DispensacionESM','MedicamentoPendienteFormulacionExterna',
                    array("formula_id"=>$dtl['formula_id']),
                    array('rpt_name'=>'','rpt_dir'=>'cache','rpt_rewrite'=>TRUE));
                   $funcion2 = $reporte->GetJavaFunction();
