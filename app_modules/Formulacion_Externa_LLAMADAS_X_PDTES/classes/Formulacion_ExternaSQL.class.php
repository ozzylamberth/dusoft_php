<?php
  ...
  /*
    ...
    */
    ...
    {
	/*$this->debug=true;*/
          /*$sql = "        SELECT   MAX(to_char(d.fecha_registro,'YYYY-mm-dd')) AS fecha_registro,
                                        '1' as resultado,
                           ...
                           GROUP BY resultado,EXT.formula_papel,SYS.nombre,razon_social ";*/
						  $sql .= "	SELECT
							...
							$sql .= "				
										and 		d.tipo_id_paciente='".trim($tipo_id_paciente)."'
										and 		d.paciente_id='".trim($paciente_id)."'
										and 		c.sw_estado='1'
    ...
    */
	...
	function GuardarLlamada($request){
		...
		$sql = "INSERT INTO llamadas_pacientes 
				(llamada_id,formula_id,contacto_nombre,contacto_parentezco,observacion,fecha,usuario_id)
				VALUES
				(default,".$request['formula_id'].",'".$request['nomcontacto']."','".$request['parentezcocontacto']."',
				 '".$request['observaciones']."',now(),".UserGetUID().")";
	...
	{
	 $sql  = "SELECT llamada_id,formula_id,contacto_nombre,contacto_parentezco,observacion,
				to_char(fecha,'YYYY-MM-DD HH12:MI:SS A.M.') as fecha,
