	...
	* @return boolean
     ...
     function Medicamentos_Farmacovigilancia()
    {
     ...
     function FormaDigitalizar_Ambulatoria()
     {
          ...
          IncludeFileModulo("Formulacion_E","RemoteXajax","app","Formulacion_Externa");
          $this->SetXajax(array("Marcar_Producto","Autorizacion_despacho","Cambiarvetana","Eliminar_codigo_prodcto_d","MostrarProductox","Cancelar_Proceso","GuardarPT","BuscarProducto1","Guardartmp_ambu","IngresarDX","MostrarDX","GuardaEntregaEnFarmacia_tmp"),"app_modules/Formulacion_Externa/RemoteXajax/Formulacion_E.php","ISO-8859-1");
          $this->IncludeJS("CrossBrowser");
          $this->IncludeJS("CrossBrowserEvent");
          $this->IncludeJS("CrossBrowserDrag");         
