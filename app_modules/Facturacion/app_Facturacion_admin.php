...
/**
 * $Id: app_Facturacion_admin.php,v 1.2 2005/06/07 13:41:45 leydi Exp $
...
class app_Facturacion_admin extends classModulo
{


	function app_Facturacion_admin()
	{
...
{
	$this->ReturnMetodoExterno($_SESSION['USER_ADMIN_MOD']['CONTENEDOR'], $_SESSION['USER_ADMIN_MOD']['MOD'], $_SESSION['USER_ADMIN_MOD']['TIPO'], 'TraerDatos',array("tabla"=>'cuentas_filtros_usuarios',"permiso"=>'FACTURACION'));
	return true;
}
