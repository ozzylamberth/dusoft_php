...
/**
 * $Id: ReporteImpCuentas.report.php,v 1.2 2007/02/15 22:41:01 luis Exp $
	...
	function CrearReporte()
	{
		...
		foreach($_SESSION['listado'] as $key=>$valor)
		{
			...
			foreach($valor as $key1=>$valor1)
			{
				...
				$salida .= "					<td width=\"15%\">TERCERO</td>";
				$salida .= "					<td width=\"15%\">PLAN</td>";
				if($this->datos['enlace']==2 AND $this->datos['opcion']==3)
						$salida .= "					<td>ESTADO CUENTA</td>\n";
				$salida .= "					<td width=\"10%\">VALOR CUBIERTO</td>";
				$salida .= "					<td width=\"10%\">VALOR NO CUBIERTO</td>";
				$salida .= "				</tr>\n";
