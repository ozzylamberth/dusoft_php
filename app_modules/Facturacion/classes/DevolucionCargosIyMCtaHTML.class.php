<?php
  /******************************************************************************
  * $Id: DevolucionCargosIyMCtaHTML.class.php,v 1.3 2007/05/09 16:45:45 carlos Exp $
  ...
  class DevolucionCargosIyMCtaHTML
  {
    ...
    ***********************************************************************************/
    function CrearFormaDevolucionCargosCta($Cuenta,$TipoId,$PacienteId,$accionDevolver,$accionSalir,$objeto,$mensaje){ 
      ...
      $file = 'app_modules/Facturacion/RemoteXajax/DevolucionCargosIyMCta.php';
          ...
          foreach($vector1 as $centro_utilidad=>$vector2){
            foreach($vector2 as $bodega=>$vector3){
              foreach($vector3 as $nom_bodega=>$vector4){                
                $html .= "<tr class=\"modulo_table_title\"><td colspan=\"3\">BODEGA:&nbsp;&nbsp;&nbsp;$bodega - $nom_bodega</td></tr>";
                $html .= "<tr class=\"modulo_table_list_title\">";
                $html .= "<td width=\"15%\">CODIGO</td>";
                $html .= "<td>DESCRIPCION</td>";
                $html .= "<td width=\"15%\">CANTIDAD<br>A DEVOLVER</td>";        
                $html .= "</tr>";                
                foreach($vector4 as $codigo_producto=>$datos){
                  ...
                  $val="cantidad||//".$empresa."||//".$centro_utilidad."||//".$bodega."||//".$codigo_producto."||//".$nom_bodega."||//".$datos['cantidad']."||//".$datos['departamento_al_cargar']."";                                                                                                                              
