<?php
  /******************************************************************************
  * $Id: DevolucionCargosIyMCta.class.php,v 1.2 2007/05/09 16:45:45 carlos Exp $
  ...
  class DevolucionCargosIyMCta
  {
    ...
    ******************************************************/
    ...
    function IYMCuenta($Cuenta){
      ...
      $query="SELECT a.*,b.descripcion,c.descripcion as nom_bodega,
      ...
      while($cargos=$resultado->FetchRow()){
        ...
        [$cargos['bodega']][$cargos['nom_bodega']][$cargos['codigo_producto']]=$cargos;    
      }      
      return $vector;
    }
