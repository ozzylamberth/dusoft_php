<?php
	...
	/**
	* $Id: reporte_pedido2_cliente.report.php,v 1.1 2010/04/09 19:50:04 hugo Exp $ 
  ...
  IncludeClass('AutoCarga');
	class reporte_pedido2_cliente_report 
	{ 
	  ...
	  function reporte_pedido2_cliente_report($datos=array())
	  {
			$this->datos=$datos;			
	    return true;
	  }
    ...
    */
		function GetMembrete()
		{
			...
			/*$titulo .= "<b $est >PEDIDO # ".$this->datos['pedido_cliente_id']."<br>";*/
			...
			$html .="		</tr>";
			$html .="		<tr>";
			$html .="			<td align=\"center\" >PEDIDO # ".$this->datos['pedido_cliente_id']."</td>";
			$html .="		</tr>";
			$html .="	</table>";
		...
		function CrearReporte()
	  {
		...
		$detl = $sql->Consulta_Pedido_d($this->datos['pedido_cliente_id']);
      ...
      if(!empty($detl))
      {
		...
		$html .= "			<td width=\"10%\" ><b>OBSERVACIONES:</b> ".$this->datos['observacion']."</td>\n";
		$html .= "		</tr>\n";
		$html .= "</table>";
		$html .= "<br><hr>";
