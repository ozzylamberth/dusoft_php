<?php
	/**
  * @package IPSOFT-SIIS
  * @version $Id: MensajesModuloHTML.class.php,v 1.1.1.1 2009/09/11 20:36:58 hugo Exp $
  ...
  */
    ...
    *
		* @return string
		*/
		function FormaMenuNovedades($action)
		{
      ...
      $html .= "				<tr>\n";
      $html .= "					<td class=\"modulo_list_claro\" align=\"center\">\n";
      $html .= "						<a href=\"".$action['retiros']."\"><b>RETIRO DE ESTUDIANTES</b></a>\n";
      $html .= "					</td>\n";
      $html .= "				</tr>\n";
			$html .= "			</table>\n";
			$html .= "		</td>\n";
