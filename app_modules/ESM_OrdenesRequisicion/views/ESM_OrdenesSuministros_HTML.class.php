<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: ESM_OrdenesSuministros_HTML.class.php
  ...
  */
	...
	class ESM_OrdenesSuministros_HTML
	{
		/**
		* Constructor de la clase
		*/
		function ESM_OrdenesSuministros_HTML(){}
		
    function Vista_OrdenesSuministrosTemporales($accion)
    {
    ...
    $html .= ThemeAbrirTabla('CREACION DE ORDENES DE SUMINISTROS');
    if($_REQUEST['datos']['ssiid']=='0')
    {
			...
			$html .= "        <a href=\"".$accion['suministro']."\">CREAR ORDEN DE SUMINISTRO </a>\n";
			$html .= "      </td>\n";
			$html .= "  </tr>\n";
			$html .= "	</table>\n";
			$html .= "</fieldset><br>\n";
    ...
    {
    $html .= " <div id=\"Temporales_s\"></div>";
    $html .= "";
    $html .= "";
    $html .= "<script>";
    $html .= " xajax_Listado_Temporales_Suministro();";
    $html .= "</script>";
    }
    ...
    return $html;
     ...
     function Vista_FormularioNuevoDoc_Suministro($accion,$ESM,$TiposFuerzas,$TiposRequisiciones,$CentrosUtilidad)
    {
    $html .= " <script>";
    ...
    $html .= ThemeAbrirTabla('CREACION DE ORDENES DE SUMINISTROS',"50%");
    ...
    $html .= "    <tr class=\"formulacion_table_list\" >";
    $html .= "      <td colspan=\"2\">";
    $html .= "      CREACION DE ORDENES DE SUMINISTROS";
    $html .= "      </td>";
    $html .= "    </tr>";
    ...
    function Vista_FormularioModificarDoc_suministro($accion,$DocTemporal,$BodegaSatelite)
    {
    $ctl = AutoCarga::factory("ClaseUtil");
      $html .= "<script>";
      ...
      $html .= "</script>\n";
    $html .= $ctl->AcceptNum(false);
    $html .= ThemeAbrirTabla('CREACION DE ORDENES DE SUMINISTRO');
    $html .= "  <center>";
    $html .= "  <table border=\"0\" width=\"100%\"  class=\"modulo_table_list\"  align=\"center\" rules=\"none\">\n";
    $html .= "    <tr class=\"modulo_list_claro\">";
    $html .= "      <td class=\"formulacion_table_list\">";
    $html .= "      TMP-ID";
    $html .= "      </td>";
    ...
    if(!empty($BodegaSatelite))
    {
        ...
        $html .= "<br>";
        $html .= "<center>";
        $html .= "  <table border=\"0\" width=\"60%\"   class=\"modulo_table_list\"  align=\"center\" rules=\"none\">\n";
        $html .= "    <tr class=\"modulo_list_claro\">";
    ...
    if($_REQUEST['datos']['ssiid']=='0')
    {
      ...
      $html .= "      </td>";
      $html .= "      <td class=\"modulo_list_claro\" >";
      $html .= "      <input type=\"text\" class=\"input-text\" name=\"activo_p\" id=\"activo_p\" style=\"width:100%\">";
      $html .= "      </td>";
      $html .= "		</tr>\n";
      $html .= "		<tr class=\"formulacion_table_list\" >\n";
      $html .= "      <td class=\"formulacion_table_list\" >";
    ...
    {
    $html .= "      <td align=\"center\">\n";
    $html .= "        <input class=\"input-submit\" type=\"button\" value=\"CREAR ORDEN DE SUMINISTRO\" onclick=\"xajax_CrearDocumento_suministro('".$_REQUEST['orden_requisicion_tmp_id']."');\">\n";
    $html .= "      </td>\n";
    }
    $html .= "      <td align=\"center\">\n";
    $html .= "        <input class=\"input-submit\" type=\"submit\" name=\"volver\" value=\"Volver\">\n";
    ...
    $html .= "</form>\n";
    $html .= "  <script>";
    $html .= "  xajax_Listado_Productos_TMP_s('".$_REQUEST['orden_requisicion_tmp_id']."');";
    $html .= "  </script>";
	$html .= ThemeCerrarTabla();
	$html .= $this->CrearVentana(800,"BUSCADOR DE PACIENTES");
    return $html;
    }
		...
		function main($action,$ESM,$request,$TIPO)
    {
			...
			$html .= "  function Paginador_p(value,producto,cantidad,descripcion,formulacio,offset)\n";
			$html .= "  {";
			$html .= "    xajax_Buscar_pacientes_s(value,producto,cantidad,descripcion,formulacio,offset);\n";
			$html .= "  }\n"; 
  ...
  // CREAR LA CAPITA
	function CrearVentana($tmn,$Titulo)
    {
      ...
      $html .= "    xResizeTo(ele,".$tmn.", 'auto');\n";
      $html .= "    xMoveTo(ele, xClientWidth()/5, xScrollTop()+30);\n";
