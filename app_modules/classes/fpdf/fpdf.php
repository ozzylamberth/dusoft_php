...
/*				if(empty($_SESSION['TMP']['CONTROL_CIERRE']['DPTO']))
		...
		if($_SESSION['REPORTES']['VARIABLE']=='solicitudes')
		{
			...
			$html.="<TD WIDTH='70' HEIGHT=25>".$edad['anos'].' AÑOS'."</TD>";
	...
	//		$html.="<TD WIDTH='110' HEIGHT=25></TD>";
		...
		if($_SESSION['REPORTES']['VARIABLE']=='formulacio_amb')
		{
			...
			//$html.="</TD><TD HEIGHT=22 WIDTH='110'>Institución:</TD>";
			//$html.="<TD WIDTH='270' HEIGHT=22></TD>";
			$html.="</TR>";
...
*/
			...
			{
				$html.="<TR>";
				$html.="<TD WIDTH='110' HEIGHT=25>Dirección.:</TD>";
				$dir = $datos[0][residencia_direccion];
				$dir = substr("$dir", 0, 38);
				$html.="<TD WIDTH='270' HEIGHT=25>".strtoupper($dir)."."."</TD>";
				$html.="<TD WIDTH='110' HEIGHT=25>Teléfono:</TD>";
...
//darling envios
		...
		if($_SESSION['REPORTES']['VARIABLE']=='formulacio_amb')
		{
     		...
     		$this->SetFont('Arial','',7);
				...
				$this->Cell(0,10,'Caducidad Tres (3) días calendario',0,0,"C");
