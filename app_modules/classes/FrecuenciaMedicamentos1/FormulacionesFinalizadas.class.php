	...
	class FormulacionesFinalizadas
	{
      ...
      $this->salida .= ReturnBody()."<br>\n";
			...
			foreach($this->soluciones as $key=> $nivel1)
			{
				...
				{
					$this->salida .= "											<tr>\n";
					$this->salida .= "												<td class=\"label\" valign=\"bottom\" align=\"left\"  width=\"80%\">".$nivel2['producto']." <font $est1>(".$nivel2['principio_activo'].")</font></td>\n";
					$this->salida .= "												<td class=\"label\" valign=\"bottom\" align=\"right\" width=\"10%\">".$nivel2['cmedicamento']."</td>\n";
					$this->salida .= "												<td class=\"label\" valign=\"bottom\" align=\"left\"  width=\"10%\">".$nivel2['umm']."</td>\n";
					$this->salida .= "											</tr>\n";
				}
