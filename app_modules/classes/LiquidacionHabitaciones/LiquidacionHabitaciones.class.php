...
/**
* $Id: LiquidacionHabitaciones.class.php,v 1.4 2005/09/26 14:09:28 alex Exp $
*/
...
class LiquidacionHabitaciones
{
    ...
    * @access public
    */
    function LiquidarCargosInternacion($cuenta,$reliquidar=false)
    {
        ...
        while($movimiento =$result->FetchRow())
        {
            ...
            $datos_mov[$Fecha][$movimiento['tipo_clase_cama_id']][$movimiento['tipo_cama_id']][$movimiento['movimiento_id']]=$movimiento;
...
//                             }
                            ...
                            if(!($ultima_clase_cama==$tipo_clase_cama_id && $ultimo_tipo_cama==$tipo_cama_id))
                            {
                                if(!empty($ultima_fecha_mov))
                                {
                                ...
                                $ultimo_tipo_cama = $tipo_cama_id;
                            }

                            if(empty($v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['INICIO']))
                            {
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['INICIO']['FECHA']=$datos['fecha_ingreso'];
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['INICIO']['MKTIME']=$this->getMktime($datos['fecha_ingreso']);
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['INICIO']['DATE']=$this->getDate($datos['fecha_ingreso']);
                            }
                            ...
                            {
                                $ahora=date('Y-m-d H:i:s');
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['FINAL']['FECHA']=$ahora;
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['FINAL']['MKTIME']=$this->getMktime($ahora);
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['FINAL']['DATE']=date('Y-m-d');
                            }
                            else
                            {
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['FINAL']['FECHA']=$datos['fecha_egreso'];
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['FINAL']['MKTIME']=$this->getMktime($datos['fecha_egreso']);
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['FINAL']['DATE']=$this->getDate($datos['fecha_egreso']);
                            }
                            ...
                            if($numTotalMov==$numero_de_movimiento)
                            {
                                ...
                                $v_hospitalizacion[$ultima_fecha_mov][$tipo_clase_cama_id][$tipo_cama_id]['FINAL']['NUM_DIAS']=$numero_dias;
                            }
    ...
    */
    function GenerarCargosRetorno($datos,$dptos_mvto)
    {
        ...
        foreach($datos as $k=>$v)
        {
            ...
            $cargo_liquidado['valor_no_cubierto']=round($v['valor_excedente'],GetDigitosRedondeo());
            $cargo_liquidado['valor_cubierto']=round($v['valor_unidad']*$v['cantidad'],GetDigitosRedondeo());
            $cargo_liquidado['valor_cargo']=round($v['valor_unidad']*$v['cantidad'],GetDigitosRedondeo());
