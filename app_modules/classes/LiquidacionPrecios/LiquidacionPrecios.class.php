		    ...
		    function PlanTarifario($plan_id=null, $tarifario_id='', $cargo='', $grupo_tarifario_id='', $subgrupo_tarifario_id='', $grupo_tipo_cargo='', $tipo_cargo='', $filtro_adicional='', $campos_select='*', $fetch_mode_assoc=false, $Of='',$limit='', $recordSet=true)
    {
        ...
        foreach($filtros as $v){
          ...
          $query = "SELECT $campos_select
                    FROM (
                        (
                            SELECT b.plan_id, a.grupo_tarifario_id, a.subgrupo_tarifario_id, a.grupo_tipo_cargo, a.tipo_cargo, a.tarifario_id, a.cargo, a.descripcion, a.precio, a.gravamen, b.porcentaje, b.por_cobertura, b.sw_descuento, a.sw_cantidad, a.tipo_unidad_id, e.sw_copagos,tu.descripcion_corta
                            FROM tarifarios_detalle a, plan_tarifario b, subgrupos_tarifarios e,tipos_unidades_cargos tu$filtro_tipo_solicitud_tablas
                            WHERE
                            ...
                            excepciones(b.plan_id,b.tarifario_id, a.cargo) = 0 AND
														a.tipo_unidad_id = tu.tipo_unidad_id
                        )
                            UNION
                        (
                            SELECT b.plan_id, a.grupo_tarifario_id, a.subgrupo_tarifario_id, a.grupo_tipo_cargo, a.tipo_cargo, a.tarifario_id, a.cargo, a.descripcion, a.precio, a.gravamen, b.porcentaje, b.por_cobertura, b.sw_descuento, a.sw_cantidad, a.tipo_unidad_id, e.sw_copagos,tu.descripcion_corta   
                            FROM tarifarios_detalle a, excepciones b, subgrupos_tarifarios e,tipos_unidades_cargos tu
                            WHERE
                            $filtroCargo
                            b.plan_id = ".$plan_id." AND
                            b.tarifario_id = a.tarifario_id AND
