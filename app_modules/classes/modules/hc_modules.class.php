...
//                     $salida_submodulo=$this->ProcesoCerrarHistoria(&$tipoCierre);
    ...
    function ExigirSubmodulosObligatorios()
    {
        ...
        while(!$result->EOF)
        {
            ...
            $submodulo_obj->InitSubmodulo($this->datosEvolucion,"cerrar",'frm_'.$result->fields[submodulo],$this->datosPaciente,'',$_SESSION['HC']['estacion'],$_SESSION['HC']['bodega'],0,$this->hc_modulo,$_SESSION['HC']['especialidad'],0,$result->fields[submodulo],$this->datosResponsable,$this->datosAdministrativos);
