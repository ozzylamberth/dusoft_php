...
/*
* selectortariserv.js  13/04/2004 depende de selectortariserv.php
...
function abrirVentana(nombre, url, frm)
{
	...
	var url2 = url+"?tarifario1="+t1+"&empresacon="+em+"&estadocont="+es;
...
function cambio(frm)
{
	...
	var em = frm.empresacon.value;
	var es = frm.estadocont.value;
	window.location='selectortariserv.php?tarifario1='+t1+"&empresacon="+em+"&estadocont="+es;
}
