...
class app_AtencionUrgencias_userclasses_HTML extends app_AtencionUrgencias_user
{

    function app_AtencionUrgencias_user_HTML()
    {
      $this->app_AtencionUrgencias_user(); //Constructor del padre 'modulo'
        $this->salida='';
        return true;
    }
    ...
    {
        $this->ReturnMetodoExterno('app', 'EstacionEnfermeria', 'user', '',array('modulo_externo'=>'AtencionUrgencias','metodo_externo'=>'Pantalla_de_Opciones'));
        return true;
				//ListadoPaciente
    }
		...
		function Pantalla_de_Opciones()
    {
			...
			if(!empty($_REQUEST['AtencionUrgencias']['empresa_id']))
      {
			...
			$this->salida .= ThemeMenuAbrirTabla("ESTACION DE ENFERMERIA &nbsp;".$_SESSION['AtencionUrgencias']['descripcion5']."","50%");
			$this->salida.="<table align='center' border='0' width='95%' cellpadding=\"4\" cellspacing=\"4\">";

    	$conteo_hosp=FormatoValor($this->Get_Conteo_Pacientes_Hospitalizados($_SESSION['AtencionUrgencias']['estacion_id']));
			$conteo_ing=$this->Get_Conteo_Pacientes_XHospitalizar($_SESSION['AtencionUrgencias']);
      $conteo =$conteo_hosp + $conteo_ing;
			if($conteo >0)
      {
					...
					$this->salida.="		</td>";
					$this->salida.="		<td width='68%' align='left'><a href=\"".ModuloGetURL('app','AtencionUrgencias','user','CallListRevisionPorSistemas',array("estacion"=>$_SESSION['AtencionUrgencias']))."\"><b>PACIENTES HOSPITALIZADOS</b></a></td>";
					$this->salida.="	</tr>";
					$this->salida.="	<tr  class='modulo_list_oscuro'>";
					$this->salida.="		<td width='2%' align='center'>&nbsp;</td>";
					$this->salida.="		<td width='68%' align='left'>";
					$this->salida.="			<img src=\"". GetThemePath() ."/images/flecha_der.gif\" width='10' height='10'>&nbsp;Numero de pacientes &nbsp; (".$conteo_hosp.")   &nbsp;,&nbsp; Por Ingresar(".$conteo_ing.")";
					$this->salida.="		</td>";
					$this->salida.="	</tr>";
			}
			...
			if($conteo_cons > 0)
			{
				...
				if(!empty($cons))
				{
						...
						for($d=0; $d<sizeof($cons); $d++)
						{
								...
								$this->salida.="			<img src=\"". GetThemePath() ."/images/editar.gif\"><a href=\"".ModuloGetURL('app','AtencionUrgencias','user','Pac_consultas_Urgencias',array("estacion"=>$_SESSION['AtencionUrgencias'],'consultorio'=>$cons[$d][paciente_urgencia_consultorio_id]))."\">&nbsp;<b>".$nomCons."</b></a> ";
				...
				else
				{
						...
						$this->salida.="			<img src=\"". GetThemePath() ."/images/editar.gif\">&nbsp;&nbsp;";
						$this->salida.="		</td>";
						$this->salida.="		<td width='68%' align='left'><a href=\"".ModuloGetURL('app','AtencionUrgencias','user','Pac_consultas_Urgencias',array("estacion"=>$_SESSION['AtencionUrgencias']))."\"><b>PACIENTES EN CONSULTA</b></a></td>";
						$this->salida.="	</tr>";
						$this->salida.="	<tr class='modulo_list_oscuro'>";
						$this->salida.="		<td width='2%' align='center'>&nbsp;</td>";
						$this->salida.="		<td width='68%' align='left'>";
		  ...
		  $conteo_admin=FormatoValor($this->Get_Conteo_Pacientes_Admision($_SESSION['AtencionUrgencias']['estacion_id']));
			if($conteo_admin > 0)
			{
				...
				$this->salida.="			<img src=\"". GetThemePath() ."/images/editar.gif\">&nbsp;&nbsp;";
				$this->salida.="		</td>";
				$this->salida.="		<td width='68%' align='left'><a href=\"".ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesConfirmarAdmision',array("estacion"=>$_SESSION['AtencionUrgencias']))."\"><b>PACIENTES PARA CONFIRMAR ADMISION</b></a></td>";
				$this->salida.="	</tr>";
				$this->salida.="	<tr  class='modulo_list_oscuro'>";
				$this->salida.="		<td width='2%' align='center'>&nbsp;</td>";
				$this->salida.="		<td width='68%' align='left'>";
			...
			if($conteo_remision > 0 )
			{
				...
				$this->salida.="			<img src=\"". GetThemePath() ."/images/editar.gif\">&nbsp;&nbsp;";
				$this->salida.="		</td>";
				$this->salida.="		<td width='68%' align='left'><a href=\"".ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesClasificar',array("estacion"=>$_SESSION['AtencionUrgencias']))."\"><b>PACIENTES PARA CONFIRMAR REMISION</b></a></td>";
				$this->salida.="	</tr>";
				$this->salida.="	<tr  class='modulo_list_oscuro'>";
				$this->salida.="		<td width='2%' align='center'>&nbsp;</td>";
				$this->salida.="		<td width='68%' align='left'>";
  		...
  		$nom=UserGetVars(UserGetUID());
			if(sizeof($arr) > 0)
			{
				...
				$this->salida.="			<img src=\"". GetThemePath() ."/images/editar.gif\">&nbsp;&nbsp;";
				$this->salida.="		</td>";
				$this->salida.="		<td width='68%' align='left'><a href=\"".ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesAtendidosTriage',array("estacion"=>$_SESSION['AtencionUrgencias']))."\"><b>PACIENTES CLASIFICADOS POR &nbsp;".$nom['nombre']."</b></a></td>";
				$this->salida.="	</tr>";
				$this->salida.="	<tr  class='modulo_list_oscuro'>";
				$this->salida.="		<td width='2%' align='center'>&nbsp;</td>";
				$this->salida.="		<td width='68%' align='left'>";
			...
			$action2=ModuloGetURL('app','AtencionUrgencias','user','main');
	 ...
	 return true;
		...
		*/
		function FormaSacarLista($tipoid,$id,$nombre,$triage,$ingreso)
		{
					...
					$this->salida .= "  </table><BR>";
					$accion=ModuloGetURL('app','AtencionUrgencias','user','SacarPaciente',array('triage_id'=>$triage,'nombre'=>$nombre,'tipo_id_paciente'=>$tipoid,'paciente_id'=>$id,'ingreso'=>$ingreso));
          ...
          if($_SESSION['ATENCION']['URGENCIAS']['SWITCH']=='admision')
				  {$accion=ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesConfirmarAdmision');}

          if($_SESSION['ATENCION']['URGENCIAS']['SWITCH']=='consulta')
            {$accion=ModuloGetURL('app','AtencionUrgencias','user','Pac_consultas_Urgencias');}

					if($_SESSION['ATENCION']['URGENCIAS']['SWITCH']=='remision')
					{$accion=ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesClasificar');}
                        ...
                        foreach($r as $p=>$h)
                        {
                            ...
                            foreach($h as $i=>$j)
                            {
                                ...
                                if(empty($j[6]))
                                {
                                    if($j[9]==='0')
                                    {
                                        $accion=ModuloGetURL('app','AtencionUrgencias','user','ClasificarTriage', array('tipo_id_paciente'=>$t, 'paciente_id'=>$k, 'plan_id'=>$j[10], 'triage_id'=>$j[11], 'punto_triage_id'=>$j[12], 'punto_admision_id'=>$j[13], 'sw_no_atender'=>$j[14], 'ingreso'=>$j[3], 'moduloh'=>$modulo, 'estacion_id'=>$j[8]));
                                    }
                                    else
                                    {
                            ...
                            $this->salida .= "</td>";
														//sacar listado
														$this->salida .= '<td align="center">';
														$accionS=ModuloGetURL('app','AtencionUrgencias','user','SacarPacienteLista',array('nombre'=>$p,'paciente_id'=>$k, 'tipo_id_paciente'=>$t,'ingreso'=>$j[3],'lista'=>1));
    ...
    {
        $_SESSION['HISTORIACLINICA']['RETORNO']['modulo']='AtencionUrgencias';
        ...
        {
            $accion=ModuloGetURL('app','AtencionUrgencias','','');
        }
        ...
        $this->salida .='</td>';
        $this->salida .='<td align="center">';
        $accion=ModuloGetURL('app','AtencionUrgencias','','ListadoPaciente');
        $this->salida .='<form name="volver" method="post" action="'.$accion.'">';
...
/*funcion que debe estar en el mod estacione_controlpaciente*/
		...
		*/
		function ListRevisionPorSistemas($estacion)
		{
			...
			$_SESSION['ESTACION_ENFERMERIA_URG']['RETORNO']['modulo']='AtencionUrgencias';
      ...
      $_SESSION['HISTORIACLINICA']['RETORNO']['contenedor']='app';
			...
			$_SESSION['CENTRALHOSP']['RETORNO']['modulo']='AtencionUrgencias';
			...
			if(!empty($datoscenso))
			{
				...
				{//echo "<br>".$key;//
					if($key == "hospitalizacion")
					{
						...
						$this->salida .= "		<td width=\"16%\"><sub>PACIENTE DE ESTACIÓN</sub></td>\n";
  					...
  					$this->salida .= "		<td width=\"3%\"><sub>ORDEN</sub></td>\n";
						...
						foreach($value as $A => $B)
						{
										...
										//	$open=RetornarWinOpenDatosPaciente($t,$k,$p);
                    //  $this->salida .=$open;
											$linkVerDatos = ModuloGetURL('app','EstacionE_Pacientes','user','CallMostrarDatosIngreso',array("ingresoID"=>$B['ingreso'],"retorno"=>"CallListRevisionPorSistemas","modulito"=>'AtencionUrgencias',"datos_estacion"=>$estacion));
			...
			else //es por que no hay hospitalizados pero todavia podemos revisar los pendientes x ingresar.
			{
					...
					else
					{
								...
								$refresh = ModuloGetURL('app','AtencionUrgencias','user','ListRevisionPorSistemas',array('estacion'=>$estacion));
								$href = ModuloGetURL('app','AtencionUrgencias','user','Pantalla_de_Opciones');
...
function Pacientes_X_Ingresar($estacion,&$reporte,$pacientes)
{
			if(is_array($pacientes))
		{
			for($i=0; $i<sizeof($pacientes); $i++)
			{
				...
				$this->salida .= "<tr class=\"$estilo\" onmouseout=mOut(this,'$backgrounds[$estilo]'); onmouseover=mOvr(this,'#7A99BB');>\n";
				$linkVerDatos = ModuloGetURL('app','EstacionE_Pacientes','user','CallMostrarDatosIngreso',array("ingresoID"=>$pacientes[$i][4],"retorno"=>"CallListRevisionPorSistemas","modulito"=>'AtencionUrgencias',"datos_estacion"=>$estacion));
    ...
    function ListadoPacientesAtendidosTriage()
    {
        ...
        if($arr)
        {
            ...
            $this->salida .= '</table>';*/
				...
				unset($reporte);
        $this->salida .= "<BR>";
				$refresh = ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesAtendidosTriage',array('estacion'=>$estacion));
				$href = ModuloGetURL('app','AtencionUrgencias','user','Pantalla_de_Opciones');
				$this->salida .= "<div class='normal_10' align='center'><br>\n";
				$this->salida .= "	<a href='".$href."'>Retornar al Menu</a>&nbsp;&nbsp;-&nbsp;&nbsp;\n";
				$this->salida .= "	<a href='$refresh'>Refrescar</a><br>\n";
...
function ListadoPacientesClasificar($estacion)
{
        ...
        if($pacientestriage)
        {
            ...
            foreach($pacientestriage as $k=>$v)
            {
                foreach($v as $t=>$s)
                {
                    ...
                    $this->salida .= "</td>";
                    $this->salida .= '<td align="center">';
                    $accion=ModuloGetURL('app','AtencionUrgencias','user','ClasificarTriage',array('paciente_id'=>$s['paciente_id'], 'tipo_id_paciente'=>$s['tipo_id_paciente'], 'plan_id'=>$s['plan_id'], 'triage_id'=>$s['triage_id'], 'punto_triage_id'=>$s['punto_triage_id'], 'punto_admision_id'=>$s['punto_admision_id'], 'sw_no_atender'=>$s['sw_no_atender']));
                    $this->salida.='<a href="'.$accion.'">Clasificar</a>';
                    $this->salida .= "</td>";
										//sacar listado
                    $this->salida .= '<td align="center">';
                    $accionS=ModuloGetURL('app','AtencionUrgencias','user','SacarPacienteLista',array('nombre'=>$s['nombre'],'paciente_id'=>$s['paciente_id'], 'tipo_id_paciente'=>$s['tipo_id_paciente'], 'triage_id'=>$s['triage_id']));
                    $this->salida.='<a href="'.$accionS.'">Sacar</a>';
                    $this->salida .= "</td>";
                    $this->salida .= "</tr>";
                }
        ...
        $this->salida .= "<BR>";
				$refresh = ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesClasificar',array('estacion'=>$estacion));
				$href = ModuloGetURL('app','AtencionUrgencias','user','Pantalla_de_Opciones');
				$this->salida .= "<div class='normal_10' align='center'><br>\n";
				$this->salida .= "	<a href='".$href."'>Retornar al Menu</a>&nbsp;&nbsp;-&nbsp;&nbsp;\n";
				$this->salida .= "	<a href='$refresh'>Refrescar</a><br>\n";
        ...
        if($pacientestriage)
        {
            ...
            foreach($pacientestriage as $k=>$v)
            {
                foreach($v as $t=>$s)
                {
                    ...
                    $this->salida .= '<td align="center">';
                    $accion=ModuloGetURL('app','AtencionUrgencias','user','ClasificarTriage',array('paciente_id'=>$s['paciente_id'], 'tipo_id_paciente'=>$s['tipo_id_paciente'], 'plan_id'=>$s['plan_id'], 'triage_id'=>$s['triage_id'], 'punto_triage_id'=>$s['punto_triage_id'], 'punto_admision_id'=>$s['punto_admision_id'], 'sw_no_atender'=>$s['sw_no_atender'],'pte'=>true));
                    ...
                    $this->salida .= "</td>";
										//sacar listado
                    $this->salida .= '<td align="center">';
                    $accionS=ModuloGetURL('app','AtencionUrgencias','user','SacarPacienteLista',array('nombre'=>$s['nombre'],'paciente_id'=>$s['paciente_id'], 'tipo_id_paciente'=>$s['tipo_id_paciente'], 'triage_id'=>$s['triage_id'],'lista'=>2));
                    $this->salida.='<a href="'.$accionS.'">Sacar</a>';
                    $this->salida .= "</td>";
                    $this->salida .= "</tr>";
                }
            ...
            $this->salida .= '</table>';*/
				...
				$refresh = ModuloGetURL('app','AtencionUrgencias','user','ListadoPacientesConfirmarAdmision',array('estacion'=>$estacion));
				$href = ModuloGetURL('app','AtencionUrgencias','user','Pantalla_de_Opciones');
				$this->salida .= "<div class='normal_10' align='center'><br>\n";
				$this->salida .= "	<a href='".$href."'>Retornar al Menu</a>&nbsp;&nbsp;-&nbsp;&nbsp;\n";
				$this->salida .= "	<a href='$refresh'>Refrescar</a><br>\n";
...
//BuscarPacientesConsulta_Urgencias
						...
						if(is_array($pacientes))
						{
								...
								$this->salida .= "<br><table align=\"center\" width=\"100%\"  border=\"0\" >\n";
								$this->salida .= "	<tr class=\"modulo_table_title\"><td colspan='11' height='30'>PACIENTES EN CONSULTA</td></tr>\n";
								$this->salida .= "	<tr class=\"modulo_table_title\">\n";
								$this->salida .= "		<td width=\"2%\"></td>\n";
								$this->salida .= "		<td width=\"20%\"><sub>PACIENTE DE ESTACIÓN</sub></td>\n";
							...
							//	$this->salida .= "		<td>TRANFUSIONES</td>\n";
								...
								$this->salida .= "</table><br>\n";
								$refresh = ModuloGetURL('app','AtencionUrgencias','user','Pac_consultas_Urgencias',array('estacion'=>$estacion));
								$href = ModuloGetURL('app','AtencionUrgencias','user','Pantalla_de_Opciones');
								$this->salida .= "<div class='normal_10' align='center'><br>\n";
								$this->salida .= "	<a href='".$href."'>Retornar al Menu</a>&nbsp;&nbsp;-&nbsp;&nbsp;\n";
								$this->salida .= "	<a href='$refresh'>Refrescar</a><br>\n";
...
//echo "<br>".$pacientes[$i][23];
									...
									$linkVerDatos = ModuloGetURL('app','EstacionE_Pacientes','user','CallMostrarDatosIngreso',array("ingresoID"=>$pacientes[$i][4],"retorno"=>"Pac_consultas_Urgencias","modulito"=>'AtencionUrgencias',"datos_estacion"=>$estacion));
								...
								/*	//MEDICAMENTOS
									...
									*/
									...
									}else
									{
										...
										//$this->salida .= "	<td align=\"center\">".$pacientes[$i][16]."</td>\n";
										...
										if(empty($pacientes[$i][14]))
										{
												...
												if($pacientes[$i][11] ==='0' )
												{
													   ...
													   $accion=ModuloGetURL('app','AtencionUrgencias','user','ClasificarTriage', array('tipo_id_paciente'=>$pacientes[$i][3], 'paciente_id'=>$pacientes[$i][2], 'plan_id'=>$pacientes[$i][18], 'triage_id'=>$pacientes[$i][19], 'punto_triage_id'=>$pacientes[$i][20], 'punto_admision_id'=>$pacientes[$i][22], 'sw_no_atender'=>$pacientes[$i][21], 'ingreso'=>$pacientes[$i][4], 'moduloh'=>$_SESSION['AtencionUrgencias']['hc_modulo_consulta_urgencias'], 'estacion_id'=>$_SESSION['AtencionUrgencias']['estacion_id']));
										...
										$_SESSION['ATENCION']['URGENCIAS']['SWITCH']='consulta';
  									$accionS=ModuloGetURL('app','AtencionUrgencias','user','SacarPacienteLista',array('nombre'=>$nom,'paciente_id'=>$pacientes[$i][2], 'tipo_id_paciente'=>$pacientes[$i][3],'ingreso'=>$pacientes[$i][4],'lista'=>1));
