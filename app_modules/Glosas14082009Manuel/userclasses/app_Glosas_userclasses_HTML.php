<?php
	/************************************************************************************  
	* $Id: app_Glosas_userclasses_HTML.php,v 1.33 2009/03/19 20:07:27 cahenao Exp $ 
	* 
...
/*			$this->salida .= "			<tr class=\"modulo_table_list_title\">\n";
			...
			$ConceptosGenerales = $gld->ObtenerConceptosGenerales();
			...
			{$none = 'block';}
				...
				{
					$checked = "";
					if($this->CodigoCE == $ConceptosGenerales[$k][codigo_concepto_especifico])
					{$checked = 'checked';}
					$this->salida .= "				<tr class=\"modulo_table_list\">\n";
...
echo "-".$this->MotivoGlosaDescripcion."-";
		...
		************************************************************************************************/
		...
		{			
			...
			$this->SetXajax(array("ObtenerObservacion","IngresarObservacion","AnularGlosaCuenta","ModificarValores","AsignarConceptos"),"app_modules/Glosas/RemoteXajax/Observaciones.php");
		...
		**************************************************************************************************/
		function FormaModificarGlosaCargoCuenta()
		{
			...
			$this->SetXajax(array("ActualizarDetalleGlosa","AnularDetalleGlosa"),"app_modules/Glosas/RemoteXajax/Observaciones.php");
