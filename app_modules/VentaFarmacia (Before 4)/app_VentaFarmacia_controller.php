  ...
  */
    ...
    */
		function main()
		{
			...
			$ttl_gral = "ADMINISTRACI&#211N DE FARMACIA";
			$mtz[0] = 'FARMACIAS';
    ...
    function IngresoTercero()
    {
      ...
      if(!empty($cajas))
      {
        ...
        $action = ModuloGetURL('app','VentaFarmacia','controller',"VentaProductos");
            ...
            $this->salida .= '<script>var href=document.getElementById("link_menu_1").getAttribute("href");window.location.href=href;</script>';
        }
        else
        {
        $frm = AutoCarga::factory("AdministracionFarmaciaHTML", "views", "app", "VentaFarmacia");
