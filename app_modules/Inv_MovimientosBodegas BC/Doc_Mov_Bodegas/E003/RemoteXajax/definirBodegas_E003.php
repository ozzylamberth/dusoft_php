<?php
	/**************************************************************************************
	* $Id: definirBodegas_E003.php,v 1.1 2011/05/30 22:48:03 mauricio Exp $ 
...
//             {var_dumP($productos);
                    ...
                    $salida .= "                      <td align=\"center\">\n";
                                                      $direccion="app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E003/imprimir/imprimir_docE003.php";
 ...
 if(!empty($vector))
 {
   ...
   foreach($vector as $valor=>$productos)
   {
		...
		$salida .= "                      <td align=\"right\">\n";
          ...
          $salida .= "                        ".FormatoValor($productos['cantidad_sistema']-$productos['cantidad'],0);
          $salida .= "                      </td>\n";
          $salida .= "                      <td align=\"right\" class=\"normal_10AN\">\n";
    ...
    if($criterio != "0" && $criterio != "")
    {
      ...
      {             
          ...
          //Mes/Dia/Año  "02/02/2010
           ...
           $malo=$Cont[0]['count'];
                         $action = "Bus_Pro('".$empresa_id."','".$centro_utilidad."','".$bodega."','".$tip_bus."','".$criterio."','".$tipo_prestamo_id."','".$bodegas_doc_id."','".$doc_tmp_id."'";
...
{                       
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $sql = AutoCarga::factory("MovDocE003","classes","app","Inv_MovimientosBodegas");
...
function GuardarTmpDoc($bodegas_doc_id, $observacion, $coordinador_auxiliar,$control_interno,$fecha_selectivo)
{
    ...
    $path = SessionGetVar("rutaImagenes");
    $consulta=new MovBodegasSQL();
    $consulta1=new doc_bodegas_E003();
