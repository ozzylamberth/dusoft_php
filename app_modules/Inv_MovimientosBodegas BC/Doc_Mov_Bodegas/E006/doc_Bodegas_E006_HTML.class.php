<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_E006_HTML.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
	* 
...
include "app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E006/doc_Bodegas_E006.class.php";
...
class doc_Bodegas_E006_HTML
{
 function doc_Bodegas_E006_HTML(){}
...
***********************************************************************************/   
  ...
  $salida .= "                       </td>\n";
  $salida .= "                      <td rowspan='1' id='deparx' colspan='1' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                    DEPARTAMENTO";
  ...
  $sw_maneja_proyecto=$consulta->ConsultaSolicitudProyecto($bodegas_doc_id);
  
  	  if($sw_maneja_proyecto[0]['sw_maneja_proyectos']=='1'){
		$salida .= "                    <tr>\n";
		$salida .= "                      <td rowspan='1' colspan='1' align=\"left\" class=\"modulo_list_claro\"> \n";
		$salida .= "                    PROYECTOS";
		$proyecto=$consulta->ColocarProyectos();
		if(!empty($proyecto))
		{
			  $salida .= "                       <select id=\"proyecto_id\" name=\"proyecto_id\" class=\"select\">";
			  $salida .= "                           <option value=\"0\" SELECTED>SELECCIONAR</option>\n"; 
			  //var_dump($utility);
			  for($i=0;$i<count($proyecto);$i++)
			  {
				$salida .= "                      <option value=\"".$proyecto[$i]['proyecto_id']."\">".$proyecto[$i]['descripcion']."</option>\n";
			  }
			  $salida .= "                       </select>\n";
		}
		$salida .= "                       </td>\n";
		...
		$salida .= "  <input name='proyecto_id' id='proyecto_id' type=\"hidden\" value=\"-1\">\n";
	  }
  $salida .= "                    <tr>\n";
  $salida .= "                       <td  COLSPAN='2' align=\"center\" class=\"modulo_list_claro\">\n";                          //GrabarDocumento(bodegas_doc_id, observacion,centro,bodega)
  $salida .= "                          <input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('depar').value,document.getElementById('proyecto_id').value);\">";//
  $salida .= "                       </td>\n"; 
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
function ColocarProductos3500($bodegas_doc_id,$datos,$tmp_doc_id)
 {
