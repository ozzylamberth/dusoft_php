/**************************************************************************************
* $Id: definirBodegas_E012.js,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
...
function GrabarDocumento(bodegas_doc_id, observacion, codigo_proveedor_id, factura)
  {
  ...
  xajax_GuardarTmpDoc(bodegas_doc_id, observacion, codigo_proveedor_id, factura);
...
************************************************************************************/
function Seleccionado(formulario,tipo_id_tercero,tercero_id,nombre_tercero,codigo_proveedor_id,empresa_id)
{ 
  ...
  if(formulario=="unocreate")
  {
    ...
    document.unocreate.codigo_proveedor_id.value=codigo_proveedor_id;
    document.getElementById('td_terceros_nue_mov').innerHTML=nombre_tercero;
    xajax_Cuadrar_ids_terceros(tipo_id_tercero);
    xajax_Listar_FacturasProveedor(codigo_proveedor_id);
