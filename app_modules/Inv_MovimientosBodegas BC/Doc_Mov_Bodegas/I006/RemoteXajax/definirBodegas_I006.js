/**************************************************************************************
* $Id: definirBodegas_I006.js,v 1.1 2009/07/17 19:08:20 johanna Exp $ 
...
function GrabarDocumento(bodegas_doc_id, observacion, documento_devolucion, fecha_doc_devolucion,tipo_id,tercero_id,fecha_actual)
{
    //alert(documento_devolucion);
    if(documento_devolucion=='')
    {
      document.getElementById('errorcreartmp').innerHTML="EL DOCUMENTO EXIGE UN DOCUMENTO DEVOLUCION";
      return false;
    }
    f1 = new Date(fecha_actual);
    fecha_devolucion=fecha_doc_devolucion.split('-');
    fecha_devol_doc=fecha_devolucion[2]+'/'+ fecha_devolucion[1]+'/'+ fecha_devolucion[0];
    f2 = new Date(fecha_devol_doc);
   // if(fecha_doc_devolucion=='' || f1<f2 || f1>f2)
    //{
   ...
   // alert(observacion);
    // alert(tipo_id);
     //alert(tercero_id);
//alert(documento_devolucion);
//alert(fecha_doc_devolucion);
//     alert(fecha_doc_compra);

  xajax_GuardarTmpDoc(bodegas_doc_id, observacion, documento_devolucion, fecha_doc_devolucion,tipo_id,tercero_id);
}
/////////////////////////////////////
/*function GrabarDocumento(bodegas_doc_id, observacion, documento_devolucion, tipo_id_tercero, tercero_id, fecha_doc_devolucion)
{
...
// alert(documento_devolucion);
//     alert(fecha_doc_compra);
//$observacion='',$tipo_id_tercero,$tercero_id, $documento_devolucion, $fecha_doc_devolucion, $usuario_id=null
 /* xajax_GuardarTmpDoc(bodegas_doc_id, observacion, documento_devolucion, tipo_id_tercero, tercero_id, fecha_doc_devolucion);
 //
}*/
///////////////////////////////////////////
...
//Bus_ter('0','0','0','ContenidoMov1','unocreate','".$tipo_doc_bodega_id."','1')
