<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_E017_HTML.class.php,v 1.1 2009/07/17 19:08:17 mauricio Exp $ 
	* 
...
class doc_bodegas_E017_HTML
{
 function doc_bodegas_E017_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file ='app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E017/RemoteXajax/definirBodegas_E017.php';
...
***********************************************************************************/   
  ...
  $salida .= "                          <a  title=\"SELECIONAR FARMACIA\" class=\"label_error\" href=\"".$java."\">SELECCIONAR FARMACIA DESTINO</a>\n";
  $salida .= "                        </td>";
  $salida .= "                    </tr>\n";
  $salida .= "                    <tr>\n";
  ...
  $salida .="<input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('farmacia_id').value);\">";//
  $salida .= "                       </td>\n"; 
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
***********************************************************************************/   
  ...
  */
  ...
  $salida .= "                  <tr class=\"modulo_table_list_title\">";
  $salida .= "                      <td>FARMACIA DESTINO:</TD><td class=\"modulo_list_claro\">".$DocTemporal_Auxiliar['farmacia_id']."-".$DocTemporal_Auxiliar['razon_social']."</td>";
  $salida .= "                  </tr>";
  $salida .= "                </table>";
  $salida .= "                <br>";
  $salida .= "                 <table width=\"60%\" align=\"center\" class=\"modulo_table_list\">\n";
