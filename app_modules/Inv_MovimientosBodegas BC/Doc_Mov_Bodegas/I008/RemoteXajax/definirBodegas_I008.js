/**************************************************************************************
* $Id: definirBodegas_I008.js,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
...
function GrabarDocumento(bodegas_doc_id, observacion,doc_despacho)
  {
     if(doc_despacho==0)
    {
  ...
  xajax_GuardarTmpDoc(bodegas_doc_id, observacion, doc_despacho);
