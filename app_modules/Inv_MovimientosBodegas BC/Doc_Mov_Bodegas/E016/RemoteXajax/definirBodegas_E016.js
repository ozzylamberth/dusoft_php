/**************************************************************************************
* $Id: definirBodegas_E016.js,v 1.2 2010/07/07 15:40:25 hugo Exp $ 
...
/////////////////////////////////////
function GrabarDocumento(bodegas_doc_id, observacion,orden_requisicion_id,centro_utilidad,bodega)
{
  if(orden_requisicion_id=="")
    {
    alert("Debe Seleccionar Una Orden De Requisicion!!");
    return false;
    }
  xajax_GuardarTmpDoc(bodegas_doc_id,observacion,orden_requisicion_id,centro_utilidad,bodega);
}
///////////////////////////////////////////
