<?php
  /******************************************************************************
  * $Id: doc_Bodegas_E016.class.php,v 1.3 2010/07/07 15:51:31 hugo Exp $
...
//   }
   function SacarProductosTMP($doc_tmp_id,$usuario_id)//
   {
    ...
    function CrearDoc($bodegas_doc_id, $observacion,$OrdenRequisicion)
    {
       $ClassDOC= new BodegasDocumentos($bodegas_doc_id);
       $OBJETO=$ClassDOC->GetOBJ();
       //print_r($OrdenRequisicion);
       $RETORNO=$OBJETO->NewDocTemporal($observacion,UserGetUID(),$OrdenRequisicion);
 ...
 function Guardar_InfoAdicional($Formulario)
		{

		//$this->debug=true;
		$sql  = " UPDATE inv_bodegas_movimiento_tmp_despacho_campania ";
		$sql .= " SET 
                  direccion = '".$Formulario['direccion']."',
                  empresa_transportadora = '".$Formulario['empresa_transportadora']."',
                  numero_guia = '".$Formulario['numero_guia']."'
                  ";
		$sql .= " Where ";
