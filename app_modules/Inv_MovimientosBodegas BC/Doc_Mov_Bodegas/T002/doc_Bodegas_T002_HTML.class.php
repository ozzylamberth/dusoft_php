<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_T002_HTML.class.php,v 1.2 2010/07/07 15:40:25 hugo Exp $ 
	* 
...
class doc_Bodegas_T002_HTML
{
 function doc_Bodegas_T002_HTML(){}
...
*********************************************************************************/ 
    ...
    {    //var_dump($DATOS);
      ...
      $file = 'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/T002/RemoteXajax/definirBodegas_T002.php';
...
function CrearDocumentosHtml($bodegas_doc_id,$dir,$tipo_doc_bodega_id,$nom_bodega,$utilidad,$bodega,$datos)
 {
    ...
    //print_r($datos);
    $consulta = new MovBodegasSQL();
    $OrdenesRequisicion=$consulta->OrdenesRequisicion($datos['empresa_id']);
    $javaC = "<script>\n";
