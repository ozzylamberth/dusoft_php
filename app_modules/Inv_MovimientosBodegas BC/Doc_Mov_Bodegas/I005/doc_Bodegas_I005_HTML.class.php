<?php
    /**************************************************************************************
    * $Id: doc_Bodegas_I005_HTML.class.php,v 1.1 2009/07/17 19:08:20 johanna Exp $
    *
...
include "app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I005/doc_Bodegas_I005.class.php";
...
class doc_bodegas_I005_HTML
{
 function doc_bodegas_I005_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file = 'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I005/RemoteXajax/definirBodegas_I005.php';
     $objeto->SetXajax(array("PintarDptos","PintarBodegas","Subtimit","CrearDocumentoFinalx","BorrarTmpAfirmativo1","MostrarProductox","Borrar","BorrarAjuste","GuardarPT","BuscarProducto1","ObtenerPaginadoPro","GuardarTmpDoc","Cuadrar_ids_terceros","CrearUSA","Buscadorter","ObtenerPaginadoter","Actualizartmp","Devolver","GuardarDevolucion"),$file);
...
***********************************************************************************/
  ...
  $salida .= "                    <tr>\n";
  $salida .= "                      <td rowspan='1' colspan='2' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                    MOTIVO APROVECHAMIENTO";
  $apro=$consulta->Aprovechar();
    if(!empty($apro))
    {
          $salida .= "                       <select id=\"aprov\" name=\"aprov\" class=\"select\" onchange=\"\">";
          $salida .= "                           <option value=\"0\" SELECTED>SELECCIONAR</option>\n";
          //var_dump($utility);
          for($i=0;$i<count($apro);$i++)
          {
            $salida .= "                      <option value=\"".$apro[$i]['tipo_aprovechamiento_id']."\">".$apro[$i]['descripcion']."</option>\n";
          }
          $salida .= "                       </select>\n";
    }
  $salida .= "                       </td>\n";
  ...
  $salida .="<input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('aprov').value,document.getElementById('depar').value);\">";//
  $salida .= "                       </td>\n";
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
***********************************************************************************/
  ...
  $salida .= "                       ";
  $salida .= "                       </td>\n";
  $salida .= "                        <td width='15%' align=\"center\" class=\"modulo_list_claro\" class=\"normal_10AN\" colspan=\"6 \" >\n";
  ...
  $salida .= "		<td width=\"15%\" class=\"modulo_list_claro\" align=\"center\">\n";
	...
	$salida .= "    <input type=\"hidden\"  name=\"token\" id=\"token\"  value=\"0\">\n";
...
$salida .= "                       <td align=\"left\" class=\"modulo_table_list_title\">\n";
  ...
  $salida .= "                        CANTIDAD";
  $salida .= "                       </td>\n";
  $salida .= "                       <td  align=\"left\" class=\"modulo_list_claro\" colspan=\"6\"> \n";
...
function ColocarProductos5000($bodegas_doc_id,$datos,$tmp_doc_id)
 {
    ...
    <script language=\"javaScript\">
      function mOvr(src,clrOver)
               ...
               MostrarProductoxjs('".$tmp_doc_id."','".UserGetUID()."');
    </script>";
    $salida.= $javaC1;
    $salida .= " <div id='ContenedorB3' class='d2Container' style=\"display:none;\">";
    $salida .= "    <div id='tituloB3' class='draggable' style=\"text-transform: uppercase;\"></div>\n";
