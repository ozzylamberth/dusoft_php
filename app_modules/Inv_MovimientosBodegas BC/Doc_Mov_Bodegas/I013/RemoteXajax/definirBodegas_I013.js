...
function Buscar_Formula(evt)
{
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {
    xajax_BuscarFormula(document.getElementById('formula_papel_').value,document.getElementById('empresa_id_receptora').value);
   } 
}   
...
***********************************************************/
function Buscar_ProductosFormula(evt)
{
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {                                                         
     xajax_ListadoProductos_Formula(document.getElementById('bodegas_doc_id').value,document.getElementById('doc_tmp_id').value,document.getElementById('formula_id').value,document.getElementById('formula_papel').value,document.getElementById('empresa_idz').value,document.getElementById('codigo_barras').value,document.getElementById('descripcion').value);
   }
}   
