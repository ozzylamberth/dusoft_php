...
function FormaDocEditar($DATOS)
{
 ...
 function PintarTabla($busqueda,$DocTemporal_Auxiliar)
 {
   ...
   $salida .= "                 <table width=\"50%\" align=\"center\" class=\"modulo_table_list\">\n";
      ...
      $salida .= "                 <table width=\"60%\" align=\"center\" class=\"modulo_table_list\">\n";
      $salida .= "                  <tr class=\"modulo_table_list_title\">";
      $salida .= "                      <td>CODIGO BARRAS :</td><TD><input style=\"width:100%\" onkeydown=\"Buscar_ProductosFormula(event);\" type=\"text\" class=\"input-text\" id=\"codigo_barras\" name=\"codigo_barras\"></TD><td>DESCRIPCION</td><TD><input style=\"width:100%\" type=\"text\" class=\"input-text\" id=\"descripcion\" name=\"descripcion\" onkeydown=\"Buscar_ProductosFormula(event);\"></TD>";
      $salida .= "                  </tr>";
      $salida .= "                 </table>";
	  $salida .= "                <br>";
...
***********************************************************************************/   
  ...
  $salida .= "                    </tr>";
  $salida .= "                    <tr class=\"modulo_list_claro\">";
  $salida .= "                    <td id=\"descripcion_formula\" colspan=\"6\" class=\"label_error\">";
  $salida .= "					  </td>";
  $salida .= "                    </tr>";
  $salida .= "                    <tr>\n";
