<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_E004_HTML.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
	* 
...
class doc_bodegas_E004_HTML
{
 function doc_bodegas_E004_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file ='app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E004/RemoteXajax/definirBodegas_E004.php';
...
***********************************************************************************/   
  ...
  $salida .= "                       </select>\n";
  $salida .= "       </td>\n";
 // $salida .= "      <input type=\"hidden\" name=\"bodegas_doc_id\" value=\"".$bodegas_doc_id."\"size=\"5\">\n";
  $salida .= "<script>";
  $salida .= "  function MostrarOpcion()\n";
  $salida .= "  {\n";
  $salida .= "    frm=document.unocreate;\n";
  //$salida .= "    alert(frm.tipo_doc.value);";
  ...
  $salida .="<input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('tipox_id').value,document.getElementById('id_tercerox').value,document.getElementById('doc_devolucion').value);\">";//
  $salida .= "                       </td>\n"; 
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
function ColocarProductos($bodegas_doc_id,$datos,$tmp_doc_id)
 {
    ...
    <script language=\"javaScript\">
      function mOvr(src,clrOver) 
				...
				xajax_MostrarProductox('".$bodegas_doc_id."','".$tmp_doc_id."','".UserGetUID()."');
        //xajax_RecargarProductosTmp('".$tmp_doc_id."','".UserGetUID()."');
               //MostrarProductoxjs('".$bodegas_doc_id."','".$tmp_doc_id."','".UserGetUID()."');
    </script>";
		
	$salida.= $javaC1;
	$salida .= "<script>";
	$salida .= "	function ValidarCantidad(campo,valor,cant_sol,capa,check)\n";
  	$salida .= "	{\n";
...
***********************************************************************************/   
  ...
  $salida .= "<center><label id=\"error\" class=\"label_error\"></label></center>";
   ...
   $salida .= "         </td>\n";
   $salida .= "         <td>\n";
   $salida .= "         <input type=\"text\" class=\"input-text\" onkeypress=\"return recogerTeclab_1(event);\" id=\"codigo_barras\" style=\"width:100%\">";
   $salida .= "         </td>\n";
   $salida .= "         <td class=\"modulo_table_list_title\">\n";
   $salida .= "         DESCRIPCION";
   $salida .= "         </td>\n";
   $salida .= "         <td>\n";
   $salida .= "         <input type=\"text\" class=\"input-text\" onkeypress=\"return recogerTeclab_1(event);\" id=\"descripcion\" style=\"width:100%\">";
   $salida .= "         </td>\n";
   $salida .= "      </tr>\n";
   $salida .= "     </table>";
