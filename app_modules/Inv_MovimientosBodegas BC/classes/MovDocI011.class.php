...
class MovDocI011 extends ConexionBD
{
/***********************
* constructora
*************************/
...
function Listar_Farmacias($Empresa_Id,$CentroUtilidad,$Bodega,$CodigoEmpresa,$RazonSocial,$offset)
      ...
      SELECT DISTINCT
         ...
         FROM
          empresas
      WHERE
              razon_social ILIKE '%".$RazonSocial."%'
          AND empresa_id ILIKE '%".$CodigoEmpresa."%'
          AND sw_tipo_empresa = '1'
          AND empresa_id IN (
                            SELECT
                            empresa_id
                            from
                            inv_bodegas_movimiento
                            where
                            empresa_destino ='".$Empresa_Id."'
                            )
      ";
    ...
    $sql .= " ORDER BY empresa_id,razon_social ";
