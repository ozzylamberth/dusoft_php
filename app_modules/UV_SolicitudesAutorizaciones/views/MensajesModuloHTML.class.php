<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: MensajesModuloHTML.class.php,v 1.1 2008/03/13 13:36:18 hugo Exp $
  ...
  class MensajesModuloHTML
  {
    ...
    *
		...
		*/
		...
		{
			$html  = ThemeAbrirTabla('SOLICITUDES - MENU');
      ...
      $html .= "            <a href=\"".$action['solicitud']."\"><b>SOLICITUDES</b></a>\n";
      $html .= "          </td>\n";
      $html .= "        </tr>\n";
      $html .= "        <tr>\n";
      $html .= "          <td class=\"modulo_list_claro\" align=\"center\">\n";
      $html .= "            <a href=\"".$action['ordenes']."\"><b>ORDENES DE SERVICIOS</b></a>\n";
      $html .= "          </td>\n";
      $html .= "        </tr>\n";
			$html .= "			</table>\n";
			$html .= "		</td>\n";
