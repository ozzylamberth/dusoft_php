	...
	*/
		...
		function ListarEmpresas()
		{
      		...
      		$sql =" SELECT      b.empresa_id,
								b.razon_social        
					FROM 	    empresas AS b 
					WHERE    	b.sw_tipo_empresa='0' AND  b.sw_activa='1' 
	...
	*/
       ...
       $sql.= " delete from ProductosPendientesPorVerificar
			...
			return $datos;
                 ...
                 /*
                 * consulta que trae los documentos que se debem mostrar en la vista de devolucion a bodega - documentos de la farmacia 
                 */
		function DocumentosParaFarmacia()
		{
		
		
			$sql  = "select valor 
                                 from system_modulos_variables
                                 where  variable = 'documentos_farmacia';";
