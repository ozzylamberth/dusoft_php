    ...
    class app_AdminPedidosEstados_controller extends classModulo
    {
        ...
        ***************************************************************/
		function ResponsablesEstadosPedido()
		{
			...
			$this->salida=$vista->ResponsablesEstadosPedido($action, $datos, $pedido_id, $estado, $siguiente_estado);
        ...
        ***************************************************************/
		function AsignarResponsablesEstadosPedido()
		{
			...
			$this->salida=$vista->FormaMensajeModulo($action,$mensaje,$destinatario_pedido_label);
