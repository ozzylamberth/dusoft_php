<?php
  ...
  */
	...
	{ 
		...
		list($anio,$mes,$dias) = explode(":",$datos_farma[0]['edad']);
		...
		$inicial_apellido=substr($datos_farma[0]['apellidos'], 0, 1);
		   	$inicial_nombre=substr($datos_farma[0]['nombres'], 0, 1);
    ...
    $Salida .= "      <td  class=\"formulacion_table_list\" > <b>NUMERO DE DOCUMENTO: <u>#".$datos_farma[0]['esm_farmaco_id']."</u></b> </td>\n";
		...
		$Salida .= "			<td width=\"10%\" ><b>FARMACIA:</b></td>\n";
		$Salida .= "			<td colspan=\"3\"><b>".$datos_farma[0]['razon_social']." </b></td>\n";
		$Salida .= "		</tr>\n";
		$Salida .= "		<tr $estilo2 height=\"21\">\n";
		...
		$Salida .= "			<td width=\"10%\" ><b>".$datos_farma[0]['tipo_id_paciente']." -".$datos_farma[0]['paciente_id']."</b></td>\n";
			$Salida .= "			<td width=\"5%\" ><b>INICIALES</b></td>\n";
		$Salida .= "			<td width=\"7%\"><b>".$inicial_apellido."  ".$inicial_nombre." </b></td>\n";
		...
		$Salida .= "			<td width=\"10%\" ><b>EDAD</b></td>\n";
		$Salida .= "			<td width=\"15%\"><b>".$edad." &nbsp; ".$edad_t." </b></td>\n";
