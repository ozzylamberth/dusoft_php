            ...
            $vencida='VENCIDA';
              ...
              if($vencida=='' ||  $Cabecera_Formulacion['sw_autorizado']=='1')
              {
                       if(!empty($tiempo_entrega))
                     {
                            ...
                            {
                                $pghtml = AutoCarga::factory('ClaseHTML');
                                $html .= "<table   class=\"modulo_table_list\"  align=\"center\" border=\"0\" width=\"100%\">";
                                $html .= "<tr class=\"formulacion_table_list\">";
                              ...
                              foreach($datos as $key => $dtl)
                              {
                                  ...
                                  if( $con % 2){$estilo='modulo_list_claro';}
                                   ...
                                   else
                                  {
                                              ...
                                              if(empty($marcado))
                                              {
                                                       ...
                                                       $html .= "      <td align=\"center\">\n";
                                                        $html .= "         <a href=\"#\" onclick=\"Recoger_Datos('".$dtl['descripcion']."','".$dtl['codigo_producto']."',document.registrar_dx.cantidad_formulada".$codigo.".value,'".$dtl['cod_principio_activo']."','".$formula_id."')\"  class=\"label_error\" ><img src=\"".GetThemePath()."/images/producto.png\" border='0' ></a>\n";
                                                        $html .= "      </td>\n";
                                          
                                                        $html .= "      <td align=\"center\">\n";
                                                        $html .= "         <a href=\"#\" onclick=\"Recoger_Datos2('".$dtl['descripcion']."','".$dtl['codigo_producto']."',document.registrar_dx.cantidad_formulada".$codigo.".value,'".$dtl['cod_principio_activo']."','".$formula_id."')\"  class=\"label_error\" ><img src=\"".GetThemePath()."/images/checkno.png\" border='0' ></a>\n";
                                                        $html .= "      </td>\n";
                                              }else
                                              {
                                                      $html .= "      <td align=\"center\">\n";
