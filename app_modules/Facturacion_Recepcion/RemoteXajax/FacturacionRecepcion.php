<?php
	...
	*/
	...
	function AdicionarFacturaRecepcion($EmpresaId,$prefijo,$numero,$tamaño,$indicetabla,$indicetr,$agrupada)
	{//echo $numero;
		$objResponse = new xajaxResponse();
		$ventana = CrearVentanaRecepcionFacturaCredito($EmpresaId,$prefijo,$numero,$tamaño,$indicetabla,$indicetr,$agrupada);   
	...
	function CrearVentanaRecepcionFacturaCredito($EmpresaId,$prefijo,$numero,$tamaño,$indicetabla,$indicetr,$agrupada)
	{
		...
		$ventana .= "    <input type=\"button\" class=\"input-submit\" name=\"insertar\" value=\"ACEPTAR\" onclick=\"xajax_ActualizarRecepcionFacturaCredito('$EmpresaId','$prefijo','$numero','$tamaño','$indicetabla','$indicetr','$agrupada',document.formaRecepcionFacturaCredito.observacion.value)\"></td></tr>\n";    
		$ventana .= "  </table><BR>"; 
	...
	function ActualizarRecepcionFacturaCredito($EmpresaId,$prefijo,$numero,$tamaño,$indicetabla,$indicetr,$agrupada,$observacion)
	{
		$objResponse = new xajaxResponse();
