...
/**
 * $Id: FacturaInventario.report.php,v 1.5 2010/11/18 14:18:05 hugo Exp $
...
class FacturaInventario_report
{

	//CONSTUCTOR DE LA CLASE - RECIBE EL VECTOR DE DATOS - METODO PRIVADO NO MODIFICAR
	function FacturaInventario_report($datos=array())
	{
			$this->datos=$datos;
			return true;
	}
    ...
    */
    function CrearReporte()
    {
        ...
        $salida .=  "<td align=\"left\" class=\"normal_10N\">Cliente : ".$dat[0][nombre_tercero]."</td>";
				...
				$salida .= "<table width='80%' border=0>";
				$salida .=  "<tr>";		
				$salida .=  "<td align=\"left\" class=\"normal_10N\" width='15%'>PRODUCTO</td>";
				$salida .=  "<td align=\"left\" class=\"normal_10N\" width='45%'>DETALLE</td>";
				$salida .=  "<td align=\"left\" class=\"normal_10N\" width='5%'>CANTIDAD</td>";
				$salida .=  "<td align=\"right\" class=\"normal_10N\" width='10%'>VALOR SIN IVA</td>";
				$salida .=  "<td align=\"right\" class=\"normal_10N\" width='15%'>VALOR</td>";
				$salida .=  "</tr>";
				for($i=1; $i<sizeof($dat); $i++)
				{        
						$salida .=  "<tr>";
						$salida .=  "<td align=\"left\" class=\"normal_10\" width='15%'>".$dat[$i][codigo_producto]."</td>";
						$salida .=  "<td align=\"left\" class=\"normal_10\" width='45%'>".$dat[$i][descripcion]."</td>";
						$salida .=  "<td align=\"left\" class=\"normal_10\" width='5%'>".$dat[$i][cantidad]."</td>";
						$salida .=  "<td align=\"right\" class=\"normal_10\" width='10%'>".FormatoValor($dat[$i][cantidad]*$dat[$i][precio])."</td>";
						$salida .=  "<td align=\"right\" class=\"normal_10\" width='15%'>$ &nbsp;".FormatoValor($dat[$i][valor_total])."</td>";
						$salida .=  "</tr>";				
				}//fin for

				$salida .=  "<tr>";
				$salida .=  "<td align=\"right\" width='100%' colspan=\"5\">";
				$salida .= "<table width='80%' border=0>";
				$salida .=  "<tr>";		
				$salida .=  "<td colspan=\"3\"align=\"right\" class=\"normal_10N\" width='60%'>%IVA</td>";				
				$salida .=  "<td align=\"right\" class=\"normal_10N\" width='20%'>&nbsp;</td>";
				$salida .=  "</tr>";	
				$j=0;
				...
				{     
					...
					{
						$total_iva=$dat[$j][valor_gravamen];
						$j++;
					}
					$iva=$dat[$j-1][porcentaje_gravamen];
					$i=$j;
					if($iva>0)
					{
						$salida .=  "<tr>";		
						$salida .=  "<td colspan=\"2\"align=\"right\" class=\"normal_10N\" width='60%'>&nbsp;</td>";				
						$salida .=  "<td align=\"right\" class=\"normal_10\" width='20%'>".$iva."</td>";
						$salida .=  "<td align=\"right\" class=\"normal_10\" width='20%'>$ &nbsp;".$total_iva."</td>";
						$salida .=  "</tr>";	
					}
					//$salida .=  "<tr>";		
					//$salida .=  "<td colspan=\"3\"align=\"right\" class=\"normal_10N\" width='80%'>TOTAL IVA</td>";				
					//$salida .=  "<td align=\"right\" class=\"normal_10N\" width='20%'>$ &nbsp;".$total_iva."</td>";
					//$salida .=  "</tr>";	
				}//fin for
				$salida .=  "</table>";
				$salida .=  "</td>";
				...
				$salida .= "<tr><td colspan=\"5\"><br></td></tr>";
				$salida .=  "<tr>";		
				$salida .=  "<td colspan=\"4\"align=\"right\" class=\"normal_10N\" width='80%'>TOTAL</td>";				
				$salida .=  "<td align=\"right\" class=\"normal_10N\" width='20%'>$ &nbsp;".FormatoValor($dat[0][total_factura])."</td>";
				$salida .=  "</tr>";	
				...
				$salida .= "<tr><td align=\"center\" colspan=\"5\">&nbsp;</td></tr>"; 
				$salida .= "<tr><td align=\"center\" colspan=\"5\" class=\"normal_10\">Esta factura cambiaria de compraventa se asimila para todos sus efectos legales a la Letra de Cambio (artículo 621 - 774 del Código de Comercio), el comprador acepta que la firma que aparece como recibido está avalando la firma del mismo.</td></tr>"; 
				$salida .=  "</table>";										
				return $salida;
    }
...
/*					$query = "SELECT a.*, 
					...
					$query = "SELECT a.*, 
										a.fac_factura_inventario_id,c.descripcion,
										c.codigo_producto
