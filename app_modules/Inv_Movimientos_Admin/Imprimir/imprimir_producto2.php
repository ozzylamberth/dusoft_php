<?php
    ...
    **/
    ...
    $consulta1=new BodegasProductos();      
             //GetMovimientoCostosProductoPorLapso($empresa_id,$codigo_producto,$lapso=null, $dia_inicial=null, $dia_final=null)
    $resultado=$consulta1->GetMovimientoCostosProductoPorLapso($empresa_id,$codigo_producto,$lapso,$fecha_inicial, $fecha_final);
...
//          }   
        ...
        else
        {
         ...
         if(!empty($resultado['KARDEX']))
         {
            $salida .= "                   <table width=\"90%\" border='1' align=\"center\" class=\"modulo_table_list\">\n";
            $salida .= "                    <tr>\n";
            $salida .= "                       <td colspan='14' align=\"center\">\n";
            $nombre=$consulta->bodegasname($bodega);
            $salida .= "                        KARDEX GENERAL";
            $salida .= "                       </td>\n";
            $salida .= "                    </tr>\n";
...
//             $salida .= "                       </td>\n";
            ...
            for($i=0;$i<count($resultado['KARDEX']);$i++)
            {
              ...
              $salida .= "                       <td align=\"center\">\n";
              $salida .= "                        ".$resultado['KARDEX'][$i]['centro_utilidad'];
              $salida .= "                       </td>\n";
              $salida .= "                       <td align=\"center\">\n";
              $salida .= "                        ".$resultado['KARDEX'][$i]['bodega'];
              $salida .= "                       </td>\n";
              $salida .= "                       <td align=\"center\">\n";
