...
//         print_r($resultado);
         if(!empty($resultado['KARDEX']))
         {
            ...
            $nombre=$consulta->bodegasname($bodega);
            $salida .= "                        MOVIMIENTO DEL PRODUCTO: <b>".$resultado['codigo_producto']."-".$resultado['nombre']."</b> EN EL PERIODO  <b>".$periodo."</b>";
            $salida .= "                       </td>\n";
            $salida .= "                    </tr>\n";
            $salida .= "                    <tr>\n";
...
//             $salida .= "                       </td>\n";
          ...
          //  print_r($resultado['KARDEX']);
			...
			if(($resultado['KARDEX'][$i]['farmacia_id'] == 'FD' && $resultado['KARDEX'][$i]['centro_utilidad'] == '18'&& $resultado['KARDEX'][$i]['bodega'] == '18') || 
			(is_null($resultado['KARDEX'][$i]['farmacia_id'])&& is_null($resultado['KARDEX'][$i]['centro_utilidad'])&& is_null($resultado['KARDEX'][$i]['bodega']))
			|| ($resultado['KARDEX'][$i]['farmacia_id'] == 'FD' && $resultado['KARDEX'][$i]['centro_utilidad'] == '54'&& $resultado['KARDEX'][$i]['bodega'] == '54')
			||($resultado['KARDEX'][$i]['farmacia_id'] == 'FD' && $resultado['KARDEX'][$i]['centro_utilidad'] == '06'&& $resultado['KARDEX'][$i]['bodega'] == '06')
			||($resultado['KARDEX'][$i]['farmacia_id'] == 'FD' && $resultado['KARDEX'][$i]['centro_utilidad'] == '64'&& $resultado['KARDEX'][$i]['bodega'] == '64')
			||($resultado['KARDEX'][$i]['farmacia_id'] == 'FD' && $resultado['KARDEX'][$i]['centro_utilidad'] == '28'&& $resultado['KARDEX'][$i]['bodega'] == '28')
			||($resultado['KARDEX'][$i]['farmacia_id'] == '01')
			||($resultado['KARDEX'][$i]['farmacia_id'] == '02')
			){
			
              $documento_detalle=$consulta->SacarDocumento($empresa_id,$resultado['KARDEX'][$i]['prefijo'],$resultado['KARDEX'][$i]['numero']);
...
//             $salida .= "                   </table>\n";
        ...
        */      
         ...
         if(!empty($compras))
         {
               ...
               $salida .= "                    <tr>\n";
               $salida .= "                       <td colspan='5' align=\"center\">\n";
               $salida .= "                        <b>PENDIENTES POR COMPRAR DE ".$resultado['nombre']."</b>";
               $salida .= "                       </td>\n";
               $salida .= "                    </tr>\n";
