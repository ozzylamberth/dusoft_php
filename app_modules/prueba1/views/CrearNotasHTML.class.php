  ...
  */
	...
	class CrearNotasHTML
	{
		...
		*/
		...
		$html .= "<script>
					function onGetTestAjax(){
					
						
						xajax_TestingAjax('table1');
					}
		...
		*/
		...
		$accion=$action['volver'];
			$html .= ThemeAbrirTabla('ACTAS TECNICAS  prueba1********* PRODUCTOS');
		...
		$html .= "      <table border=\"0\" width=\"70%\" align=\"center\" class=\"modulo_table_list\">";
			...
			$html .= "      BUSCAR PROVEEDORES - FACTURAS";
			$html .= "      </td>";
			$html .= "      </tr>";
		...
		$html .= "      <tr class=\"modulo_table_list_title\">";
			...
			$html .= "		<input type='button' onclick='onGetTestAjax()' value='TestAjax' >";
			$html .= "      </td>";
			$html .= "   </tr>";
		...
		if(!empty($datos))
		{
		 ...
		 $html .= "      <table border=\"0\" width=\"95%\" align=\"center\" class=\"modulo_table_list\" id='table1'>";
		 $html .= "      <tr class=\"modulo_table_list_title\">";
		 $html .= "         <td>";
		 $html .= "         #-FACTURA";
		 $html .= "         </td>";
		 ...
		 foreach($datos as $key=>$dtl)
		  {
			  ...
			  //$url = ModuloGetURL('app','Inv_ActasTecnicas','controller','Det_factura_prov')."&buscador[tipo_id_tercero]=".$request['tipo_id_tercero']."&buscador[tercero_id]=".$request['tercero_id']."&buscador[nombre_tercero]=".$request['nombre_tercero']."&buscador[numero_factura]=".$request['numero_factura'];
			  $url = ModuloGetURL('app','Inv_ActasTecnicas','controller','Det_factura_prov');
			  ...
			  $html .= "      <td >";
			  //$html .= "      <a href=\"".$action['detalle_fac']."&numero_factura=".$dtl['numero_factura']."&codigo_proveedor_id=".$dtl['codigo_proveedor_id']."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."\">";
			  $html .= "      <a href=\"".$url."&numero_factura=".$dtl['numero_factura']."&codigo_proveedor_id=".$dtl['codigo_proveedor_id']."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."\">";
			  $html .= "          <img title=\"DETALLE DE LA FACTURA\" src=\"".GetThemePath()."/images/panulado.png\" border=\"0\">\n";
			  $html .= "      </a>";
			  $html .= "      </td>";
			  // $html .= "      <td >";
		 ...
		 $html .= "      </table>";
			...
			$html .= "fdfdfd";
			$html .= "      <table border=\"0\" width=\"95%\" align=\"center\" class=\"modulo_table_list\" id=\"table_test\">";

			$html .= "      </table>";
			
			$html .="<script>";
			$html .="xajax_TestingAjax();";
			$html .="</script>";
		}
...
***********************************/
  ...
  $html .= "  function MostrarSpan()\n";
    ...
    return $html;
		...
		* @return string
		************************************************************************/
		function FormaDetalle($action,$mensaje,$datosF,$fac,$prov)
		{
		    $ctl = AutoCarga::factory("ClaseUtil");
            $sql = AutoCarga::factory("AdicionalesActas", "", "app","Inv_ActasTecnicas");
		    $html  = $ctl->RollOverFilas();

			$html .= "<script lenguage=\"javascript\" src=\"./javascripts/cross-browser/x/x_core.js\"></script>\n";
			$html .= "<script lenguage=\"javascript\" src=\"./javascripts/cross-browser/x/x.js\"></script>\n";
			$html .= "<script lenguage=\"javascript\" src=\"./javascripts/cross-browser/x/x_drag.js\"></script>\n";
			$html .= "<script lenguage=\"javascript\" src=\"./javascripts/cross-browser/x/x_event.js\"></script>\n";
			$html .= "<script lenguage=\"javascript\" src=\"./javascripts/cross-browser/x/lib/xaddeventlistener.js\"></script>\n";
			$html .= "<script lenguage=\"javascript\" src=\"./javascripts/cross-browser/x/lib/xtabpanelgroup.js\"></script>\n";			
        ...
        /******************script*************************/
			...
			$html .= "	function Iniciar(tit)\n";
			$html .= "	{\n";
			$html .= "	 	contenedor = 'd2Container';\n";
			$html .= "		titulo = 'titulo';\n";
			$html .= "		document.getElementById('error').innerHTML = '';\n";
			$html .= "		document.getElementById('criterio').value = '';\n";
			$html .= "		document.getElementById(titulo).innerHTML = tit;\n";
			$html .= "		ele = xGetElementById(contenedor);\n";
			$html .= "	  xMoveTo(ele, xClientWidth()/8, xScrollTop()+50);\n";

			$html .= "	  xResizeTo(ele,700,'auto');\n";
			$html .= "		ele = xGetElementById('d2Contents');\n";
			
			$html .= "	  xMoveTo(ele, xClientWidth(), xScrollTop());\n";
			...
			$html .= "       ele = xGetElementById('d2Contents2');\n";
			$html .= "	}\n";
			
			$html .= "	function Iniciar2(tit)\n";
			$html .= "	{\n";
			$html .= "	 	contenedor = 'd2Container2';\n";
			$html .= "		titulo = 'titulo2';\n";
			$html .= "		document.getElementById('error2').innerHTML = '';\n";
			$html .= "		document.getElementById(titulo).innerHTML = tit;\n";
			$html .= "		ele = xGetElementById(contenedor);\n";
			$html .= "	  xMoveTo(ele, xClientWidth()/3, xScrollTop()+250);\n";
			$html .= "	  xResizeTo(ele,200,'auto');\n";
			...
			$html .= "		ele = xGetElementById(titulo);\n";
			$html .= "	  xResizeTo(ele,180, 20);\n";
			$html .= "		xMoveTo(ele, 0, 0);\n";
			$html .= "	  xEnableDrag(ele, myOnDragStart, myOnDrag, myOnDragEnd);\n";
			$html .= "		ele = xGetElementById('cerrar2');\n";

			$html .= "	  xResizeTo(ele,20, 20);\n";
			$html .= "		xMoveTo(ele, 180, 0);\n";
			$html .= "	}\n";
		
			$html .= "	function Iniciar3(tit)\n";
			$html .= "	{\n";
			//$html .= "      alert('titulo:'+tit);";
			$html .= "	 	contenedor = 'd2Container2';\n";
			$html .= "		titulo = 'titulo2';\n";
			$html .= "		document.getElementById('error2').innerHTML = '';\n";
			$html .= "		document.getElementById('titulo2').innerHTML = tit;\n";
			$html .= "		ele = xGetElementById(contenedor);\n";
			$html .= "	  xMoveTo(ele, xClientWidth()/6, xScrollTop()+5);\n";
			$html .= "	  xResizeTo(ele,900,'auto');\n";
		
			$html .= "	  ele = xGetElementById('d2Contents2');\n";
			$html .= "	   xMoveTo(ele, xClientWidth(), xScrollTop());\n";
			$html .= "	  xResizeTo(ele,900, 'auto');\n";
			$html .= "		ele = xGetElementById(titulo);\n";
			$html .= "	  xResizeTo(ele,850, 20);\n";
			$html .= "		xMoveTo(ele, 0, 0);\n";
			$html .= "	  xEnableDrag(ele, myOnDragStart, myOnDrag, myOnDragEnd);\n";
			$html .= "		ele = xGetElementById('cerrar2');\n";
			$html .= "	  xResizeTo(ele,20, 20);\n";
			$html .= "		xMoveTo(ele, 850 , 0);\n";
			$html .= "	}\n";
			...
			$html .= "</script>\n";		
		/******************script*************************/	
			$html .= ThemeAbrirTabla('ACTAS TECNICAS PRODUCTOS');
			...
			$html .= "	</tr>\n";
			 ...
			 $html .= "         </td>";
			 $html .= "         <td>";
			 $html .= "         <a title=\"PREFIJO-NUMERO\" id=\"doc\">DOCUMENTO</a>";
			 $html .= "         </td>";
			 $html .= "         <td>";
			 $html .= "           ACTA";
			 $html .= "         </td>";			 
			 ...
			 foreach($datosF as $key=>$value)
			 {
			   ...
			   $ordenId = $sql->ObtenerOrden($fac,$prov,$value['codigo_producto'],$value['lote']);
			  
			   $est  = ($est == 'modulo_list_oscuro')?'modulo_list_claro':'modulo_list_oscuro'; 
			   $bck = ($bck == "#CCCCCC")? "#DDDDDD":"#CCCCCC";	
			   $lot = $value['lote'];
			   $fvc = $value['fecha_vencimiento'];
			   $desc = $value['descripcion'];
			   $cod = $value['codigo_producto'];
			   $orden = $ordenId['orden_pedido'];
			   $cant = $ordenId['cantidad'];
			   $emp = $value['empresa_id'];
			   $Cu = $value['centro_utilidad'];
			   $Bod = $value['bodega'];
			   $pref = $value['prefijo'];
			   $num = $value['numero'];
			   ...
			   $html .= "  <td>$".number_format($value['valor'],2)."</td>\n";
			   $html .= "  <td>".$value['lote']."</td>\n";		 
			   $html .= "  <td>".$value['fecha_vencimiento']."</td>\n";		 
			   $html .= "  <td>".number_format($value['porc_iva'],2)."</td>\n";		 
			   $html .= "  <td>".$value['prefijo']."-".$value['numero']."</td>\n";
			   
			   if($value['estado_acta']=='0')
               {			   
			    $html .= " <td>";
			    //$html .= " <a href=\"#\" onclick=\"xajax_FormaActa('$key','$doc_tmp_id','$bodegas_doc_id',xGetElementById('orden').value);\">";
			    $html .= " <a href=\"#\" onclick=\"xajax_FormaActa('".$fac."','".$lot."','".$fvc."','".$desc."','".$cod."','".$orden."','".$cant."','".$emp."','".$Cu."','".$Bod."','".$pref."','".$num."','".$prov."');return false;\">";
			    $html .= " <img title=\"GENERAR ACTA TECNICA\" src=\"".GetThemePath()."/images/folder_vacio.png\" border=\"0\">\n";
			    $html .= " </a>";
			    $html .= " </td>";
               }
				else
				 {
			      $html .= " <td>";
			      $html .= " <img title=\"ACTA YA REGISTRADA PARA ESTE PRODUCTO\" src=\"".GetThemePath()."/images/folder_lleno.png\" border=\"0\">\n";
			      $html .= " </td>";
			     }
			   $html .= " </tr>\n";
			 } 
			...
			$html .= "<div id=\"d2Container2\" class=\"d2Container\" style=\"display:none\">";
			$html .= "    <div id=\"titulo2\" class=\"draggable\" style=\"text-transform: uppercase;\"></div>\n";
			$html .= "    <div id=\"cerrar2\" class=\"draggable\"> <a class=\"hcPaciente\" href=\"javascript:Cerrar('d2Container2');\" title=\"Cerrar\" style=\"font-size:9px\">X</a></div><br><br>\n";
			$html .= "    <div id=\"error2\" class=\"label_error\" style=\"text-transform: uppercase; text-align:center;\"></div>\n";
			$html .= "    <div id=\"d2Contents2\">\n";
			$html .= "    </div>\n";
			$html .= "</div>\n";
