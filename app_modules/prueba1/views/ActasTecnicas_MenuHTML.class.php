<?php
  ...
  */
  ...
  /**
  * Clase Vista: ActasTecnicas_MenuHTML
  * Clase Contiene el menu inicial del Módulo
  */

	class ActasTecnicas_MenuHTML
	{
		/********************************************************
		* Constructor de la clase
		********************************************************/
		function ActasTecnicas_MenuHTML(){}
		...
		********************************************************/        
		...
		$html  = ThemeAbrirTabla('ACTAS TECNICAS DE PRUEBA1******* PRODUCTOS');
		...
		$html .= "      <a href=\"". ModuloGetURL('app','prueba1','controller','CrearNotas')."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."\">BUSCAR FACTURAS POR PROVEEDOR</a>";
		$html .= "      </td>";
		$html .= "      </tr>";
