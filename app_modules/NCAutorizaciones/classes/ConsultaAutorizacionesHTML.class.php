<?php
	/**************************************************************************************
	* $Id: ConsultaAutorizacionesHTML.class.php,v 1.9 2007/06/04 16:12:18 hugo Exp $
		...
		***********************************************************************************/
		function FormaCrearLista($datos,$action,$fnc)
		{
			...
			foreach($datos as $key => $autorizacion)
			{
					...
					$html .= "		<tr class=\"modulo_list_claro\">\n";
					$html .= "			<td class=\"normal_10AN\">".$autorizacion['ingreso']."</td>\n";
					...
					$html .= "				<a title=\"Mostrar Autorizaciones del Ingreso ".$autorizacion['ingreso']."\" href=\"javascript:Autorizaciones(".$autorizacion['ingreso'].",'".$fnc."')\">\n";
