...
function ModificarMolecula($CodigoMolecula_Id) {
    ...
    /*
      ...
      $html .= "      </td>";
      $html .= "      <td align=\"center\" width=\"20%\">";
      $html .= '      <input class="input-text" type="Text" value="'.$Molecula[0]['concentracion'].'" name="concentracion" maxlength="30" onkeyup="this.value=this.value.toUpperCase()" style="width:100%;height:100%">';
      $html .= "      </td>";
      $html .= "      </tr>";
