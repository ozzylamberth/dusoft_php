...
//			$this->salida = gui_theme_menu_acceso($ttl_gral, $mtz, $permisos, $url, $action['buscador']);
		...
		/*
			...
			$action['productos'] = ModuloGetURL("app", "Consulta_Productos", "controller", "BusquedaProductosFarmacias",array("Consulta_Productos"=>$request['Consulta_Productos']));
			
			$action['volver'] = ModuloGetURL("app", "Consulta_Productos", "controller", "MenuBodega");
			$act = AutoCarga::factory("AdminFarmaciaHTML", "views", "app", "Consulta_Productos");
			$this->salida = $act->FormaMenu($action);
			return true;
		}*/
