...
/**
 * $Id: app_EE_PanelEnfermeria_userclasses_HTML.php,v 1.55 2007/01/29 21:29:43 tizziano Exp $
...
class app_EE_PanelEnfermeria_userclasses_HTML extends app_EE_PanelEnfermeria_user
{
     ...
     */
     function FrmListadoPacientesEstacion()
     {
          ...
          $this->salida .= "      <td colspan='14' height='30'>PACIENTES INTERNADOS EN LA ESTACION</td>\n";
          $this->salida .= "  </tr>\n";
          $this->salida .= "  <tr class=\"modulo_table_title\">\n";
          ...
          $this->salida .= "      <td align=\"center\">PROFESIONAL ATENCION</td>\n";
          $this->salida .= "  </tr>\n";
          ...
          foreach($listadoPacientes as $k => $filaPacinte)
          {
               ...
               if($filaPacinte[paciente_cirugia] == 0 )
               {
                    ...
                    if($conducta[hc_tipo_orden_medica_id] == '01' OR  $conducta[hc_tipo_orden_medica_id] == '02' OR $conducta[hc_tipo_orden_medica_id] == '04')
                    {
                         ...
                         if($this->GetUserPermisos($datosEstacion['estacion_id'],'04') AND $this->GetUserPermisos($datosEstacion['estacion_id'],'03'))
                         {
                    ...
                    else
                    {
                         ...
                         if($this->GetUserPermisos($datosEstacion['estacion_id'],'01') AND $this->GetUserPermisos($datosEstacion['estacion_id'],'03') AND $this->GetUserPermisos($datosEstacion['estacion_id'],'04'))
                         {
               ...
               else
               {
                    ...
                    $this->salida .= "      <td>$imagenHC</td>\n";
                    $this->salida .= "      <td align=\"right\">" . $this->GetDiasHospitalizacion($filaPacinte['fecha_hospitalizacion']) . "</td>\n";
                    $this->salida .= "      <td colspan=\"8\" class=\"label_mark\" align=\"center\">EL PACIENTE SE ENCUENTRA EN CIRUGIA</td>\n";
               }
          }
          $this->salida .= "  </table>\n";
     }
     ...
     */
     function FrmListadoPacientesPendientesIngreso()
     {
          ...
          foreach($listadoPacientes as $k => $filaPacinte)
          {
               ...
               if($this->GetUserPermisos($datosEstacion['estacion_id'],'01') AND $this->GetUserPermisos($datosEstacion['estacion_id'],'04'))
               {
     ...
     */
     function FrmListadoPacientesEstacionCirugia()
     {
          ...
          foreach($listadoPacientes as $k => $filaPacinte)
          {
               ...
               if($this->USERPERFIL == '10' OR $this->USERPERFIL == '11' OR $this->USERPERFIL == '12' OR $this->USERPERFIL == '13')
               {
     ...
     */
     function  FrmListadoPacientesConsultaUrgencias($sw)
     {
          ...
          $this->salida .= "<table align=\"center\" width=\"100%\"  border=\"0\" >\n";
          $this->salida .= "  <tr class=\"modulo_table_title\">\n";
          $this->salida .= "      <td colspan='13' height='30'>PACIENTES EN CONSULTA DE URGENCIAS</td>\n";
          $this->salida .= "  </tr>\n";
          $this->salida .= "  <tr class=\"modulo_table_title\">\n";
          $this->salida .= "      <td width=\"15\">&nbsp;</td>\n";
          $this->salida .= "      <td align=\"center\">NOMBRE DEL PACIENTE</td>\n";
		...
		$this->salida .= "      <td width=\"22\">PRIORI.</td>\n";
          ...
          foreach($listadoPacientes as $k => $filaPacinte)
          {
               ...
               {
	               $this->salida .= "<td colspan=\"7\" class=\"label_mark\" align=\"center\">EL PACIENTE SE ENCUENTRA EN CIRUGIA</td>\n";               
               }
               $this->salida .= "  </tr>\n";
          }
          $this->salida .= "  </table>\n";
