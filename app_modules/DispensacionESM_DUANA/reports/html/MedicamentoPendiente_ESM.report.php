	...
	{ 
	   ...
	   /*Constructor de la clase- Metodo Privado No Modificar*/
		...
		function CrearReporte()
		{
			...
			$html .= "									<td width=\"50%\" colspan=\"2\" style=\"text-align:left;text-indent:3pt\" class=\"formulacion_table_list\" >MEDICAMENTO</td>\n";
			...
			{
				$html .= "								<tr >\n";
				$html .= "									<td width=\"50%\" colspan=\"2\" style=\"text-align:left;text-indent:3pt\" class=\"formulacion_table_list\" >".$fila['codigo_medicamento']."</td>\n";
				$html .= "									<td width=\"50%\" colspan=\"2\" style=\"text-align:left;text-indent:3pt\" class=\"formulacion_table_list\" >".$fila['descripcion_prod']."</td>\n";
				$html .= "									<td width=\"50%\" colspan=\"2\" style=\"text-align:left;text-indent:3pt\" class=\"formulacion_table_list\" >".round($fila['total'])."</td>\n";
				$html .= "									</td>\n";
				$html .= "								</tr>\n";
			}
