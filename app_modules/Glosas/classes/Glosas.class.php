  ...
  ********************************************************************************/
	...
	class Glosas
	{
		...
		*****************************************************************************************/
		...
		{
      $sql  = "SELECT GCG.codigo_concepto_general, GCG.descripcion_concepto_general ";
			$sql .= "FROM 	glosas_concepto_general GCG ";
			
      /*SELECT DISTINCT GCG.codigo_concepto_general, GCG.descripcion_concepto_general, 
			CGE.codigo_concepto_especifico, CGE.descripcion_concepto_especifico 
			FROM 	glosas_concepto_general GCG, 
				glosas_concepto_especifico CGE, 
				glosas_concepto_general_especifico GCGE 
			WHERE GCG.codigo_concepto_general = '1' AND GCG.codigo_concepto_general = GCGE.codigo_concepto_general 
			AND GCGE.codigo_concepto_especifico = CGE.codigo_concepto_especifico 
			AND CGE.codigo_concepto_especifico <> '-1' */
    ...
    function ObtenerConceptosGeneralesEdit()
		{
    ...
    function ObtenerConcepGeneralesEspecificos($codigo)
    {
      $sql .= "SELECT DISTINCT GCG.codigo_concepto_general, GCG.descripcion_concepto_general, ";
			$sql .= "	CGE.codigo_concepto_especifico, CGE.descripcion_concepto_especifico ";
			$sql .= "FROM 	glosas_concepto_general GCG, ";
			$sql .= "	glosas_concepto_especifico CGE, ";
			$sql .= "	glosas_concepto_general_especifico GCGE ";
			$sql .= "WHERE GCG.codigo_concepto_general = ".$codigo." AND GCG.codigo_concepto_general = GCGE.codigo_concepto_general ";
			$sql .= "AND GCGE.codigo_concepto_especifico = CGE.codigo_concepto_especifico ";
			$sql .= "AND CGE.codigo_concepto_especifico <> '-1'; ";
