<?php
  /******************************************************************************
  * $Id: GlosaDetalleHTML.class.php,v 1.1 2009/09/02 13:02:28 hugo Exp $
...
//print_r($action);
      ...
      $js .= "  if(valor=='V')\n";
			$js .= "  {\n";
			$js .= "    document.getElementById('div_con_gen').style.display = 'none';\n";
			$js .= "    return;\n";
			$js .= "  }\n";
			$js .= "  var vect;\n";
			...
			$js .= "  } ;\n";*/      
			$js .= "  xajax_ObtenerConcepGeneralesEspecificos(valor, '', '', '');\n";
			$js .= " }\n";
			$js .= " function GetConceptosCargos(valor,vector,transaccion,cargo_cups){\n";
      $js .= "  if(valor=='V')\n";
			$js .= "  {\n";
			$js .= "    document.getElementById('conceptocargos_'+transaccion).style.display = 'none';\n";
			$js .= "    return;\n";
			$js .= "  }\n";
			$js .= "  var vect;\n";
			$js .= "  for(i=0; i<vector.length; i++){\n";
			...
			$js .= "   document.getElementById(identificador).style.display = 'none';\n";
			$js .= "  } ;\n";*/
      $js .= "  xajax_ObtenerConcepGeneralesEspecificos(valor, transaccion, cargo_cups, '');";
			$js .= " }\n";
			$js .= " function GetConceptosInsumos(valor,vector,transaccion,key){\n";
			$js .= "  if(valor=='V')\n";
			$js .= "  {\n";
			$js .= "    document.getElementById('conceptoinsumos_'+transaccion).style.display = 'none';\n";
			$js .= "    return;\n";
			$js .= "  }\n";
			$js .= "  var vect;\n";
			$js .= "  for(i=0; i<vector.length; i++){\n";
			...
			$js .= "    document.getElementById(identificador).style.display = 'none';\n";
			$js .= "  } ;\n";*/
      $js .= "  xajax_ObtenerConcepGeneralesEspecificos(valor, transaccion, '', key);";
			$js .= " }\n";
			$js .= "</script>\n";
			$html .= "$js";
      ...
      $a=0;
			foreach($ConceptosGenerales as $indice => $valor)
      {
        ($a == 0)? $sel = "selected": $sel = "";
        $html .= "          <option value=\"".$valor['codigo_concepto_general']."\" ".$sel.">".$valor['descripcion_concepto_general']."</option>\n";
        $a++;
      }
			$html .= "					</select>\n";
			$html .= "				</td>\n";
...
/*					$html .= "			<td class=\"normal_10AN\">\n";
					...
					{$disableb = "disabled";}
          $html .= "		<td  class=\"normal_10AN\" >\n";
          $html .= "			<select name=\"concepto_general\" id=\"concepto_general\" class=\"select\" onchange=\"GetConceptosCargos(this.value,document.cuenta,'".$detalle['transaccion']."','".$detalle['cargo_cups']."');\" $disableb>\n";
          ...
          foreach($ConceptosGenerales as $indice => $valor)
          {            
            $html .= "          <option value=\"".$valor['codigo_concepto_general']."\" ".$sel.">".$valor['descripcion_concepto_general'].$this->Concepto."</option>\n";
          }
          $html .= "					</select>\n";
...
/*					else
          ...
          $html .= "          <div id=\"conceptocargos_".$detalle['transaccion']."\">\n";
          $html .= "          </div>\n";
					$html .= "				</td>\n";
					$html .= "		</tr>\n";
					//
...
/*					$html .= "			<td class=\"normal_10AN\">\n";
					...
					$html .= "				<select name=\"concepto_general\" id=\"concepto_general\" class=\"select\" onchange=\"GetConceptosInsumos(this.value,document.cuenta,'".$detalle['transaccion']."','".$key."');\" $disableb>\n";
					$html .= "					<option value='V' >-------SELECCIONAR-------</option>\n";			
						/*for($i=0; $i<sizeof($ConceptosGenerales); )
						{
							//($this->Concepto == $ConceptosGenerales[$i]['codigo_concepto_general'])? $sel = "selected": $sel = "";
          ...
          foreach($ConceptosGenerales as $indice => $valor)
          {
            ($this->Concepto == $valor['codigo_concepto_general'])? $sel = "selected": $sel = "";
            $html .= "          <option value=\"".$valor['codigo_concepto_general']."\" ".$sl.">".$valor['descripcion_concepto_general']."</option>\n";
          }
					$html .= "				</select>\n";
					if($detalle['motivo_glosa_descripcion'])
					$html .= "<img src=\"".GetThemePath()."/images/pcargos.png\" style=\"cursor:pointer;\" border=\"0\" title=\"MOTIVO GLOSA: ".$detalle['motivo_glosa_descripcion']."\" >\n";
...
/*					else
          ...
          $html .= "          <div id=\"conceptoinsumos_".$detalle['transaccion']."\">\n";
          $html .= "          </div>\n";
					$html .= "				</td>\n";
					$html .= "		</tr>\n";
					//
...
*/
      ...
      /*$html .= "  if(valor=='V')\n";
			$html .= "  {\n";
			$html .= "    document.getElementById('div_con_gen').style.display = 'none';\n";
			$html .= "    return;\n";
			$html .= "  }\n";*/
			$html .= "  var vect;\n";
      ...
      //$html .= "			  document.getElementById('div_con_gen').style.display = 'none';\n";
			...
			$html .= "  } ;\n";
      //$html .= "  xajax_ObtenerConcepGeneralesEspecificos(valor, '', '', '');\n";
			$html .="}\n";
...
/*			$html .= "		<tr $estilo >\n";
			...
			$html .= "		</tr>\n";
//***********************************
			$ConceptosGenerales = $gl->ObtenerConceptosGeneralesEdit();
