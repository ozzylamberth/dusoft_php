<?php
	/**************************************************************************************
	* $Id: carteraenviada.report.php,v 1.6 2007/08/09 19:44:11 hugo Exp $ 
	* @copyright (C) 2005 IPSOFT - SA (www.ipsoft-sa.com)
	* @package IPSOFT-SIIS
	* 
	**************************************************************************************/
	include_once "./app_modules/Cartera/classes/Cartera.class.php";
	class carteraenviada_report extends Cartera
	{ 
	  ...
	  {
			$anticipo = $this->ObtenerAnticipos($_SESSION['cartera']['empresa_id']);
			...
			$rst = $this->ConsultarCarteraClientesReporte($rqst,$_SESSION['cartera']['empresa_id']);
			...
			if(sizeof($Clientes) > 0)
			{
				...
				$Salida .= $Columna;
				$Salida .= "			<td align=\"center\"><b>ANTICIPOS(-)</b></td>\n";
				...
				foreach($Clientes as $key => $cartera)
				{
					if($cartera['empresa'] != "")
					{
						...
						$saldo -= $anticipo[$cartera['id']]['saldo'];
						$antcp +=  $anticipo[$cartera['id']]['saldo'];
						
						$Salida .= "			<td align=\"right\" valign=\"top\">".formatoValor($anticipo[$cartera['id']]['saldo'])."</td>\n";
						
						$porcentaje = ($cartera['saldo']/$total_cartera)*100;
							
						$Salida .= "			<td align=\"right\" valign=\"top\">".formatoValor($cartera['saldo']-$anticipo[$cartera['id']]['saldo'])."</td>\n";
				...
				$Salida .= "			<td align=\"right\" valign=\"bottom\" ><b>".formatoValor($antcp)." </b></td>\n";
				$Salida .= "			<td align=\"right\" valign=\"bottom\" ><b>".formatoValor($total-$antcp)." </b></td>\n";
