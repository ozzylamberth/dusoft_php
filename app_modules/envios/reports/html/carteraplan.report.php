<?php
	...
	/**************************************************************************************
	* $Id: carteraplan.report.php,v 1.3 2007/05/15 19:06:32 hugo Exp $ 
	* @copyright (C) 2005 IPSOFT - SA (www.ipsoft-sa.com)
	* @package IPSOFT-SIIS
	* 
	**************************************************************************************/
	include_once "./app_modules/Cartera/classes/Cartera.class.php";
	class carteraplan_report extends Cartera
	{ 
		...
		function CrearReporte()
	  {
			...
			$rst = $this->ConsultarCarteraPlanesReporte($this->datos['envio'],$this->datos['periodo'],$_SESSION['cartera']['empresa_id']);
			...
			if(sizeof($Clientes) > 0)
			{
				...
				$Salida .= "		<tr>";
				$Salida .= "			<td align=\"center\" width=\"50\"><b>PLAN</b></td>\n";
				$Salida .= $Columna;
				...
				foreach($Clientes as $key => $cartera)
				{
					if($cartera['plan'] != "")
					{
						$saldo = 0;
						$Salida .= "		<tr height=\"23\">\n";
						$Salida .= "			<td width=\"280\" valign=\"top\"><b>".$cartera['plan']."</b></td>\n";
