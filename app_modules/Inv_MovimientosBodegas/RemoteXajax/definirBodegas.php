             ...
             foreach($tips_docus as $tipo_documento=>$doc_id)
              {  //var_dumP($tipo_documento);
                ...
                {   
                  ...
                  */
                  if($tipo_documento=="I011" || $tipo_documento=="I012")
                  {
                   $direccion_= "app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I011/imprimir/imprimir_docI011.php";
                    ...
                    $salida .= "                     ".$y."";
				    $TorresDespacho = $consulta->Listar_Torres(SessionGetVar("EMPRESA"),$valor['prefijo'],$valor['numero']);
				    $salida .= "<td align=\"center\">\n";                          
		
					$salida .= "<select class = 'select' id='numero_torre' onchange=\"ImprimirDocumentoI011(this.value,'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I011/imprimir/imprimir_documentoI011.php','".SessionGetVar("EMPRESA")."','".$valor['prefijo']."','".$valor['numero']."');\">
				
					<option value=\"No\">--Seleccionar--</option> <option value=\"Todos\">--Todos--</option>";
