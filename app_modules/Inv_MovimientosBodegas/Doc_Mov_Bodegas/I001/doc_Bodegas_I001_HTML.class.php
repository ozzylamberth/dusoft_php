<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_I001_HTML.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
	* 
...
include "app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I001/doc_Bodegas_I001.class.php";
...
class doc_bodegas_I001_HTML
{
 function doc_bodegas_I001_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file = 'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I001/RemoteXajax/definirBodegas_I001.php';
...
***********************************************************************************/   
  ...
  $salida .= "                      </tr>\n";
  $salida .= "                    <tr>\n"; 
  $salida .= "                       <td COLSPAN='2' align=\"left\" class=\"modulo_table_list_title\">\n";
  $salida .= "                        DOCUMENTO DE COMPRA";
  $salida .= "                       </td>\n"; 
  $salida .= "                       <td COLSPAN='2' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                          <input type=\"text\" id=\"doc_compra\" class=\"input-text\" value=\"\">\n";
  $salida .= "                       </td>\n";
  ...
  $salida .= "                       </td>\n"; 
  $salida .= "                       <td COLSPAN='2' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                         <input type=\"text\"  class=\"input-text\" name=\"fecha1\" id=\"fecha1\" value=\"".$fecha."\" size=\"12\" >";//onkeypress=\"return acceptNum(event)\">\n";
  $salida .= "                         <input type=\"text\"  class=\"input-text\" name=\"fecha1\" id=\"fecha1\" value=\"".$fecha."\" size=\"12\" >";//onkeypress=\"return acceptNum(event)\">\n";
 // $salida .="<sub>".ReturnOpenCalendario("unocreate","fecha1","-")."</sub>";
  $salida .= "                       </td>\n";*/
  $salida .= "                    </tr>\n";
  ...
  $salida .="<input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('tipox_id').value,document.getElementById('id_tercerox').value,document.getElementById('doc_compra').value,'','".$fecha."');\">";//
  $salida .= "                       </td>\n"; 
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
***********************************************************************************/   
  ...
  $salida .= "		</td>\n";
  //$salida .= "    <td  width=\"15%\" class=\"modulo_list_claro\" >\n";
  ...
  $salida .= "                       </td>\n";
  $salida .= "                       <td  ROWSPAN='3' id='unidad_pro' align=\"left\" class=\"modulo_list_claro\"COLSPAN='5'> \n";
