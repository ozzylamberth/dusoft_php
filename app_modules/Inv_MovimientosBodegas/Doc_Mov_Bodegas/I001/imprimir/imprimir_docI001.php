...
// echo "<pre>"; print_r($resultado);
  ...
  $salida .=  "<tr><td COLSPAN='7' align=\"center\"><h2>{$resultado['descripcion']}</h2></td></tr>";
  $salida .= "  <tr>\n";
    ...
    if($tipo_doc_general_id=='E012')
      {
                 ...
                 //$IvaProducto = ($valor['valor_unitario']*$porc_iva);
                  $IvaProducto = (($valor['valor_unitario'] * $valor['cantidad'])*$porc_iva);
          ...
          $salida .= "<table width=\"100%\" border='1' align=\"center\" class=\"modulo_table_list\" rules=\"all\">\n";
                  ...
                  $salida .= "                      </td>\n";
                  if($valor_un[$k]==$resultado['tipo_doc_bodega_id'])
                  {
                    $salida .= "                      <td align=\"left\">\n";
                    $salida .= "                       <a>";
                    $salida .= "                       ". $valor_pactado['valor_pactado'];
                    $salida .= "                      </td>\n";
                  }
                  if($tipo_doc_general_id!="I012")
                  {
                  ...
                  {
                    $salida .= "                      <td align=\"RIGHT\">\n";
                    $salida .= "                       ".FormatoValor($valor['valor_unitario'],2);
                    $salida .= "                      </td>\n";
                    $valorTotal += $valor['valor_unitario'];
                  }
                  else
                        if(empty($si_esfarmacia))
                        {
                          $salida .= "                      <td align=\"RIGHT\">\n";
                          $salida .= "                       ".FormatoValor($valor['total_costo'],2);
                          $salida .= "                      </td>\n";
                        }
  ...
  if(empty($si_esfarmacia))
  {
	...
	if($tipo_doc_general_id=="I002")
	{
        ...
        if($parametros_retencion['sw_reteiva']=='2' ||$parametros_retencion['sw_reteiva']=='3')
         ...
         $valorTotal = (((($subtotal+$IvaTotal)-$retencion_fuente)-$retencion_ica)-$retencion_iva);

		      $salida .= "  <tr>\n";
		      $salida .= "    <td width=\"30%\"  class=\"label_error\" >SUBTOTAL</td>\n";
          $salida .= "    <td width=\"30%\"  align=\"right\">".FormatoValor($subtotal,2)."</td>\n";
		      $salida .= "    <td width=\"20%\"  class=\"label_error\" >RET-FTE</td>\n";
		      $salida .= "    <td align=\"right\">".FormatoValor($retencion_fuente,2)."</td>\n";
		      $salida .= "  </tr>\n";
          ...
          $salida .= "    <td align=\"right\">".FormatoValor($IvaTotal,2)."</td>\n";
		      $salida .= "    <td class=\"label_error\" >RETE-ICA</td>\n";
		      $salida .= "    <td align=\"right\">".FormatoValor($retencion_ica,2)."</td>\n";
		      $salida .= "  </tr>\n";

          $salida .= "  <tr>\n";
          $salida .= "    <td class=\"label_error\" >RETE-IVA</td>\n";
          $salida .= "    <td align=\"right\">".FormatoValor($retencion_iva,2)."</td>\n";
