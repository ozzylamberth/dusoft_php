<?php
  /******************************************************************************
  * $Id: doc_Bodegas_E004.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $
  ...
  function SacarProductosTMP($doc_tmp_id,$usuario_id)//
   {
    ...
    function CrearDoc($bodegas_doc_id, $observacion, $tipo_id_tercero, $tercero_id, $doc_devolucion)
    {
       ...
       $RETORNO=$OBJETO->NewDocTemporal($observacion, $tipo_id_tercero, $tercero_id,UserGetUID(),$doc_devolucion);
...
/**
  ...
  function ConsultarItemsExistencias($Codigo_Producto,$Empresa_Id,$Centro_Utilidad,$Bodega,$lote,$fecha_vencimiento)
   ...
   function ProductosDocumento($empresa_id,$prefijo,$numero,$codigo_barras,$descripcion,$bodegas_doc_id,$doc_tmp_id,$codigo_producto)
  {
