/**************************************************************************************
* $Id: definirBodegas_I013.js,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
...
function Buscar_Formula(evt)
{
  var tipo_doc=document.getElementById('tipoDocumento').value;
  var doc=document.getElementById('documento_id').value;
  var formula=document.getElementById('formula_papel_').value;
  

  if(formula.trim() == ""){
   document.getElementById('errorcreartmp').innerHTML="DEBE INGRESAR EL NUMERO DE FORMULA";
   return false; 
  }
  if(doc.trim() !== null && tipo_doc == -1){
   document.getElementById('errorcreartmp').innerHTML="DEBE SELECCIONAR EL TIPO DE DOCUMENTO";
   return false; 
  }
  if(doc.trim() == ""){
   document.getElementById('errorcreartmp').innerHTML="DEBE INGRESAR EL NUMERO DE DOCUMENTO";
   return false; 
  }
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {
    xajax_BuscarFormula(document.getElementById('formula_papel_').value,document.getElementById('empresa_id_receptora').value,tipo_doc,doc);
   } 
}   
...
function GrabarDocumento(bodegas_doc_id, observacion, formula_id,formula_papel)
  {
     if(formula_id=='')
    {
      document.getElementById('errorcreartmp').innerHTML="EL DOCUMENTO EXIGE UNA FORMULA DILIGENCIADA";
      return false;
    }
	if(formula_papel=='')
    {
  ...
  xajax_GuardarTmpDoc(bodegas_doc_id, observacion, formula_id, formula_papel);
...
***********************************************************/
function Buscar_ProductosFormula(evt,tipo_paciente,paciente_id)
{
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {                                                         
      xajax_ListadoProductos_Formula(document.getElementById('bodegas_doc_id').value,document.getElementById('doc_tmp_id').value,document.getElementById('formula_id').value,document.getElementById('formula_papel').value,document.getElementById('empresa_idz').value,document.getElementById('codigo_barras').value,document.getElementById('descripcion').value,tipo_paciente,paciente_id);
   }
}   
