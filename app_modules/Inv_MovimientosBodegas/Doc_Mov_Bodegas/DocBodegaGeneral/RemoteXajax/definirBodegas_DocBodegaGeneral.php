<?php
    /**************************************************************************************
    * $Id: definirBodegas_DocBodegaGeneral.php,v 1.1 2009/07/17 19:08:17 johanna Exp $
...
function BuscarProducto2($empresa_id,$centro_utilidad,$bodega,$tipo_movimiento,$tip_bus,$criterio,$offset)
{
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $consulta=new DocBodegaGeneral();
   //echo $tip_bus;
    if($tip_bus==2)
    {
      $aumento="AND b.codigo_producto ILIKE '%".$criterio."%'";
      $aumento2="";
    }
    elseif($tip_bus==1)
    {
    ...
    elseif($tip_bus==3)
    {
     ...
     elseif($tip_bus==4)
    {
      $aumento2="AND e.descripcion ILIKE '%".$criterio."%'";
    }
    elseif($tip_bus==5)
    {
      $aumento2="AND e.subclase_id ILIKE(UPPER('%".$criterio."%'))";
    }
    elseif($tip_bus==6)
    {
      $aumento2="AND g.descripcion ILIKE(UPPER('%".$criterio."%'))";
    }
    elseif($tip_bus==7)
    {
      $aumento2="AND g.clase_id ='".$criterio."' ";
    }
    ...
    $busqueda=$consulta->BuscarProducto2($empresa_id,$centro_utilidad,$bodega,$aumento,$aumento2,$offset);
    if(!empty($busqueda))
    {
               ...
               $salida .= "                      </td>\n";
               //$salida .= "<pre>".print_r($tip_bus,true)."</pre>";
               $salida .= "                      <td align=\"center\" width=\"35%\">\n";
               ...
               $salida .= "                    </tr>\n";
                for($i=0;$i<count($busqueda);$i++)
                {
                  ...
                  $salida .= "                      </td>\n";*/
                  $salida .= "                      <td align=\"center\" onclick=\"AsignarPro2('".$busqueda[$i]['codigo_producto']."','".$busqueda[$i]['descripcion']."','".$busqueda[$i]['descripcion_unidad']."');\">\n";
               ...
               /*  $Cont=$consulta->ContarProStip($empresa_id,$centro_utilidad,$bodega,$aumento,$aumento2);*/
                ...
                $action = "Bus_Pro('".$empresa_id."','".$centro_utilidad."','".$bodega."','".$tipo_movimiento."','".$tip_bus."','".$criterio."' ";
...
function BuscarProducto21($empresa_id,$centro_utilidad,$bodega,$tipo_movimiento,$tip_bus,$criterio,$offset)
{
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $consulta=new DocBodegaGeneral();
    ...
    if(!empty($busqueda))
    {
             ...
             /*  $salida .= "                      <td align=\"center\" width=\"10%\">\n";
               ...
               /*   $salida .= "                      <td align=\"left\" class=\"label_mark\">\n";
                  ...
                  $salida .= "                         ".$busqueda[$i]['laboratorio'];
                  $salida .= "                      </td>\n";*/
                  $salida .= "                      <td align=\"center\" onclick=\"AsignarPro21('".$busqueda[$i]['codigo_producto']."','".$busqueda[$i]['descripcion']."','".$busqueda[$i]['descripcion_unidad']."','".$fechavencimiento."','".$busqueda[$i]['lote']."');\">\n";
                  $salida .= "                         <a title='SELECCIONAR PRODUCTO'>\n";
                  $salida .= "                          <sub><img src=\"".$path."/images/checkno.png\" border=\"0\" width=\"14\" height=\"14\"></sub>\n";
                  $salida .= "                         </a>\n";
                  $salida .= "                      </td>\n";
              ...
              $Cont=$consulta->ContarProStip1($empresa_id,$centro_utilidad,$bodega,$aumento,$aumento2);
              $malo=$Cont[0]['count'];
...
//(empresa_id,centro_utilidad,bodega,tipo_movimiento,tip_bus,criterio,offset
function BuscarProducto1($empresa_id,$centro_utilidad,$bodega,$tipo_movimiento,$tip_bus,$criterio,$offset)
{                       
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $consulta=new DocBodegaGeneral(); 
   //echo $tip_bus; 
    ...
    elseif($tip_bus==4)
    {
      $aumento2="AND z.descripcion ILIKE '%".$criterio."%'";
    }
    elseif($tip_bus==5)
    {
      $aumento2="AND z.subclase_id ILIKE(UPPER('%".$criterio."%'))";
    }
    elseif($tip_bus==6)
    {
      $aumento2="AND g.descripcion ILIKE(UPPER('%".$criterio."%'))";
    ...
    {             
               ...
               $salida .= "                    </tr>\n";         
                ...
                {   
                  ...
                  $salida .= "                         ".$busqueda[$i]['laboratorio'];
                  $salida .= "                      </td>\n";
                  $salida .= "                      <td align=\"center\" onclick=\"AsignarPro('".$busqueda[$i]['codigo_producto']."','".$busqueda[$i]['descripcion']."','".$busqueda[$i]['descripcion_unidad']."','".$busqueda[$i]['costo']."','".$busqueda[$i]['existencia']."');\">\n";
                  $salida .= "                         <a title='SELECCIONAR PRODUCTO'>\n";
                  $salida .= "                          <sub><img src=\"".$path."/images/checkno.png\" border=\"0\" width=\"14\" height=\"14\"></sub>\n";
                  $salida .= "                         </a>\n";
                  $salida .= "                      </td>\n";
...
function BuscarProducto12($empresa_id,$centro_utilidad,$bodega,$tipo_movimiento,$tip_bus,$criterio,$offset)
{
    $objResponse = new xajaxResponse();
   ...
   //echo $tip_bus;
    ...
    elseif($tip_bus==4)
    {
      $aumento2="AND z.descripcion ='".$criterio."'";
    }
    elseif($tip_bus==5)
    {
      $aumento2="AND z.subclase_id ILIKE(UPPER('%".$criterio."%'))";
             ...
             /*  $salida .= "                      <td align=\"center\" width=\"10%\">\n";
               ...
               $salida .= "                    </tr>\n";
                ...
                /*  $salida .= "                      <td align=\"left\" class=\"label_mark\">\n";
                  ...
                  $salida .= "                         ".$busqueda[$i]['laboratorio'];
                  $salida .= "                      </td>\n";*/
                  $salida .= "                      <td align=\"center\" onclick=\"AsignarPro1('".$busqueda[$i]['codigo_producto']."','".$busqueda[$i]['descripcion']."','".$busqueda[$i]['descripcion_unidad']."','".$busqueda[$i]['costo']."','".$busqueda[$i]['existencia']."','".$fechavencimiento."','".$busqueda[$i]['lote']."');\">\n";
                  $salida .= "                         <a title='SELECCIONAR PRODUCTO'>\n";
                  $salida .= "                          <sub><img src=\"".$path."/images/checkno.png\" border=\"0\" width=\"14\" height=\"14\"></sub>\n";
                  $salida .= "                         </a>\n";
                  $salida .= "                      </td>\n";
...
function GuardarTmpDoc($bodegas_doc_id, $observacion)
{
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $consulta=new MovBodegasSQL();
    $consulta1=new DocBodegaGeneral();
    $valor=$consulta1->CrearDoc($bodegas_doc_id, $observacion);
