/**************************************************************************************
 * $Id: definirBodegas_I012.js,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
...
function Imprimir(torre, direccion, empresa_id, prefijo, numero)
{	
...
function GrabarDocumento(bodegas_doc_id, observacion, tipo_id_tercero, tercero_id, factura)
{
    ...
    if (factura == '')
    {
        document.getElementById('errorcreartmp').innerHTML = "EL DOCUMENTO EXIGE UNA FACTURA DEL PROVEEDOR";
        return false;
    }


    xajax_GuardarTmpDoc(bodegas_doc_id, observacion, tipo_id_tercero, tercero_id, factura);
...
function recogerTeclaBus(evt)
{
    ...
    {
        Bus_Pro(document.getElementById('empresa_idz').value, document.getElementById('centro_utilidadz').value, document.getElementById('bodegaz').value, document.getElementById('tip_bus').value, document.getElementById('criterio').value, document.getElementById('tipo_prestamo_id').value, 1);
    }
}
 ...
 ************************************************************************************/
function Seleccionado(formulario, tipo_id_tercero, tercero_id, nombre_tercero, empresa_id)
{
    ...
    if (formulario == "unocreate")
    {
        ...
        xajax_Listar_FacturasProveedor(tipo_id_tercero, tercero_id);
...
function BuscarProveedor(div, forma)
{
    ...
    xajax_BuscadorProveedores(div, forma);
}

function Paginador(empresa_id, tipo_id_tercero, tercero_id, nombre_tercero, offset)
{
    xajax_BuscadorProveedor_d(empresa_id, tipo_id_tercero, tercero_id, nombre_tercero, offset);
}
...
function productosDevoluciones(bodegas_doc_id, datos, tmp_doc_id, empresa_id, tipo_id_tercero, tercero_id,prefijo,numero,empresa_idD, InformacionTercero, ProductosFactura, DATOS, offset)
{
 
    xajax_productosDevoluciones(bodegas_doc_id, datos, tmp_doc_id, empresa_id,tipo_id_tercero, tercero_id,prefijo,numero,empresa_idD, InformacionTercero, ProductosFactura, DATOS, offset);
}