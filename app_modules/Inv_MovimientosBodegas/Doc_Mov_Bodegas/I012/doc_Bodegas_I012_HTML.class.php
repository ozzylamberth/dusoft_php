...
class doc_bodegas_I012_HTML {
    ...
    function FormaDocumento($DATOS) {    //var_dump($DATOS);
        ...
        $objeto->SetXajax(array("Subtimit", "CrearDocumentoFinalx", "BorrarTmpAfirmativo1", "MostrarProductox", "Borrar", "BorrarAjuste", "IngresoProductosTemporal",
            ...
            "BuscarProductoFactura", "RegistrarFactura", "BuscarProductoFacturaDespacho", "RegistrarFacturaProveedor", "productosDevoluciones"), $file, "ISO-8859-1");
...
//
    ...
    function FormaDocEditar($DATOS, $offset) {
        ...
        $ProductosFactura = $consulta->ProductosFactura(trim($DocTemporal_Auxiliar['tipo_id_tercero']), trim($DocTemporal_Auxiliar['tercero_id']), $DocTemporal_Auxiliar['prefijo'], $DocTemporal_Auxiliar['numero'], $DocTemporal_Auxiliar['empresa_id'],$offset);
         ...
         */                               
        $salida .=$this->ColocarProductos($DATOS['bodegas_doc_id'], $datos, $DATOS['doc_tmp_id'], $datox['empresa_id'], $DocTemporal_Auxiliar, $InformacionTercero, $ProductosFactura, $DATOS, $offset);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    function ColocarProductos($bodegas_doc_id, $datos, $tmp_doc_id, $empresa_id, $DocTemporal_Auxiliar, $InformacionTercero, $ProductosFactura, $DATOS, $offset) {
        $consulta = new MovBodegasSQL();
        ...
        $javaC1.= "</script>\n";
		$javaC1 .="<script>";
        $javaC1 .= "  function PaginadorDocumentos(bodegas_doc_id, datos, tmp_doc_id, empresa_id, tipo_id_tercero, tercero_id,prefijo,numero,empresa_idD, InformacionTercero, ProductosFactura, DATOS,offset)\n";
        $javaC1 .= "  {";
        $javaC1 .= "  xajax_productosDevoluciones(bodegas_doc_id, datos, tmp_doc_id, empresa_id, tipo_id_tercero, tercero_id,prefijo,numero,empresa_idD, InformacionTercero, ProductosFactura, DATOS,offset); \n";//xajax_productosDevoluciones  xajax_IngresoProductosTemporal(bodegas_doc_id,tmp_doc_id,ProductosFactura,'" . UserGetUID() . "'); 
        $javaC1 .= "  }\n";
        $javaC1 .="</script>";
        $salida.="
    <script language=\"javaScript\">
      function mOvr(src,clrOver) 
        ...
        $salida .= "   </div>\n";
        $salida.="</div>";
		//$bodegas_doc_id, $datos, $tmp_doc_id, $empresa_id, $DocTemporal_Auxiliar, $InformacionTercero, $ProductosFactura, $DATOS, $offset
		  
	    $salida.="<script language=\"javaScript\">
										
				
              productosDevoluciones('" . $bodegas_doc_id . "','" . $datos . "','" . $tmp_doc_id . "','" . $empresa_id . "',
			  '" . $DocTemporal_Auxiliar['tipo_id_tercero'] . "',
			  '" . $DocTemporal_Auxiliar['tercero_id'] . "',
			  '" . $DocTemporal_Auxiliar['prefijo'] . "',
			  '" . $DocTemporal_Auxiliar['numero'] . "',
			  '" . $DocTemporal_Auxiliar['empresa_id'] . "',
			  '" . $InformacionTercero . "','" . $ProductosFactura . "','" . $DATOS . "','" . $offset . "');
		</script>";
		
		//productosDevoluciones('" . $bodegas_doc_id . "','" . $datos . "','" . $tmp_doc_id . "','" . $empresa_id . "','" . $DocTemporal_Auxiliar . "','" . $InformacionTercero . "','" . $ProductosFactura . "','" . $DATOS . "');
	
	 $salida .= "<div id=\"Listado_Productos_Devolucion\">\n";
        $salida .= "</div>"; //CIERRA DIV DE LISTADO DE PRODUCTOS CREADOS    
		 
		/*$sql22 = AutoCarga::factory("MovDocI012", "classes", "app", "Inv_MovimientosBodegas");
		$salida .="<script>";
        $salida .= "  function PaginadorDocumentos(param,offset)";
        $salida .= "  {";
        $salida .= "    console.log(param,offset);\n";
        $salida .= "  }\n";
        $salida .="</script>";
		$path = SessionGetVar("rutaImagenes");
		$action['paginador'] = "PaginadorDocumentos('" . $DATOS . "'";
		$pghtml = AutoCarga::factory("ClaseHTML");   
		//FormaDocEditar $this->FormaDocEditar($DATOS,1);
	 
		$salida .= $pghtml->ObtenerPaginadoXajax(356, 1, $action['paginador']);
