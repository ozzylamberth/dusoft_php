...
//   }
    ...
    function consultarPedidoFarmacia($numero_pedido) {
    ...
    function consultarPedidoCliente($numero_pedido) {
    ...
    function ObtnerCantidadSolicitada($Codigo_Producto, $doc_tmp_id, $identificador) {
		...
		FROM
		(
		SELECT  CASE WHEN FR.cantidad_pendiente IS NOT NULL THEN FR.cantidad_pendiente
    ...
    function registrar_log_despachos_ws($tipo_pedido, $numero_pedido, $empresa_id, $prefijo, $numero, $datos_envidos, $datos_recibidos, $tipo) {

        $sql = " insert into logs_despachos_ws (tipo_pedido, numero_pedido, empresa_id, prefijo, numero, datos_envidos, datos_recibidos, tipo) 
                 values ('{$tipo_pedido}', $numero_pedido, '{$empresa_id}', '{$prefijo}', $numero, '{$datos_envidos}', '{$datos_recibidos}', '{$tipo}') ; ";
