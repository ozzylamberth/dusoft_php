   ...
   /* if(($resultado['DATOS_ADICIONALES']['TIPO DE DESPACHO :'])=='CLIENTES')
    ...
    if(($resultado['DATOS_ADICIONALES']['TIPO DE DESPACHO :'])!='CLIENTES')
    {
     ...
     /*$salida .= "     <td align=\"left\">".$valor['unidad_id']."</td>\n";*/
      ...
      /* Registro INVIMA */    
    $registro_invima = $consulta->obtener_codigo_invima_producto($valor['codigo_producto']);    
    $salida .= "     <td align=\"left\">{$registro_invima['codigo_invima']}</td>";
