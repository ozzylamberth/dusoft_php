<?php
	/**************************************************************************************
	* $Id: definirBodegas_E017.php,v 1.1 2009/07/17 19:08:17 mauricio Exp $ 
	...
	**************************************************************************************/	
	...
	include "../../../app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E017/doc_Bodegas_E017.class.php";
...
//             {var_dumP($productos);
                    ...
                    $salida .= "                      <td align=\"center\">\n";
                                                      $direccion="app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E017/imprimir/imprimir_docE017.php";
...
function GuardarTmpDoc($bodegas_doc_id, $observacion, $farmacia_id)
{
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $consulta1=new doc_bodegas_E017();
    
    $valor=$consulta1->CrearDoc($bodegas_doc_id, $observacion, $farmacia_id);
...
function BuscadorFarmacia($div,$Forma)
{
      $objResponse = new xajaxResponse(); 
      $path = SessionGetVar("rutaImagenes");
      $sql = AutoCarga::factory("MovDocE017","classes","app","Inv_MovimientosBodegas");
