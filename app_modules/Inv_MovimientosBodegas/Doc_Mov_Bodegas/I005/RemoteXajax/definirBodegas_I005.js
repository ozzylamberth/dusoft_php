/**************************************************************************************
* $Id: definirBodegas_I005.js,v 1.1 2009/07/17 19:08:20 johanna Exp $
...
document.getElementById('op22').value="";
       ...
       //   $doc_tmp_id,                 $codigo_producto,                   $cantidad,                                       $porcentaje_gravamen,                           $total_costo,                   $usuario_id=null
function GuardarProductoTemporal200(doc_bodega_id,doc_tmp_id,codigo_producto,cantidad,porcentaje_gravamen,total_costo,usuario_id)
{  /*alert("aa"+codigo_producto);
  alert(doc_bodega_id);
   alert(doc_tmp_id);
   alert("codigo"+codigo_producto);
...
function AsignarPro200(codigo_producto,descripcion,descripcion_unidad)
{
...
function GrabarDocumento(bodegas_doc_id, observacion, aprovechamiento,departamento)
{
     if(observacion=='')
     {
  ...
  xajax_GuardarTmpDoc(bodegas_doc_id, observacion, aprovechamiento,departamento);
}
///////////////////////////////////////////
