...
function confirmarCreacion(){
	var txt;
	var r = confirm('FAVOR VERIFICAR EL PREFIJO, VALORES Y LOS PRODUCTOS DEL DOCUMENTO \nRECUERDE QUE UNA VEZ GUARDADO NO SE PUEDE MODIFICAR!');
	if (r == true) {
		
		r = confirm('CONFIRMA QUE LEYO EL MENSAJE ANTERIOR? \nRECUERDE QUE UNA VEZ GUARDADO NO SE PUEDE MODIFICAR!');
		
		if(r == true){
			xajax_CrearDocumento(xGetElementById('doc_tmp_id').value,xGetElementById('bodegas_doc_id').value);
		}
