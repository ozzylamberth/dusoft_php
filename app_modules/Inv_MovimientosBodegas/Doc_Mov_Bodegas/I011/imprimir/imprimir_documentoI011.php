    ...
    if($tipo_doc_general_id=='E012')
      {
          ...
          $salida .= "<table width=\"100%\" border='1' align=\"center\" class=\"modulo_table_list\" rules=\"all\">\n";
                  ...
                  $salida .= "  <tr  class=\"label\">\n";
				  $salida .= "    <td WIDTH='8%' align=\"center\">\n";
                  $salida .= "      <a TITLE='TORRE'>";
                  $salida .= "        TORRE ". $torre;
                  $salida .= "      </a>";
                  $salida .= "    </td>\n";
				  $salida .= "    <td WIDTH='8%' align=\"center\">\n";
                  $salida .= "      <a TITLE='TIPO PRODUCTO'>";
                 ...
                 /* $salida .= "    <td WIDTH='10%' align=\"center\">\n";
                  ...
                  foreach($resultado['DETALLE'] as $doc_val=>$valor)
                  {
				  if( $torre == 'Todos' || $torre == $valor['torre'] || $torre == 'Sin definir'){
                  $valor_pactado=$consulta->valorunitario($valor['codigo_producto'],$empresa_id);
...
/*FIN*/
  ...
  $salida .= "  <tr>\n";
  $salida .= "    <td align=\"left\">\n";
  $salida .= "     <h4>DEBEN VERIFICAR QUE LOS LOTES, FECHAS DE VENCIMIENTO Y CANTIDADES SEAN IGUALES AL FISICO</h4>";
  $salida .= "    </td>\n";
  $salida .= "  </tr>\n";
  $salida .= "</table>\n";
