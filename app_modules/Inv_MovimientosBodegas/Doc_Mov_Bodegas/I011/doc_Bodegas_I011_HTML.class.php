...
/* * ************************************************************************************  
 * $Id: doc_Bodegas_I011_HTML.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
 * 
...
class doc_bodegas_I011_HTML {

    function doc_bodegas_I011_HTML() {
    ...
    function FormaDocumento($DATOS) {    //var_dump($DATOS);
        ...
        $file = 'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I011/RemoteXajax/definirBodegas_I011.php';
        $objeto->SetXajax(array("Subtimit", "CrearDocumentoFinalx", "BorrarTmpAfirmativo1", "MostrarProductox", "Borrar", "BorrarAjuste", "IngresoProductosTemporal",
            ...
            "ListadoProductos_Farmacia", "ListadoProductos_Farmacia_d", "RegistrarFacturaProveedor", "CambiarInfoDevolucion", "HacerCambiarInfoDevolucion"), $file, "ISO-8859-1");
...
//
    ...
    function FormaDocEditar($DATOS) {
        ...
        $salida .= ReturnOpenCalendarioScript("cambiarinfodevolucion", "fvXX0", '-')
                . ReturnOpenCalendarioScript("cambiarinfodevolucion", "fvXX1", '-')
                . ReturnOpenCalendarioScript("cambiarinfodevolucion", "fvXX2", '-')
                . ReturnOpenCalendarioScript("cambiarinfodevolucion", "fvXX3", '-')
                . ReturnOpenCalendarioScript("cambiarinfodevolucion", "fvXX4", '-');
        ...
        $salida .= "  </table>\n";
        $salida .= " </form>\n";
        $salida .= $this->CrearVentana(650, "CAMBIAR INFORMACION LOTE RECIBIDO");
        $salida .= ThemeCerrarTabla();
        return $salida;
    }
    ...
    function CrearVentana($tmn, $Titulo) {
        ...
        $html .= "  <div id='Contenido' class='d2Content' style='height: 365px ! important;'>\n";
        $html .= "  </div>\n";
        $html .= "</div>\n";
        $html .= "</script>\n";
...
////////////////////////////////////////////////////////////////////////////////
    ...
    <script language=\"javaScript\">
      function mOvr(src,clrOver) 
        ...
        $salida .= "                          <a  title=\"SELECIONAR FARMACIA\" class=\"label_error\" href=\"" . $java . "\">SELECCIONAR FARMACIA</a>\n";
        $salida .= "                        </td>";
        $salida .= "                    </tr>\n";
        $salida .= "                    <tr class=\"modulo_list_claro\">";
