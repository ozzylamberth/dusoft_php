...
class MovDocE011 extends ConexionBD
{
/***********************
* constructora
*************************/
...
function Listar_TercerosProveedores($TipoIdTercero,$TerceroId,$Descripcion,$Empresa_Id,$offset)
      ...
      WHERE
          ...
          and
          ter.tipo_id_tercero IN 
                                        (
                                        SELECT
                                        fact.tipo_id_tercero
                                        from
    ...
    /**************************************************************************************
     ...
     $sql .=" AND fact.tipo_id_tercero = '".$tipo_id_tercero."' ";
     $sql .=" AND fact.tercero_id = '".$tercero_id."' ";
