...
class app_Inventarios_userclasses_HTML extends app_Inventarios_user {
    ...
    //=====================================================================================
    function FormaDatosProductoEnInventarios($Empresa, $NombreEmp, $Producto, $existMinima, $existMaxima, $precioVentaAnt, $precioVenta, $precioMinimo, $precioMaximo, $venta, $servicio, $grupo, $NomGrupo, $clasePr, $NomClase, $subclase, $NomSubClase, $codigoPro, $descripcionPro, $grupoContratacion, $autorizadorCompra, $descripcion, $permisosUsuarioMaestro)
    {
		
	    if ($permisosUsuarioMaestro !== 1)
        {
            $varDisabled = 'readonly=\"readonly\"';
        }
        ...
        $this->salida .= "	  	<td><input size=\"15\" type=\"text\" name=\"precioVenta\" value=\"$precioVenta\" class=\"input-text\" $varDisabled>";
        $this->salida .= "		  </tr>";
        $this->salida .= "		  <tr class=\"modulo_list_claro\" height=\"15\">";
        $this->salida .= "	  	<td class=\"" . $this->SetStyle("precioMinimo") . "\">PRECIO MINIMO:</td>";
        $this->salida .= "	  	<td><input size=\"15\" type=\"text\" name=\"precioMinimo\" value=\"$precioMinimo\" class=\"input-text\" $varDisabled>";
        $this->salida .= "	  	<td class=\"" . $this->SetStyle("precioMaximo") . "\">PRECIO MAXIMO:</td>";
        $this->salida .= "	  	<td colspan=\"3\"><input size=\"15\" type=\"text\" name=\"precioMaximo\" value=\"$precioMaximo\" class=\"input-text\" $varDisabled></td>";
        $this->salida .= "		  </tr>";
        if ($venta == 1)
        {
            $varCheck = 'checked';
    ...
    function EditarProductoEmpresa($Empresa, $NombreEmp, $grupo, $clasePr, $subclase, $NomGrupo, $NomClase, $NomSubClase, $Seleccion, $codigoProducto, $codigoPro, $descripcionPro, $permisosUsuarioMaestro)
    {
        ...
        if ($DatosProd)
        {
            ...
            $this->salida .= "			   <td width=\"15%\" class=\"label\">COSTO ULTIMA COMPRA</td><td>" . $DatosProd['costo_ultima_compra'] . "</td>";
            $this->salida .= "			   <td width=\"15%\" class=\"label\">PRECIO VENTA ANTERIOR</td><td>" . $DatosProd['precio_venta_anterior'] . "</td>";
            $this->salida .= "			   <td width=\"15%\" class=\"label\">PRECIO VENTA</td><td><input size=\"10\" type=\"text\" name=\"precioVenta\" value=\"$precioVenta\" $varDisabled></td>";  
            $this->salida .= "			   <input type=\"hidden\" name=\"PrecioVentaActual\" value=\"" . $DatosProd['precio_venta'] . "\">";
            $this->salida .= "			   </tr>";
            $this->salida .= "			   <tr class=\"modulo_list_claro\">";
            $this->salida .= "			   <td width=\"15%\" class=\"label\">PRECIO MINIMO</td><td><input size=\"10\" type=\"text\" name=\"precioMinimo\" value=\"" . $DatosProd['precio_minimo'] . "\" $varDisabled></td>";
            $this->salida .= "			   <td width=\"15%\" class=\"label\">PRECIO MAXIMO</td><td><input size=\"10\" type=\"text\" name=\"precioMaximo\" value=\"" . $DatosProd['precio_maximo'] . "\" $varDisabled></td>";
            $this->salida .= "			   <td width=\"15%\" class=\"label\">&nbsp;</td><td>&nbsp;</td>";
            $this->salida .= "			   </tr>";
            $this->salida .= "			   <tr class=\"modulo_list_oscuro\">";
            if ($DatosProd['sw_vende'] == 1)
