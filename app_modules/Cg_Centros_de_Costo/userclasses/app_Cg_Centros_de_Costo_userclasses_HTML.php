<?php
	/**************************************************************************************  
	* $Id: app_Cg_Centros_de_Costo_userclasses_HTML.php,v 1.3 2007/04/17 21:08:09 jgomez Exp $ 
	* 
  ...
  IncludeClass("ClaseHTML");
	class app_Cg_Centros_de_Costo_userclasses_HTML extends app_Cg_Centros_de_Costo_user
	{
		function app_Cg_Centros_de_Costo_userclasses_HTML(){	}
...
//        var_dump($cuantas);
       if(count($cuantas)>1)
       {
         ...
         $url[1]='Cg_Centros_de_Costo';//m�ulo 
         $url[2]='user';//clase 
         $url[3]='CrearCentro';//m�odo 
  ...
  **********************************************************************************/	
  ...
  { 
      ...
      $this->SetXajax(array("Buscar_Cen","ModificarCen","ModificarCen","CreateCent","Guardar_Cent","up_Cen","EliminarCen","DeleteCent","ChangeSw"),$file); 
      IncludeClass("ClaseHTML");
      ...
      $this->IncludeJS('RemoteXajax/definirCen.js', $contenedor='app', $modulo='Cg_Centros_de_Costo');
           ...
           $javaC1.= "}\n";   
           $javaC1.= "xajax_Buscar_Cen('0','".SessionGetVar("EMPRESA")."','1','0','','');"; 
           $javaC1.= "</script>\n";
           $this->salida.= $javaC1;        
...
***********************************************************************************/              
    ...
    $this->salida .= ThemeAbrirTabla("ADMINISTRADOR DE CENTROS DE COSTO"); 
    $this->salida .= "            <form name=\"cost_cen\" action=\"javascript:Buscar_Cen1('0','".SessionGetVar("EMPRESA")."','1',document.cost_cen.tip_bus.value,document.cost_cen.des_cento.value,'');\" method=\"post\">\n";
    ...
    $this->salida .= "                       <td colspan=align=\"center\">\n";
    ...
    $this->salida .= "                           <option value=\"1\">CENTRO DE COSTO ID</option> \n";
    ...
    $this->salida .= "                          <input type=\"text\" class=\"input-text\" name=\"des_cento\" id=\"des_cento\"  size=\"12\" >\n";//onkeypress=\"return acceptNum(event)\"
    $this->salida .= "                       </td>\n";
    $this->salida .= "                        <td align=\"center\" class=\"normal_10AN\">\n";
    $this->salida .= "                          <input type=\"button\" class=\"input-submit\" value=\"BUSCAR\" onclick=\"xajax_Buscar_Cen('0','".SessionGetVar("EMPRESA")."','1',document.cost_cen.tip_bus.value,document.cost_cen.des_cento.value,'');\">\n";
    $this->salida .= "                        </td>";
    $this->salida .= "                    </tr>\n";         
    $this->salida .= "                    </table>";
    //$this->salida .= "              </form>";        
    ...
    $this->salida .= "                    <tr>\n";
    $this->salida .= "                      <td align=\"center\">\n";
    $nuevocen="javascript:MostrarCapa('ContenedorCent');CreateCent();IniciarCent('CREAR NUEVO CENTRO DE COSTO');";
    $this->salida .= "                          <a  title=\"CREAR NUEVO CENTRO DE COSTO\" class=\"label_error\" href=\"".$nuevocen."\">CREAR NUEVO CENTRO DE COSTO</a>\n";
    $this->salida .= "                      </td>\n";
    $this->salida .= "                      <td align=\"center\">\n";
    $add=ModuloGetURL('app','Cg_Centros_de_Costo','user','AsignarDepto');
    //$add="javascript:MostrarCapa('ContenedorCent');CreateCent();IniciarCent('CREAR NUEVO CENTRO DE COSTO');";
    $this->salida .= "                          <a  title=\"ASIGNAR CENTRO DE COSTO A DEPARTAMENTO\" class=\"label_error\" href=\"".$add."\">ASIGNAR A DEPARTAMENTO</a>\n";
    $this->salida .= "                      </td>\n";
    $this->salida .= "                    </tr>\n";
    $this->salida .= "                   </table>\n";
    $this->salida .= "                <br>\n";        
    $this->salida .= " </div>\n"; 
    $this->salida .= "    <div id='errorchent' class='label_error' style=\"text-transform: uppercase; text-align:center;\"></div>\n";
    $this->salida .= "    <div id=\"centrox\">";
    $this->salida .= "    </div>\n"; 
    $this->salida .= "              </form>";       
...
//       $this->SubMenu();
      ...
      //Buscar_los_depar('".SessionGetVar("EMPRESA")."','1',document.bus_dep.tip_bus.value,document.bus_dep.des_depto.value);
      
      $this->salida .= "            <form name=\"bus_dep\" action=\"javascript:Buscardepartx('".SessionGetVar("EMPRESA")."','1',document.bus_dep.tip_bus.value,document.bus_dep.des_depto.value);\" method=\"post\">\n";
    $this->salida .= "               <div id=\"ventana1\">\n";
