...
/**
 * $Id: app_Os_ListaTrabajo_adminclasses_HTML.php,v 1.2 2005/06/07 13:24:58 leydi Exp $
...
class app_Os_ListaTrabajo_adminclasses_HTML extends app_Os_ListaTrabajo_admin
{
	/**
  ...
  function app_Os_ListaTrabajo_admin_HTML()
	{
		$this->salida='';
		$this->app_Os_ListaTrabajo_admin();
		return true;
	}
