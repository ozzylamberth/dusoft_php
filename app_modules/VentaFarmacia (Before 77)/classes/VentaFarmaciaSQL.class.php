...
class VentaFarmaciaSQL extends ConexionBD
{
    ...
    */
    ...
    function IngresarFacturaVenta($datos, $empresa, $caja)
    {
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en consulta a tmp_bodegas_documentos_d';
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en Bloqueo de tabla';
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en Update de documentos';
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en consulta a documentos';
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en Insert a fac_facturas';
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en Insert a fac_facturas_contado';

        if ($datos['h_cheque'] > 0) {
            $sql = "SELECT NEXTVAL('cheques_mov_venta_directa_cheque_mov_id_seq') AS indice ";
            if (!$rst = $this->ConexionTransaccion($sql))
                //return false;
                return 'Error en consulta a NEXTVAL(\'cheques_mov_venta_directa_cheque_mov_id_seq\')';
            ...
            if (!$rst = $this->ConexionTransaccion($sql))
                //return false;
                return 'Error en Insert en cheques_mov_venta_directa';
            ...
            if (!$rst = $this->ConexionTransaccion($sql))
                //return false;
                return 'Error en Insert en cheques_mov_venta_directa_confirmacion';
        }
        ...
        if ($datos['h_credito'] > 0) {
            ...
            if (!$rst = $this->ConexionTransaccion($sql))
                //return false;
                return 'Error en consulta a NEXTVAL(\'tarjetas_mov_credito_venta_tarjeta_mov_id_seq\')';
            ...
            if (!$rst = $this->ConexionTransaccion($sql))
                //return false;
                return 'Error en INSERT en tarjetas_mov_credito_venta';
            ...
            if (!$rst = $this->ConexionTransaccion($sql))
                //return false;
                return 'Error en INSERT en tarjetas_mov_credito_confirmacion';
        }
        ...
        if ($datos['h_debito'] > 0) {
            ...
            if (!$rst = $this->ConexionTransaccion($sql)) {
                //return false;
                return 'Error en INSERT en tarjetas_mov_debito_venta';
            }
        }
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en LOCK TABLE en bodegas_doc_numeraciones';
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            //return false;
            return 'Error en UPDATE en bodegas_doc_numeraciones';
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            return 'Error en Consulta en numeracion';
            //return false;
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            return 'Error en Insert en bodegas_documentos';
            //return false;
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            return 'Error en Insert en bodegas_documentos_d';
            //return false;
        ...
        if (!$rst = $this->ConexionTransaccion($sql))
            return 'Error en Insert en facturas_documentos_bodega';
            //return false;
        ...
        foreach ($productos as $key => $dtl) {
            ...
            if (!$rst = $this->ConexionTransaccion($sql))
                return 'Error en Update en existencias_bodegas';
                //return false;
            ...
            if (!$rst = $this->ConexionTransaccion($sql))
                return 'Error en Update en existencias_bodegas_lote_fv';
                //return false;
        }
