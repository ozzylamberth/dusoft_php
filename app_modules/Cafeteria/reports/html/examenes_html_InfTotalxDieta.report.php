...
/**
 * $Id: examenes_html_InfTotalxDieta.report.php,v 1.2 2009/06/04 20:31:24 hugo Exp $
...
class examenes_html_InfTotalxDieta_report 
{ 
    ...
    function examenes_html_InfTotalxDieta_report($datos=array())
    {
			$this->datos=$datos;
      return true;
    }
...
// 	}
	...
	function GetMembrete()
	{
		$Membrete = array('file'=>false,'datos_membrete'=>array('titulo'=>'INFORME DE DIETAS CAFETERIA',
																'subtitulo'=>"INFORME TOTAL DE DIETAS",
																'logo'=>'logocliente.png',
																'align'=>'left'));
		return $Membrete;
	}
    ...
    function CrearReporte()
    {
			...
			$salida.=" <tr>\n";
			$salida.=" <td>\n";
				$salida.="<table  align=\"center\" border=\"1\"  width=\"60%\" >\n";
				foreach($dietas As $solicitud_id => $d){
					$solicitud_descripcion = $this->GetDescripcionSolicitud($solicitud_id);
					$salida.="	<tr >\n";
					$salida.="		<td colspan = 2 align=\"center\" width=\"100%\" class=\"Normal_10N\">DIETAS PARA : ".$solicitud_descripcion."</td>\n";
					$salida.="	</tr>\n";
					...
					if($control== 0){
						$salida.="	<tr>\n";
						$salida.="		<td colspan = 2 align=\"center\" width=\"100%\">NO SE REGISTRO NINGUNA DIETA PARA ESTE TIPO DE SOLICITUD</td>\n";
						$salida.="	</tr>\n";
					}
					$control = 0;
				}
