<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: Consultas_Afiliados_FUERZAS.class.php,
  ...
  */ 
  ...
  class Consultas_Afiliados_FUERZAS extends ConexionBD
  {
    /**
    * Contructor
    */
    
	function Consultas_Afiliados_FUERZAS(){}
...
*/
    ...
    /**********************************************************************************
		...
		************************************************************************************/
		...
		function Insertar_ProfesionalESM($tipo_fuerza,$tipo_id_tercero,$tercero_id)
		{
	...
	// $this->debug=true;
      ...
      ";
		...
		$sql .= " and    p.afiliado_tipo_id||' '|| p.afiliado_id NOT IN (  
                                                                ...
                                                                from 
                                                                esm_pacientes_fuerzas
                                                                where
                                                                     tipo_fuerza_id = ".$tipo_fuerza."
	...
	*/
	...
	//$this->debug=true;
      $sql = "SELECT 
                    ...
                    from 
                    eps_afiliados_datos p LEFT JOIN eps_afiliados EPS ON (EPS.afiliado_tipo_id=p.afiliado_tipo_id AND EPS.afiliado_id=p.afiliado_id),
                    esm_pacientes_fuerzas epe
      ";	
      $sql .= " where ";
      $sql .= "        epe.tipo_fuerza_id = ".$tipo_fuerza." ";
  ...
  /*
	...
	*/
     ...
     // $this->debug=true;
      $sql = " delete from esm_pacientes_fuerzas ";
      $sql .= " where ";
      $sql .= "        tipo_fuerza_id = ".$tipo_fuerza." ";
      $sql .= " and    tipo_id_paciente = '".$tipo_id_tercero."' ";
