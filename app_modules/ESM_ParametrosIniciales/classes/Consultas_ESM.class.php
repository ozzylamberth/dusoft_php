<?php
  ...
  */ 
  ...
  class Consultas_ESM extends ConexionBD
  {
    /**
    * Contructor
    */
    
	function Consultas_ESM(){}
    ...
    /**********************************************************************************
		...
		************************************************************************************/
		...
		function Insertar_TerceroESM($tipo_id_tercero,$tercero_id)
		{
		$sql  = "INSERT INTO esm_empresas (";
		$sql .= "       tipo_id_tercero, ";
		$sql .= "       tercero_id ";
		$sql .= "          ) ";
		$sql .= "VALUES ( ";
  ...
  /*
	...
	*	Existentes en el sistema, segun el grupo.
	*/
		function Listar_ESM($tipo_id_tercero,$tercero_id,$nombre_tercero,$offset)
		{
			//$this->debug=true;
      if($tipo_id_tercero!="")
        {
	...
	*	Existentes en el sistema, segun el grupo.
	*/
		function Borrar_TerceroESM($tipo_id_tercero,$tercero_id,$nombre_tercero,$offset)
		{
			//$this->debug=true;
      $sql = " delete from esm_empresas ";
      $sql .= " where ";
