...
/**
  * @package IPSOFT-SIIS
  * @version $Id: Remotos_IPS_ESM.php
  ...
  */  
  ...
  function Listado_ProfesionalesSinEsm($esm_empresas,$nombre,$identificacion,$tipo,$offset)
  {
	...
	$ips=$sql->Listado_ProfesionalesSinEsm($esm_tipo_id_tercero,$esm_tercero_id,$nombre,$identificacion,$tipo,$offset);
   // print_r($ips);
	$action['paginador'] = "Paginador('".$esm_empresas."','".$nombre."','".$identificacion."','".$tipo."'";
	...
	$html .= "  <legend class=\"normal_10AN\">IPS NO ASIGNADOS A LA ESM SELECCIONADA</legend>\n";
  ...
  */  
  ...
  function Listado_ProfesionalesEnEsm($esm_empresas,$nombre,$identificacion,$tipo,$offset)
  {
	$objResponse = new xajaxResponse();
  list($esm_tipo_id_tercero,$esm_tercero_id) = explode("@",$esm_empresas);
	$sql = AutoCarga::factory("Consultas_IPS_ESM","classes","app","ESM_ParametrosIniciales");

	$afiliados=$sql->Listado_ProfesionalesEnEsm($esm_tipo_id_tercero,$esm_tercero_id,$nombre,$identificacion,$tipo,$offset);
   
	$action['paginador'] = "Paginador_('".$esm_empresas."','".$nombre."','".$identificacion."','".$tipo."'";
	...
	$html .= "  <legend class=\"normal_10AN\">IPS ASIGNADAS A LA ESM SELECCIONADA</legend>\n";
  ...
  $objResponse->script("xajax_Listado_ProfesionalesSinEsm(document.getElementById('esm_empresas').value,document.getElementById('nombre').value,document.getElementById('identificacion').value,document.getElementById('tipo').value,'1');");
  $objResponse->script("xajax_Listado_ProfesionalesEnEsm(document.getElementById('esm_empresas_').value,document.getElementById('nombre_').value,document.getElementById('identificacion_').value,document.getElementById('tipo_').value,'1');");
