...
/**
  * @package IPSOFT-SIIS
  * @version $Id: Remotos_Afiliado.php
  ...
  */  
  ...
  function Listado_ProfesionalesSinEsm($esm_empresas,$nombre,$apellido,$identificacion,$tipo,$offset)
  {
	...
	$Afiliados=$sql->Listado_ProfesionalesSinEsm($esm_tipo_id_tercero,$esm_tercero_id,$nombre,$apellido,$identificacion,$tipo,$offset);
   
	$action['paginador'] = "Paginador('".$esm_empresas."','".$nombre."','".$apellido."','".$identificacion."','".$tipo."'";
	...
	$html .= "  <legend class=\"normal_10AN\">AFILIADOS NO ASIGNADOS A LA ESM SELECCIONADA</legend>\n";
	...
	$html .= "        <a href=\"#\" onclick=\"xajax_Asignar_ProfesionalESM('".$esm_empresas."','".$ED['afiliado_tipo_id']."','".$ED['afiliado_id']."')\">\n";
  ...
  */  
  ...
  function Listado_ProfesionalesEnEsm($esm_empresas,$nombre,$apellido,$identificacion,$tipo,$offset)
  {
	$objResponse = new xajaxResponse();
  list($esm_tipo_id_tercero,$esm_tercero_id) = explode("@",$esm_empresas);
	$sql = AutoCarga::factory("Consultas_Afiliados_ESM","classes","app","ESM_ParametrosIniciales");

	$afiliados=$sql->Listado_ProfesionalesEnEsm($esm_tipo_id_tercero,$esm_tercero_id,$nombre,$apellido,$identificacion,$tipo,$offset);
   
	$action['paginador'] = "Paginador_('".$esm_empresas."','".$nombre."','".$apellido."','".$identificacion."','".$tipo."'";
	...
	$html .= "      <td>".$ED['nombre']." </td>\n";
	$html .= "      <td align=\"center\">\n";
	$html .= "        <a href=\"#\" onclick=\"xajax_Borrar_ProfesionalESM('".$esm_empresas."','".$ED['afiliado_tipo_id']."','".$ED['afiliado_id']."')\">\n";
