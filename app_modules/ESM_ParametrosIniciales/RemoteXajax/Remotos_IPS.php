...
/**
  ...
  */  
  ...
  $token=$sql->Insertar_TerceroIPS($tipo_id_tercero,$tercero_id);
  ...
  $objResponse->script("xajax_Listado_IPS(document.getElementById('esm_tipo_id_tercero').value,document.getElementById('esm_tercero_id').value,document.getElementById('esm_nombre_tercero').value,'1');");
  ...
  $token=$sql->Borrar_TerceroIPS($tipo_id_tercero,$tercero_id);
  ...
  */  
  ...
  function Listado_IPS($tipo_id_tercero,$tercero_id,$nombre_tercero,$offset)
  {
	$objResponse = new xajaxResponse();
	$sql = AutoCarga::factory("Consultas_IPS","classes","app","ESM_ParametrosIniciales");

	$Terceros=$sql->Listar_IPS($tipo_id_tercero,$tercero_id,$nombre_tercero,$offset);
	...
	$html .= "<center>";
	$html .= "<fieldset style=\"width:80%\" class=\"fieldset\">\n";
	$html .= "  <legend class=\"normal_10AN\">CONSULTA DE IPS</legend>\n";
