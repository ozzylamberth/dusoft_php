...
/**
  * @package IPSOFT-SIIS
  * @version $Id: Remotos_TiposFormulas.php
  ...
  */  
  ...
  function Listado_TiposFormulas($cod_anatomofarmacologico,$descripcion,$offset)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("Consultas_TiposFormulas","classes","app","ESM_ParametrosIniciales");
  
  $PerfilesTerapeuticos=$sql->Listar_TiposFormulas($cod_anatomofarmacologico,$descripcion,$offset);
  ...
  $action['paginador'] = "Paginador('".$cod_anatomofarmacologico."','".$descripcion."'";
    ...
    $html .= "  <legend class=\"normal_10AN\">TIPOS DE FORMULAS</legend>\n";
    ...
    foreach($PerfilesTerapeuticos as $key => $ED)
    {
          ...
          $html .= "      <td>".$ED['descripcion_tipo_formula']." </td>\n";


          $html .= "      <td align=\"center\">\n";
          $html .= "        <a href=\"#\" onclick=\"xajax_Modificacion_TipoFormula('".$ED['tipo_formula_id']."')\">\n";
          ...
          {
          $html .= "<td align=\"center\">
          <a href=\"#\" onclick=\"xajax_CambioEstado('esm_tipos_formulas','sw_estado','0','".$ED['tipo_formula_id']."','tipo_formula_id')\">\n";
          $html .="<img title=\"ACTIVO\" src=\"".GetThemePath()."/images/checksi.png \" border=\"0\"></a></td>\n";
          }
          else
          {
          $html .= "<td align=\"center\"><a href=\"#\" onclick=\"xajax_CambioEstado('esm_tipos_formulas','sw_estado','1','".$ED['tipo_formula_id']."','tipo_formula_id')\">\n";
          ...
          $objResponse->assign("Listado_TiposFormulas","innerHTML",$objResponse->setTildes($html));
          return $objResponse;
  ...
  $token=$sql->Insertar_TipoFormula($datos);
  
  if($token)
  {
  $objResponse->script("Cerrar('Contenedor');");
  $objResponse->script("xajax_Listado_TiposFormulas('','','1');");
  ...
  $objResponse = new xajaxResponse();
		...
		$html .= "      CREACION DE TIPOS DE FORMULAS";
		$html .= "      </td>";
		$html .= "      </tr>";
				
		$html .= "      <tr class=\"modulo_list_claro\">";
		$html .= "      <td class=\"label\" align=\"left\" width=\"40%\">";
		$html .= "      DESCRIPCION TIPO FORMULA:";
		$html .= "      </td>";
  ...
  cargado en un Xajax
  */
  function Modificacion_TipoFormula($tipo_formula_id)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("Consultas_TiposFormulas","classes","app","ESM_ParametrosIniciales");
  
  $tipo_evento=$sql->Buscar_TipoFormula($tipo_formula_id);
  ...
  $html .= "  <table border=\"0\" width=\"100%\" align=\"center\" class=\"modulo_table_list\">";
		...
		$html .= "      <tr class=\"modulo_table_list_title\">";
		$html .= "      <td align=\"center\" colspan=\"2\">";
		$html .= "      MODIFICAR TIPO DE FORMULA";
		$html .= "      </td>";
		$html .= "      </tr>";
		...
		$html .= "      </td>";
		$html .= "      <td align=\"center\" width=\"60%\">";
		$html .= '      <input style="width:100%;height:100%" value="'.$tipo_evento[0]['descripcion'].'" class="input-text" type="Text" name="descripcion" maxlength="30" onkeyup="this.value=this.value.toUpperCase()">';
		$html .= "      <input type=\"hidden\" name=\"estado\" value=\"1\">";
    $html .= "      </td>";
		$html .= "      </tr>";
    ...
    $html .= '      <input class="input-text" value="'.$tipo_evento[0]['tipo_formula_id'].'" type="hidden" name="tipo_formula_id">';
    $html .= "      <input class=\"input-submit\" type=\"button\" value=\"Enviar\" name=\"boton\" onclick=\"Confirmar(xajax.getFormValues('FormularioCreacionTiposEventos'))\">";
		$html .= "      </td>";
		$html .= "      </tr>";
		$html .= "		</form>";
  ...
  */
  ...
  $token=$sql->Modificar_TipoFormula($datos);
  if($token)
  {
  $objResponse->script("Cerrar('Contenedor');");
  $objResponse->script("xajax_Listado_TiposFormulas('','','1');");
