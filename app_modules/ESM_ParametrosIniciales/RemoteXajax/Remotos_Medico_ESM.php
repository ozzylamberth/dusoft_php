...
/**
  ...
  */  
  ...
  list($esm_tipo_id_tercero,$esm_tercero_id) = explode("@",$esm_empresas);
	...
	$html .= "  <legend class=\"normal_10AN\">PROFESIONALES NO ASIGNADOS A LA ESM SELECCIONADA</legend>\n";
  ...
  */  
  ...
  list($esm_tipo_id_tercero,$esm_tercero_id) = explode("@",$esm_empresas);
	...
	$html .= "<center>";
	$html .= "<fieldset style=\"width:80%\" class=\"fieldset\">\n";
	$html .= "  <legend class=\"normal_10AN\">PROFESIONALES ASIGNADOS A LA ESM SELECCIONADA</legend>\n";
