<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: Parametrizar_TiposFuerzas_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: Parametrizar_TiposFuerzas_HTML
  ...
  */
	...
	class Parametrizar_TiposFuerzas_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_TiposFuerzas_HTML(){}
		/**
	    * @param array 
...
{ 
  ...
  $html .="<script>";
    ...
    $html .= "  {";
    $html .= "    xajax_Listado_TiposFuerzas(cod_anatomofarmacologico,descripcion,offset);\n";
    $html .= "  }\n";   
    $html .="</script>";
    
  
    $html .= ThemeAbrirTabla('CREACION DE TIPOS DE FUERZAS FF.MM');
      ...
      $html .= "          </td>\n";
      $html .= "          <td>";
      $html .= "        <input type=\"button\" value=\"BUSCAR\" onclick=\"xajax_Listado_TiposFuerzas('',document.getElementById('descripcion').value,'1');\" style=\"width:100%\" class=\"input-submit\">";
      $html .= "    </td>";
      $html .= "    </tr>\n";
      ...
      $html .= "  <div id=\"Listado_TiposFuerzas\">";
      $html .= "  </div>";
      ...
      $html .= "   <script>";
      $html .= "    xajax_Listado_TiposFuerzas('','','1');";
      $html .= "   </script>";
