<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: Parametrizar_TipoEvento_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: Parametrizar_TipoEvento_HTML
  ...
  */
	...
	class Parametrizar_TipoEvento_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_TipoEvento_HTML(){}
		/**
	    * @param array 
...
{ 
  ...
  $html .="<script>";
                 ...
                 if(band==1)
                  ...
                  alert("¡Por favor, Diligenciar todos los Datos!");
                      ...
                      else
                      {
                               ...
                               {
                               //alert("Ingreso");
                               xajax_Insertar_TipoEvento(Formulario);
                               }
                                  else
                                      {
                                      //alert("Modificacion");
                                      xajax_Modificar_TipoEvento(Formulario);
                                      }
                      }
    ...
    $html .= "  {";
    $html .= "    xajax_Listado_TiposEventos(cod_anatomofarmacologico,descripcion,offset);\n";
    $html .= "  }\n";   
    $html .="</script>";
    
  
    $html .= ThemeAbrirTabla('CREACION DE TIPOS DE EVENTOS');
      ...
      $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_Ingreso_TipoEvento()\">[::CREAR - NUEVO TIPO DE EVENTO::]</a><BR></CENTER>";
      ...
      $html .= "          </td>\n";
      $html .= "          <td>";
      $html .= "        <input type=\"button\" value=\"BUSCAR\" onclick=\"xajax_Listado_TiposEventos('',document.getElementById('descripcion').value,'1');\" style=\"width:100%\" class=\"input-submit\">";
      $html .= "    </td>";
      $html .= "    </tr>\n";
      ...
      $html .= "  <div id=\"Listado_TiposEventos\">";
      $html .= "  </div>";
      ...
      $html .= "   <script>";
      $html .= "    xajax_Listado_TiposEventos('','','1');";
      $html .= "   </script>";
      
    $html .= $this->CrearVentana(600,"CREACION DE TIPOS DE EVENTOS");
