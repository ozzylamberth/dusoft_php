<?php
  ...
  */
	...
	class Parametrizar_Medico_ESM_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_Medico_ESM_HTML(){}
		/**
	    * @param array 
...
{ 
  ...
  $html .="<script>";
    ...
    $html .= ThemeAbrirTabla('ASOCIAR MEDICOS A ESTABLECIMIENTOS DE SANIDAD MILITAR');
      ...
      //PRIMER TAB
			...
			$html .= "									<h2 class=\"tab\">ASIGNAR MEDICOS A ESM</h2>\n";
      ...
      $html .= "								</div>\n"; //CIERRA PRIMER TAB
       ...
       $html .= "									<h2 class=\"tab\">CONSULTAR: MEDICOS ASIGNADOS A ESM </h2>\n";
