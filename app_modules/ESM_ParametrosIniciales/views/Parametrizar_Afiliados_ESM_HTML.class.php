<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: Parametrizar_Medico_ESM_HTML.class.php,
  ...
  */
	...
	class Parametrizar_Afiliados_ESM_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_Afiliados_ESM_HTML(){}
		/**
	    * @param array 
		...
		function main($action,$ESM,$request,$TIPO)
    {
			...
			$html .= "  }\n";   
			$html .= "  function Paginador_(esm_empresas,nombre_,apellidos_,identificacion_,tipo_,offset)\n";
			$html .= "  {";
			$html .= "    xajax_Listado_ProfesionalesEnEsm(esm_empresas,nombre_,apellidos_,identificacion_,tipo_,offset);\n";
			$html .= "  }\n"; 
			$html .="</script>";

  
    $html .= ThemeAbrirTabla('ASOCIAR AFILIADOS A ESTABLECIMIENTOS DE SANIDAD MILITAR');
      ...
      //PRIMER TAB
			...
			$html .= "									<h2 class=\"tab\">ASIGNAR AFILIADOS A ESM</h2>\n";
      ...
      $html .= "								</div>\n"; //CIERRA PRIMER TAB
       ...
       $html .= "									<h2 class=\"tab\">CONSULTAR: AFILIADOS ASIGNADOS A ESM </h2>\n";
