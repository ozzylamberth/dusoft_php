<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: Parametrizar_TiposRequisicion_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: Parametrizar_TiposRequisicion_HTML
  ...
  */
	...
	class Parametrizar_TiposRequisicion_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_TiposRequisicion_HTML(){}
		/**
	    * @param array 
...
{ 
  ...
  $html .="<script>";
    ...
    var temp;
		  ...
		  if(Formulario.movimiento=="")
          {
          cadena.push("No Haz Seleccionado Un Tipo de Movimiento\n");
          band=1;
          }
                 ...
                 if(band==1)
                  ...
                  alert("¡Por favor, Diligenciar todos los Datos!");
                      ...
                      else
                      {
                               ...
                               {
                               //alert("Ingreso");
                               xajax_Insertar_TipoRequision(Formulario);
                               }
                                  else
                                      {
                                      //alert("Modificacion");
                                      xajax_Modificar_TipoRequision(Formulario);
                                      }
                      }
    ...
    $html .= "  {";
    $html .= "    xajax_Listado_TiposRequisicion(cod_anatomofarmacologico,descripcion,offset);\n";
    $html .= "  }\n";   
    $html .="</script>";
    
  
    $html .= ThemeAbrirTabla('CREACION DE TIPOS DE REQUISICION');
      ...
      $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_Ingreso_TipoRequisicion()\">[::CREAR - NUEVO TIPO DE TIPO DE REQUISICION::]</a><BR></CENTER>";
      ...
      $html .= "          </td>\n";
      $html .= "          <td>";
      $html .= "        <input type=\"button\" value=\"BUSCAR\" onclick=\"xajax_Listado_TiposRequisicion('',document.getElementById('descripcion').value,'1');\" style=\"width:100%\" class=\"input-submit\">";
      $html .= "    </td>";
      $html .= "    </tr>\n";
      ...
      $html .= "  <div id=\"Listado_TiposRequisicion\">";
      $html .= "  </div>";
      ...
      $html .= "   <script>";
      $html .= "    xajax_Listado_TiposRequisicion('','','1');";
      $html .= "   </script>";
      
    $html .= $this->CrearVentana(600,"CREACION DE TIPOS DE REQUISICION");
