<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: Parametrizar_ESM_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: Parametrizar_ESM_HTML
  ...
  */
	...
	class Parametrizar_ESM_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_ESM_HTML(){}
		/**
	    * @param array 
...
{ 
  ...
  $html .="<script>";
    ...
    $html .= ThemeAbrirTabla('PARAMETRIZACION DE ESTABLECIMIENTOS DE SANIDAD MILITAR');
      ...
      //PRIMER TAB
			...
			$html .= "									<h2 class=\"tab\">TERCEROS (NO ESM)</h2>\n";
      ...
      $html .= "								</div>\n"; //CIERRA PRIMER TAB
       ...
       $html .= "									<h2 class=\"tab\">ESTABLECIMIENTOS DE SANIDAD MILITAR - ESM</h2>\n";
      ...
      $html .= "          </td>\n";
      $html .= "          <td>";
      $html .= "        <input type=\"button\" value=\"BUSCAR\" onclick=\"xajax_Listado_ESM(document.getElementById('esm_tipo_id_tercero').value,document.getElementById('esm_tercero_id').value,document.getElementById('esm_nombre_tercero').value,'1');\" style=\"width:100%\" class=\"input-submit\">";
      $html .= "    </td>";
      $html .= "    </tr>\n";
      $html .= "  </table>";
      $html .= "</center>";
