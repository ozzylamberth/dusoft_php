<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: Parametrizar_ProductoClasificacion_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: Parametrizar_ProductoClasificacion_HTML
  ...
  */
	...
	class Parametrizar_ProductoClasificacion_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_ProductoClasificacion_HTML(){}
		/**
	    * @param array 
      * $action Vector de links de la aplicaion
		* 
		*/
		function main($action,$empresas,$request)
    {
...
{ 
  ...
  $html .="<script>";
    ...
    $html .="<script>";
    $html .= "  function Paginador(empresa_id,codigo_producto,descripcion,offset)\n";
    $html .= "  {";
    $html .= "    xajax_Listado_ProductosEmpresa(empresa_id,codigo_producto,descripcion,offset);\n";
    $html .= "  }\n";   
    $html .= "  function Paginador_(esm_empresas,nombre,offset)\n";
    $html .= "  {";
    $html .= "    xajax_Listado_ProfesionalesEnEsm(esm_empresas,nombre,offset);\n";
    $html .= "  }\n"; 
    $html .="</script>";
    
  
    $html .= ThemeAbrirTabla('CLASIFICACION DE LOS PRODUCTOS');
      ...
      //PRIMER TAB
			...
			$html .= "									<h2 class=\"tab\">CLASIFICAR PRODUCTOS</h2>\n";
      $html .= "									<script>	tabPane.addTabPage( document.getElementById(\"crear_estadosdocumentos\")); </script>\n";
       
      $select .= "<select class=\"select\" style=\"width:100%;\" name=\"empresa_id\" id=\"empresa_id\">";      
      $select .= "<option value=\"\">SELECCIONAR</option>";
      foreach($empresas as $key=>$esm)
      {
      $select .= "<option value=\"".$esm['empresa_id']."\">(".$esm['identificacion'].") ".$esm['razon_social']."</option>";
      }
      $select .= "</select>";
      ...
      $html .= "    <tr class=\"modulo_list_claro\">\n";
      $html .= "          <td class=\"modulo_table_list_title\">";
      $html .= "          CODIGO DEL PRODUCTO";
      $html .= "          </td>";
      $html .= "          <td align=\"center\">\n";
      $html .= "          <input type=\"text\" name=\"codigo_producto\" id=\"codigo_producto\" class=\"input-text\" style=\"width:100%\">";
      $html .= "          </td>\n";
      $html .= "          <td class=\"modulo_table_list_title\">";
      $html .= "          DESCRIPCION DEL PRODUCTO";
      $html .= "          </td>";
      $html .= "          <td align=\"center\">\n";
      $html .= "          <input type=\"text\" name=\"descripcion\" id=\"descripcion\" class=\"input-text\" style=\"width:100%\">";
      $html .= "          </td>\n";
      $html .= "          <td>";
      $html .= "        <input type=\"button\" value=\"BUSCAR\" onclick=\"xajax_Listado_ProductosEmpresa(document.getElementById('empresa_id').value,document.getElementById('codigo_producto').value,document.getElementById('descripcion').value,'1');\" style=\"width:100%\" class=\"input-submit\">";
      $html .= "    </td>";
      $html .= "    </tr>\n";
      $html .= "  </table>";
      $html .= "</center>";
      ...
      $html .= "  <form id=\"Formulario_ProductosClasificacion\" name=\"Formulario_ProductosClasificacion\" >"; 
