<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: Parametrizar_TiposFormulas_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: Parametrizar_TiposFormulas_HTML
  ...
  */
	...
	class Parametrizar_TiposFormulas_HTML
	{
		/**
		* Constructor de la clase
		*/
		function Parametrizar_TiposFormulas_HTML(){}
		/**
	    * @param array 
...
{ 
  ...
  $html .="<script>";
                 ...
                 if(band==1)
                  ...
                  alert("¡Por favor, Diligenciar todos los Datos!");
                      ...
                      else
                      {
                               ...
                               {
                               //alert("Ingreso");
                               xajax_Insertar_TipoFormula(Formulario);
                               }
                                  else
                                      {
                                      //alert("Modificacion");
                                      xajax_Modificar_TipoFormula(Formulario);
                                      }
                      }
              }
                else
    ...
    $html .= "  {";
    $html .= "    xajax_Listado_TiposFormulas(cod_anatomofarmacologico,descripcion,offset);\n";
    $html .= "  }\n";   
    $html .="</script>";
    
  
    $html .= ThemeAbrirTabla('CREACION DE TIPOS DE FORMULAS');
      ...
      $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_Ingreso_TipoFormula()\">[::CREAR - NUEVO TIPO DE FORMULA::]</a><BR></CENTER>";
      ...
      $html .= "          </td>\n";
      $html .= "          <td>";
      $html .= "        <input type=\"button\" value=\"BUSCAR\" onclick=\"xajax_Listado_TiposFormulas('',document.getElementById('descripcion').value,'1');\" style=\"width:100%\" class=\"input-submit\">";
      $html .= "    </td>";
      $html .= "    </tr>\n";
      ...
      $html .= "  <div id=\"Listado_TiposFormulas\">";
      $html .= "  </div>";
      ...
      $html .= "   <script>";
      $html .= "    xajax_Listado_TiposFormulas('','','1');";
      $html .= "   </script>";
      
    $html .= $this->CrearVentana(600,"CREACION DE TIPOS DE FORMULA");
