...
class AdministracionFarmaciaHTML
{
    ...
    function FormaBuscarProductosVenta($action, $empresa, $documento, $tipos_documentos)
    {
        ...
        $html .= "      xhttp.send(\"accion=tipos_listas_precios&empresa=\"+empresa_id+\"&centro=".$empresa['centro_utilidad']."\"); \n";
        $html .= "  }\n";
        ...
        //$empresa['empresa_id'];
        /*
        $nombre_empresa = $empresa['descripcion2'];
        ...
        $sql_datosTercero = '
            ...
            FROM 
              terceros
            WHERE 
              nombre_tercero = \''.$nombre_empresa.'\'
        ';
        $query = pg_query($dbconn, $sql_datosTercero);
        $tercero = pg_fetch_all($query);
        $html .= '<h3>--> '.print_r($tercero, true).'</h3>';
        ...
        */
        ...
        $empresa_nombre = $_REQUEST['VentaFarmacia']['descripcion4'];
        //$html .= "-->".print_r($_REQUEST['VentaFarmacia'], false)."<--";
        include_once('conexion2.php');
        ...
        $sqlTercero = '
            ...
            FROM 
                terceros
            WHERE
                nombre_tercero = \''.$empresa_nombre.'\'
                AND
                tipo_id_tercero = \'NIT\'
        ';
        $queryTercero = pg_query($dbconn, $sqlTercero);
        $datosTercero = pg_fetch_all($queryTercero);

        if(isset($datosTercero[0]['tercero_id'])){
            $id_tercero = $datosTercero[0]['tercero_id'];
        }else{
            $id_tercero = '';
        }
        ...
        $html .= "                <td>\n";
        //var_dump($sqlTercero);
        $html .= "                  <input type=\"text\" class=\"input-text\" name=\"tercero_id\" id=\"id_tercero\" maxlength=\"32\" style=\"width:70%\" value=\"".$id_tercero."\">\n";
        $html .= "                </td>\n";
        $html .= "              </tr>\n";
        $html .= "            </table>\n";
        $html .= "            <center>\n";
        ...
        $html .= "                <td>TELEFONO</td>\n";
        $html .= "                <td>\n";
        $html .= "                  <input type=\"text\" class=\"input-text\" style=\"width:70%\" id=\"telefono_tercero\" name=\"telefono\" maxlength=\"30\" value=''>\n";
        $html .= "                </td>\n";
        $html .= "              </tr>\n";
        $html .= "              <tr>\n";
        $html .= "                <td>CELULAR</td>\n";
        $html .= "                <td>\n";
        $html .= "                  <input type=\"text\" class=\"input-text\" style=\"width:70%\" id=\"celular_tercero\" name=\"celular\" maxlength=\"15\" value=''>\n";
        $html .= "                </td>\n";
        $html .= "              </tr>\n";
        $html .= "            </table>\n";
        $html .= "            <table width=\"98%\" align=\"center\" class=\"normal_10AN\">\n";
        ...
        $html .= "</div>\n";
        $html .= "<script>\n";
        $html .= "      document.getElementById('id_tercero').innerHTML = '".$id_tercero."';\n";
        $html .= "      xajax_BuscarTercero(xajax.getFormValues('datos_tercero'));\n";
