...
{
  echo $this->datos['paciente_id'];
		//*******************************************termino
		$datos = $this->ReportePagare();
		$Salida.="<table  align=\"center\" border=\"0\"  width=\"100%\">";
		$Salida.="<tr>";
		$Salida.="  <td class=\"Normal_10N\" align=\"center\" width=\"100%\" colspan=\"4\">PAGARE NRO:'".$_REQUEST['paciente_id']."'</td>";
		$Salida.="</tr>";
		for($t=1; $t<3;$t++)
		{
			$Salida.="<tr>";
