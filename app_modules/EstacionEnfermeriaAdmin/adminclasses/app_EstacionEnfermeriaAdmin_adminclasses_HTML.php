...
*/
	function Menu($datos)
	{
		$this->salida.= ThemeAbrirTabla('MENÚ ADMINISTRACION DE LA ESTACION');
		$this->Encabezado();
		$this->salida.="<br><table border=\"0\"  class=\"modulo_table_list\"  align=\"center\"   width=\"80%\" >";
		...
		$this->salida .= "	</tr>\n";
		$this->salida .= "	<tr class='modulo_list_oscuro'>\n";
		$this->salida .= "		<td align='center' width=16 height=16><img src=\"".GetThemePath()."/images/EstacionEnfermeria/configuracion.png\" width=18 height=18 align='middle' border=0></td><td><a href=\"".ModuloGetURL('app','EstacionEnfermeriaAdmin','admin','CallFrmCrearTurnos',array("datos_estacion"=>$datos)) ."\" target=\"Contenido\">Definir Horario de Controles de la Estación</a></td>\n";
		$this->salida .= "	</tr>\n";
		$this->salida .= "	<tr class='modulo_list_oscuro'>\n";
...
//////////REVISAR ESTO MAÑÑANNNNNNNNNNNNNNNNNNNAAAAAAAAAAAAAAAAAAAA//////
