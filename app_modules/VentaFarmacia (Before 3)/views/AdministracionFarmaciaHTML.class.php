...
class AdministracionFarmaciaHTML {
    ...
    function FormaBuscarProductosVenta($action, $empresa, $documento, $tipos_documentos) {
        ...
        $html .= "<script>";
        $html .= "  function reset(){";
        $html .= "      var form_codigo_producto = document.getElementById(\"codigo_producto\");";
        $html .= "      form_codigo_producto.readOnly = true;";
        $html .= "      form_codigo_producto.style.width = \"100%\";";
        $html .= "      form_codigo_producto.style.background = \"#dedede\";";
        $html .= "      form_codigo_producto.style.cursor = \"not-allowed\";";

        $html .= "      var form_codigo_barras = document.getElementById(\"codigo_barras\");";
        $html .= "      form_codigo_barras.readOnly = true;";
        $html .= "      form_codigo_barras.style.width = \"100%\";";
        $html .= "      form_codigo_barras.style.background = \"#dedede\";";
        $html .= "      form_codigo_barras.style.cursor = \"not-allowed\";";

        $html .= "      var form_descripcion = document.getElementById(\"descripcion\");";
        $html .= "      form_descripcion.readOnly = true;";
        $html .= "      form_descripcion.style.width = \"100%\";";
        $html .= "      form_descripcion.style.background = \"#dedede\";";
        $html .= "      form_descripcion.style.cursor = \"not-allowed\";";

        $html .= "      var form_codigo_alterno = document.getElementById(\"codigo_alterno\");";
        $html .= "      form_codigo_alterno.readOnly = true;";
        $html .= "      form_codigo_alterno.style.width = \"100%\";";
        $html .= "      form_codigo_alterno.style.background = \"#dedede\";";
        $html .= "      form_codigo_alterno.style.cursor = \"not-allowed\";";

        $html .= "      var form_btn_search = document.getElementById(\"btn_search\");";
        $html .= "      form_btn_search.setAttribute('type', 'button');";
        $html .= "      form_btn_search.style.cursor = \"not-allowed\";";
        ...
        $html .= "          var form_codigo_producto = document.getElementById(\"codigo_producto\");";
        $html .= "          form_codigo_producto.readOnly = false;";
        $html .= "          form_codigo_producto.style.width = \"100%\";";
        $html .= "          form_codigo_producto.style.background = \"\";";
        $html .= "          form_codigo_producto.style.cursor = \"text\";";

        $html .= "          var form_codigo_alterno = document.getElementById(\"codigo_alterno\");";
        $html .= "          form_codigo_alterno.readOnly = false;";
        $html .= "          form_codigo_alterno.style.width = \"100%\";";
        $html .= "          form_codigo_alterno.style.background = \"\";";
        $html .= "          form_codigo_alterno.style.cursor = \"text\";";

        $html .= "          var form_codigo_barras = document.getElementById(\"codigo_barras\");";
        $html .= "          form_codigo_barras.readOnly = false;";
        $html .= "          form_codigo_barras.style.width = \"100%\";";
        $html .= "          form_codigo_barras.style.background = \"\";";
        $html .= "          form_codigo_barras.style.cursor = \"text\";";

        $html .= "          var form_descripcion = document.getElementById(\"descripcion\");";
        $html .= "          form_descripcion.readOnly = false;";
        $html .= "          form_descripcion.style.width = \"100%\";";
        $html .= "          form_descripcion.style.background = \"\";";
        $html .= "          form_descripcion.style.cursor = \"text\";";

        $html .= "          btn_search.setAttribute(\"type\", \"submit\");";
        $html .= "          btn_search.style.cursor = \"pointer\";";
