<?php
  ...
  */
    ...
    * @return String
		*/
		function FormaDatosAfiliado($action,$datos_cotizante,$salida,$cuantos,$beneficiarios)
		{
      ...
      {    
        ...
        $html .= "    </tr>\n";
        $html .= "    <tr class=\"modulo_table_list_title\">\n";
        $html .= "      <td style=\"text-align:left;text-indent:8pt\">Nº AFILIACION</td>\n";
		...
		if(!empty($beneficiarios))
		{
			...
			foreach($beneficiarios as $key => $tipo_id)
			{
			  ...
			  {
				$nuevousu = ModuloGetURL('app','UV_Afiliaciones','controller','Info_AfiliadosCotizante',array('eps_afiliacion_id'=>$detalle['eps_afiliacion_id'],'afiliado_tipo_id'=>$key,'afiliado_id'=>$keyI));
				$html .= "    <tr class=\"modulo_list_claro\">\n";
				$html .= "      <td><a title='INFORMACION COMPLETA DEL USUARIO' href=\"".$nuevousu."\">\n";
				$html .= "           <sub><img src=\"".$path."/images/modificar.png\" border=\"0\" width=\"17\" height=\"17\"></sub>\n";
				$html .= "                         </a>\n";
				$html .= 			$key." ".$keyI."</td>\n";
