...
/**
 * $Id: fpdf_reporte_univalle.class.php,v 1.1.1.1 2009/09/11 20:36:58 hugo Exp $
 ...
 */
    ...
    class fpdf_reporte_univalle extends PDF
    {
            var $correcion_x;
            var $correcion_y;
    
            function fpdf_reporte_univalle($orientation,$unit,$format)
            {
                    $this->correcion_x = 1;
                    $this->correcion_y = 1;
...
//$pdf->Text(162,79,'CALI');
            ...
            //$vect[2][5][1]=$var['fecha_accidente'];
                ...
                else
                {
                    ...
                    $vect[24][0]=15;
                    $vect[24][1]=159;
                    $vect[24][2]=substr($var['informe_accidente'],0,113);//17,114

                    //Si el informe es demasiado extenso, se debe utilizar otra linea
                    $informe = substr($var['informe_accidente'],113,226);
                    if(!empty($informe))
                    {
                     $vect[82][0]=15;
                     $vect[82][1]=167;
                    ...
                    //FIN Si el informe es demasiado extenso, se debe utilizar otra linea
       ...
       $query = "SELECT A.ingreso AS ingreso_id,
								...
								--AND F.tipo_diagnostico_id=I.diagnostico_id
								--AND E.evolucion_id = G.evolucion_id 
								--AND G.tipo_diagnostico_id=I.diagnostico_id
								ORDER BY E.fecha DESC;";//ORDER BY A.ingreso
/*           SELECT b.fecha,evolucion_id//CC-98539297
 FROM ingresos_soat a join hc_evoluciones b on (a.ingreso=b.ingreso AND a.evento=546 AND b.estado='0')
...
//cc 14800423
      $resulta = $dbconn->Execute($query);
                ...
                $vect[46][0]=44;
                $vect[46][1]=275;
                $vect[46][2]=$fecha[0];//42,179 //fecha ingreso A�
...
//DATOS DE EGRESO
                                ...
                                $vect[50][0]=44;
                                $vect[50][1]=290;
                                $vect[50][2]=$fecha[0];//42,188 //fecha egreso A�
...
//DATOS REMISION DESDE LA HC
                                ...
                                if($result->RecordCount()>0)
                                {
                                        ...
                                        $vect[59][0]=160;
                                        $vect[59][1]=335;
                                        $vect[59][2]=$f2[2];//155,236 fecha remision A�
                                        ...
                                        $vect[64][0]=160;
                                        $vect[64][1]=345;
                                        $vect[64][2]=$f4[0];//155,240 fecha a� 
        ...
        /*            $vect1[3][5][1]='---';
              ...
              if(empty($vect[57][2]))
                            ...
                            $vect[64][0]=160;
                            $vect[64][1]=345;
                            $vect[64][2]=$f3[2];//155,240 fecha a�
...
//DATOS SOBRE LA DEFUNCION DEL PACIENTE
                                ...
                                if($var6['diagnostico_nombre']<>NULL)
                {
                                        ...
                                        $vect[73][0]=65;
                                        $vect[73][1]=365;
                                        $vect[73][2]=$fecha_muerte[0];//A� DEFUNCION
                                    ...
                                    //DATOS DEL PROFESIONAL QUE FIRM�EL CERTIFICADO DE DEFUNCI�
                                    $vect[78][0]=135;
                                    $vect[78][1]=375;
...
/*          $dpto=CallMetodoExterno('app','Triage','user','nombre_dpto',$argumentos=array(
            ...
            // REPORTE SOAT 3
        function BuscarReporteAmbulanciaSoat($ambulancia)//Busca la informaci� de la ambulancia para imprimir
        {
            list($dbconn) = GetDBconn();
...
//             $vect[1][0]=160;
//             $vect[1][1]=20;
//             $vect[1][2]=$fecha_accidente[2][0];//167 32 A�
// 
//             $vect[2][0]=163;
//             $vect[2][1]=20;
//             $vect[2][2]=$fecha_accidente[2][1];//167 32 A�

            $vect[3][0]=185;
            $vect[3][1]=42;
            $vect[3][2]=$fecha_accidente[2][2];//167 32 A�

            $vect[4][0]=190;
            $vect[4][1]=42;
            $vect[4][2]=$fecha_accidente[2][3];//167 32 A�
