		  ...
		  if(!empty($datosPqrsAct))
           {		  
			...
			foreach($datosPqrsAct as $key => $valor)
			{
				...
				{
				 $html .= "					   <center><a class=\"label_error\" href=\"#\"  title=\"CASO RESUELTO / Ó VENCIDO\"><img src=\"".GetThemePath()."/images/si.png\" border='0'></a></center>\n";
				}
				else 
				 {
				...
				if($dias_diferencia >=3)
                  {
				     $html .= "                 <a title=\"CASO VENCIDO Ó CERRADO\"><img src=\"".GetThemePath()."/images/Redlab.png\" border='0'></a>";			
                  }
                  else  
                    {
