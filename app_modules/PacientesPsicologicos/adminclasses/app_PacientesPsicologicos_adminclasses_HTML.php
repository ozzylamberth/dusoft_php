...
class app_PacientesPsicologicos_adminclasses_HTML extends app_PacientesPsicologicos_admin
{
	/**
	...
	*/
  	...
  	function app_PacientesPsicologicos_admin_HTML()
	{
		$this->salida='';
		$this->system_PacientesPsicologicos_admin();
		return true;
	}
