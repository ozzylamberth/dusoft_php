...
function PintarTablaAgentes(espacio)
{
    xajax_PintarAgentesdeRiesgoPorEspacio(espacio);
}


function Evaluar2(valor)
{
    if(valor=='0')
    {
        document.getElementById('tipo_id_ter1').disabled=true;
        document.getElementById('tipo_id_ter2').disabled=true;
        document.getElementById('tipo_id_ter3').disabled=true;
    ...
    else
    {
        if(valor != '0')
        {
            document.getElementById('tipo_id_ter1').disabled=false;
            document.getElementById('tipo_id_ter2').disabled=false;
            document.getElementById('tipo_id_ter3').disabled=false;
        }
    }
}
...
function Evaluar(valor)
{
    if(valor=='0')
    {
        document.getElementById('descripcion_trabajo_no_habitual').disabled=true;
    ...
    else
    {
        if(valor != '0')
        {
            document.getElementById('descripcion_trabajo_no_habitual').disabled=false;
        }
    }
}
...
function habilitar(valor,persona)
{

    id_ter='id_ter'+persona;
    nom_ter='nom_ter'+persona;
    if(valor.value=='-1')
    { 

        document.getElementById(id_ter).disabled=true;
        document.getElementById(id_ter).disabled=true;
        document.getElementById(id_ter).disabled=true;
        document.getElementById(nom_ter).disabled=true;
        document.getElementById(nom_ter).disabled=true;
        document.getElementById(nom_ter).disabled=true;
    ...
    else
    {
        ...
        {  
           /* alert(valor.name);*/
            document.getElementById(id_ter).disabled=false;
            document.getElementById(id_ter).disabled=false;
            document.getElementById(id_ter).disabled=false;
            document.getElementById(nom_ter).disabled=false;
            document.getElementById(nom_ter).disabled=false;
            document.getElementById(nom_ter).disabled=false;
        }
    }
