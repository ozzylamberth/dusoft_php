<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: EstadosAfiliados.class.php,v 1.6 2008/01/08 13:32:14 hugo Exp $
  ...
  */
  ...
  class EstadosAfiliados extends Afiliaciones1
  {
    /**
    ...
    */
    function ObtenerHistorialEstados($datos,$pg_siguiente)
    {
      ...
      if($datos['fecha_registro'])
        $whr .= "AND    HE.fecha_registro::date = '".$datos['fecha_registro']."'::date ";
