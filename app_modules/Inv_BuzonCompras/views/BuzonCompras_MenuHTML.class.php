<?php
  ...
  */
	...
	class BuzonCompras_MenuHTML
	{
		/**
		* Constructor de la clase
		*/
		function BuzonCompras_MenuHTML(){}
		 
     
		function Menu($action,$num)
		{
		$accion=$action['volver'];
		$html  = ThemeAbrirTabla('MENU - BUZON COMPRAS');
		$html .= "<script>";
		$html .= "function Paginador(empresa_id,offset)";
		$html .= "{";
		$html .= "xajax_MensajesBuzonT(empresa_id,offset);";
		$html .= "}";
		$html .= "</script>";
    ...
    $html .= "  <table border=\"0\" width=\"60%\" align=\"center\">";
		...
		$html .= "      <a onclick=\"xajax_MensajesBuzonT('".$_REQUEST['datos']['empresa_id']."','1');\">";
		$html .="<img title=\"VER BUZON COMPRAS\" src=\"".GetThemePath()."/images/buzon.gif\" border=\"0\"><center><div id=\"dato_mail\">(".$num[0]['count']." <i>Mensajes Nuevos</i>)</div></center>";
		$html .= "      </a>";
		$html .= "      </td>";
		$html .= "      </tr>";
		//elimina.png,    
		...
		$html .= "  <legend    align=\"left\">BUZON COMPRAS</legend>\n";
		$html .= "<div id=\"ListadoBuzonCompras\">";
		$html .= "</div>";
		$html .= "</fieldset><br>\n";
		
		$html .= ThemeCerrarTabla();
		$html .= $this->CrearVentana(640,"MENSAJE");;
		return $html;
