...
/**
  ...
  */  
  ...
  $sql = AutoCarga::factory("BuzonCompras","classes","app","Inv_BuzonCompras");
  
  
	$MensajesBuzonCompras=$sql->ListadoMensajesBuzon($EmpresaId,$offset);
   ...
   $html .= "  <legend class=\"normal_10AN\">MENSAJES DEL SISTEMA</legend>\n";
        ...
        $bck = "#DDDDDD";
        foreach($MensajesBuzonCompras as $key => $ms)
        {
        ...
        //$objResponse->alert("SI?");
          $objResponse->assign("ListadoBuzonCompras","innerHTML",$objResponse->setTildes($html));
          return $objResponse;
  }
 ...
 function CambioEstadoMensaje($buzon_compras_id,$EmpresaId)
  ...
  $objResponse = new xajaxResponse();
		...
		$MensajeBuzonCompras=$sql->MensajeBuzon($buzon_compras_id);
    ...
    $DatoMail="(".$NoLeidos[0]['count']." <i>Mensajes Nuevos</i>)";
		...
		$html .= '      <input style="width:100%;height:100%" value="'.$MensajeBuzonCompras[0]['fecha_mensaje'].'" class="input-text" type="Text" name="mensaje_sistema_id" disabled >';
		$html .= "      </td>";
		$html .= "      </tr>";
		...
		$html .= "      </td>";
		$html .= "      <td align=\"center\" width=\"30%\">";
		$html .= '      <input disabled style="width:100%;height:100%" class="input-text" type="Text" value="'.$MensajeBuzonCompras[0]['asunto'].'">';
		$html .= "      </td>";
		$html .= "      </tr>";
		...
		$html .= '      <textarea disabled style="width:100%;height:100%" class="input-text">'.$MensajeBuzonCompras[0]['mensaje'].'</Textarea>';
		$html .= "      </td>";
		$html .= "      </tr>";
