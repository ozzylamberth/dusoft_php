...
function BorrarSubClases($Grupo_id, $Clase_id, $NombreClase, $NombreGrupo, $SubClase_id, $Sw_Medicamento) {
    ...
    if ($Token) {
        ...
        //                                                      $NombreGrupo,$NombreClase,$CodigoGrupo,$CodigoClase,$Nombre,$Codigo,$Sw_Medicamento,
        // $objResponse->script("xajax_BusquedaSubClasesAsignadas('".$NombreGrupo."','".$NombreClase."','".$CodigoGrupo."','".$CodigoClase."','','','".$Sw_Medicamento."')");
        $objResponse->script("xajax_Subclases('" . $CodigoGrupo . "','" . $CodigoClase . "','" . $NombreClase . "','" . $NombreGrupo . "','" . $Sw_Medicamento . "')");
    }
    else
