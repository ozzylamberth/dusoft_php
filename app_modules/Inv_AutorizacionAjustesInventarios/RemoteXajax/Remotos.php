...
/**
  ...
  */
  ...
  function BorrarItem_Reservado($solicitud_prod_a_bod_ppal_id,$solicitud_prod_a_bod_ppal_det_id,$tabla)
  {
    ...
    //action del formulario= Donde van los datos del formulario.
	  ...
	  $html .= "      </table>";
        ...
        $html .= "      <tr >";
        $html .= "        <td align=\"center\" class=\"label_error\">";
        $html .= "          <input class=\"input-submit\" type=\"button\" value=\"CONFIRMA BORRAR EL ITEM DEL PEDIDO #".$solicitud_prod_a_bod_ppal_id."?\" onclick=\"xajax_Borrar('".$solicitud_prod_a_bod_ppal_id."','".$solicitud_prod_a_bod_ppal_det_id."','".$tabla."');\">";
        $html .= "        </td>";
        $html .= "      </tr>";
        $html .= "      </table>";
        }
