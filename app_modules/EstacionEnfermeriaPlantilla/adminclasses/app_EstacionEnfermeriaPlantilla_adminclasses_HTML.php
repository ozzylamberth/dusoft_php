...
class app_EstacionEnfermeria_adminclasses_HTML extends app_EstacionEnfermeria_admin
{
	/**
	...
	*		@return string
	*/
	function app_EstacionEnfermeria_adminclasses_HTML()
	{
...
*/
	function Menu()
 {
			$this->salida.= ThemeAbrirTabla('MENU ADMINISTRADOR MODULO ESTACION ENFERMERIA');
	    ...
	    $this->salida .= "<td colspan=\"2\"   align=\"center\" class=\"modulo_table_title\" >EVENTOS DE USUARIOS</td>";
			$this->salida.="</tr>";
			$ac=ModuloGetURL('app','EstacionEnfermeria','admin','RetornarPermisos');
    	...
    	$this->salida.="<tr>";
			...
			$action3=ModuloGetURL('app','EstacionEnfermeria','admin','Retornar');
