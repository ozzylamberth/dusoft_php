...
function ValoresSeleccion(centro,unidad,departam,frm,emp)
{
  ...
  { 
    ...
    window.opener.document.data.centroUDescripcion.value = frm.centro.options[frm.centro.options.selectedIndex].text;
  ...
  else
  {
    ...
    window.opener.document.data.unidadFDescripcion.value = frm.unidad.options[frm.unidad.options.selectedIndex].text;
  ...
  else
  {
    ...
    window.opener.document.data.DptoSelDescripcion.value = frm.departam.options[frm.departam.options.selectedIndex].text;
