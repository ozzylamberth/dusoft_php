...
class CodificacionProductos_MenuHTML {
    ...
    function Menu($action, $sw, $EmpresaId)
    {
        ...
        $html .= "      <tr class=\"modulo_list_claro\">";
        $html .= "      <td class=\"label\" align=\"center\">";
        $html .= "      <a href=\"" . ModuloGetURL('app', 'Inv_CodificacionProductos', 'controller', 'DiasTratamientos') . "&datos[sw_tipo_empresa]=" . $sw . "&datos[empresa_id]=" . $EmpresaId . "\">DIAS TRATAMIENTOS</a>";
        $html .= "      </td>";
        $html .= "      </tr>";
