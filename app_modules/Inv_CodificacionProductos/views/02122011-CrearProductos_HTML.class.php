<?php
  ...
  */
  ...
  ';
     ...
     * @Observaciones: 
     *  Porción de Código agregado, para la visualización de la ventana emergente, a través de la cual
     *  se ingresara el Factor de conversión para cada medicamento.
     * <Inicia aqui>
     */   
    ...
    var temp;
	 ...
	 //ADICION: validacion campo cod_presenta no vacio (codigo admin. presentacion)
          ...
          {
          cadena.push("Codigo de Min. Defensa, Vacío\n");
          band=1;
          }
          ...
          {
          cadena.push("Codigo de Registro Invima, Vacío\n");
          band=1;
          }
          ...
          {
          cadena.push("Porcentaje de Iva, Vacío\n");
          band=1;
          }
          ...
          {
          cadena.push("No Haz Seleccionado si el Producto Es Generico o Nó!!!\n");
          band=1;
          }
                 ...
                 if(band==1)
                  ...
                  alert("¡Por favor, Diligenciar todos los Datos!");
                      ...
                      else
                      {
                            ...
                            {
                                //para evaluar si es Modificacion o Ingreso: token=1-> Ingreso, token=0-> Modificación
...
";
  ...
  $html .="<script>";
    ...
    var temp;
          ...
          {
          cadena.push("No Haz Seleccionado Si el Producto posee Manejo Luz  o Nó\n");
          band=1;
          }
          ...
          {
          cadena.push("No Haz Seleccionado Si el Producto presenta Farmacovigilancia o Nó\n");
          band=1;
          }
          ...
          {
          cadena.push("Debes seleccionar al menos 1 Nivel de Atención!!!\n");
          band=1;
          }
...
$html .= "
   ...
   $html .= "
    ...
    //FIN URL    
     ...
     //Acá se desplegará Un buscador y un listado de Clases asociadas a un Grupo Seleccionado anteriormente
        $html .="<div id=\"clases\">";
        $html .="</div>";
   //     $html .= "      </td>\n";
    
     //   $html .= "      <td align=\"center\" width=\"50%\">\n";
//Acá se desplegará Un buscador y un listado de SubClases asociadas a un Grupo y una Clase Seleccionados anteriormente
        $html .= "								</div>\n";
...
*/ 
        ...
        $html .="</div>";
        $html .= "								</div>\n";
      //Acá se desplegará el formulario de Ingreso de Productos
    ...
    //Captura Info del Buscador y se envía a xajax
...
//Buscador de Productos Creados
    ...
    //Se dirija a la ultima pestañita
    $html .= "<script>";
