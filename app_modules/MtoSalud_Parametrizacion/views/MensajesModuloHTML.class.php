<?php
    ...
    *
		...
		*/
		...
		{
			$html  = ThemeAbrirTabla('PARAMETRIZACION');
			...
			$html .= "						<a href=\"".$action['parametrizacion']."\"><b>GUIA DE MANTENIMIENTO DE LA SALUD</b></a>\n";
			$html .= "					</td>\n";
			$html .= "				</tr>\n";      
			$html .= "			</table>\n";
			$html .= "		</td>\n";
			...
			$html .= "			<form name=\"form\" action=\"".ModuloGetURL('system','Menu')."\" method=\"post\">";
