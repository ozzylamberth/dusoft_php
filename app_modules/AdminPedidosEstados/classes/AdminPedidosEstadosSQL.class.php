<?php
  class AdminPedidosEstadosSQL extends ConexionBD
  {
    ...
    */
    ...
    /**
    * Metodo para obtener el valor del "estado" del pedido del cliente
    *
    * @param $pedido_id
    * @return array
    * @access public
    */
    function ObtenerEstadoPedidoCliente($pedido_id)
    {
      $sql  = "SELECT estado ";
      $sql .= "FROM   ventas_ordenes_pedidos ";
      $sql .= "WHERE  pedido_cliente_id = '".trim($pedido_id)."' ";
      //echo $sql."<br>";
      if(!$rst = $this->ConexionBaseDatos($sql))
        return false;
