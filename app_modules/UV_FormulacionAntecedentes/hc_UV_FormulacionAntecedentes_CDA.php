...
/**
* $Id: hc_ExamenFisico_CDA.php,v 1.1 2005/06/14 23:25:12 tizziano Exp $
*/
...
* @package SIIS
*/ 
class UV_FormulacionAntecedentes_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    * @access public    
    */  
    function UV_FormulacionAntecedentes_CDA()
    {
