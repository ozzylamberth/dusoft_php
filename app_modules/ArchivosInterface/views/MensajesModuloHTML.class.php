<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: MensajesModuloHTML.class.php,v 1.1 2010/12/17 19:20:05 hugo Exp $
  ...
  class MensajesModuloHTML
  {
    ...
    *
		...
		*/
		...
		{
			$html  = ThemeAbrirTabla('MENU ARCHIVOS');
			$html .= "<table border=\"0\" width=\"50%\" align=\"center\" >\n";
			$html .= "	<tr>\n";
			$html .= "		<td>\n";
      ...
      $html .= "						<a href=\"".$action['aceptar'].URLRequest(array("archivo_subir"=>"MD"))."\"><b>SUBIR ARCHIVOS MEDICOS</b></a>\n";
      $html .= "					</td>\n";
      $html .= "				</tr>\n";
      $html .= "				<tr>\n";
      $html .= "					<td class=\"modulo_list_claro\" align=\"center\">\n";
      $html .= "						<a href=\"".$action['aceptar'].URLRequest(array("archivo_subir"=>"PA"))."\"><b>SUBIR ARCHIVOS PACIENTES / AFILIADOS</b></a>\n";
      $html .= "					</td>\n";
      $html .= "				</tr>\n";/*
      $html .= "				<tr>\n";
      $html .= "					<td class=\"modulo_list_claro\" align=\"center\">\n";
      $html .= "						<a href=\"".$action['aceptar'].URLRequest(array("archivo_subir"=>"FR"))."\"><b>SUBIR ARCHIVOS FORMULAS</b></a>\n";
      $html .= "					</td>\n";
      $html .= "				</tr>\n";*/
      $html .= "        <tr>\n";
      $html .= "          <td class=\"modulo_list_claro\" align=\"center\">\n";
      $html .= "            <a href=\"".$action['aceptar'].URLRequest(array("archivo_subir"=>"DE"))."\"><b>SUBIR ARCHIVOS DESPACHOS</b></a>\n";
      $html .= "          </td>\n";
      $html .= "        </tr>\n";
			$html .= "			</table>\n";
			$html .= "		</td>\n";
