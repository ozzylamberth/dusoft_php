...
/**
 * $Id: Recibo.report.php,v 1.5 2010/11/18 14:18:05 hugo Exp $
...
class Recibo_report extends pos_reports_class
{
    
    //constructor por default
    function Recibo_report()
    {
    ...
    */
    function CrearReporte()
    {
        ...
        $reporte->PrintFTextoValor('TOTAL',$datos[total_abono],0,true,11,true,'right');
        $reporte->PrintEnd();
	...
	function detalles($recibo,$prefijo)
	{
     	...
     	$query = "SELECT a.numerodecuenta as cuenta,c.tipo_afiliado_nombre,b.rango
								FROM rc_detalle_hosp a,cuentas b, tipos_afiliado c
