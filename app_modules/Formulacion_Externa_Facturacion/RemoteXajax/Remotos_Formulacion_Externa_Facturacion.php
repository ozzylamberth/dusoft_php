...
/**
  * @package IPSOFT-SIIS
  * @version $Id: Remotos_Formulacion_Externa_Facturacion.php
 ...
 function GuardarGlosa($Formulario)
		{
		$objResponse = new xajaxResponse();
		$url = ModuloGetURL("app","Formulacion_Externa_Facturacion","controller","Glosar")."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."&datos[ssiid]=".$_REQUEST['datos']['ssiid']."&esm_glosa_id=".$_REQUEST['esm_glosa_id']."";
		$sql = AutoCarga::factory("Consultas_Formulacion_Externa_Facturacion","classes","app","Formulacion_Externa_Facturacion");
		$k=0;
		$j=0;
 ...
 // $objResponse->script("xajax_Listado_ProfesionalesEnEsm(document.getElementById('esm_empresas_').value,document.getElementById('nombre_').value,'1');");
  ...
  $url = ModuloGetURL("app","Formulacion_Externa_Facturacion","controller","Crear_OrdenesRequisicion")."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."&datos[ssiid]=".$_REQUEST['datos']['ssiid']."";
  ...
  if($token)
  {
  $direccion="app_modules/Formulacion_Externa_Facturacion/Imprimir/imprimir_producto.php";
  ...
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("Consultas_Formulacion_Externa_Facturacion","classes","app","Formulacion_Externa_Facturacion");
  $url = ModuloGetURL("app","Formulacion_Externa_Facturacion","controller","Modificar_Glosa")."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."&datos[ssiid]=".$_REQUEST['datos']['ssiid']."&esm_glosa_id=".$_REQUEST['esm_glosa_id']."";
  ...
  $sql = AutoCarga::factory("Consultas_Formulacion_Externa_Facturacion","classes","app","Formulacion_Externa_Facturacion");
  $DetalleGlosa=$sql->Buscar_GlosaActiva($esm_glosa_id);
  $url = ModuloGetURL("app","Formulacion_Externa_Facturacion","controller","Glosas")."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."&datos[ssiid]=".$_REQUEST['datos']['ssiid']."&esm_glosa_id=".$_REQUEST['esm_glosa_id']."";
  //print_r($DetalleGlosa);
