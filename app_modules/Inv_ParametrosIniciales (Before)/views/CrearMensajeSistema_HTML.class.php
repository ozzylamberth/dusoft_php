<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: CrearMensajeSistema_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: CrearMensajeSistema_HTML
  ...
  */
	...
	class CrearMensajeSistema_HTML
	{
		/**
		* Constructor de la clase
		*/
		function CrearMensajeSistema_HTML(){}
		/**
	    * @param array 
  ...
  if(formulario.mensaje_sistema_id=="")
  {
  alert("Codigo del Mensaje esta Vacío");
  band=1;
  }
  
  if(formulario.descripcion=="")
  {
  alert("El Texto del Mensaje, está Vacío");
  band=1;
  }
          ...
          else
          {
              ...
              if (entrar) 
              {
               ...
               if(formulario.token=="1") //Si es Ingreso de Laboratorio
                  {
                  xajax_InsertarMensajeSistema(formulario);
                  //alert("ingreso");
                  }
                       else
                          {
                          xajax_GuardarModMensajeSistema(formulario);
                         // alert("Modi");
                          }
...
{ 
  ...
  ';
    ...
    $html .= ThemeAbrirTabla('CREAR MENSAJES DEL SISTEMA');
    
      
    $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_IngresoMensajeSistema()\">[::CREAR - NUEVO MENSAJE SISTEMA::]</a><BR></CENTER>";
    ...
    $html .= "  {";
    $html .= "    xajax_MensajesSistemaT(offset);\n";
    $html .= "  }\n";
    ...
    $html .= $this->CrearVentana(600,"MENSAJES DEL SISTEMA");
    $html .= ThemeCerrarTabla();
    $html .= "<script>";
    $html .= "xajax_MensajesSistemaT();";
    $html .= "</script>";
