...
/**
 * $Id: app_Os_Listas_Trabajo_Apoyod_Agrupado_userclasses_HTML.php,v 1.1.1.1 2009/09/11 20:36:53 hugo Exp $
    ...
    function FormaMetodoBuscar($arr)
		{
			...
			*/
			...
			if($x)
			{
				...
				$this->salida .= "									</td>\n";
				$this->salida .= "									<td>\n";
				$this->salida .= "										<a href=\"javascript:AsignarFecha('CUALQUIER FECHA')\" class=\"label_error\">[CUALQUIER FECHA]</a>\n";
				$this->salida .= "									</td>\n";
  ...
  /*
    ...
    */
    ...
    {//echo "<pre>".print_r($_SESSION,true)."</pre>";
            ...
            $this->salida= ThemeAbrirTablaSubModulo('CAPTURA DE RESULTADOS INDIVIDUALESs');
        ...
        //habria que hacer la prueba para ver si al enviar un examen que no exista que pasa.
            ...
            if ($datos)
            {
                    for($k=0;$k<sizeof($datos);$k++)
                    {
                            ...
                            $this->salida.="<td align=\"center\" width=\"12%\" colspan=\"5\">OPCIONES</td>";
							...
							//INICIO IMAGENOLOGIA
							$estudio = $this->GetEstudiosImagenologia($datos[$k]['numero_orden_id']);
							$this->salida.="<td align=\"center\" width=\"3%\"><a href=\"\">";
							if (!empty($estudio)) {						
								...
								$this->salida .="       <a href=\"javascript:void(0);\" onclick=\"window.open('".$ruta."', '".$nombre."', '".$str."');\"><img align=\"center\" src=\"". GetThemePath() ."/images/radiology.png\" border='0' title='Estudio Radiologia'></a>";
							} else {
