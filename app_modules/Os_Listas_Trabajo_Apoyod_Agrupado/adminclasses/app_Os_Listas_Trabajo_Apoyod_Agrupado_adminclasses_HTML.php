...
/**
 * $Id: app_Os_Listas_Trabajo_Apoyod_Agrupado_adminclasses_HTML.php,v 1.1.1.1 2009/09/11 20:36:53 hugo Exp $
...
class app_Os_Listas_Trabajo_Apoyod_adminclasses_HTML extends app_Os_Listas_Trabajo_Apoyod_admin
{
	/**
  ...
  function app_Os_Listas_Trabajo_Apoyod_admin_HTML()
	{
		$this->salida='';
		$this->app_Os_Listas_Trabajo_Apoyod_admin();
		return true;
	}
...
*/
	function Menu()
 {
			$this->salida.= ThemeAbrirTabla('MENU ADMINISTRADOR CAJA GENERAL SIIS');
