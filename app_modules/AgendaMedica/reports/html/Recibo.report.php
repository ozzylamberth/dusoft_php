  ...
  class Recibo_report
  {
    ...
    */
    function CrearReporte()
    {
      ...
      $salida .= "        <TR class=\"normal_10\">";
      $salida .= "          <TD colspan='1'><font size='2'><b>VALOR</b> :</font>&nbsp;<font size='3'>$".FormatoValor($this->datos[liqcita][valor_total_paciente])."</font></TD>";
      $salida .= "        </TR>";
      $salida .= "    </TD>";
      $salida .= "  </TR>";
      $salida .= "</table>";
	  ...
	  $salida .= "  </TR><TR>";
	  $salida .= "    <TD align='right'><font size='1'><b>Fecha</b> :&nbsp;".$this->datos['fecharegistro']."</font></TD>";
      $salida .= "  </TR>";
      $salida .= "</table>";
      $salida .= "<br>";
      $salida .= "<br>";
