  ...
  */
  class Citas extends ConexionBD
  {
    ...
    * @return mixed
      ...
      $sql .= "       CASE WHEN TL.dir IS NULL THEN  UF.ubicacion ELSE  TL.dir END AS departamentoubicacion,";
      $sql .= "       CASE WHEN TL.tel IS NULL THEN UF.telefono ELSE TL.tel END AS telefonocancelacion,";
      ...
      $sql .= "       LEFT JOIN(SELECT C.consultorio as nom_consultorio,
									   TC.descripcion,
									   TC.direccion as dir,
									   TC.telefono as tel,
								...
								WHERE  C.tipo_consultorio = TC.tipo_consultorio
									   AND TCC.consultorio_id= C.consultorio_id 
									   AND TC.tipo_consultorio=C.tipo_consultorio) AS TL "; 
      $sql .= "       ON(AU.consultorio_id = TL.nom_consultorio AND AU.tipo_consulta_id = TL.tipo_consulta_id),";
      ...
      $sql .= "AND    DE.departamento = TC.departamento "; 
      $sql .= "AND    DE.unidad_funcional = UF.unidad_funcional ";
      $sql .= "AND    DE.empresa_id = UF.empresa_id ";	  
      $sql .= "AND    AA.plan_id = PL.plan_id "; 
      $sql .= "AND    PA.paciente_id = AA.paciente_id "; 
      $sql .= "AND    PA.tipo_id_paciente = AA.tipo_id_paciente ";
      $sql .= "AND    TC.tipo_consulta_id = TS.tipo_servicio_amb_id ";
