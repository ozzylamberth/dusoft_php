...
class app_ModuloAdminPsicologia_adminclasses_HTML extends app_ModuloAdminPsicologia_admin
{
	/**
	...
	*/
  	...
  	function app_ModuloAdminPsicologia_admin_HTML()
	{
		$this->salida='';
		$this->system_ModuloAdminPsicologia_admin();
		return true;
	}
