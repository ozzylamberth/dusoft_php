/**************************************************************************************
* $Id: EECargo.js,v 1.2 2007/12/06 16:03:21 jgomez Exp $ 
...
function ValidarInsumos(Cuenta)
{
    xajax_ValidarTmpInsumos(Cuenta);
}

function Guardartmp()
{
    document.formaguardar.submit();
    
}

function DesbloquearBoton()
{
    document.getElementById('Guardar_todo').disabled=false;
}

function BloquearBoton()
{
    document.getElementById('Guardar_todo').disabled=true;
}
