	...
	**************************************************************************************/
    ...
    function ActivarTaller($Taller, $Estado)
    {
     ...
     function CancelarTalleres($DatosTaller)
     {
          ...
          $salida .= "<table align=\"center\" width=\"100%\"  border=\"0\" >\n";
          $salida .= "  <tr class=\"modulo_table_title\">\n";
          $salida .= "      <td colspan='6'>CANCELAR PROGRAMACION: ".$vars[0]['nombre_taller']."</td>\n";
          $salida .= "  </tr>\n";
          $salida .= "  <tr class=\"hc_table_submodulo_list_title\">\n";
          $salida .= "      <td>SESION</td>\n";
          $salida .= "      <td>FECHA</td>\n";
          ...
          for($i=0; $i<sizeof($vars); $i++)
          {
               ...
               $salida .= "      <td align=\"center\" class=\"modulo_list_claro\"><input type=\"button\" class=\"input-submit\" name=\"CancelTaller\" id=\"CancelTaller\" onclick=\"CancelTallerP('".$vars[$i]['sesion_id']."', ".$vars[0]['taller_id'].");\" value=\"CANCELAR SESION\"></td>\n";
               $salida .= "  </tr>\n";          
          }
          $salida .= "</table><br>\n";
     ...
     function CancelProgramacionT($sesion, $Taller)
     {
     	$objResponse = new xajaxResponse();
          $centinela = false;
          list($dbconn) = GetDBconn();

          $query = "UPDATE hc_psicologia_talleres_programaciones_sesiones
          		SET sw_estado = '2'
          ...
          if($data['0'] == 0)
          {
          	$query3 = "UPDATE hc_psicologia_programaciones_talleres
          			 SET sw_estado = '2'
                    	 WHERE taller_id = ".$Taller.";";
