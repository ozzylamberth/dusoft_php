...
/**
  ...
  */  
  ...
  function UsuariosDocumentosBodegasT($CodigoEmpresa,$offset)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasEstadosDocumentos","classes","app","Inv_ParametrosIniciales");
  
  
  $Usuarios=$sql->Listar_UsuariosDocumentosBodegas($CodigoEmpresa,$offset);
  
  $action['paginador'] = "Paginador('".$CodigoEmpresa."'";
    ...
    $html .= "<fieldset class=\"fieldset\">\n";
      ...
      $html .= "    </tr>\n";
          ...
          foreach($Usuarios as $key => $u)
          {
            ...
            $html .= "        <a href=\"#\" onclick=\"xajax_UsuarioEstadosDocumentos('".$u['usuario_id']."','".$CodigoEmpresa."')\">\n";
            $html .= "          <img title=\"ASIGNAR ESTADOS\" src=\"".GetThemePath()."/images/modificar.gif\" border=\"0\">\n";
          ...
          $objResponse->assign("ListadoUsuarios","innerHTML",$objResponse->setTildes($html));
          return $objResponse;
  ...
  */  
  ...
  $action['paginador'] = "Paginador(";
    ...
    $html .= "<fieldset class=\"fieldset\">\n";
      ...
      $html .= "      <td width=\"25%\">CREA DOCUMENTO</td>\n";
      ...
      $html .= "    </tr>\n";
        ...
        if($ED['sw_crear_documento']==1)
          {
          $html .= "<td align=\"center\">
                <a href=\"#\" onclick=\"xajax_CambioEstadoEstadoDocumento('inv_estados_documentos','sw_crear_documento','0','".$ED['abreviatura']."','abreviatura')\">\n";
          $html .="<img title=\"INACTIVAR\" src=\"".GetThemePath()."/images/checksi.png\" border=\"0\"></a></td>\n";
          }
          else
            {
            $html .= "<td align=\"center\"><a href=\"#\" onclick=\"xajax_CambioEstadoEstadoDocumento('inv_estados_documentos','sw_crear_documento','1','".$ED['abreviatura']."','abreviatura')\">\n";
  ...
  */
  ...
  $html .= "  <table border=\"0\" width=\"100%\" align=\"center\" class=\"modulo_table_list\">";
    ...
    $html .= "      <td class=\"label\" align=\"center\" colspan=\"2\">";
		$html .= '      <input type="hidden" value="'.$EstadoDocumento[0]['abreviatura'].'" name="abreviatura_old">';
...
function InsertarEstadoDocumento($datos)
  ...
  $objResponse = new xajaxResponse();
    ...
    $html .= "      <tr class=\"modulo_list_claro\">";
		...
		$html .= "      </td>";
		$html .= "      <td align=\"center\" width=\"10%\">";
		$html .= '      <input class="checkbox" type="checkbox" name="sw_crear_documento" value="1">';
		$html .= "      </td>";
		$html .= "      </tr>";
  ...
  */  
  ...
  function UsuarioEstadosDocumentos($CodigoUsuario,$CodigoEmpresa)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasEstadosDocumentos","classes","app","Inv_ParametrosIniciales");
  
  $Usuario=$sql->Buscar_Usuario($CodigoUsuario);
  //$EstadosDocumentos=$sql->Listar_EstadosDocumentos();
  
      
      $html .=" <center>";
      $html .= "<fieldset class=\"fieldset\" style=\"width:60%\">\n";
      $html .= "  <legend class=\"normal_10AN\">USUARIO</legend>\n";
          
      $html .= "  <table border=\"0\" width=\"100%\" align=\"center\" class=\"modulo_table_list\">\n";
          
      $html .= "    <tr>\n";
      $html .= "      <td class=\"formulacion_table_list\" width=\"7%\">USUARIO ID</td>\n";
      $html .= "<td class=\"modulo_list_claro\">".$Usuario[0]['usuario_id']."</td>";
      $html .= "    </tr>\n";
      
      $html .= "    <tr>\n";
      $html .= "      <td class=\"formulacion_table_list\" width=\"7%\">NOMBRE</td>\n";
      $html .= "<td class=\"modulo_list_claro\">".$Usuario[0]['nombre']."</td>";
      $html .= "    </tr>\n";
      
      $html .= "    <tr>\n";
      $html .= "      <td class=\"formulacion_table_list\" width=\"7%\">DESCRIPCION</td>\n";
      $html .= "<td class=\"modulo_list_claro\">".$Usuario[0]['descripcion']."</td>";
      $html .= "    </tr>\n";
      ...
      $html .="<div id=\"listado_EstadosUsuarios\">";
      $html .="</div>";
      ...
      $html .= "  <table border=\"0\" width=\"100%\" align=\"center\" class=\"modulo_table_list\">\n";
          ...
          {
          $band=0;
          $UsuarioEstado=$sql->Buscar_UsuarioEstadoDocumento($Usuario[0]['usuario_id'],$ED['abreviatura']);
          
          if(!empty($UsuarioEstado))
          {
          $band=1;
          }
        ...
        if($band==1)
          {
          $html .= "<td align=\"center\">
                <a href=\"#\" onclick=\"xajax_asignar('inv_estados_documentos','estado','0','".$ED['abreviatura']."','abreviatura')\">\n";
          $html .="<img title=\"QUITAR\" src=\"".GetThemePath()."/images/checksi.png\" border=\"0\"></a></td>\n";
          }
          else
            {
            $html .= "<td align=\"center\"><a href=\"#\" onclick=\"xajax_Borrar('inv_estados_documentos','estado','1','".$ED['abreviatura']."','abreviatura')\">\n";
            $html .="<img title=\"ASIGNAR\" src=\"".GetThemePath()."/images/checkno.png\" border=\"0\"></a></td>\n";
            }
        ...
        //LLamado a funcion Javascript que muestre la ventanita (en capa) con Ajax
          $objResponse->call("MostrarSpan");
          $objResponse->script("xajax_ListadoEstadosUsuarios('".$CodigoUsuario."','".$CodigoEmpresa."');");
          return $objResponse;
  ...
  */  
  ...
  function ListadoEstadosUsuarios($CodigoUsuario,$CodigoEmpresa,$offset)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasEstadosDocumentos","classes","app","Inv_ParametrosIniciales");
  $sql1 = AutoCarga::factory("ConsultasEstadosDocumentos","classes","app","Inv_ParametrosIniciales");
  
  $Usuario=$sql1->Buscar_Usuario($CodigoUsuario);
  $EstadosDocumentos=$sql->Listar_EstadosDocumentos($offset);
      
      
    $action['paginador'] = "paginador('".$CodigoUsuario."','".$CodigoEmpresa."'";
    $pghtml = AutoCarga::factory("ClaseHTML");
      ...
      $html .= "<tr>";
      $html .= "      <td class=\"formulacion_table_list\" width=\"7%\">ABREVIATURA</td>\n";
      $html .= "      <td class=\"formulacion_table_list\" width=\"7%\">ESTADO</td>\n";
      $html .= "      <td class=\"formulacion_table_list\" width=\"7%\">OP</td>\n";     
      $html .= "</tr>";
        ...
        if($band==1)
          ...
          $html .= "<td align=\"center\">
                <a href=\"#\" onclick=\"xajax_BorrarEstadoUsuario('inv_bodegas_usuarios_estados_documentos','".$UsuarioEstado[0]['usuario_estado_id']."','usuario_estado_id','".$CodigoUsuario."','".$CodigoEmpresa."','".$offset."')\">\n";
          $html .="<img title=\"QUITAR\" src=\"".GetThemePath()."/images/checksi.png\" border=\"0\"></a></td>\n";
          }
          else
            { 
            $html .= "<td align=\"center\"><a href=\"#\" onclick=\"xajax_AsignarEstadoUsuario('".$ED['abreviatura']."".$CodigoUsuario."','".$CodigoUsuario."','".$ED['abreviatura']."','".$CodigoEmpresa."','".$offset."')\">\n";
            $html .="<img title=\"ASIGNAR\" src=\"".GetThemePath()."/images/checkno.png\" border=\"0\"></a></td>\n";
            }
          ...
          $objResponse->assign("listado_EstadosUsuarios","innerHTML",$objResponse->setTildes($html));
        //LLamado a funcion Javascript que muestre la ventanita (en capa) con Ajax
          return $objResponse;
  ...
  */  
  ...
  function BuscarUsuario($datos,$offset)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasEstadosDocumentos","classes","app","Inv_ParametrosIniciales");
  
  
  $Usuarios=$sql->UsuarioDocumentoBodega($datos,$offset);
  
  $action['paginador'] = "Paginador('".$datos."'";
  ...
  function AsignarEstadoUsuario($EstadoUsuario,$CodigoUsuario,$Abreviatura,$CodigoEmpresa,$offset)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasEstadosDocumentos","classes","app","Inv_ParametrosIniciales");
  
  $token=$sql->InsertarEstadoUsuario($EstadoUsuario,$CodigoUsuario,$Abreviatura);
  
  if($token)
  {
  $objResponse->script("xajax_ListadoEstadosUsuarios('".$CodigoUsuario."','".$CodigoEmpresa."','".$offset."');"); 
  }
  else
  ...
  Funcion Xajax para borrar Grupos
  */
  function BorrarEstadoUsuario($tabla,$id,$campo_id,$CodigoUsuario,$CodigoEmpresa,$offset)
  {
    $objResponse = new xajaxResponse();
    $sql = AutoCarga::factory("ClaseUtil"); //cargo Funcion General para cambiar de estado un registro.
    $token=$sql->Borrar_Registro($tabla,$id,$campo_id);
