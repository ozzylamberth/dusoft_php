<?php
  ...
  */
  ...
  /**
  * Clase Vista: CrearTiposSalidasProductos_HTML
  ...
  */
	...
	class CrearTiposSalidasProductos_HTML
	{
		/**
		* Constructor de la clase
		*/
		function CrearTiposSalidasProductos_HTML(){}
		/**
	    * @param array 
  ...
  if(formulario.tipo_salida_producto_id=="")
  {
  alert("CODIGO VACÍO!!!");
  band=1;
  }
          ...
          else
          {
              ...
              if (entrar) 
              {
               ...
               if(formulario.token=="1") //Si es Ingreso de Laboratorio
                  {
                  xajax_InsertarTipoSalidaProducto(formulario);
                  //alert("ingreso");
                  }
                       else
                          {
                          xajax_GuardarModTipoSalidaProducto(formulario);
                         // alert("Modi");
                          }
...
{ 
  ...
  ';
    ...
    $html .= ThemeAbrirTabla('CREAR TIPOS DE SALIDAS DE PRODUCTOS');
    
      
    $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_IngresoTipoSalidaProducto()\">[::CREAR - NUEVO TIPO SALIDA PRODUCTOS::]</a><BR></CENTER>";
    ...
    $html .= "  {";
    $html .= "    xajax_TiposSalidasProductosT(offset);\n";
    $html .= "  }\n";
    ...
    $html .= $this->CrearVentana(600,"TIPOS DE SALIDAS");
    $html .= ThemeCerrarTabla();
    $html .= "<script>";
    $html .= "xajax_TiposSalidasProductosT();";
    $html .= "</script>";
