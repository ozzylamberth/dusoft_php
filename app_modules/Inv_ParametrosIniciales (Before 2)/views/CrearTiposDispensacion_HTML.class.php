<?php
  ...
  */
	...
	class CrearTiposDispensacion_HTML
	{
		/**
		* Constructor de la clase
		*/
		function CrearTiposDispensacion_HTML(){}
		/**
	    * @param array 
  ...
  if(formulario.tipo_dispensacion_id=="")
  {
          ...
          else
          {
              ...
              if (entrar) 
              {
               ...
               if(formulario.token=="1") //Si es Ingreso de Laboratorio
                  {
                  xajax_InsertarTipoDispensacion(formulario);
                  //alert("ingreso");
                  }
                       else
                          {
                          xajax_GuardarModTipoDispensacion(formulario);
                         // alert("Modi");
                          }
...
{ 
  ...
  ';
    ...
    $html .= ThemeAbrirTabla('CREAR TIPOS DE DISPENSACION');
    
      
    $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_IngresoTipoDispensacion()\">[::CREAR - NUEVO TIPO DE DISPENSACION::]</a><BR></CENTER>";
    ...
    $html .= "  {";
    $html .= "    xajax_TiposDispensacionT(offset);\n";
    $html .= "  }\n";
    ...
    $html .= $this->CrearVentana(600,"TIPOS DE DISPENSACION");
    $html .= ThemeCerrarTabla();
    $html .= "<script>";
    $html .= "xajax_TiposDispensacionT();";
    $html .= "</script>";
