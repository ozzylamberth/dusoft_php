<?php
  ...
  */
	...
	class AsignarCondicionesDeDevolucionProductosXLaboratorio_HTML
	{
		/**
		* Constructor de la clase
		*/
		function AsignarCondicionesDeDevolucionProductosXLaboratorio_HTML(){}
		/**
	    * @param array 
      * $action Vector de links de la aplicaion
		* 
		*/
		function main($action,$Empresa_id,$Empresas)
    {
    ...
    $html .= ThemeAbrirTabla('CONDICIONES DE DEVOLUCION POR FARMACIA (PROVEEDOR)');
    
    $html .=    "<script>";
    $html .= "  function Paginador(empresa_id,tercero_id,nombre,offset)\n";
    $html .= "  {";
    $html .= "    xajax_TercerosProveedoresT(empresa_id,tercero_id,nombre,offset);\n";
    $html .= "  }\n";
    $html .=    "</script>";
    ...
    $html .= "Identificador del Proveedor :";
    $html .= "</td>";
    $html .= "<td>";
    $html .= "<input style=\"width:100%;height:100%\" class=\"input-text\" type=\"text\" id=\"usuario_id\" name=\"usuario_id\" maxlength=\"6\" >";
    $html .= "</td>";
    $html .= "</tr>";
    $html .= "<tr class=\"modulo_list_claro\">";
    $html .= "<td class=\"formulacion_table_list\">";
    ...
    $html .= "</td>";
    $html .= "<td>";
    $html .= "<input style=\"width:100%;height:100%\" class=\"input-text\" type=\"text\" name=\"nombre\" id=\"nombre\" maxlength=\"30\" >";
    $html .= "</td>";
    $html .= "</tr>";
    $html .= "<tr class=\"modulo_list_claro\">";
    $html .= "<td colspan=\"2\" align=\"center\">";
    $html .= "<input value='".$EmpresaId."' type=\"hidden\" name=\"empresa\">";
    $html .= "<input value=\"Buscar\" class=\"input-submit\" type=\"button\" onclick=\"xajax_TercerosProveedoresT('".$EmpresaId."',document.getElementById('usuario_id').value,document.getElementById('nombre').value,'1');\">";
    ...
    $html .= "<script>";
    $html .= "xajax_TercerosProveedoresT('".$EmpresaId."','','','1');";
    $html .= "</script>";
    ...
    $html .= $this->CrearVentana(600,"POLITICAS DE DEVOLUCION DE PRODUCTOS");
