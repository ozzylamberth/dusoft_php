<?php
  ...
  */
  /**
  * Clase Vista: TransportadorasHTML
  ...
  * @author Mauricio Adrian Medina S
  */
	class TransportadorasHTML
	{
		/**
		* Constructor de la clase
		*/
		function TransportadorasHTML(){}
		/*
		...
		*/ 
		...
		function Forma($action,$Listado_Transportadoras,$conteo, $pagina)
		{
			$html  = ThemeAbrirTabla(' CREACION DE TIPOS DE CLIENTES ');
			...
			$html .= "		NUEVA TRANSPORTADORA";
			$html .= "    </td>\n";
			$html .= "    <td align=\"center\">\n";
			$html .= "		<center class=\"label_error\"><a href=\"#\" onclick=\"xajax_Formulario_Transportadora('---');\"><img src=\"".GetThemePath()."/images/proveedor.png\" border='0'></a></center>";
			$html .= "    </td>\n";
			$html .= "	</tr>";
			$html .= "</table>";
			$html .= "<br>";
			...
			$html .= "      <td  class=\"formulacion_table_list\">CODIGO TRANSPORTADORA</td>\n";
			$html .= "      <td  class=\"formulacion_table_list\"><input name=\"buscador[transportadora_id]\" id=\"buscador[transportadora_id]\" class=\"input-text\" style=\"width:100%\"></td>\n";
			...
			$html .= "	</tr>";
			$html .= "  <tr align=\"center\" >\n";
			$html .= "      <td  class=\"formulacion_table_list\" colspan=\"6\"><input type=\"submit\" value=\"BUSCAR TRANSPORTADORA\" class=\"input-submit\"></td>\n";
			$html .= "	</tr>";
			$html .= "</table>";
			$html .= "</form>";
			$html .= "<br>";
			...
			$html .= "                      </td>\n";
			$html .= "                      <td align=\"center\" >\n";
			$html .= "                        <a title='CARRO PROPIO'>CARRO PROPIO</a>";
			$html .= "                      </td>\n";
			$html .= "                      <td align=\"center\" >\n";
			...
			$html .= "                      </td>\n";
			$html .= "                    </tr>\n";
			foreach($Listado_Transportadoras as $key => $valor)
			{
			$html .= "                  <tr class=\"modulo_list_claro\" onMouseOver=\"mOvr(this,'#ffffff');\" onMouseOut=\"mOut(this,'#DDDDDD');\">\n";
			$html .= "						<td>".$valor['transportadora_id']."</td>";
			$html .= "						<td>".$valor['descripcion']."</b></td>";
			$html .= "						<td>".$valor['carro_propio']."</b></td>";
			$html .= "						<td>";
			$html .= "						<center><a href=\"#\" class=\"label_error\" title=\"MODIFICAR TRANSPORTADORA\" onclick=\"xajax_Formulario_Transportadora('".$valor['transportadora_id']."');\"><img src=\"".GetThemePath()."/images/modificar.png\" border='0'></a></center>\n";
			$html .= "						</td>";
			if($valor['estado']=='1')
				{
			$html .= "						<td>";
			$html .= "						<center><a onClick=\"return confirm('INACTIVAR LA TRANSPORTADORA: ".$valor['descripcion']."?');\" href=\"".ModuloGetURL('app','Inv_ParametrosIniciales','controller','Transportadoras',array("transportadora_id"=>$valor['transportadora_id'],"cambiar_estado"=>"0","buscador"=>$_REQUEST['buscador']))."\" class=\"label_error\"  title=\" LA TRANSPORTADORA ACTIVA, CAMBIAR A INACTIVO\"><img src=\"".GetThemePath()."/images/pactivo.png\" border='0'></a></center>\n";
			$html .= "						</td>";
				}
			else
				{
			$html .= "						<td>";
			$html .= "							<center><a onClick=\"return confirm('ACTIVAR LA TRANSPORTADORA: ".$valor['descripcion']."?');\" href=\"".ModuloGetURL('app','Inv_ParametrosIniciales','controller','Transportadoras',array("transportadora_id"=>$valor['transportadora_id'],"cambiar_estado"=>"1","buscador"=>$_REQUEST['buscador']))."\" class=\"label_error\"  title=\"TRANSPORTADORA INACTIVA, CAMBIAR A ACTIVO\"><img src=\"".GetThemePath()."/images/pinactivo.png\" border='0' ></a></center>\n";
			$html .= "						</td>";
				}
			$html .= "                   </tr>\n";
			}
			...
			$html .= $this->CrearVentana('600','TRANSPORTADORA');
			return $html;
        }
