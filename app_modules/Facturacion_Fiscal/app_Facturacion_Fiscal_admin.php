...
/**
 * $Id: app_Facturacion_Fiscal_admin.php,v 1.5 2010/12/06 22:13:37 hugo Exp $
...
class app_Facturacion_Fiscal_admin extends classModulo
{


	function app_Facturacion_Fiscal_admin()
	{
...
{
	$this->ReturnMetodoExterno($_SESSION['USER_ADMIN_MOD']['CONTENEDOR'], $_SESSION['USER_ADMIN_MOD']['MOD'], $_SESSION['USER_ADMIN_MOD']['TIPO'], 'TraerDatos',array("tabla"=>'userpermisos_tipos_facturas',"permiso"=>'FACTURACION FISCAL'));
	return true;
}
