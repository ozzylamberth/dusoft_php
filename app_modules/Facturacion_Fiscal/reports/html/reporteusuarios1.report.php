...
/**
 * $Id: reporteusuarios1.report.php,v 1.1.1.1 2009/09/11 20:36:46 hugo Exp $
...
class reporteusuarios_report
{
	...
	*/
	function CrearReporte()
	{
			...
			{
					$Salida.="<tr class=\"titulo\">";
					$Salida.="<td>".$arr[$i][nombre_tercero]."</td>";
					$Salida.="</tr>";
					$d=$i;
					...
					{
							$Salida.="<tr>";
							$Salida.="<td class=\"normal_10n\">".$arr[$d][plan_descripcion]."</td>";
							$Salida.="</tr>";
							$Salida.="<tr>";
							$Salida.="<td>";
							$Salida.="<DIV>";
			...
			$Salida.="<tr>";
			$Salida.="<td class=\"normal_10n\">VALOR TOTAL ($):  ".FormatoValor($total)."";
			$Salida.="</td>";
			$Salida.="</tr>";
			if(!empty($cant))
			{
					...
					$Salida.="</tr>";
					$Salida.="<tr>";
					$Salida.="<td class=\"normal_10n\">TOTAL FACTURAS :  $cant";
					$Salida.="</td>";
					$Salida.="</tr>";
			}
			if(!empty($cuentas))
			{
					...
					$Salida.="</tr>";
					$Salida.="<tr>";
					$Salida.="<td class=\"normal_10n\">TOTAL CUENTAS  :  $cuentas";
					$Salida.="</td>";
					$Salida.="</tr>";
			}
			$Salida.="</table>";
  ...
  */
  ...
  {      //solo trae las facturas de cliente sw_tipo=1 cliente
      ...
      echo  $query = "( select c.estado, a.tipo_id_tercero, a.tercero_id, a.empresa_id, a.prefijo, a.factura_fiscal, a.total_factura,
