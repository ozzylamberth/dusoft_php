...
/**
 * $Id: Soat_Anexo1.report.php,v 1.1.1.1 2009/09/11 20:36:46 hugo Exp $
...
class Soat_Anexo1_report
{
	...
	{
		$this->datos['var']=$_SESSION['FACTURACION']['datos_periodo_soat'];
		...
		$HTML_WEB_PAGE.="<TD WIDTH='30%' ALIGN='LEFT'><FONT SIZE='1'>DD____MM____AÑO________</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='20%' ALIGN='LEFT'><FONT SIZE='1'>No. Radicado:</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='30%' ALIGN='LEFT'><FONT SIZE='1'>_______________</FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="</TABLE>";
		...
		//TIPOS DE EVENTOS
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'>Accidente de Tránsito</FONT></TD>";
		...
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'>Catástrofes Naturales</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'>0</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='5%' ALIGN='CENTER'><FONT SIZE='1'>$</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='30%' ALIGN='RIGHT'><FONT SIZE='1'>0</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='15%' ALIGN='CENTER'><FONT SIZE='1'></FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'>Eventos Terroristas</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'>0</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='5%' ALIGN='CENTER'><FONT SIZE='1'>$</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='30%' ALIGN='RIGHT'><FONT SIZE='1'>0</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='15%' ALIGN='CENTER'><FONT SIZE='1'></FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'>Población Desplazada</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'>0</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='5%' ALIGN='CENTER'><FONT SIZE='1'>$</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='30%' ALIGN='RIGHT'><FONT SIZE='1'>0</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='15%' ALIGN='CENTER'><FONT SIZE='1'></FONT></TD>";
		...
		//TIPOS DE EVENTOS
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'><B>TOTAL</B></FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='25%' ALIGN='CENTER'><FONT SIZE='1'><B>".$registros."</B></FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='5%' ALIGN='CENTER'><FONT SIZE='1'><B>$</B></FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='30%' ALIGN='RIGHT'><FONT SIZE='1'><B>".number_format(($valor), 0, ',', '.')."</B></FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='15%' ALIGN='CENTER'><FONT SIZE='1'></FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="</TABLE>";
		$HTML_WEB_PAGE.="<TABLE WIDTH='100%' BORDER=1>";
		...
		$HTML_WEB_PAGE.=" Contraloría General de la República, de no ser así, acepto todas las consecuencias legales que produzca esta situación.</li><br>";
		$HTML_WEB_PAGE.="<li>Que las reclamaciones incluidas en el medio magnético cumplen con los requisitos establecidos en los Decretos Ley 1032 de 1991, 663";
...
$numeroresidu=($registros%30);
		...
		$HTML_WEB_PAGE.="<B>IPS:&nbsp;&nbsp;&nbsp;&nbsp;".$datos1['razon_social']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$datos1['periodorec']."</B><br>";
		...
		$HTML_WEB_PAGE.="<TR>";
		//$HTML_WEB_PAGE.="<TD></TD>";
		$HTML_WEB_PAGE.="<TD COLSPAN='4' ALIGN='CENTER'><FONT SIZE='0.8'>Nombre de la Víctima</FONT></TD>";
		$HTML_WEB_PAGE.="<TD COLSPAN='2' ALIGN='CENTER'><FONT SIZE='0.8'>Identificación</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='6%'  ALIGN='CENTER' ROWSPAN='2'><FONT SIZE='0.8'>Tipo Evento</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='6%'  ALIGN='CENTER' ROWSPAN='2'><FONT SIZE='0.8'>Fecha Ingreso DD/MM/AÑO</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='6%'  ALIGN='CENTER' ROWSPAN='2'><FONT SIZE='0.8'>Fecha Egreso DD/MM/AÑO</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='12%' ALIGN='CENTER' ROWSPAN='2'><FONT SIZE='0.8'>Valor Servicios Prestados</FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD><FONT SIZE='0.8'>Reg.</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='28%' ALIGN='CENTER'><FONT SIZE='0.8'>Primer Apellido</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='28%' ALIGN='CENTER'><FONT SIZE='0.8'>Segundo Apellido</FONT></TD>";
		...
		{
			$HTML_WEB_PAGE.="<TR>";
			$HTML_WEB_PAGE.="<TD ALIGN='RIGHT'><FONT SIZE='0.8'>".$k;
			$HTML_WEB_PAGE.="</FONT></TD>";
			$HTML_WEB_PAGE.="<TD WIDTH='27%' ALIGN='LEFT'><FONT SIZE='0.8'>";
			$HTML_WEB_PAGE.="".$datos2[$i]['primer_apellido']."";
			$HTML_WEB_PAGE.="</FONT></TD>";
			$HTML_WEB_PAGE.="<TD WIDTH='27%' ALIGN='LEFT'><FONT SIZE='0.8'>";
			$HTML_WEB_PAGE.="".$datos2[$i]['segundo_apellido']."";
			$HTML_WEB_PAGE.="</FONT></TD>";
			$HTML_WEB_PAGE.="<TD WIDTH='27%' ALIGN='LEFT'><FONT SIZE='0.8'>";
		...
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD COLSPAN='9' ALIGN='RIGHT'><FONT SIZE='0.8'>SUBTOTAL</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='12%' ALIGN='RIGHT'><FONT SIZE='0.8'>".number_format(($valor), 0, ',', '.')."</FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="<TR>";
		$HTML_WEB_PAGE.="<TD COLSPAN='9' ALIGN='RIGHT'><FONT SIZE='0.8'>TOTAL</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='12%' ALIGN='RIGHT'><FONT SIZE='0.8'>".number_format(($valor), 0, ',', '.')."</FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="</TABLE>";
		$HTML_WEB_PAGE.="<TABLE WIDTH='100%' BORDER=1>";
		...
		$HTML_WEB_PAGE.="<TD WIDTH='20%' ALIGN='LEFT'><FONT SIZE='0.8'>04 - Erupción Volcánica<br>09 - Explosión Terrorista<br>14 - Población Desplazada</FONT></TD>";
		$HTML_WEB_PAGE.="<TD WIDTH='20%' ALIGN='LEFT' VALIGN='TOP'><FONT SIZE='0.8'>05 - Deslizamiento de Tierra<br>10 - Incendio Terrorista</FONT></TD>";
		$HTML_WEB_PAGE.="</TR>";
		$HTML_WEB_PAGE.="</TABLE>";
		$HTML_WEB_PAGE.="<TABLE WIDTH='100%' BORDER=0>";
		$HTML_WEB_PAGE.="<TR>";
	...
	function BuscarDatosReporte1($datos)
	{
		...
		$fdradi = explode('-',$datos['fechadradi']);
		$fechadradi = $fdradi[2].' '.$fdradi[1].' '.$fdradi[0];

		$prec = explode('-',$datos['periodorec']);
		$periodorec = 'Mes:&nbsp;<u>'.$prec[1].'</u>&nbsp;&nbsp;Año:&nbsp;<u>'.$prec[0].'</u>';

		$finici = explode('-',$datos['fechainici']);
		$fechainici =  $finici[2].' '.$finici[1].' '.$finici[0];

		$ffinal = explode('-',$datos['fechafinal']);
		$fechafinal =  $ffinal[2].' '.$ffinal[1].' '.$ffinal[0];

		$var['fechadradi']=$fechadradi;
		$var['numeroradi']=$datos['numeroradi'];
		$var['periodorec']=$periodorec;
		$var['fechainici']=$fechainici;
	...
	function BuscarDatosReporte2($datos)
	{
		...
		$query = "SELECT A.ingreso,
				...
				G.segundo_apellido,
				Y.fecha_egreso::date,
				Z.fecha_registro::date as fecha_registro_is,
				G.primer_nombre||' '||G.segundo_nombre AS nombres
				FROM ingresos_soat AS A,
				ingresos AS B LEFT JOIN movimientos_habitacion as Y
				ON (B.ingreso = Y.ingreso)
                        	LEFT JOIN ingresos_salidas as Z
                        	ON (B.ingreso = Z.ingreso),
				cuentas AS C,
				planes AS D,
				...
				AND H.envio_id = ".$datos['envio']."
				AND H.factura_fiscal = F.factura_fiscal
		...
		//AND H.prefijo = F.prefijo envios_detalle as H   AND H.factura_fiscal = F.factura_fiscal	
		$resulta = $dbconn->Execute($query);
		if ($dbconn->ErrorNo() != 0)
		{
			$this->error = "Error al Cargar el Modulo";
		...
		for($i=0;$i<sizeof($var);$i++)
		{
			...
			{*/
				$fingreso = explode('-',$var[$j]['fecha_ingreso']);
				$fecha_ingreso =$fingreso[2].'/'.$fingreso[1].'/'.$fingreso[0];
		
				if(!empty($var[$j]['fecha_egreso']))
				{
					$fregistro = explode('-',$var[$j]['fecha_egreso']);
					$fecha_registro =  $fregistro[2].'/'.$fregistro[1].'/'.$fregistro[0];
				}
				else
				{	
					if(!empty($var[$j]['fecha_registro_is']))
					{
						$fregistro = explode('-',$var[$j]['fecha_registro_is']);
						$fecha_registro =  $fregistro[2].'/'.$fregistro[1].'/'.$fregistro[0];
					}
					else
					{
						//$fregistro = explode('-',$var['datovector'][$j]['fecha_registro']);
						$fecha_registro =  $fecha_ingreso;//$fregistro[2].'/'.$fregistro[1].'/'.$fregistro[0];
					}	
				}
				$datosdefinit[$j]=$var[$i];
				$datosdefinit[$j]['fecha_ingreso']=$fecha_ingreso;
				...
				$datosdefinit[$j]['fecha_registro']=$fecha_registro;
				$j++;
			//}
		}
