...
class FacturaRC_report
{

	//CONSTUCTOR DE LA CLASE - RECIBE EL VECTOR DE DATOS - METODO PRIVADO NO MODIFICAR
	function FacturaRC_report($datos=array())
	{
	$this->datos=$datos;
    ...
    */
    function CrearReporte()
    {
					...
					$arr=$this->GetDatosFactura($this->datos['cuenta'],$this->datos['prefijo'], $this->datos['factura_fiscal']);
	...
	function GetDatosFactura($cuenta,$prefijo,$factura_fiscal)
	{
        ...
        //c.sw_tipo=0 PACIENTE
				...
				$query = " SELECT c.prefijo,
					  ...
					  AND    c.factura_fiscal = '".$factura_fiscal."'
