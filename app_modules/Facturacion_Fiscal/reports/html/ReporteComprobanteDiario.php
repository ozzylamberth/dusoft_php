...
/**
 * $Id: ReporteComprobanteDiario.php,v 1.1.1.1 2009/09/11 20:36:46 hugo Exp $
 * @copyright (C) 2007 IPSOFT - SA (www.ipsoft-sa.com)
 * @package IPSOFT-SIIS
 *
 */

class ReporteComprobanteDiario
{
	var $datos;
	
	function ReporteComprobanteDiario($datos=array())
	{
		return true;
	}
...
//$salida .= "<table align=\"center\" width=\"100%\" border=\"1\" class=\"modulo_table_list\">\n";
			...
			$salida.= "<td width=\"100%\" align=\"CENTER\"><font size=\"2\">COMPROBANTE INFORME DIARIO</font>";
			$salida.= "</td>";
			$salida.= "</tr>";
			$salida.= "</table><br>";
			$cont = true;
...
$rep=new ReporteComprobanteDiario();
$rep->CrearReporte();
