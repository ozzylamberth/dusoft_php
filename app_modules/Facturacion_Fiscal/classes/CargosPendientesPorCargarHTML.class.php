<?php
  /******************************************************************************
  * $Id: CargosPendientesPorCargarHTML.class.php,v 1.1.1.1 2009/09/11 20:36:46 hugo Exp $
...
// 				unset($_SESSION['ARREGLO_LIQUIDACIONQX_CARGOS']);
		...
		*/
		function FormaCuentaCargosLiquidadosQX($Cuenta,$TipoId,$PacienteId,$Nivel,$PlanId,$Cama,$Fecha,$Ingreso,$vars,$Transaccion,$mensaje,$Dev,$Estado,$arre,$id)
		{
				...
				$accionT=ModuloGetURL('app','Facturacion_Fiscal','user','GetLlamaFormaCuantaPendientesCargar',array("Cuenta"=>$Cuenta,"TipoId"=>$TipoId,"PacienteId"=>$PacienteId,"Nivel"=>$Nivel,"PlanId"=>$PlanId,"Cama"=>$Cama,"Fecha"=>$Fecha,"Ingreso"=>$Ingreso,"vars"=>$vars,"Transaccion"=>$Transaccion,"mensaje"=>$mensaje,"Dev"=>$Dev,"Estado"=>$Estado,"arre"=>$arre));
				...
				if($_SESSION['ARREGLO_LIQUIDACIONQX_CARGOS'])
				{
						...
						$html .= "    </table>";
						$html .= "    <table border=\"0\" width=\"80%\" align=\"center\" class=\"normal_10\">";
						$action=ModuloGetURL('app','Facturacion_Fiscal','user','GetCargarALaCuentaPaciente',array("NoLiquidacion"=>$_SESSION['Liquidacion_QX']['LIQUIDACION_ID'],"TipoDocumento"=>$TipoId,"Documento"=>$PacienteId,"externo"=>1,"Cuenta"=>$Cuenta,"TipoId"=>$TipoId,"PacienteId"=>$PacienteId,"Nivel"=>$Nivel,"PlanId"=>$PlanId,
