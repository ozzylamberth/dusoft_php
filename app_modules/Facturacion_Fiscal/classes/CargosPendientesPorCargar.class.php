...
/* * ****************************************************************************
 * $Id: CargosPendientesPorCargar.class.php,v 1.1.1.1 2009/09/11 20:36:46 hugo Exp $
 ...
 * 
 * ****************************************************************************** */
IncludeClass('app_Facturacion_Fiscal_userclasses_HTML', '', 'app', 'Facturacio_Fiscal');
...
class CargosPendientesPorCargar {
    ...
    function InsertarPendientesCargar($obj) {
        $FormaCuenta = new app_Facturacion_Fiscal_userclasses_HTML();
        ...
        if ($f == 0) {
            ...
            $FormaCuenta->FormaFacturas($_REQUEST[Cuenta], $_REQUEST[TipoId], $_REQUEST[PacienteId], $_REQUEST[Nivel], $_REQUEST[PlanId], $_REQUEST[Cama], $_REQUEST[Fecha], $_REQUEST[Ingreso], '', $_REQUEST[Transaccion], $mensaje, '');
        ...
        if ($dbconn->ErrorNo() != 0) {
            ...
            if ($result->fields[0] == 'QX') {
                ...
                if (!$arr['tipo_sala_id']) {
                    $arr['tipo_sala_id'] = $_REQUEST['TipoSala'];
                }
