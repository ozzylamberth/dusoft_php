<?php
 /**
  ...
  class ReporteProductosExvsC3_report
	{ 
   ...
   /**
        ...
        * @return boolean
        */
   function ReporteProductosExvsC3_report($datos=array())
   {
      $this->datos=$datos;
      return true;
   }
  ...
  {
      $consulta=new TomaFisicaSQL();
      $datox=$consulta->InconsistenciasC3($this->datos['datos']['toma_fisica']);
