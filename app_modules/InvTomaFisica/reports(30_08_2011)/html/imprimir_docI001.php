<?php
    ...
    $salida .= "                 <table width=\"90%\" border='1' align=\"center\" class=\"modulo_table_list\">\n";
         ...
         $salida .= "                         </td>\n";
         $salida .= "                    </tr>\n";
         IF($resultado['tipo_movimiento']=='E')
         {
           $salida .= "                    <tr>\n";
           $salida .= "                       <td align=\"center\">\n";
           $salida .= "                       <a title='JEFE DE BODEGA'>";
           $salida .= "                        JEFE BODEGA";
           $salida .= "                       </a>";
           $salida .= "                       </td>\n";
           $jefe_b=$consulta->NombreUsu($jefe_bodega);
           $salida .= "                        <td COLSPAN='3' align=\"left\">\n";
           $salida .= "                          ".$jefe_bodega."-".$jefe_b[0]['nombre'];
           $salida .= "                         </td>\n";
           $salida .= "                    </tr>\n";
          }
         $salida .= "                   </table>\n";
         ...
         IF($resultado['tipo_movimiento']=='E')
         {
           ...
           $salida .= "                        </td>\n";
           $salida .= "                        <td WIDTH='8%' align=\"center\">\n";
           $salida .= "                          <a TITLE='ENCARGADO TORRE'>";
           $salida .= "                            ENCARGADO";
           $salida .= "                          </a>";
           $salida .= "                        </td>\n";
          }
      ...
      foreach($resultado['DETALLE'] as $doc_val=>$valor)
       {
            //var_dump($doc_val);     
            $paramTorres=$consulta->Buscarparamprod($resultado['empresa_id'],$valor['codigo_producto']);
            //print_r($paramTorres);
                 $salida .= "                    <tr>\n";
                 ...
                 IF($resultado['tipo_movimiento']=='E')
                 {
                  $salida .= "                       ".$paramTorres['torre'];
                  $salida .= "                      </td>\n";
                  $salida .= "                      <td align=\"left\">\n";
                  $salida .= "                       <a>";
                  $salida .= "                       ".$paramTorres['dueno_torre'];
                  $salida .= "                      </td>\n";
                 }
                 $salida .= "                      <td align=\"left\">\n";
                 $salida .= "                       <a>";
                 ...
                 $salida .= "                    <tr>\n";
                 $salida .= "                      <td colspan='9' align=\"right\">\n";
                 $salida .= "                       ";
                 $salida .= "                      </td>\n";
                 $salida .= "                      <td align=\"right\">\n";
