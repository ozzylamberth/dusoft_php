<?php
	/**
  * $Id: ReporteProductosTomaFisicaSC3_csv.class.php
  ...
  */
  ...
  class ReporteProductosTomaFisicaSC3_csv
  {
    var $error = "";
    /**
    * Constructor de la clase
    */
    function ReporteProductosTomaFisicaSC3_csv(){}
    /**
    ...
    */
    function GetReporteCsv($parametros)
    {
      ...
      $rst = $consulta->ObtenerReporteNoCuadroC3Reporte($parametros['toma_fisica']);
