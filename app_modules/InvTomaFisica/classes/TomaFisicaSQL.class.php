...
function ListarProductosFaltantesEnExistencias($empresa,$cu,$bodega,$cabecera)
    {

        $sql="SELECT distinct on ( b.codigo_producto)  b.codigo_producto
                FROM
                inv_conteo_tomas_fisicas_detalle as b 
                WHERE
                b.bodega ='$bodega' and  b.empresa_id='$empresa' and b.centro_utilidad='$cu' and id_conteo_toma_fisica='$cabecera'

                except

                SELECT  distinct on ( b.codigo_producto)  b.codigo_producto
                FROM
                existencias_bodegas as b 
                WHERE
                b.bodega ='$bodega' and  b.empresa_id='$empresa' and b.centro_utilidad='$cu' and 
                b.codigo_producto in
                (SELECT distinct on ( b.codigo_producto)  b.codigo_producto
                FROM
                inv_conteo_tomas_fisicas_detalle as b 
                WHERE
                b.bodega ='$bodega' and  b.empresa_id='$empresa' and b.centro_utilidad='$cu' and conteo='2' and id_conteo_toma_fisica='$cabecera')";
                 ...
                 from
                         ...
                         inner join
                                     ( (
                                         ...
                                         where empresa_id='$empresa' and bodega='$bodega' and centro_utilidad='$centro' and existencia_actual > 0)
                                    except
                                          (select
                                                 empresa_id,bodega,codigo_producto,lote,0 as cantidad,fecha_vencimiento,0 as existencia_actual
