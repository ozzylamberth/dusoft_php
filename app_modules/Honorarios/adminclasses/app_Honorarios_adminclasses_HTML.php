...
/**
* app_Honorarios_adminclasses_HTML.php
*
//*
**/

class app_Honorarios_adminclasses_HTML extends app_Honorarios_admin
{
	function app_Honorarios_admin_HTML()
	{
		$this->app_Honorarios_admin(); //Constructor del padre 'modulo'
		$this->salida='';
		return true;
	}
	...
	function PrincipalContra()//Llama a todas las opciones posibles
	{
		...
		$this->salida .= "      <a href=\"". ModuloGetURL('app','Honorarios','user','EmpresasContra') ."\">CONTRATACIÓN PARA CLIENTES</a><br>";
		$this->salida .= "      </td>";
		$this->salida .= "      </tr>";
		$this->salida .= "      <tr>";
		$this->salida .= "      <td class=\"modulo_list_claro\"label\" align=\"center\">";
		$this->salida .= "      <a href=\"". ModuloGetURL('app','Honorarios','user','ProvedorContra') ."\">CONTRATACIÓN PARA PROVEEDORES</a><br>";
		$this->salida .= "      </td>";
		$this->salida .= "      </tr>";
		$this->salida .= "      </table>";
		$action=ModuloGetURL('app','Honorarios','user','PrincipalContra2');
