<?php
  ...
  */
    ...
    $html .= "            document.getElementById(\"lista_1\").setAttributeNode(document.createAttribute(\"selected\"));\n";
    $html .= "            var lista_value = document.getElementById('lista_1').value; \n";
    $html .= "            document.getElementById('select_listas_precios').setAttribute(\"value\", \"lista_value\");\n";
    $html .= "            \n";
