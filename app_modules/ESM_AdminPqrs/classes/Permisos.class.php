...
class Permisos extends ConexionBD {
    ...
    function BuscarPermisos()
    {
        $sql = "SELECT	
							   ...
							   e.empresa_id, up.sw_mostrar_todos
    ...
    function BuscarBodegas($empresa)
    {
       ...
       $sql = " SELECT b.empresa_id, b.centro_utilidad, b.bodega, b.descripcion FROM  userpermisos_dispensacion a 
                    inner join bodegas b on a.empresa_id = b.empresa_id AND a.centro_utilidad = b.centro_utilidad
    ...
    function SerialCaso()
    {
        $sql = "SELECT last_value + 1 AS consecutivo FROM esm_registro_pqrs_registro_pqrs_id_seq ";
