...
class FacturasDespachoSQL extends ConexionBD {
     ...
     * @return booleano
     */
    function InsertarFactura($Documento, $Tercero, $Formulario, $Parametros_Retencion) {
    ...
    function Listado_FacturasCliente($empresa_id, $filtros, $offset) {
        ...
        $sql = "
            ...
            LEFT JOIN logs_facturacion_clientes_ws_fi b on a.prefijo = b.prefijo and  a.factura_fiscal = b.factura_fiscal
            ";
    ...
    function insertar_factura_agrupada($documento_facturacion, $datos_cliente, $parametros_retencion) {
        $porcentaje_rtf = '0';
        $porcentaje_ica = '0';
        $porcentaje_reteiva = '0';
    ...
    function obtener_factura_despacho($empresa_id, $prefijo, $numero) {
        ...
        $sql = "
                ...
                a.porcentaje_ica, a.porcentaje_reteiva, cast(a.valor_total as double precision ) as valor_total, a.fecha_registro
    ...
    function registrar_resultado_sincronizacion($prefijo, $numero_factura, $mensaje, $estado) {
        ...
        $sql = " select * from logs_facturacion_clientes_ws_fi where prefijo = '{$prefijo}' and  factura_fiscal = {$numero_factura} ;";
        ...
        $sql = " update logs_facturacion_clientes_ws_fi set mensaje='{$mensaje}', estado='{$estado}' where prefijo = '{$prefijo}' and  factura_fiscal = {$numero_factura} ;";
