<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: CrearCondicionesCompra_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: CrearCondicionesCompra_HTML
  ...
  */
	...
	class CrearCondicionesCompra_HTML
	{
		/**
		* Constructor de la clase
		*/
		function CrearCondicionesCompra_HTML(){}
		/**
	    * @param array 
  ...
  if(formulario.condicion_compra_id=="")
  {
  alert("Codigo de la Condicion de Compra esta Vacío");
  band=1;
  }
          ...
          else
          {
              ...
              if (entrar) 
              {
               ...
               if(formulario.token=="1") //Si es Ingreso de Laboratorio
                  {
                  xajax_InsertarCondicionCompra(formulario);
                  //alert("ingreso");
                  }
                       else
                          {
                          xajax_GuardarModCondicionCompra(formulario);
                         // alert("Modi");
                          }
...
{ 
  ...
  ';
    ...
    $html .= ThemeAbrirTabla('CREAR CONDICIONES DE COMPRA');
    
      
    $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_IngresoCondicionesCompra()\">[::CREAR - NUEVA CONDICION DE COMPRA::]</a><BR></CENTER>";
    ...
    $html .= "  {";
    $html .= "    xajax_CondicionesCompraT(offset);\n";
    $html .= "  }\n";
    ...
    $html .= $this->CrearVentana(600,"CONDICIONES DE COMPRA");
    $html .= ThemeCerrarTabla();
    $html .= "<script>";
    $html .= "xajax_CondicionesCompraT();";
    $html .= "</script>";
