<?php
  ...
  * @author Mauricio Adrian Medina S
  */
	class TiposClienteHTML
	{
		/**
		* Constructor de la clase
		*/
		function TiposClienteHTML(){}
		/*
		...
		*/ 
		...
		function Forma($action,$Listado_TiposCliente,$conteo, $pagina)
		{
			...
			$html .= "		NUEVO TIPO DE CLIENTE";
			$html .= "    </td>\n";
			$html .= "    <td align=\"center\">\n";
			$html .= "		<center class=\"label_error\"><a href=\"#\" onclick=\"xajax_Formulario_TiposCliente('---');\"><img src=\"".GetThemePath()."/images/proveedor.png\" border='0'></a></center>";
			$html .= "    </td>\n";
			$html .= "	</tr>";
			$html .= "</table>";
			$html .= "<br>";
			...
			$html .= "      <td  class=\"formulacion_table_list\">CODIGO TIPO CLIENTE</td>\n";
			$html .= "      <td  class=\"formulacion_table_list\"><input name=\"buscador[tipo_cliente]\" id=\"buscador[tipo_cliente]\" class=\"input-text\" style=\"width:100%\"></td>\n";
			...
			$html .= "	</tr>";
			$html .= "  <tr align=\"center\" >\n";
			$html .= "      <td  class=\"formulacion_table_list\" colspan=\"6\"><input type=\"submit\" value=\"BUSCAR TIPO DE CLIENTE\" class=\"input-submit\"></td>\n";
			$html .= "	</tr>";
			$html .= "</table>";
			$html .= "</form>";
			$html .= "<br>";
			...
			$html .= "                      </td>\n";
			$html .= "                    </tr>\n";
			foreach($Listado_TiposCliente as $key => $valor)
			{
			$html .= "                  <tr class=\"modulo_list_claro\" onMouseOver=\"mOvr(this,'#ffffff');\" onMouseOut=\"mOut(this,'#DDDDDD');\">\n";
			$html .= "						<td>".$valor['tipo_cliente']."</td>";
			$html .= "						<td>".$valor['descripcion']."</b></td>";
			$html .= "						<td>";
			$html .= "						<center><a href=\"#\" class=\"label_error\" title=\"MODIFICAR TIPO DE CLIENTE\" onclick=\"xajax_Formulario_TiposCliente('".$valor['tipo_cliente']."');\"><img src=\"".GetThemePath()."/images/modificar.png\" border='0'></a></center>\n";
			$html .= "						</td>";
			if($valor['estado']=='1')
				{
			$html .= "						<td>";
			$html .= "						<center><a onClick=\"return confirm('INACTIVAR EL TIPO DE CLIENTE: ".$valor['descripcion']."?');\" href=\"".ModuloGetURL('app','Inv_ParametrosIniciales','controller','TiposCliente',array("tipo_cliente"=>$valor['tipo_cliente'],"cambiar_estado"=>"0","buscador"=>$_REQUEST['buscador']))."\" class=\"label_error\"  title=\"TIPO DE CLIENTE ACTIVO, CAMBIAR A INACTIVO\"><img src=\"".GetThemePath()."/images/pactivo.png\" border='0'></a></center>\n";
			$html .= "						</td>";
				}
			else
				{
			$html .= "						<td>";
			$html .= "							<center><a onClick=\"return confirm('ACTIVAR EL TIPO DE CLIENTE: ".$valor['descripcion']."?');\" href=\"".ModuloGetURL('app','Inv_ParametrosIniciales','controller','TiposCliente',array("tipo_cliente"=>$valor['tipo_cliente'],"cambiar_estado"=>"1","buscador"=>$_REQUEST['buscador']))."\" class=\"label_error\"  title=\"TIPO DE CLIENTE INACTIVO, CAMBIAR A ACTIVO\"><img title=\"CONTRATO INACTIVO\" src=\"".GetThemePath()."/images/pinactivo.png\" border='0' ></a></center>\n";
			$html .= "						</td>";
				}
			$html .= "                   </tr>\n";
			}
			...
			$html .= $this->CrearVentana('600','TIPOS DE CLIENTE');
			return $html;
        }
