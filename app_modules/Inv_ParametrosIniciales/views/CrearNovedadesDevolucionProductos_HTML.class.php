<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: CrearNovedadesDevolucionProductos_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: CrearNovedadesDevolucionProductos_HTML
  ...
  */
	...
	class CrearNovedadesDevolucionProductos_HTML
	{
		/**
		* Constructor de la clase
		*/
		function CrearNovedadesDevolucionProductos_HTML(){}
		/**
	    * @param array 
  ...
  {
  var band=0;
  //alert("Codigo de la Novedad esta Vacío");
  
  if(formulario.novedad_devolucion_id=="")
  {
  alert("Codigo de la Novedad esta Vacío");
  band=1;
  }
  ...
  {
  alert("la Descripcion de la Novedad, está Vacío");
  band=1;
  }
          ...
          else
          {
              ...
              if (entrar) 
              {
               ...
               if(formulario.token=="1") //Si es Ingreso de Laboratorio
                  {
                  xajax_InsertarNovedadDevolucion(formulario);
                  //alert("ingreso");
                  }
                       else
                          {
                          xajax_GuardarModNovedadDevolucion(formulario);
                         // alert("Modi");
                          }
...
{ 
  ...
  ';
    ...
    $html .= ThemeAbrirTabla('CREAR NOVEDADES POR DEVOLUCION DE PRODUCTOS');
    
      
    $html .= "<BR><BR><CENTER><a class=\"label_error\" href=\"#\" onclick=\"xajax_IngresoNovedadDevolucion()\">[::CREAR UNA NUEVA NOVEDAD- DEVOLUCION PRODUCTOS::]</a><BR></CENTER>";
    ...
    $html .= "  {";
    $html .= "    xajax_NovedadesDevolucionT(offset);\n";
    $html .= "  }\n";
	  ...
	  $html .= "<div id=\"ListadoNovedades\">\n"; //DIV PARA EL LISTADO DE NOVEDADES CREADAS
    ...
    $html .= "<script>";
    $html .= "xajax_NovedadesDevolucionT();";
    $html .= "</script>";
