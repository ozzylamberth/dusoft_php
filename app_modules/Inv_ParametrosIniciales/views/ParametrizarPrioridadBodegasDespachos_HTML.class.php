<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: ParametrizarPrioridadBodegasDespachos_HTML.class.php,
  * @copyright (C) 2009 IPSOFT - SA (www.ipsoft-sa.com)
  * @author Mauricio Adrian Medina Santacruz
  */

  /**
  * Clase Vista: ParametrizarPrioridadBodegasDespachos_HTML
  ...
  */
	...
	class ParametrizarPrioridadBodegasDespachos_HTML
	{
		/**
		* Constructor de la clase
		*/
		function ParametrizarPrioridadBodegasDespachos_HTML(){}
		/**
	    * @param array 
    ...
    //print_r($request);
      ...
      $html .= ThemeAbrirTabla("DEFINIR PRIORIDAD DE DESPACHOS DE PRODUCTOS");
