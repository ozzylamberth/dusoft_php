...
/**
  * @package IPSOFT-SIIS
  * @version $Id: RemotosTiposDispensacion.php,v 1.1 2009/10/30 20:34:27 mauricio Exp $
  ...
  */  
  function TiposDispensacionT($offset)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasTiposDispensacion","classes","app","Inv_ParametrosIniciales");
  
  
	$TiposDispensacion=$sql->ListadoTiposDispensacion($offset);
   ...
   $html .= "  <legend class=\"normal_10AN\">TIPOS DE DISPENSACION</legend>\n";
        ...
        $html .= "      <td width=\"40%\">DISPENSACION</td>\n";
        ...
        foreach($TiposDispensacion as $key => $td)
        {
          ...
          $html .= "      <td >".$td['codigo']."</td><td>".$td['descripcion']." </td>\n";
                          
					$html .= "      <td align=\"center\">\n";
          $html .= "        <a href=\"#\" onclick=\"xajax_ModificarTipoDispensacion('".$td['codigo']."')\">\n";
          ...
          {
          $html .= "<td align=\"center\">
                <a href=\"#\" onclick=\"xajax_CambioEstadoTipoDispensacion('inv_farmacias_tiposdispensacion','estado','0','".$td['codigo']."','tipo_dispensacion_id')\">\n";
          $html .="<img title=\"INACTIVAR\" src=\"".GetThemePath()."/images/checksi.png\" border=\"0\"></a></td>\n";
          }
          else
            {
            $html .= "<td align=\"center\"><a href=\"#\" onclick=\"xajax_CambioEstadoTipoDispensacion('inv_farmacias_tiposdispensacion','estado','1','".$td['codigo']."','tipo_dispensacion_id')\">\n";
  ...
  */
  function CambioEstadoTipoDispensacion($tabla,$campo,$valor,$id,$campo_id)
  {
    $objResponse = new xajaxResponse();
    ...
    $objResponse->call("xajax_TiposDispensacionT");
    return $objResponse;	
	}
...
/*
  ...
  */
  function GuardarModTipoDispensacion($datos)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasTiposDispensacion","classes","app","Inv_ParametrosIniciales");
  
  $token=$sql->ModificarTipoDispensacion($datos);
  if($token)
  {
  $objResponse->call("xajax_TiposDispensacionT");
  ...
  cargado en un Xajax
  */
  function ModificarTipoDispensacion($CodigoTipoDispensacion)
  {
  $objResponse = new xajaxResponse();
  $sql = AutoCarga::factory("ConsultasTiposDispensacion","classes","app","Inv_ParametrosIniciales");
  
  $TipoDispensacion=$sql->BuscarTipoDispensacion($CodigoTipoDispensacion);
  
  //action del formulario= Donde van los datos del formulario.
		$html .= "  <form name=\"FormularioTipoDispensacion\" id=\"FormularioTipoDispensacion\" method=\"post\">";
		
		$html .= "      <table border=\"0\" width=\"80%\" align=\"center\" class=\"modulo_table_list\">";
		$html .= "      <tr class=\"modulo_table_list_title\">";
		$html .= "      <td align=\"center\" colspan=\"2\">";
		$html .= "      MODIFICAR DE TIPOS DE DISPENSACION";
		$html .= "      </td>";
		$html .= "      </tr>";
		...
		$html .= '      <input style="width:100%;height:100%" value="'.$TipoDispensacion[0]['codigo'].'" class="input-text" maxlength="4" type="Text" name="tipo_dispensacion_id" onkeyup="this.value=this.value.toUpperCase()">';
    $html .= '      <input type="hidden" name="tipo_dispensacion_id_old" value="'.$TipoDispensacion[0]['codigo'].'">'; //esto es para definir si es Update o Insert
		$html .= "      </td>";
		$html .= "      </tr>";
		...
		$html .= "      </td>";
		$html .= "      <td align=\"center\">";
		$html .= '      <input style="width:100%;height:100%" value="'.$TipoDispensacion[0]['descripcion'].'" class="input-text" type="Text" name="descripcion" maxlength="30" onkeyup="this.value=this.value.toUpperCase()">';
		$html .= "      </td>";
		$html .= "      </tr>";
    ...
    $html .= "      <input class=\"input-submit\" type=\"button\" value=\"Enviar\" name=\"boton\" onclick=\"Validar(xajax.getFormValues('FormularioTipoDispensacion'))\">";
		$html .= "      </td>";
		$html .= "      </tr>";
		$html .= "		</form>";
		$html .= "      </table>";
 ...
 function InsertarTipoDispensacion($datos)
  ...
  $token=$sql->InsertarTipoDispensacion($datos);
  ...
  function IngresoTipoDispensacion()
  {
  $objResponse = new xajaxResponse();
		...
		$html .= "      <tr class=\"modulo_table_list_title\">";
		$html .= "      <td align=\"center\" colspan=\"2\">";
		$html .= "      CREACION DE TIPOS DE DISPENSACION";
		$html .= "      </td>";
		$html .= "      </tr>";
		...
		$html .= "      </td>";
		$html .= "      <td align=\"center\" width=\"10%\">";
		$html .= '      <input style="width:100%;height:100%" class="input-text" maxlength="4" type="Text" name="tipo_dispensacion_id" onkeyup="this.value=this.value.toUpperCase()">';
		$html .= "      </td>";
		$html .= "      </tr>";
