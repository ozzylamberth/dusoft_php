...
/**
 * $Id: prueba.report.php,v 1.2 2005/06/03 20:20:33 leydi Exp $
...
// 	
	...
	function GetMembrete()
	{
		$Membrete = array('file'=>'MembreteLogosTunal','datos_membrete'=>array());
		return $Membrete;
	}
...
/*	function GetMembrete()
    ...
    {
		$Salida .= "<table width='100%' border='1' align='left'>\n";
		$Salida .= "    <tr>\n";
		$Salida .= "      <td colspan='2' align='center'>TITULO DEL REPORTE</td>\n";
		$Salida .= "    </tr>\n";
		$Salida .= "    <tr>\n";
		$Salida .= "      <td width='20%' style='HOLA'>NOMBRE</td>\n";
