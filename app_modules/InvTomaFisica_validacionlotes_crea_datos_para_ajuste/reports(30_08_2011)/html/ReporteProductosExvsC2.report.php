<?php
 /**
    * @package IPSOFT-SIIS
    * @version $Id: ReporteProductosExvsC2.report.php
  ...
  class ReporteProductosExvsC2_report
	{ 
   ...
   /**
        ...
        * @return boolean
        */
   function ReporteProductosExvsC2_report($datos=array())
   {
      $this->datos=$datos;
      return true;
   }
  ...
  {
      $consulta=new TomaFisicaSQL();
      $datox=$consulta->InconsistenciasC2($this->datos['datos']['toma_fisica']);
