<?php
 /**
    * @package IPSOFT-SIIS
    * @version $Id: ReporteProductosSistVsTF.report.php
    * @copyright (C) 2007 IPSOFT - SA (www.ipsoft-sa.com)
    * @author Johanna Alarcon Duque
    */
    
    /**
    * Clase Reporte: ReporteProductosSistVsTF
  ...
  class ReporteProductosSistVsTF_report
	{ 
   ...
   /**
        ...
        * @return boolean
        */
   function ReporteProductosSistVsTF_report($datos=array())
   {
      $this->datos=$datos;
      return true;
   }
  ...
  {
      $consulta=new TomaFisicaSQL();
      $datox=$consulta->InconSistemaVsTomaF($this->datos['datos']['toma_fisica'],$this->datos['datos']['empresa_id'],$this->datos['datos']['centro_utilidad'],$this->datos['datos']['bodega']);
      ...
      $ESTILO4="style=\"border-color:#000000;border-style:solid; border-width: thin;\"";
       ...
       if(!empty($datox))
       {
          ...
          $salida .= "                        <b $estilo>REPORTE DE AJUSTE FINAL - INVENTARIOS. TOMA FISICA #".$this->datos['datos']['toma_fisica']."</b>";
          $salida .= "                      </td>\n";
          ...
          $salida .= "                   </tr>\n";
          $salida .= "                 </table>\n";
          $salida .= "                 <table width=\"98%\" border='1' cellspacing='0' align=\"center\" rules=\"all\">\n";
          $salida .= "                    <tr>\n";
          ...
          for($i=0;  $i<count($datox);$i++)
          {
              ...
              $salida .= "                      </td>\n";
              $salida .= "                      <td $ESTILO3 align=\"r\">\n";
              $salida .= "                       ".$datox[$i]['lote']."&nbsp;";
              $salida .= "                      </td>\n";
              $salida .= "                      <td $ESTILO3 align=\"left\">\n";
              $salida .= "                       ".$datox[$i]['fecha_vencimiento']."&nbsp;";
              $salida .= "                      </td>\n";
              $salida .= "                      <td $ESTILO3 align=\"right\">\n";
              $salida .= "                       ".FormatoValor($datox[$i]['existencia'])."&nbsp;";
              $salida .= "                      </td>\n";
              $salida .= "                      <td $ESTILO3 align=\"right\">\n";
              $salida .= "                       ".FormatoValor($datox[$i]['nueva_existencia'])."&nbsp;";
              $salida .= "                      </td>\n";
              $salida .= "                      <td $ESTILO3 align=\"right\">\n";
              $salida .= "                       ".FormatoValor($datox[$i]['ajuste_egreso'])."&nbsp;";
              $salida .= "                      </td>\n";
              $salida .= "                      <td $ESTILO3 align=\"right\">\n";
              $salida .= "                       ".FormatoValor($datox[$i]['ajuste_ingreso'])."";
              $salida .= "                      </td>\n";
              $salida .= "                      <td $ESTILO3 align=\"right\">\n";
              $salida .= "                       ".FormatoValor($datox[$i]['costo'],2)."";
              $salida .= "                      </td>\n";
