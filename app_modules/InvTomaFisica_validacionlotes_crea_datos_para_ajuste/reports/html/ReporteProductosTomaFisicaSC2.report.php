<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: ReporteProductosTomaFisicaSC2.report.php,v 1.2 2010/02/01 21:17:19 johanna Exp $ 
  ...
  */
  ...
  class ReporteProductosTomaFisicaSC2_report 
	{ 
      ...
      * @return boolean
      */
      function ReporteProductosTomaFisicaSC2_report($datos=array())
      {
         $this->datos=$datos;
         //print_r($this->datos);
         return true;
      ...
      **/
      function CrearReporte()
      {
          ...
          $datox=$consulta->SacarNoCuadroC2Reporte($this->datos['datos']['toma_fisica']);
          ...
          if(!empty($datox))
          {
             ...
             //$salida .= "     <b $estilo>PRODUCTOS NO CUADRADOS EN CONTEO (2) TOMA FISICA ".$this->datos['datos']['toma_fisica']."</b>";
             $salida .= "     <b $estilo>PRODUCTOS DEL CONTEO (2) TOMA FISICA ".$this->datos['datos']['toma_fisica']."</b>";
             $salida .= "   </td>\n";
             ...
             for($i=0;$i<count($datox);$i++)
             {
                ...
                $salida .= "   </td>\n";
                $salida .= "   <td style=\"color:#FF0000;\" align=\"center\" title=\"DIFERENCIA CONTEO 1 Vs 2\">\n";
                $salida .= "      ".FormatoValor($datox[$i]['diferencia_1con2']);
                $salida .= "    </td>\n";
                $salida .= "   <td $ESTILO3 align=\"center\" title=\"COSTO\">\n";
                $salida .= "      ".FormatoValor($datox[$i]['costo']);
                $salida .= "    </td>\n";
                $salida .= "    <td $ESTILO3 align=\"center\" title=\"DIFERENCIA COSTO\">\n";
                $salida .= "        ".FormatoValor($datox[$i]['diferencia_1con2']*$datox[$i]['costo']);
                $salida .= "    </td>\n";
