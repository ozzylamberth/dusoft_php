      ...
      function CrearReporte()
      {
          ...
          if(!empty($datox))
          {
             ...
             for($i=0;$i<count($datox);$i++)
             {
                ...
                $salida .= "   </td>\n";
                $salida .= "   <td style=\"color:#FF0000;\" align=\"center\" title=\"DIFERENCIA CONTEO 1 Vs EXISTENCIA\">\n";
                $salida .= "      ".FormatoValor($datox[$i]['diferencia_1']);
                $salida .= "    </td>\n";
                $salida .= "   <td $ESTILO3 align=\"center\" title=\"COSTO\">\n";
                $salida .= "      ".FormatoValor($datox[$i]['costo']);
                $salida .= "    </td>\n";
                $salida .= "    <td $ESTILO3 align=\"center\">\n";
                $salida .= "        ".FormatoValor($datox[$i]['diferencia_1']*$datox[$i]['costo']);
                $salida .= "    </td>\n";
                $total_diferencia+=($datox[$i]['diferencia_1']*$datox[$i]['costo']);
                $salida .= " </tr>\n";                        
              }
              $salida .= "   <tr>\n";
              /*$salida .= "    <td COLSPAN='7'>\n";
              $salida .= "       &nbsp;";
              $salida .= "     </td>\n";*/
              $salida .= "    <td $ESTILO2 colspan=\"8\" align=\"right\">\n";
