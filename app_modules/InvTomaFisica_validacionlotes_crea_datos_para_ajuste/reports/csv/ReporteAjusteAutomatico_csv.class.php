<?php
	/**
  * $Id: ReporteAjusteAutomatico_csv.class.php
  ...
  */
  ...
  class ReporteAjusteAutomatico_csv
  {
    var $error = "";
    /**
    * Constructor de la clase
    */
    function ReporteAjusteAutomatico_csv(){}
    /**
    ...
    */
    function GetReporteCsv($parametros)
    {
      ...
      $rst = $consulta->ObtenerReporteAutomatico($parametros['toma_fisica']);
