...
/**
 * $Id: app_AgendaMedica_adminclasses_HTML.php,v 1.5 2010/03/12 13:37:04 sandra Exp $
...
class app_AgendaMedica_adminclasses_HTML extends app_AgendaMedica_admin
{

	function app_AgendaMedica_admin_HTML()
	{
	...
	function Menu()
	{
		...
		$accion=ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda');
		$this->salida .='<a href="'.$accion.'">Creación Agenda Medica</a>';
		$this->salida .='</td>';
		$this->salida .='</tr>';
		$this->salida .='<tr class="modulo_list_oscuro">';
		$this->salida .='<td align="center">';
		$accion=ModuloGetURL('app','AgendaMedica','admin','CambiarBorrarAgenda');
		$this->salida .='<a href="'.$accion.'">Cambiar y Borrar Agenda Medica</a>';
		$this->salida .='</td>';
		$this->salida .='</tr>';
		$this->salida .='<tr class="modulo_list_claro">';
		$this->salida .='<td align="center">';
		$accion=ModuloGetURL('app','AgendaMedica','admin','MantenimientoProfesionales');
...
//Creación de Agenda Medica
		...
		else
		{
			...
			if(empty($_SESSION['CreacionAgenda']['tercero']))
			{
				...
				if($profesionales)
				{
					...
					while($i<sizeof($profesionales[0]))
					{
						...
						$this->salida .= '</td>';
						$this->salida .= '<td>';
						$this->salida .= '<a href="'.ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('tercero'=>$profesionales[1][$i],'tipoid'=>$profesionales[0][$i],'nombrep'=>$profesionales[2][$i])).'">Ir</a>';
						$this->salida .= '</td>';
						$this->salida .= '</tr>';
						$i++;
					}
					...
					$this->salida .= '<tr>';
					$this->salida .= '<td align="center">';
					$accion=ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('volver1'=>'true'));
			...
			else
			{
				if(empty($_REQUEST['accion']))
				{
					...
					$accion=ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('volver2'=>'true'));
					$this->salida .='<form name="volver" action="'.$accion.'" method="post">';
					$this->salida .='<input type="submit" name="volver" value="volver" class="input-submit">';
					$this->salida .='</form>';
					$this->salida .= '</td>';
					$this->salida .= '<td align="left" width="50%">';
					$accion=ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('accion'=>'add'));
					$this->salida .='<form name="volver" action="'.$accion.'" method="post">';
					...
					else
					{
						...
						$vec['saber']=1;
						$accion=ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',$vec);
				...
				else
				{
					if($_REQUEST['accion']=='add' and empty($_REQUEST['guardar']))
					{
						if(empty($_REQUEST['Enviar']))
						{
							...
							if($a<>date("Y"))
							{
								$this->salida .= '<a href="'.ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('accion'=>'add','a'=>'0')).'">actual</a>';
							}
							$this->salida .= '<a href="'.ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('accion'=>'add','a'=>($_REQUEST['a']-1))).'"><<</a> '.$a.' <a href="'.ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('accion'=>'add','a'=>($_REQUEST['a']+1))).'">>></a>';
							$this->salida .= '</td>';
							$this->salida .= '</tr>';
							$this->salida .= '</table>';
							$this->salida .= '<br>';
							$this->salida .= '<form name="cosa" action="'.ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',array('accion'=>'add','a'=>$_REQUEST['a'])).'" method="post">';
						...
						else
						{
							if(empty($_REQUEST['guardar']))
							{
									...
									else
									{
										...
										foreach($_REQUEST as $v=>$v1)
										{
											if($v=='mes1')
											{
												...
												unset($vec1['1mes']);
												$vec1[$v]=$v1;
												$accion=ModuloGetURL('app','AgendaMedica','admin','CreacionAgenda',$vec1);
								...
								else
								{
									...
									$accion=ModuloGetURL('app','AgendaMedica','admin','',$vec);
									$this->salida  = ThemeAbrirTabla('CREACIÓN AGENDA MEDICA');
									$this->salida .= '<br>';
									$this->salida .= '<table width="70%" align="center" class="modulo_table_list">';
									$this->salida .= '<tr align="center" class="modulo_table_title">';
	...
	function AgendaHtml()
	{
		...
		$this->salida.='{'."\n";
		$this->salida.='window.location.href="Contenido.php?modulo=AgendaMedica&year="+t.elements[1].value+"&meses="+t.elements[2].value+"';
		foreach($_REQUEST as $v=>$v1)
		{
		...
		$this->salida .= '<td>';
		$this->salida .= '</form>';
		$accion=ModuloGetURL('app', 'AgendaMedica', 'admin', 'GuardarDatos', $vec1);
		$this->salida .= '<form name="atras" action="'.$accion.'" method="post">';
	...
	function ListarProfesionales()
	{
		...
		if($profesionales)
		{
			...
			while($i<sizeof($profesionales[0]))
			{
				...
				$this->salida .= '</td>';
				$this->salida .= '<td>';
				$this->salida .= '<a href="'.ModuloGetURL('app','AgendaMedica','admin','ListadoAgendaMesTurnos',array('tercero'=>$profesionales[1][$i],'tipoid'=>$profesionales[0][$i],'nombrep'=>$profesionales[2][$i])).'">Ir</a>';
				$this->salida .= '</td>';
				$this->salida .= '</tr>';
				$i++;
			}
	...
	function ListadoAgendaMesTurnos()
	{
		...
		if($turnos)
		{
			...
			$accion=ModuloGetURL('app','AgendaMedica','admin','BorrarAgenda',$vec);
			...
			while($i<sizeof($turnos[0]))
			{
				...
				if(sizeof($a)==1)
				{
					...
					$accion=ModuloGetURL('app','AgendaMedica','admin','ListadoDiaAgenda',$vec);
			...
			$accion=ModuloGetURL('app','AgendaMedica','admin','CambiarAgenda',$vec);
			...
			$accion=ModuloGetURL('app','AgendaMedica','admin','ListarProfesionales',$vec);
			$this->salida .= '<form name="volver" method="post" action="'.$accion.'">';
			$this->salida .= '<input type="submit" name="volver" value="volver" class="input-submit">';
			$this->salida .= '</form>';
			$this->salida .= '</td>';
	...
	function ListadoDiaAgenda()
	{
		...
		if($turnosdia)
		{
			...
			$accion=ModuloGetURL('app','AgendaMedica','admin','BorrarAgendaDia',$vec);
			$this->salida.='<form name="siguiente" method="post" action="'.$accion.'">';
			$this->salida .= '<table width="70%" align="center" class="modulo_table_list">';
			$this->salida .= '<tr align="center" class="modulo_table_title">';
			$this->salida .= '<td align="center">';
			...
			$accion=ModuloGetURL('app','AgendaMedica','admin','ListadoAgendaMesTurnos',$vec1);
			$this->salida .= '<form name="volver" method="post" action="'.$accion.'">';
			$this->salida .= '<input type="submit" name="volver" value="volver" class="input-submit">';
			$this->salida .= '</form>';
			$this->salida .= '</td>';
...
//Mantenimiento Profesionales
  ...
  $this->salida .= "  <table border=\"0\" width=\"98%\" align=\"center\" class=\"modulo_table\">";
		...
		$accion=ModuloGetURL('app','AgendaMedica','admin','BuscarPacientes',array('Busqueda'=>$_REQUEST['Busqueda']));
		...
		$accion=ModuloGetURL('app','AgendaMedica','admin','ListarProfe');
		$this->salida .= "             <form name=\"formabuscar\" action=\"$accion\" method=\"post\">";
		...
		if($arr!=false)
		{
			...
			while($i<sizeof($arr[0]))
			{
				...
				$this->salida .= '</td>';
				$this->salida .= '<td>';
				$this->salida .= '<a href="'.ModuloGetURL('app','AgendaMedica','admin','PantallaProfesional',array('tercero'=>$arr[3][$i],'tipoid'=>$arr[2][$i],'nombrep'=>$arr[0][$i],'TipoProf'=>$arr[4][$i],'Sexo'=>$arr[5][$i],'TarjProf'=>$arr[6][$i],'estado'=>$arr[1][$i])).'">Ir</a>';
				$this->salida .= '</td>';
				$this->salida .= '</tr>';
				$i++;
			}
		...
		{
			$this->salida .= '<td align="center">';
			$accion=ModuloGetURL('app','AgendaMedica','admin','PantallaProfesional');
	...
	function PantallaProfesional()
	{
		...
		$this->salida .= "</td>";
		$this->salida .= "</tr>";
		$accion=ModuloGetURL('app','AgendaMedica','admin','Desicion');
		$this->salida .= '<form name="volver" method="post" action="'.$accion.'">';
		...
		if($tipo_especialidad)
		{
			...
			if($especialidades)
			{
				foreach($especialidades as $k=>$v)
				{
					...
					$this->salida .= "</td>";
					$this->salida .= '<td align="center">';
					$accion=ModuloGetURL('app','AgendaMedica','admin','EliminarEspecialidad',array('espe'=>$k));
