<?php
  /**
  * $Id: app_Inv_Movimientos_Admin_compras_userclasses_HTML.php,v 1.2 2011/05/19 22:19:10 hugo Exp $
  *
...
//$_ROOT = "../../../";
  ...
  class app_Inv_Movimientos_Admin_compras_userclasses_HTML extends app_Inv_Movimientos_Admin_compras_user
  {
    /**
    * Funcion constructora
    * @return true;
    **/
    function app_Inv_Movimientos_Admin_compras_userclasses_HTML(){ }
    /**
    ...
    **/
    function SelectEmpresa()
    {
      ...
      $url[1]='Inv_Movimientos_Admin_compras';//m�ulo
      $url[2]='user';//clase
    ...
    **/   
    function SelectCentroCosto()
    {
      ...
      $titulo[1] = 'BODEGA';
      $url[0]= 'app';
      $url[1]= 'Inv_Movimientos_Admin_compras';
      $url[2]= 'user';
      $url[3]= 'Menu_Movimientos_Admin';
      $url[4]= 'Chentro';
      $this->salida .= gui_theme_menu_acceso('SELECCIONAR BODEGA',$titulo,$this->TodosCentros,$url,ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','SelectEmpresa'));
      return true;
    }
    /**
    ...
    */
    function Menu_Movimientos_Admin()
    {
      ...
      $CONSULTARPRO=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','BuscadorProductos');
      $CONSULTARDOC=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','MenuBodegas');
     ...
     /*if($bodegas['sw_cierre'] == '1')
      {
        if($bodegas['lapso_cerrar'] && $bodegas['lapso_cerrar'] < date('Ym'))
        {
          ...
          $this->salida .= "                          <a class=\"label_error\" href=\"".ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','FormaCierre')."\" onclick=\"document.getElementById('campa_fondo_bodegas').style.display='block';\">HACER CIERRE DE BODEGA PERIODO ".$bodegas['lapso_cerrar']."</a>\n";
          $this->salida .= "                       </td>";
          $this->salida .= "                    </tr>";        
        }
      }*/
     ...
     /* $this->salida .= "                    <tr class=\"modulo_list_claro\">\n";
      ...
      $Exit = ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','SelectCentroCosto');
    ...
    **/
    ...
    { 
        ...
        $file ='app_modules/Inv_Movimientos_Admin_compras/RemoteXajax/definirAdmin.php';
        ...
        $this->IncludeJS('RemoteXajax/definirAdmin.js', $contenedor='app', $modulo='Inv_Movimientos_Admin_compras');
        /*print_r($Empresas);*/
		$javaC = "<script>\n";
      ...
      $this->salida .=  "                  </center>\n";
        ...
        if(empty($_REQUEST['VolverCuy']))
        {
            $Volver=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','Menu_Movimientos_Admin');
        }
        else
        {
            $nombre=$consulta1->bodegasname($bodega);
            $Volver=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','Menu_Movimientos_Admin',array('Bodeguix'=>array('bodega'=>$bodega,'descripcion'=>$nombre[0]['descripcion'])));
...
//         }
      ...
      **/
        ...
        $this->salida.=" </div>";
        $this->salida .= "    <div id='error_con_busqueda' class='label_error' style=\"text-transform: uppercase; text-align:center;\"></div>\n";
        $CONSULTARPRO=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','DatosProducto',array('empresa_id'=>$empresa_id,'centro_id'=>$centro_id,'bodega'=>$bodega,'codigo_producto'=>$codigo_producto,'fecha_inicio_lapso'=>$fecha_inicio_lapso,'fecha_final_lapso'=>$fecha_final_lapso,'limite'=>10,'pagina'=>'1'));
...
//               $this->salida .= "                       </td>\n";
                ...
                {
                    $direccion="app_modules/Inv_Movimientos_Admin_compras/Imprimir/imprimir_doc2.php";
                ...
                {
                    $direccion="app_modules/Inv_Movimientos_Admin_compras/Imprimir/imprimir_docI001.php";
                    $imagen = $resultado['KARDEX'][$i]['prefijo']."-".$resultado['KARDEX'][$i]['numero'];      //"themes/$VISTA/" . GetTheme() ."/images//imprimir.png";
                    $actualizar="false";
                    $alt="IMPRIMIR DOCUMENTO";
...
//             }
            ...
            $this->salida .= "                     <tr>\n";
            $this->salida .= "                       <td align='left'>\n";
                $direccion="app_modules/Inv_Movimientos_Admin_compras/Imprimir/imprimir_producto1.php";
            ...
            $this->salida .= "                       </td>\n";
            $this->salida .= "                       <td align='RIGHT'>\n";
                $direccion="app_modules/Inv_Movimientos_Admin_compras/Imprimir/imprimir_producto2.php";
                $codigo = $codigo_producto;
                $alt="VER INFORMACION DEL PRODUCTO";
        ...
        $Volver=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','BuscadorProductos',array('centro_id'=>$centro_id,'bodega'=>$bodega,'codigo_pro'=>$codigo_producto,'nom_bus'=>$nom_bus,'grupos_pro'=>$grupo,'clasexx'=>$clasex,'subclasexy'=>$subclase));
        $this->salida .= "    <div id=\"volvercen_cos\">";
        $this->salida .= "     <form name=\"volver\" action=\"".$Volver."\" method=\"post\">\n";
        $this->salida .= "      <table align=\"center\" width=\"50%\">\n";
        $this->salida .= "       <tr>\n";
        ...
        if ($TotalRegistros > 0)
        {
            ...
            if($NumeroPaginas > 1)
            {
                ...
                if($pagina > 1)
                {
                    ...
                    $CONSULTARPRO=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','DatosProducto',array('empresa_id'=>$empresa_id,'centro_id'=>$centro_id,'bodega'=>$bodega,'codigo_producto'=>$codigo_producto,'limite'=>10,'pagina'=>'1','periodo'=>$lapso,'dia1'=>$fecha1,'dia2'=>$fecha2,'boton_buscar'=>true));
                    ...
                    $CONSULTARPRO=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','DatosProducto',array('empresa_id'=>$empresa_id,'centro_id'=>$centro_id,'bodega'=>$bodega,'codigo_producto'=>$codigo_producto,'limite'=>10,'pagina'=>$pagina-1,'periodo'=>$lapso,'dia1'=>$fecha1,'dia2'=>$fecha2,'boton_buscar'=>true));
                ...
                for($i=$Inicio; $i< $Fin ; $i++)
                {
                    ...
                    {
                        $CONSULTARPRO=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','DatosProducto',array('empresa_id'=>$empresa_id,'centro_id'=>$centro_id,'bodega'=>$bodega,'codigo_producto'=>$codigo_producto,'limite'=>10,'pagina'=>$i,'periodo'=>$lapso,'dia1'=>$fecha1,'dia2'=>$fecha2,'boton_buscar'=>true));
            ...
            if($pagina <  $NumeroPaginas )
            {
                ...
                $TablaPaginado .= "   </td><td bgcolor=\"#D3DCE3\">\n";
                $CONSULTARPRO=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','DatosProducto',array('empresa_id'=>$empresa_id,'centro_id'=>$centro_id,'bodega'=>$bodega,'codigo_producto'=>$codigo_producto,'limite'=>10,'pagina'=>$NumeroPaginas,'periodo'=>$lapso,'dia1'=>$fecha1,'dia2'=>$fecha2,'boton_buscar'=>true));
    ...
    */  
    function MenuBodegas()
    {
        ...
        $REVISARDOCS=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','MenuBodegas',array('empresabus_id'=>$_REQUEST['empresabus_id'],'fecha1'=>$_REQUEST['fecha1'],'fecha2'=>$_REQUEST['fecha2']));
        ...
        {
          $Volver=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','Menu_Movimientos_Admin',array('Bodeguix'=>array('descripcion'=>$_REQUEST['nom_bodega'],'bodega'=>$_REQUEST['bodega'])));
        }
        $this->salida .= " <form name=\"volver\" action=\"".$Volver."\" method=\"post\">\n";//".$this->action[0]."
        $this->salida .= "  <table align=\"center\" width=\"50%\">\n";
        $this->salida .= "    <tr>\n";
    ...
    */  
    function ListarDocumentos()
    {
        ...
        $BODEGA=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','ListarDocumentos' ,array('empresa_idx'=>$empresaBus_id,'documento_id'=>$vector[$i]['documento_id'],'fecha1'=>$fecha_inicial,'fecha2'=>$fecha_final, 'nombre_doc'=>$vector[$i]['descripcion']));
        ...
        **/
        ...
        $this->salida .= "            </div>\n";
        $this->salida .= "               <br>";
        $REVISARDOCS=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','MenuBodegas',array('empresabus_id'=>$_REQUEST['empresa_idx'],'fecha1'=>$_REQUEST['fecha1'],'fecha2'=>$_REQUEST['fecha2'],'bodega'=>$_REQUEST['bodega'],'nom_bodega'=>utf8_decode($_REQUEST['nom_bodega'])));
    ...
    function ObtenerPaginadoDocus($path,$slc,$op,$empresa_id,$documento_id,$fecha1,$fecha2,$nombre,$limite,$pagina,$bodega,$nom_bo)
    {
        ...
        if ($TotalRegistros > 0)
        {
            ...
            if($NumeroPaginas > 1)
            {
                ...
                {
                    $TablaPaginado .= "   <td class=\"label\" bgcolor=\"#D3DCE3\">\n";
                    $BODEGA=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','ListarDocumentos' ,array('empresa_idx'=>$empresa_id,'documento_id'=>$documento_id,'fecha1'=>$fecha1,'fecha2'=>$fecha2,'nombre_doc'=>$nombre,'offset'=>1,'bodega'=>$bodega,'nom_bodega'=>utf8_decode($nom_bo)));
                    ...
                    $TablaPaginado .= "   </td><td bgcolor=\"#D3DCE3\">\n";
                    $BODEGA=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','ListarDocumentos' ,array('empresa_idx'=>$empresa_id,'documento_id'=>$documento_id,'fecha1'=>$fecha1,'fecha2'=>$fecha2,'nombre_doc'=>$nombre,'offset'=>($pagina-1),'bodega'=>$bodega,'nom_bodega'=>$nom_bo));
                ...
                for($i=$Inicio; $i< $Fin ; $i++)
                {
                    ...
                    {
                        $BODEGA=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','ListarDocumentos' ,array('empresa_idx'=>$empresa_id,'documento_id'=>$documento_id,'fecha1'=>$fecha1,'fecha2'=>$fecha2,'nombre_doc'=>$nombre,'offset'=>$i,'bodega'=>$bodega,'nom_bodega'=>$nom_bo));
            ...
            if($pagina <  $NumeroPaginas )
            {
                ...
                $TablaPaginado .= "   </td><td bgcolor=\"#D3DCE3\">\n";
                $BODEGA=ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','ListarDocumentos' ,array('empresa_idx'=>$empresa_id,'documento_id'=>$documento_id,'fecha1'=>$fecha1,'fecha2'=>$fecha2,'nombre_doc'=>$nombre,'offset'=>$NumeroPaginas,'bodega'=>$bodega,'nom_bodega'=>$nom_bo));
    ...
    */
    function FormaCierre()
    {
      ...
      $action['volver'] = ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','FormaCierre',array("opcion"=>$op));
      $action['cancelar'] = ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','Menu_Movimientos_Admin');
      $empresas = SessionGetVar("EMPRESAS");
      $empresa = SessionGetVar("EMPRESA");
            
      IncludeClass("CierreBodegas","","app","Inv_Movimientos_Admin_compras");
      $crb = new CierreBodegas();
      switch($op)
      {
        case 1:
          $documento = ModuloGetVar('app','Inv_Movimientos_Admin_compras','documento_costos_'.$empresas['empresa_id']);
        ...
        break;        
        case 5:
          $action['volver'] = ModuloGetURL('app','Inv_Movimientos_Admin_compras','user','SelectCentroCosto');
    ...
    *
      ...
      if($imprimir)
      {
        ...
        $html .= "    <td align=\"center\">\n";
        $rpt = new GetReports();
        $html .= $rpt->GetJavaReport("app","Inv_Movimientos_Admin_compras","DocumentosMovimientos",array('empresa_id'=>$empresa,"usuario"=>UserGetUID()),array('rpt_name'=>'','rpt_dir'=>'cache','rpt_rewrite'=>TRUE));
