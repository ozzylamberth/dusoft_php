...
/**
 * $Id: reporteNotaOperatoria_html.report.php,v 1.1 2007/02/01 19:47:02 tizziano Exp $
...
class reporteNotaSeguimiento_html_report
{
    ...
    function reporteNotaSeguimiento_html_report($datos=array())
    {
...
//FUNCION QUE RETORNA EL HTML DEL REPORTE (lo que va dentro del tag <BODY>)
	...
	//*******************************************termino	
		...
		$Salida .= "		<tr>\n";
		$Salida .= "			<td align=\"center\" width=\"25%\" height=\"30\"><b>NOTA DE SEGUIMIENTO</b></td>\n";		
		$Salida .= "		</tr>\n";
		$Salida .= "	</table><br>";
...
//*****************************************fin de termino
	...
	function ConsultaNotasOperatoriasRealizadas($programacion,$tipoidpaciente,$paciente){
		...
		ter2.nombre_tercero as anestesiologo,ter3.nombre_tercero as ayudante,a.evolucion_id,evol.ingreso
