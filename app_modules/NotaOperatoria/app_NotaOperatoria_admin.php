...
/**
 * $Id: app_NotaOperatoria_admin.php,v 1.3 2005/06/02 16:01:53 leydi Exp $
...
class app_NotaOperatoria_admin extends classModulo
{


	function app_NotaOperatoria_admin()
	{
...
{
	$this->ReturnMetodoExterno($_SESSION['USER_ADMIN_MOD']['CONTENEDOR'], $_SESSION['USER_ADMIN_MOD']['MOD'], $_SESSION['USER_ADMIN_MOD']['TIPO'], 'TraerDatos',array("tabla"=>'userpermisos_bioestadistica',"permiso"=>'NotaOperatoria'));
	return true;
}
