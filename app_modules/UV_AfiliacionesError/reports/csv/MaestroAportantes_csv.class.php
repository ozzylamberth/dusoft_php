<?php
	/**
  * $Id: MaestroAportantes_csv.class.php,v 1.1.1.1 2009/09/11 20:36:58 hugo Exp $ 
  * @copyright (C) 2005 IPSOFT - SA (www.ipsoft-sa.com)
  * @package IPSOFT-SIIS
  * 
  * @author Hugo Freddy Manrique Arango
  */
  class MaestroAportantes_csv
  {
    var $error = "";
    /**
    * Constructor de la clase
    */
    function MaestroAportantes_csv(){}
    /**
    ...
    */
    function GetReporteCsv($parametros)
    {
      ...
      $rst = $nvd->ObtenerAportantes($parametros);
