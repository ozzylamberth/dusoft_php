...
function enviar_documentos_agrupados($tipo_id_tercero, $tercero_id, $documentos) {

    $objResponse = new xajaxResponse();
    $url = ModuloGetURL("app", "FacturasDespacho", "controller", "generar_facturacion_agrupada", array('tipo_id_tercero' => $tipo_id_tercero, 'tercero_id' => $tercero_id, 'documentos' => $documentos));
