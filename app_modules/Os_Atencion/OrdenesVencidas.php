...
/**
 * $Id: OrdenesVencidas.php,v 1.3 2010/02/26 12:36:19 sandra Exp $
...
echo "</head>";
  ...
  IncludeFile($filename);
	...
	list($dbconn) = GetDBconn();
			...
			if(is_array($vector2))
			{
				$salida .= "<center class=\"normal_10AN\">OS ESTADO2</center>\n";
...
//echo "---->".$_SESSION['LABORATORIO']['SW_HONORARIO'];
			...
			if(is_array($vector3))
			{
				$salida .= "<center class=\"normal_10AN\">OS ESTADO3</center>\n";
