<?php
 /**
  * @package IPSOFT-SIIS
  * @version $Id: InformacionAfiliados.class.php,v 1.3 2010/02/26 12:36:19 sandra Exp $
  ...
  */
  class InformacionAfiliados extends ConexionBD
  {
	...
	*/
	function ActualizarEmailPaciente($id,$tipo,$email)
	{
        ...
        return ("El Correo Electronico ha sido Actualizado: \n \n".$email);
	}
