	...
	class app_AnularFacturacion_userclasses_HTML extends app_AnularFacturacion_user
	{
		...
		*************************************************************************************/
		function FormaMostrarMenuAnulacion()
		{
			...
			$url[1] = 'AnularFacturacion';			//módulo 
			$url[2] = 'user';										//clase 
			$url[3] = 'FormaMostrarDocumentos';	//método 
			$url[4] = 'permiso';								//indice del request
			$titulo[0] = 'EMPRESAS';
			
			$this->salida .= gui_theme_menu_acceso('ANULACIÓN DE FACTURAS',$titulo,$this->Rta,$url,$this->action[0]);
			return true;
		}
		/************************************************************************************
		...
		*************************************************************************************/
		function FormaMostrarDocumentos()
		{
			...
			$url[1] = 'AnularFacturacion';			//módulo 
			$url[2] = 'user';										//clase 
			$url[3] = 'FormaBuscarFacturasAnulacion';	//método 
		...
		*************************************************************************************/
		function FormaBuscarFacturasAnulacion()
		{
			...
			$this->salida .= "				</select>\n";
			$this->salida .= "			</td>\n";			
			$this->salida .= "			<td><b class=\"label\">NÚMERO:</b></td>\n";
			$this->salida .= "			<td>\n";
