<?php
   ...
   /**
  * @package IPSOFT-SIIS
  * @version $Id: ESM_Facturacion_HTML.class.php
  ...
  */
	...
	class ESM_Facturacion_HTML
	{
		/**
		* Constructor de la clase
		*/
		function ESM_Facturacion_HTML(){}
    ...
    $html .= '  <input '.$disabled.' class="input-submit" type="submit" value="CONFIRMAR: CREACION DE LA FACTURA">';
		$html .= "  </form>";
    $html .= "  </td>";
		$html .= "  </tr>";
		$html .= "  </table>";
      ...
      if(!empty($DATOS))
      {
        ...
        $html .= "                  <legend  class=\"label_error\">FACTURACION</legend>\n";
        $html .= "		                <table width=\"100%\" class=\"modulo_table_list\">\n";
        $html .= "                      <tr class=\"formulacion_table_list\" >";
        $html .= "                        <td colspan=\"2\">";
        $html .= "                            ".$plan['plan_descripcion'];
        $html .= "                        </td>";
      	$html .= "                    </tr>";
        $html .= "                      <tr class=\"formulacion_table_list\" >";
        $html .= "                        <td>";
        $html .= "                          FECHA DE CREACION";
        $html .= "                        </td>";
        ...
        $html .= "                        <td>";
        $html .= "                         <b> FECHA INICIO: </b>".$DATOS['fecha_inicio']."";
        $html .= "                        </td>";
        $html .= "                        <td>";
        $html .= "                        <b>FECHA FINAL :</b>".$DATOS['fecha_fin']."";
        $html .= "                        </td>";
      	$html .= "                    </tr>";
        $html .= "	                  </table>\n";
        $html .= "	                </fieldset>\n";
        ...
        $html .= "                      </tr>";
            ...
            if($dtl['porcentaje_intermediacion']>0)
            {
            $mensaje ="(".$dtl['porcentaje_intermediacion']."%)";
            }
            else
                {
                $mensaje="";
            ...
            $html .= "                    ".$dtl['cantidad'];
      			$html .= "                    </td>";
            $html .= "                    <td>";
            $html .= "                    $".FormatoValor($dtl['valor_unitario'],2)."".$mensaje;
      			$html .= "                    </td>";
            $html .= "                    <td>";
            $html .= "                    $".FormatoValor($dtl['valor'],2);
      			$html .= "                    </td>";
            $html .= "		              </tr>\n";
            }
      			$html .= "                    <tr>";
      			$html .= "                        <td colspan=\"3\" align=\"right\">";
            $html .= "                            <b class=\"label_error\">TOTAL:</b>";
      			$html .= "                        </td>";
            $html .= "                        <td>";
            $html .= "                            <b class=\"label_error\">$".FormatoValor($suma,2)."</b>";
      			$html .= "                        </td>";
      			$html .= "                    </tr>";
            $html .= "	                  </table>\n";
            $html .= "	                </fieldset>\n";
...
//SEGUNDA FILA=> TABLA MAYOR
       /* $html .= "        <tr>";
        ...
        $html .= "                      </tr>";
            ...
            /*if($dtl['porcentaje_intermediacion']>0)
            {
            $porcentaje = ($dtl['porcentaje_intermediacion']/100)+1;
            $valor= ($dtl['valor']/$porcentaje)+$dtl['valor'];
            $mensaje ="+(".$dtl['porcentaje_intermediacion']."%)";
            }
            else
                {
            ...
            $html .= "                    ".$dtl['cantidad'];
      			$html .= "                    </td>";
            $html .= "                    <td>";
            $html .= "                    $".FormatoValor($dtl['valor_unitario'],2);
      			$html .= "                    </td>";
            $html .= "                    <td>";
            $html .= "                    $".FormatoValor($dtl['valor'],2);
      			$html .= "                    </td>";
      ...
      $html .= "      </table> ";*/
            ...
            $html .= "                  <center>";
            $html .= "	                <fieldset class=\"fieldset\" style=\"width:60%\">\n";
            $html .= "                  <legend  class=\"label_error\">TOTAL</legend>\n";
            $html .= "		                <table width=\"100%\" class=\"modulo_table_list\">\n";
            $html .= "                      <tr  >";
            $html .= "                      <td class=\"label_error\" align=\"center\"><i><u>$".FormatoValor($acum,2)."</u></i></td>";
            $html .= "                      </tr>";
            $html .= "                    </table>";
            $html .= "                  </fieldset>";
            $html .= "                  </center>";
