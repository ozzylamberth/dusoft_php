...
//        echo "<pre>";print_r($paciente);
    ...
    function GenerarEntregaMedicamentos() {
        ...
        $ParametrizacionReformular = ModuloGetVar('', '', 'ParametrizacionReformular');
         ...
         /*echo "<pre>Empresa ";
          ...
          echo "<br/> Request";
          print_r($request);
          echo "</pre> ParametrizacionReformular";
    ...
    function FormulasPaciente_p() {
        ...
        IncludeFileModulo("Dispensacion", "RemoteXajax", "app", "Dispensacion");
        $this->SetXajax(array("Cambiarvetana2", "Eliminar_codigo_prodcto_d2", "BuscarProducto2", "GuardarPTP", "MostrarProductox2", "MandarInformacion", "MostrarMensaje", "InsertarDatosFormula_tmp", "EliminarDatosFormula_tmp","Autorizacion_despacho"), "app_modules/Dispensacion/RemoteXajax/Dispensacion.php", "ISO-8859-1");
        $this->IncludeJS("CrossBrowser");
        $this->IncludeJS("CrossBrowserEvent");
        $this->IncludeJS("CrossBrowserDrag");
