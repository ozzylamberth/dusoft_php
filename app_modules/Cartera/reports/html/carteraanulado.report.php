<?php
	/***
	* $Id: carteraanulado.report.php,v 1.2 2009/06/26 13:53:16 hugo Exp $ 
	...
	*/
	...
	{ 
	  ...
	  function carteraanulado_report($datos=array())
	  {
			$this->datos=$datos;
		...
		function GetMembrete()
		{
			...
			$titulo = "<b>REPORTE FACTURAS ANULADAS</b>";
			$subtit = "<b>".$this->meses[$this->datos['mes']]." ".$this->datos['anyo']."</b>";
		...
		function CrearReporte()
	  {
			...
			$facturas = $cr->ObtenerFacturasAnuladas($this->datos,$this->datos['empresa']);
			...
			$html .= "		<td width=\"20%\"><b>VALOR ANULADO</b></td>\n";
			$html .= "		<td width=\"40%\"><b>RESPONSABLE</b></td>\n";
			$html .= "	</tr>\n";
