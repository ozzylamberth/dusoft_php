<?php
	/**
	* $Id: app_Cartera_user.php,v 1.26 2009/06/26 13:53:16 hugo Exp $
	...
	class app_Cartera_user extends classModulo
	{
		...
		*********************************************************************************/
		function MostrarMenuPrincipalCartera()
		{
			...
			$this->action1 = ModuloGetURL('app','Cartera','user','main');
			...
			$this->action5 = ModuloGetURL('app','Cartera','user','FormaSubMenuMovimientos');
			$this->action6 = ModuloGetURL('app','Cartera','user','MostrarCarteraPlanes',array("opcion"=>'R'));
			$this->action7 = ModuloGetURL('app','Cartera','user','MostrarCarteraPlanes',array("opcion"=>'N'));
      ...
      $this->request['empresa_id'] = $_SESSION['cartera']['empresa_id'];
			...
			{
				$this->request['fecha'] = date("d/m/Y");
        $crt = AutoCarga::factory("CarteraRadicada","classes","app","Cartera");
        
				$rst = $crt->ObtenerReporte($this->request,"R");
			}
      ...
      ksort($this->Intervalos);
		...
		*/
		...
		{			
			...
			$this->datos['plan_id'] = $this->request['plan_id'];
			$this->datos['plan_descripcion'] = $this->request['plan_descripcion'];
      ...
      $rqst["opcion"] = $this->request['opcion'];
      $rqst["periodo"] = $this->request['periodo'];
      $rqst["cliente_id"] = $this->request['cliente_id'];
      $rqst["plan_id"] = $this->request['plan_id'];
      $rqst["plan_descripcion"] = $this->request['plan_descripcion'];
      $rqst["intervalo"] = $this->Intervalo;
      $rqst["direccion"] = $this->Direccion;
      
			$this->action['volver'] = ModuloGetURL('app','Cartera','user',$metodo,$rqst);
		...
		*********************************************************************************/
        ...
        $crt = AutoCarga::factory("CarteraRadicada","classes","app","Cartera");
				...
				$rst = $crt->ObtenerReporte($this->request,"N");
      }
		...
		*/
		...
		{		
			...
			$this->action = ModuloGetURL('app','Cartera','user','FormaSubMenuMovimientos');
		...
		***/
		function MostrarRecibosCaja()
		{
			...
			$this->action[1] = ModuloGetURL('app','Cartera','user','FormaSubMenuMovimientos');
		...
		*/
		function BuscarInformacionFactura()
		{
			...
			$this->action1 = ModuloGetURL('app','Cartera','user','FormaSubMenuMovimientos');
      ...
      unset($_SESSION['cartera']['planes']);
			if($this->request['opcion'] != "" ) $_SESSION['cartera']['opcion'] = $this->request['opcion'];
			
			$this->envio = $_SESSION['cartera']['opcion'];
        ...
        $crt = AutoCarga::factory("CarteraRadicada","classes","app","Cartera");
				...
				$rst = $crt->ObtenerReportePlanes($this->request,$this->request['opcion'],"P");
      }
      ...
      ksort($this->Intervalos);
		...
		*********************************************************************************/
		function MostrarTodasFacturas()
		{
			...
			$this->action['volver'] = ModuloGetURL('app','Cartera','user','FormaSubMenuMovimientos');
		}
		/*********************************************************************************
