<?php 
  ...
  */
  class InformeAutorizacionServicio_fpdf
  {
    var $error = "";
    /**
    * Constructor de la clase
    */
    function InformeAutorizacionServicio_fpdf(){}
    /**
    ...
    */
    function GetReporteFPDF($parametros,$nombre,$pathImagen)
    {
      ...
      */
      $this->GenerarAutorizacionServicios($datos,$nombre,$pathImagen);
      return true;
    }
    /**
    *
    */
    function GenerarAutorizacionServicios($datos,$Dir,$pathImagen)
    {
