<?php 
  /**
  * $Id: reporte_AtencionUrgencias.inc.php,v 1.2 2009/10/21 21:49:36 hugo Exp $
  */
  
  function GenerarAtencionUrgencias($datos)
  {
    IncludeLib('funciones_admision');
    $Dir = "cache/AtencionUrgencias.pdf";
    ...
    $html .= "<TD WIDTH='20' ALIGN='CENTER' HEIGHT=28>";
    $cont=0;
    if($datos['origen_atencion']=="Enfermedad general")
    {
      $html .= "X";
    }else{
      $cont++;
    ...
    $html .= "<TABLE BORDER='1'>";
    $html .= "<TD WIDTH='20' ALIGN='CENTER' HEIGHT=28>";
    if($datos['origen_atencion']=="Accidente de Trabajo")
    {
      $html .= "X";
    }else{
      $html .= "&nbsp;";
    ...
    $html .= "<TABLE BORDER='1'>";
    $html .= "<TD WIDTH='20' ALIGN='CENTER' HEIGHT=28>";
    if($datos['origen_atencion']=="Evento Catastrófico")
    {
      $html .= "X";
    }else{
      $html .= "&nbsp;";
    ...
    $html .= "<TABLE BORDER='1'>";
    $html .= "<TD WIDTH='20' ALIGN='CENTER' HEIGHT=28>";
    if($datos['origen_atencion']=="Enfermedad Profesional")
    {
      $html .= "X";
    }else{
      $html .= "&nbsp;";
    ...
    $html .= "<TABLE BORDER='1'>";
    $html .= "<TD WIDTH='20' ALIGN='CENTER' HEIGHT=28>";
    if($datos['origen_atencion']=="Accidente de Tránsito")
    {
      $html .= "X";
    }else{
      $html .= "&nbsp;";
    ...
    if($cont==5)
    {
      ...
      $html .= "</TD>";
      $html .= "<TD WIDTH='140' ALIGN='LEFT' HEIGHT=28>";
      if($datos['origen_atencion'])
        $html .= "".$datos['origen_atencion']."";
      else
        $html .= "Otro";
      $html .= "</TD>";
    }else{
    ...
    $html .= "</TD>";
    $html .= "</TR>";
    $cant_d = count($datos['1']);

    for($j=0; $j<$cant_d; $j++)
    { 
      $html .= "<TR>";
      $tipodiag = str_pad($datos[1][$j]['tipo_diagnostico_id'], 4, "-", STR_PAD_LEFT);
      if($j!=0)
      {
        $html .= "<TD WIDTH='130' ALIGN='CENTER' HEIGHT=28>";
      ...
      for($k=0; $k<90; $k++)
      {
        $html .= "".$datos[1][$j]['diagnostico_nombre'][$k]."";
      }
      $html .= "</TD>";
      $html .= "</TR>";
      if($j==3)
