<?php
//Reporte de Formulacion de medicamentos para impresora POS
        ...
        if($datos[0][medico_evol_max][tarjeta_profesional] != '')
		    {
				...
				{
          $reporte->PrintFTexto($datos[0][medico_evol_max][tipo_id_medico].': '.$datos[0][medico_evol_max][medico_id],false,'left',false,false);
				}
