    ...
    $largo = strlen($datos[0][medico_evol_max][nombre_tercero]);
      ...
      $cad = $cad.'_';
		...
		if($datos[0][medico_evol_max][tarjeta_profesional] != '')
		{
			...
			$Salida.="<td align=\"left\" class=\"modulo_list_claro\" width=\"100%\" colspan = 4>".$cad."<br>".strtoupper($datos[0][medico_evol_max][nombre_tercero])."<br>".$datos[0][medico_evol_max][tipo_id_medico].': '.$datos[0][medico_evol_max][medico_id].' T.P.: '.$datos[0][medico_evol_max][tarjeta_profesional]."<br>".$datos[0][medico_evol_max][tipo_profesional]."</td>";
			$Salida.="</tr>";
		}
		else
		{
			$Salida.="<tr class=\"Normal_10N\">";
			$Salida.="<td align=\"left\" class=\"modulo_list_claro\" width=\"100%\" colspan = 4>".$cad."<br>".strtoupper($datos[0][medico_evol_max][nombre_tercero])."<br>".$datos[0][medico_evol_max][tipo_id_medico].': '.$datos[0][medico_evol_max][medico_id]."<br>".$datos[0][medico_evol_max][tipo_profesional]."</td>";
			$Salida.="</tr>";
		}
  	return $Salida;
 }
