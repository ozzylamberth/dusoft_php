...
class app_Os_ListaTrabajoDatalab_adminclasses_HTML extends app_Os_ListaTrabajoDatalab_admin
{
	/**
  ...
  function app_Os_ListaTrabajoDatalab_admin_HTML()
	{
		$this->salida='';
		$this->app_Os_ListaTrabajoDatalab_admin();
		return true;
	}
