...
*/
    ...
    where empresa_id='".$_SESSION['BorrarAgenda']['empresa']."' and tipo_consulta_id='".$_SESSION['BorrarAgenda']['Cita']."' and
...
*/
	...
	function ListadoTurnosDia()
	{
		...
		if(sizeof($a)==1){
			...
			$sql.=") and (a.sw_estado='0' OR a.sw_estado='1' OR a.sw_estado='2') order by a.hora,b.tipo_id_paciente,b.paciente_id;";
		}    
		$result = $dbconn->Execute($sql);
		$i=0;
		if($dbconn->ErrorNo() != 0){
