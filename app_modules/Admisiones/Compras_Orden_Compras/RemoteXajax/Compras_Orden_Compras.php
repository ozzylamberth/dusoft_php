<?php
	...
	*/
    ...
    function SeleccionDeProductos($EmpresaId)
		{
					$objResponse = new xajaxResponse();
					$sql = AutoCarga::factory("Compras_Orden_ComprasSQL", "classes", "app", "Compras_Orden_Compras");
          ...
          $html .= "	  <td>LABORATORIO</td>";
				  ...
				  $html .= "		<td>MOLECULA</td>";
					...
					$html .= "			      <td width=\"50%\">\n";
					$html .= "			        <input type=\"button\" onclick=\"xajax_BuscarProductos(document.getElementById('codigo_producto_b').value,document.getElementById('descripcion_b').value,document.getElementById('contenido_unidad_venta_b').value,'".$EmpresaId."',document.getElementById('clase_id').value,document.getElementById('subclase_id').value,'1');\"  class=\"input-submit\" value=\"Buscar\">";
					$html .= "			      </td>\n";					
          $html .= "			      <td width=\"50%\">\n";
		...
		function   BuscarProductos($CodigoProducto,$Descripcion,$Concentracion,$Empresa_Id,$ClaseId,$SubclaseId,$offset)
		{
					$objResponse = new xajaxResponse();
					$sql = AutoCarga::factory("Compras_Orden_ComprasSQL", "classes", "app", "Compras_Orden_Compras");
					
				
				$Productos=$sql->ListaProductosInventario($CodigoProducto,$Descripcion,$Concentracion,$Empresa_Id,$ClaseId,$SubclaseId,$offset);
				$pghtml = AutoCarga::factory('ClaseHTML');
        ...
        $html .= "      <td align=\"left\">".$valor['costo_ultima_compra']."</td>\n";
        
        $html .= "      <td align=\"center\">\n";
				$Prod=$valor['descripcion']." ".$valor['presentacion']."-".$valor['clase'];
				$html .= "		<a onclick=\"AdicionarProducto('".$_REQUEST['empresa_id']."','".$valor['codigo_producto']."','".$Prod."','".$valor['iva']."','".$valor['costo_ultima_compra']."');\">";
	...
	function   DetalleOC($orden_pedido_id)
		{
				...
				$html .= "      <td  align=\"center\">$".number_format($valor['valor'])." </td>\n";
				$html .= "      <td align=\"center\">\n";
        ...
        $iva = $iva+(($valor['valor']*$valor['numero_unidades'])*($valor['iva']/100));
				...
				$html .="<img title=\"BORRAR ITEM\" src=\"".GetThemePath()."/images/delete2.gif\" border=\"0\"></a>\n";
  				...
  				$html .= "  </tr>\n";
					...
					$html .= "  <tr >\n";
          $html .= "   <td>SubTotal : $".number_format($subtotal)."</td>";
          $html .= "  </tr>\n";
          $html .= "  <tr >\n";
          $html .= "   <td>Iva : $".number_format($iva)."</td>";
          $html .= "  </tr>\n";
          $html .= "  <tr >\n";
          $html .= "   <td>Total : $".number_format($subtotal+$iva)."</td>";
          $html .= "  </tr>\n";
        $html .= "	</table>\n";
