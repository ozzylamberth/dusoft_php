<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: MensajesModuloHTML.class.php,v 1.1 2008/10/10 22:27:21 hugo Exp $
  ...
  */
  class MensajesModuloHTML
  {
    ...
    *
      ...
      $html .= "            <a href=\"".$action['crear_op']."\"><b>LISTAR FACTURAS PARA ORDEN DE PAGO</b></a>\n";
      $html .= "          </td>\n";
      $html .= "        </tr>\n";        
      $html .= "        <tr>\n";
      $html .= "          <td class=\"modulo_list_claro\" align=\"center\">\n";
      $html .= "            <a href=\"".$action['consultar_op']."\"><b>CONSULTAR ORDENES DE PAGO</b></a>\n";
      $html .= "          </td>\n";
      $html .= "        </tr>\n";      
			$html .= "			</table>\n";
			$html .= "		</td>\n";
