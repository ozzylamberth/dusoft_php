  ...
  */
	...
	class NotasFacturas_Proveedor_MenuHTML
	{
		...
		*/
		...
		$html  = ThemeAbrirTabla('NOTAS DEBITO - CREDITO: FACTURAS DE DESPACHO');
		...
		$html .= "      <a href=\"". ModuloGetURL('app','Inv_NotasFacturasDespacho','controller','CrearNotas')."&datos[empresa_id]=".$_REQUEST['datos']['empresa_id']."\">NOTAS DEBITO-CREDITO A FACTURAS DE DESPACHO</a>";
		$html .= "      </td>";
		$html .= "      </tr>";
