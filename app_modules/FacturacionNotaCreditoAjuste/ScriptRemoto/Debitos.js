/**
* $Id: Debitos.js,v 1.1.1.1 2009/09/11 20:36:46 hugo Exp $ 
...
function CrearNotaDebito(objeto)
{
	cadena = new Array();
	...
	mensaje = "";
	if(cadena[1] == "")
		mensaje = "<b class=\"label_error\">SE DEBE ADICIONAR LA FACTURA,<br>QUE SE VERA AFECTADA POR LA NOTA DEBITO</b>";
	else
		jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",CrearResultado,"CrearNotaDebito",cadena);
...
function CrearResultado(cadena)
{
	...
	xGetElementById('notasDebito').innerHTML = html[0];
...
function EliminarNotaDebito(datos)
{
	jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",CrearResultado,"EliminarNotaDebito",datos);
}

function AnularNotaDebito(datos)
{
	...
	else
	{
		...
		jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",CrearResultadoAnulacion,"AnularNotaDebito",datos);
	}
}
...
function CerrarNotaDebito(datos)
{
	jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",CrearResultadoCerrar,"CerrarNotaDebito",datos);
...
function BuscarFacturas(objeto)
{
	...
	jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",CrearResultadoBusqueda,"BuscarFacturas",datos);
}
		...
		mensaje = "EL VALOR DEl CONCEPTO NO ES VALIDO";
			...
			mensaje = "SE DEBE SELECCIONAR EL DEPARTAMENTO ASOCIADO AL CONCEPTO";
				...
				else
				{
					...
					jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",CrearConceptos,"AdicionarConcepto",datos);
				}
...
{
	jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",CrearConceptos,"EliminarConceptos",datos);
}
...
function ActualizarInformacion(objeto)
{
	...
	if(datos[0] != "")
		jsrsExecute("app_modules/FacturacionNotaCreditoAjuste/ScriptRemoto/Debitos.php",Ocultar,"ActualizarInformacion",datos);
	else
		OcultarSpan('Contenedor');
}
