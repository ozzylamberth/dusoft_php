<?php
	/**
	* $Id: notasajuste.report.php,v 1.1.1.1 2009/09/11 20:36:46 hugo Exp $ 
	* @copyright (C) 2005 IPSOFT - SA (www.ipsoft-sa.com)
	* @package IPSOFT-SIIS
	* 
	*/
	include_once "./app_modules/FacturacionNotaCreditoAjuste/classes/NotasAjuste.class.php";
	...
	{ 
	  ...
	  function notasajuste_report($datos=array())
	  {
		...
		function GetMembrete()
		{
			...
			$titulo .= "<b $est>NOTA DE AJUSTE Nº ".$this->datos['prefijo_nota']." ".$this->datos['numero_nota']."</b>";
		...
		function CrearReporte()
	  {
			...
			$Notas = $nc->ObtenerInformacionNotaAjusteCerrada($this->datos['prefijo_nota'],$this->datos['numero_nota'],$this->datos['empresa']);
			...
			$creditos = $nc->ObtenerValoresFactura($Notas['prefijo_factura'],$Notas['factura_fiscal'],$this->datos['empresa'],$this->datos['numero_nota']);
			...
			$Salida .= "	</tr>\n";
			$Salida .= "	<tr height=\"21\">\n";
			$Salida .= "		<td colspan=\"2\" class=\"label\">Valor Nota Ajuste:</td>\n";			
			...
			$Conceptos = $nc->ObtenerConceptosNotaAjuste($this->datos['prefijo_nota'],$this->datos['numero_nota'],$this->datos['empresa']);
