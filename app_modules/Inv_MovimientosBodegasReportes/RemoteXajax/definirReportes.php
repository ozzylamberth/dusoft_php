<?php
	/**************************************************************************************
	* $Id: definirReportes.php,v 1.1 2007/07/17 22:24:14 jgomez Exp $ 
...
function ObtenerDatosDocumento($empresa_id,$prefijo,$numero)
{
    ...
    $consulta_=new MovBodegasSQL();
    $objResponse = new xajaxResponse();
    $resultado=$consulta->SacarDocumento($empresa_id,$prefijo,$numero);
    
    if($resultado['tipo_doc_bodega_id']=='I006')
    $Tercero = $consulta_->ObtenerTerceroDocumentoIngresoDevolucionPrestamo($prefijo,$numero);
    else
    $Tercero = $consulta_->ObtenerTerceroDocumentoIngresoPrestamo($prefijo,$numero);
    //var_dump($resultado);
         ...
         if($resultado['tipo_doc_bodega_id']=='E004' || $resultado['tipo_doc_bodega_id']=='E002' || $resultado['tipo_doc_bodega_id']=='I007' || $resultado['tipo_doc_bodega_id']=='I006')
          {
         $salida .= "                 <table width=\"90%\" border='1' align=\"center\" class=\"modulo_table_list_title\">\n";
         $salida .= "                    <tr >\n";
         ...
         $salida .= "                       <a title='IDENTIFICACION DEL TERCERO'>";
         $salida .= "                        ID";
         $salida .= "                       </a>";
         $salida .= "                       </td>\n";
         $salida .= "                       <td width=\"65%\" align=\"left\" class=\"modulo_list_claro\">\n";
         $salida .= "                          ".$Tercero[0]['tipo_id_tercero']." - ".$Tercero[0]['tercero_id'];
         $salida .= "                         </td>\n";
         $salida .= "                       </tr>\n";
         $salida .= "                       <td width=\"5%\" align=\"center\" class=\"modulo_table_list_title\">\n";
         $salida .= "                       <a title='NOMBRE'>";
         $salida .= "                        NOMBRE TERCERO";
         $salida .= "                       </a>";
         $salida .= "                       </td>\n";
         $salida .= "                        <td align=\"left\" class=\"modulo_list_claro\">\n";
         $salida .= "                          ".$Tercero[0]['nombre_tercero'];
         $salida .= "                         </td>\n";
         $salida .= "                    </tr>\n";
         $salida .= "                   </table>\n";
         $salida .= "                   <br>\n";   
