		...
		function Formabusquedaproveedores($action,$tipodocumento,$request,$datos,$conteo,$pagina,$empresita)                             
		{
			...
			if(!empty($datos))
			{
				...
				foreach($datos as $key => $dtl)
				{
		            ...
		            $html .= "      <td align=\"center\">\n";
					$html .= "      <a href=\"".$action['nuevo'].URLRequest(array("nombre_tercero"=>$dtl['nombre_tercero'],"tipoid"=>$dtl['tipo_id_tercero'],"noid"=>$dtl['tercero_id'],"codprov"=>$dtl['codigo_proveedor_id']))."\">\n";
 ...
 /**
    ...
    */ 
        ...
        $html .="<div align=\"center\" class=\"label_error\" id='error'></div> ";
				if(!empty($datos))
				{
					...
					$html .= "      <td >$ VALOR </td>\n";
					/*$html .= "      <td > POLITICA </td>\n";*/
					$html .= "	      <td  aling=\"center\" class=\"modulo_table_list_title\" >";
					...
					$html .= "      <input type=\"hidden\" name=\"politica_vencimiento".$i."\" id=\"politica_vencimiento".$i."\" >\n";
					...
					$html .="	</td> ";
					$html .=" <td> <input type=\"checkbox\" name=\"checkseleccionar".$i."\" id=\"checkseleccionar".$dtl['codigo_producto']."\" value=\"".$i."\" ".$checked." onClick=\"xajax_ValidarDatosProducto(this.value,'".trim($empresa)."','".trim($noidcontrato)."');\" > ";       
					$html .= " </td>\n";
    ...
    */ 
        ...
        $pghtml = AutoCarga::factory('ClaseHTML');
				...
				{
					$url = ModuloGetURL("app", "ContratacionProductos", "controller", "PoliticasProducto",	array("datos_producto"=>
																																			array(	"codigo_producto"=>$dtl['codigo_producto'],
																																						"descripcion"=>$dtl['descripcion'],
																																						"contrato_produc_prov_det_id"=>$dtl['contrato_produc_prov_det_id'],
																																						"contratacion_prod_id"=>$contratacion_prod_id,
																																						"empresa_id"=>$empresa)));
					$html .= "  <tr class=\"modulo_list_claro\">\n";
					$html .= "      <td align=\"center\"><b>".$dtl['codigo_producto']."</b></td>\n";
					$html .= "        <input type=\"hidden\" name=\"codigo_producto\" id=\"codigo_producto".$i."\" value=\"".$dtl['codigo_producto']."\">";
					$html .= "        <input type=\"hidden\" name=\"empresa_id\" id=\"codigo_producto".$i."\" value=\"".$empresa['empresa_id']."\">";
					$html .= "      <td align=\"left\"><b>".$dtl['descripcion']."</td>\n";
					$html .= "      <td align=\"left\"><b>$".FormatoValor($dtl['valor_total_pactado'])."</b></td>\n";
					$html .= "        <input type=\"hidden\" name=\"valor_total_pactado\" id=\"valor_total_pactado".$i."\" value=\"".$dtl['valor_total_pactado']."\">";
					$html .= "      <td align=\"center\">\n";
					$html .= "         <a href=\"".$url."\" class=\"label_error\"><img src=\"".GetThemePath()."/images/producto_consultar.png\" border=\"0\" title=\"POLITICAS DE VENCIMIENTO DE LOS PRODUCTOS\"></a>\n";
					$html .= "      </td>\n";
					$html .= "      <td align=\"center\">\n";
		...
		function Forma_ProductosPoliticas($action,$datos_completos,$request,$politicas)
		{
		$html .= ThemeAbrirTabla('POLITICAS - PRODUCTOS PROVEEDOR');
		$html .= "	<table   width=\"60%\" align=\"center\"  class=\"modulo_table_list\" border=\"0\"  >";
		$html .= "		<tr class=\"formulacion_table_list\">";
		$html .= "			<td colspan=\"2\">";
		$html .= "				POLITICAS DEVOLUCIONES - PRODUCTO";
		$html .= "			</td>";
		$html .= "		</tr>";
		$html .= "		<tr class=\"modulo_table_list_title\">";
		$html .= "			<td  align=\"left\">";
		...
		$html .= "				".$datos_completos['tipoid']." - ".$datos_completos['noid'].": ".$datos_completos['nombre_tercero'];
		$html .= "			</td>";
		$html .= "		</tr>";
		$html .= "		<tr  class=\"modulo_table_list_title\">";
		$html .= "			<td align=\"left\">";
		...
		$html .= "			</td>";
		$html .= "			<td class=\"modulo_list_oscuro\" align=\"left\">";
		$html .= "				".$request['datos_producto']['codigo_producto']." - ".$request['datos_producto']['descripcion'];
		$html .= "			</td>";
		$html .= "		</tr>";
		$html .= "		<tr  class=\"modulo_table_list_title\">";
		$html .= "			<td align=\"center\">";
		...
		$html .= "			</td>";
		$html .= "			<td class=\"modulo_list_oscuro\" align=\"left\">";
		$html .= "				<table width=\"100%\" align=\"center\"  class=\"modulo_table_list\" border=\"0\" >";
		...
		$url = ModuloGetURL("app", "ContratacionProductos", "controller", "PoliticasProducto",	array("datos_producto"=>
																																array(	"codigo_producto"=>$request['datos_producto']['codigo_producto'],
																																		...
																																		"politica" =>array(
																																		"eliminar" =>"1",
																																		"politica_producto_id" =>$valor['politica_producto_id'],
																																		)));
		
		$html .= "					<tr>";
		$html .= "						<td width=\"95%\">";
		$html .= "							<li>".$valor['politica']."</li>";
		$html .= "						<td>";
		$html .= "						<td width=\"5%\">";
		$html .= "         					<a href=\"".$url."\" class=\"label_error\"><img src=\"".GetThemePath()."/images/delete2.gif\" border=\"0\" title=\"ELIMINAR POLITICA VENCIMIENTO\"></a>\n";
		$html .= "						</td>";
		$html .= "					</tr>";
		}
		$html .= "				</table>";
		...
		$html .= "<form name=\"FormaPolitica\" id=\"FormaPolitica\" method=\"POST\" action=\"".$action['guardar']."\">";
		$html .= "	<table   width=\"60%\" align=\"center\"  class=\"modulo_table_list\" border=\"0\"  >";
		$html .= "		<tr class=\"modulo_table_list_title\">";
		$html .= "			<td>";
		$html .= "				NUEVA POLITICA";
		$html .= "			</td>";
		$html .= "			<td>";
		$html .= "				<input type=\"text\" name=\"politica[politica]\" id=\"politica\" class=\"input-text\" style=\"width:100%\">";
		$html .= "			</td>";
		$html .= "		</tr>";
		$html .= "		<tr>";
		$html .= "			<td colspan=\"2\" align=\"center\">";
		$html .= "				<input type=\"hidden\" name=\"politica[guardar]\" id=\"guardar\" value=\"1\">";
		$html .= "				<input type=\"submit\" value=\"GUARDAR POLITICA\" class=\"input-submit\">";
		$html .= "			</td>";
		$html .= "		</tr>";
		$html .= "	</table>";
		$html .= "</form>";
		
		$html .= "<form name=\"volver\" id=\"volver\" method=\"POST\" action=\"".$action['volver']."\">";
		$html .= "	<table   width=\"60%\" align=\"center\"  class=\"modulo_table_list\" border=\"0\"  >";
		$html .= "		<tr class=\"modulo_table_list_title\">";
		$html .= "			<td>";
		$html .= "				<input type=\"submit\" value=\"VOLVER\" class=\"input-submit\">";
		$html .= "			</td>";
		$html .= "		</tr>";
		$html .= "	</table>";
		$html .= "</form>";
