...
/*
      ...
      */
      ...
      $sql ="  SELECT   c.descripcion as laboratorio,
                        ...
                        p.codigo_producto,
                       fc_descripcion_producto(p.codigo_producto) as producto, 
                        p.codigo_alterno,
	...
	/*
      ...
      */
      ...
      function Insertar_PoliticaProductoProveedor($datos,$politica)
      {
      $indice = array();
      $this->ConexionTransaccion();
       $sql  = "
				INSERT INTO contratacion_produc_proveedor_politicas
				(
				...
				(
				DEFAULT,
				'".$datos['contrato_produc_prov_det_id']."',
				'".$politica['politica']."',
				'".UserGetUID()."'
				);";  
	...
	/*
      ...
      */
      ...
      function Eliminar_PoliticaProducto($datos,$politica)
      {
      $indice = array();
      $this->ConexionTransaccion();
       $sql  = "DELETE FROM contratacion_produc_proveedor_politicas
				WHERE TRUE
				AND politica_producto_id = ".trim($politica['politica_producto_id']).";";
      ...
      */  
      ...
      function Obtener_PoliticasProductoProveedor($datos)
      {
			$sql = " SELECT  
						a.politica_producto_id,
						a.contrato_produc_prov_det_id,
						a.politica
						FROM
						contratacion_produc_proveedor_politicas as a
						WHERE TRUE
						AND contrato_produc_prov_det_id = '".trim($datos['contrato_produc_prov_det_id'])."';	";
	...
	function FiltroProductosCont($filtros,$offset,$contratacion_prod_id)
      {
            ...
            $sql = "SELECT     	CONT.no_contrato, CONT.descripcion, CONT.contratacion_prod_id,  ";
            $sql .= "          	DET.contrato_produc_prov_det_id, ";
            $sql .= "          	PROD.codigo_producto, ";
            $sql .= "         	PROD.codigo_alterno, ";
            $sql .= "         	fc_descripcion_producto(PROD.codigo_producto) as descripcion, ";
            $sql .= "         	PROD.contenido_unidad_venta, ";
            $sql .= "        	  DET.valor_total_pactado,  ";
            $sql .= "       	  TIPOP.tipo_producto_id, ";
            $sql .= "       	  u.descripcion as unidad, ";
