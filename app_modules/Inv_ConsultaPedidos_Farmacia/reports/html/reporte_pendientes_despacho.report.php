  ...
  IncludeClass('AutoCarga');
    ...
    */
    ...
    // print_r($this->datos);
  			...
  			$detl = $nc->ObtenerDespachosPendientes($this->datos['empresa_'],$this->datos['farmacia'],$this->datos['prefijo'],$this->datos['numero']);
     ...
     //   print_r($detl);
      ...
      if(!empty($detl))
      {
  			...
  			$html .= "			<td width=\"10%\" class=\"label\">FARMACIA</td>\n";
        $html .= "			<td width=\"10%\" class=\"label\">DOC. PREFIJO</td>\n";
        $html .= "			<td width=\"10%\" class=\"label\">DOC. NUMERO</td>\n";
        $html .= "			<td width=\"40%\" class=\"label\">PRODUCTO</td>\n";
        $html .= "			<td width=\"15%\" class=\"label\">CANTIDAD SOLICITADA</td>\n";
        $html .= "			<td width=\"15%\" class=\"label\">CANTIDAD PENDIENTE</td>\n";
  			...
  			foreach($detl as $k1 => $dtl)
        {
          ...
          $html .= "			<td ><b>".$dtl['cantidad_pendiente']."</b></td>\n";
          $html .= "		</tr>\n";
        }
  			$html .= "	</table><br><br><br>\n";
			}
