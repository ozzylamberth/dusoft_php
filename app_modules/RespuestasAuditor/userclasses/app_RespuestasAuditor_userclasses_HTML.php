     ...
     function Informacion_NotaAuditoria()
     {
     	...
     	$ingreso = $_REQUEST['ingreso'];
          ...
          $this->salida .= "</tr>";
               ...
               {
               	$dato_evolucion = "y la Evolución: <b>".$info_nota[0][evolucion_id]."</b>";
               }else
               {
               	$dato_evolucion = "&nbsp;";               
               }
