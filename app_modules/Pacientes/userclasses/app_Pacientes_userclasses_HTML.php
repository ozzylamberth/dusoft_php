  ...
  */
  function FormaNN($TipoId,$PacienteId,$Responsable,$Nivel)
  {
        ...
        $this->salida .= "<input type=\"hidden\" name=\"Zona\" value=\"$Zona\">";				
				...
				if($_REQUEST['Edad']==3)
				{  $this->salida .= "       <option value=\"3\" selected>Años</option>";  }
				else
				{  $this->salida .= "       <option value=\"3\">Años</option>";  }
				if($_REQUEST['Edad']==1)
				{  $this->salida .= "       <option value=\"1\" selected>Días</option>";  }
				else
				{  $this->salida .= "       <option value=\"1\">Días</option>";  }
				if($_REQUEST['Edad']==2)
...
//FIN LUGAR EXPEDICION
  ...
  */
  function FormaDatosPacienteCreado($datos,$Responsable)
  {
        ...
        $this->salida .= "    </tr>";
        $this->salida .= "    <tr>";
        $this->salida .= "    <td class=\"modulo_table_list_title\">Identificación:</td>";
...
if(!empty($Responsable))
{
        ...
        $this->salida .= "    <tr>";
        $this->salida .= "    <td class=\"modulo_table_list_title\">Dirección:</td>";
        ...
        $this->salida .= "    </tr>";
        $this->salida .= "    <tr>";
        $this->salida .= "    <td class=\"modulo_table_list_title\">Teléfonos:</td>";
        ...
        $this->salida .= "    </tr>";
        $this->salida .= "    <tr>";
        $this->salida .= "    <td class=\"modulo_table_list_title\">Ocupación:</td>";
  ...
  */
  function FormaCambioIdentificacion($TipoId,$PacienteId)
  {
      ...
      if($CXC)
      {
          ...
          $this->salida .= "    <tr>";
          $this->salida .= "       <td  align=\"center\" class=\"label\">No se pueden modificar la identificación del paciente, Tiene cuentas por cobrar.</td>";
          $this->salida .= "    </tr>";
          $contenedor=$_SESSION['PACIENTES']['RETORNO']['contenedor'];
          $modulo=$_SESSION['PACIENTES']['RETORNO']['modulo'];
          $tipo=$_SESSION['PACIENTES']['RETORNO']['tipo'];
