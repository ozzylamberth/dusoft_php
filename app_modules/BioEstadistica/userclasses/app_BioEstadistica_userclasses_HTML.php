...
class app_BioEstadistica_userclasses_HTML extends app_BioEstadistica_user
{
	...
	*/
	function FormaMenus()
	{
	  ...
	  if($GetSoloLectura[sw_modificar_datos] == '1')
	  {
          ...
          $this->salida .= "                  <td align=\"center\" class=\"modulo_list_claro\"><a title='PERMITE ACTUALIZAR LA INFORMACIÓN DEL PACIENTE' href=\"$accionF\">MODIFICAR INFORMACION PACIENTE</a></td>";
          $this->salida .= "               </tr>";
          }
	  if($GetSoloLectura[sw_solo_lectura] == '1')
	  {
  ...
  //print_r($request);
          ...
          $this->salida .= "        <td ".$style.">Justificación Med. No Pos</td>\n";
                    ...
                    if($arr[$i][tipo_id_paciente].$arr[$i][paciente_id]<> $_var)
                    {
                         ...
                         if($_REQUEST['transfusion_sanguinea']==on)
                         {
                              ...
                              if(is_array($arr_transfusang))
                              {
                                ...
                                $edad_paciente=$edad_pacientep['edad']." Años";
                        ...
                        if(!empty($notas_OP) || !empty($examenes))
                        {
                         ...
                         if($_REQUEST['justi']==on)
                         {
                              ...
                              if(is_array($J_NoPos))
                              {
                                   ...
                                   {
                                        $this->salida .= "<tr align=\"center\" >";
                                        $this->salida .= "<td class=\"hc_table_submodulo_list_title\"  colspan='3'>Justificación Med. NO POS</td>";
                                   	...
                                   	//Imprimir Justificación NO POS
                                        ...
                                        $this->salida .= "<a href=\"javascript:$nombre_funcionJ_NOPOS\">ID. Justificación: ".$J_NoPos[$f][justificacion_no_pos_id]."&nbsp&nbsp&nbsp<img src=\"".GetThemePath()."/images/pparamed.png\" border='0'></a></td></tr>";
                                   }	
                              }
                              else
                              {
                                ...
                                if(!empty($Justificacion))
                                {
                                  ...
                                  if(is_array($Justificacion))
                                  {
                                      for($f=0;$f<sizeof($Justificacion);$f++)
                                      {
                                         ...
                                         $this->salida .=$mostrar;
                                         $this->salida .= "<td colspan='4' class='$estilo1' width=\"25%\" align=\"left\">";
                                         $this->salida .= "<a href=\"javascript:$nombre_funcionJ_NOPOS\">ID. Justificación: ".$Justificacion[$f][hc_justificaciones_no_pos_amb]."&nbsp&nbsp&nbsp<img src=\"".GetThemePath()."/images/pparamed.png\" border='0'></a></td></tr>";
                              ...
                              if(is_array($notas_OP))
                              {
                                   for($f=0;$f<sizeof($notas_OP);$f++)
                                   {
                                   	...
                                   	//imprimir nota operatoria
                                        ...
                                        $this->salida .= "<td colspan='4' class='$estilo1' width=\"25%\" align=\"left\">";
                                        $this->salida .= "<a href=\"javascript:$nombre_funcionOP\">Evolución: ".$notas_OP[$f][evolucion_id]."&nbsp&nbsp&nbsp<img src=\"".GetThemePath()."/images/traslado.png\" border='0'></a></td></tr>";
                                   }
                              }
                         }*/
                        $notas_OP = $examenes = array();
                                ...
                                if(!empty($Justificacion))
                                {
                                 ...
                                 //$Justificacion = $this->DatosJustificaciones_amb($arr[$i][ingreso]);
                                   if(is_array($Justificacion))
                                   {
                                      ...
                                      {
                                         $this->salida .= "<tr align=\"center\" >";
                                         $this->salida .= "<td class=\"hc_table_submodulo_list_title\"  colspan='3'>Justificación. NO POS</td>";
                                         $mostrar = $reporte->GetJavaReport('app','BioEstadistica','Justificacion_NO_POS_html',array('evolucion_id'=>$Justificacion[$f][evolucion_id],'Justificación'=>$Justificacion[$f][hc_justificaciones_no_pos_amb],'ingreso'=>$arr[$i][ingreso]),array('rpt_name'=>'','rpt_dir'=>'','rpt_rewrite'=>TRUE));
                                         $nombre_funcionJ_NOPOS = $reporte->GetJavaFunction();
                                         $this->salida .=$mostrar;
                                         $this->salida .= "<td colspan='4' class='$estilo1' width=\"25%\" align=\"left\">";
                                         $this->salida .= "<a href=\"javascript:$nombre_funcionJ_NOPOS\">ID. Justificación: ".$Justificacion[$f][hc_justificaciones_no_pos_amb]."&nbsp&nbsp&nbsp<img src=\"".GetThemePath()."/images/pparamed.png\" border='0'></a></td></tr>";
