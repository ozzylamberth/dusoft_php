...
/**
 * $Id: reporteNotaOperatoria_html.report.php,v 1.3 2009/07/17 13:09:14 hugo Exp $
...
//FUNCION QUE RETORNA EL HTML DEL REPORTE (lo que va dentro del tag <BODY>)
	...
	//*******************************************termino	
		...
		if($datos){			
			...
			$Salida.= "     </tr>";
      if($datos['sw_urg_prog'] == '1'){
        $Salida .= "		<td width=\"20%\" class=\"normal_10N\">TIPO DE CIRUGIA</td>";
        $Salida .= "		<td width=\"20%\"colspan =\"3\" class=\"normal_10\">URGENTE</td>";
      }
      else{
        $Salida .= "		<td width=\"20%\" class=\"normal_10N\">TIPO DE CIRUGIA</td>";
        $Salida .= "		<td width=\"20%\"colspan =\"3\" class=\"normal_10\">PROGRAMADA</td>";
      } 
			$Salida.= "  </table><BR>";			
...
//*****************************************fin de termino
	...
	function ProcedimientosNotaOperatoria($programacion,$tipoidpaciente,$paciente){
		...
		$query =" SELECT c.hc_nota_operatoria_cirugia_id,
		            ...
		            FROM hc_notas_operatorias_procedimientos a,
                     cups b,
                     hc_notas_operatorias_cirugias c,
		                 hc_evoluciones evol,
                     ingresos ing,
	...
	function DescripcionTecnicaQX($ingreso,$programacion,$notaid)
  {
    ...
    $query =" SELECT descripcion,
              ...
              LEFT JOIN  profesionales_usuarios prof
                     ON (a.usuario_id=prof.usuario_id)
              LEFT JOIN terceros ter
                     ON ( prof.tipo_tercero_id=ter.tipo_id_tercero AND prof.tercero_id=ter.tercero_id)
