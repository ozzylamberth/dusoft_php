<?php
  /******************************************************************************
  * $Id: LiquidacionHabitacionesCta.class.php,v 1.7 2010/11/29 14:05:53 hugo Exp $
  ...
  ********************************************************************************/
   ...
   function CargarHabitacionCuenta($EmpresaId,$Cuenta,$TipoId,$PacienteId,$PlanId,$Nivel,$Fecha,$Ingreso,$mensaje,$corte)
    {     
      ...
      $dbconn->BeginTrans();
			...
			if($corte == 'CORTE')      
			{
/*				echo			   $query = "INSERT INTO auditoria_liquidacion_manual_habitaciones(
													numerodecuenta,
													usuario_id,
								...
								if ($dbconn->ErrorNo() != 0){      
									$this->frmError['MensajeError'] = "ERROR DB : " . $dbconn->ErrorMsg().'['.get_class($this).']['.__LINE__.']';
			...
			else
			{
					...
					if ($dbconn->ErrorNo() != 0){      
						...
						$query = "select count(*)
													FROM auditoria_liquidacion_manual_habitaciones
													WHERE numerodecuenta = $Cuenta";
