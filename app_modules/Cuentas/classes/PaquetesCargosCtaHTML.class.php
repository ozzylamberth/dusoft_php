<?php
  /******************************************************************************
  * $Id: PaquetesCargosCtaHTML.class.php,v 1.7 2010/11/29 14:05:53 hugo Exp $
  ...
  ********************************************************************************/
  IncludeClass('PaquetesCargosCta','','app','Facturacion');
	...
	class PaquetesCargosCtaHTML
	{
		...
		* @return array 
		***********************************************************************************/
		function CrearFormaPaquetesCargosCta($Cuenta,$TipoId,$PacienteId,$Nivel,$PlanId,$Fecha,$Ingreso,$Estado){	
      ...
      $html .= "    </form>";     
			$accionVolver = SessionGetVar('AccionVolverCargosIYM');
