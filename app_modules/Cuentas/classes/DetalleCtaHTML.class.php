<?php
  /******************************************************************************
  * $Id: DetalleCtaHTML.class.php,v 1.7 2010/11/29 14:05:53 hugo Exp $
  ...
  ********************************************************************************/
  IncludeClass('DetalleCta','','app','Cuentas');
  IncludeLib("funciones_facturacion");
  
	class DetalleCtaHTML
	{
		function DetalleCtaHTML(){}
		/**********************************************************************************
		* Funcion donde se buscan crea la forma de los paquetes
		* 
		* @return array 
		***********************************************************************************/
		function CrearFormaDetalleCta($Cuenta,$Cerradas,$TipoId,$PacienteId,$Nivel,$PlanId,$Fecha,$Ingreso,$accionM,$accionE,$accionDevol,$modificacionCargos,$EmpresaId,$CU,$adicionales)
    {	
     
      //$file = 'app_modules/Facturacion/RemoteXajax/DetalleCta.php';
      //$objeto->SetXajax(array("reqMostrarCargosAgrupados","reqOcultarCargosAgrupados"),$file);                   
      //$html .= "<script src='javascripts/cross-browser/x/x_core.js'>\n";    
      //$html .= "</script>\n";    
      $html .= "<script>\n";    
      //$html .= "function CallMostrarCargos(Cuenta,descripcion,paqueteId,liquidacionQX,registro,Cerradas,estilo1,accionM,accionE,TipoId,PacienteId,Nivel,PlanId,Fecha,Ingreso){";      
      //$html .= "  xajax_reqMostrarCargosAgrupados(Cuenta,descripcion,paqueteId,liquidacionQX,registro,Cerradas,estilo1,accionM,accionE,TipoId,PacienteId,Nivel,PlanId,Fecha,Ingreso)";      
      //$html .= "}";
      $html .= "function CallMostrarCargos(registro,valor){";       
      $html .= "  if(valor==1){";
      $html .= "    var y;";      
      $html .= "    y=xGetElementById('Visualizar'+registro);";           
      $html .= "    y.style.display='none';";
      $html .= "    var z;";      
      $html .= "    z=xGetElementById('NoVisualizar'+registro);";           
      $html .= "    z.style.display='block';";
      $html .= "    var x;";      
      $html .= "    x=xGetElementById('Cargos'+registro);";           
      $html .= "    x.style.display='block';";
      $html .= "  }";
      $html .= "  if(valor==2){";
      $html .= "    var y;";      
      $html .= "    y=xGetElementById('Visualizar'+registro);";           
      $html .= "    y.style.display='block';";
      $html .= "    var z;";      
      $html .= "    z=xGetElementById('NoVisualizar'+registro);";           
      $html .= "    z.style.display='none';";
      $html .= "    var x;";      
      $html .= "    x=xGetElementById('Cargos'+registro);";           
      $html .= "    x.style.display='none';";
      $html .= "  }";
      $html .= "}";
      /*$html .= "function CallOcultarCargos(Cuenta,descripcion,paqueteId,liquidacionQX,registro,Cerradas,estilo1,accionM,accionE,TipoId,PacienteId,Nivel,PlanId,Fecha,Ingreso){";
      $html .= "  xajax_reqOcultarCargosAgrupados(Cuenta,descripcion,paqueteId,liquidacionQX,registro,Cerradas,estilo1,accionM,accionE,TipoId,PacienteId,Nivel,PlanId,Fecha,Ingreso)";
      $html .= "}";*/
      $html .= "</script>\n";    
      
      $funciones = new DetalleCta; 
      $vector = array();
      if(empty($adicionales['prnAnuladas']))
        $vector = $funciones->BuscarDetalleCuenta($Cuenta);      
      else
        $vector = $funciones->BuscarDetalleCuentaAnulada($Cuenta,$adicionales);      
      ...
      if($vector)
      {
        ...
        if($Cerradas!='Cerradas' && empty($adicionales['prnAnuladas']))
        ...
        for($i=0;$i<sizeof($vector);$i++){
          ...
          if($vector[$i][paquete_codigo_id])
          {
            if(empty($adicionales['prnAnuladas']))
              ...
              $paquetes = $funciones->BuscarPaquetesCuentasAnulada($Cuenta,$vector[$i]['paquete_codigo_id'],$adicionales);
          ...
          elseif($vector[$i][cuenta_liquidacion_qx_id])
          {
            ...
            {
              $vectorQX = $funciones->DatosCirugiaAnulada($vector[$i][cuenta_liquidacion_qx_id],$Cuenta,$adicionales);
              $DatosQXEquipos=$funciones->DatosEquiposQXAnulada($vector[$i][cuenta_liquidacion_qx_id],$Cuenta,$adicionales);
              $cargosQX= $funciones->CargosMedicamentosCuentaPacienteAnulada($vector[$i][cuenta_liquidacion_qx_id],$Cuenta,$adicionales);
              $cargosDevQX= $funciones->CargosMedicamentosCuentaPacienteDevolAnulada($vector[$i][cuenta_liquidacion_qx_id],$Cuenta,$adicionales);            
            }
            $valCarNFact=0;
            $valCarNFactNC=0;
          ...
          {      
            if(empty($adicionales['prnAnuladas']))
              ...
              $productos= $funciones->BuscarCargosAgrupadosAnuladosCuentas($Cuenta,$vector[$i]['descripcion'],$adicionales);                        
            $valCarNFact=0;
            $valCarNFactNC=0;
          ...
          {
            $html.= $this->MostrarDatosCargos($paquetes,$Cerradas,$estilo1,$accionM,$accionE,$accionDevol,$Cuenta,$TipoId,$PacienteId,$Nivel,$PlanId,$Fecha,$Ingreso,$modificacionCargos,$EmpresaId,$CU,$adicionales);              
          }
          ...
          {
            $html.= $this->MostrarDatosCargos($productos,$Cerradas,$estilo1,$accionM,$accionE,$accionDevol,$Cuenta,$TipoId,$PacienteId,$Nivel,$PlanId,$Fecha,$Ingreso,$modificacionCargos,$EmpresaId,$CU,$adicionales);           
          }
    ...
    ***********************************************************************************/ 
    ...
    function MostrarDatosCargos($productos,$Cerradas,$estilo1,$accionM,$accionE,$accionDevol,$Cuenta,$TipoId,$PacienteId,$Nivel,$PlanId,$Fecha,$Ingreso,$modificacionCargos,$EmpresaId,$CU,$adicionales)
    {
      if($productos)
      {
        ...
        if($modificacionCargos==1 && $Cerradas!='Cerradas' && empty($adicionales['prnAnuladas']))
        {
        ...
        for($i=0;$i<sizeof($productos);$i++)
        {
          ...
          if($modificacionCargos==1 && $Cerradas!='Cerradas' && empty($productos[$i][cuenta_liquidacion_qx_id]) && empty($adicionales['prnAnuladas']))
          {          
            if($productos[$i][codigo_producto]){
