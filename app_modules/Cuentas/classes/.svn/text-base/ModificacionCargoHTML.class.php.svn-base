<?php
  /******************************************************************************
  * $Id: ModificacionCargoHTML.class.php,v 1.7 2010/11/29 14:05:53 hugo Exp $
  ...
  class ModificacionCargoHTML
  {
    ...
    ***********************************************************************************/
    function CrearFormaModificacionCargo($Transaccion,$TipoId,$PacienteId,$Cuenta,$Nivel,$PlanId,$Fecha,$Ingreso,$D,$mensaje,$accionCancelar,$accionModificar,$EmpresaId,$CentroU){  
      ...
      $html .= "                <td><input type=\"text\" class=\"input-text\" name=\"Cantidad\" size=\"10\" value=\"".$D[cantidad]."\" ".$varRO."></td>";
	  
	  $read='';
      //$SWCantidad=$funciones->SWCantidad($TarifarioId,$Cargo);
      $SWCantidad=$funciones->SWCantidad($D[tarifario_id],$D[cargo]);  
      if($SWCantidad==0){
        $read='readonly';        
      }
      //$html .= "             <td><input type=\"text\" class=\"input-text\" name=\"Cantidad\" size=\"5\" value=\"".round($D[cantidad])."\" $read></td>";        
      //$html .= "             <td><input type=\"text\" class=\"input-text\" name=\"Cantidad\" size=\"5\" value=\"".$D[cantidad]."\" $read></td>";        
      $html .= "               </tr>";
      $html .= "              <tr>";
      ...
      $html .= "      <td><input class=\"input-submit\" type=\"submit\" name=\"Consultar\" value=\"VOLVER\"></td>";
      $html .= "    </form>";
      $html .= "    </tr>";
      $html .= " </table><br>";
