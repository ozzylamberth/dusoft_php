<?php
  /******************************************************************************
  * $Id: CargosPendientesPorCargar.class.php,v 1.7 2010/11/29 14:05:53 hugo Exp $
  ...
  class CargosPendientesPorCargar
  {
    function CargosPendientesPorCargar(){}
			...
			*/
			...
			{
					$FormaCuenta = new app_Cuentas_userclasses_HTML();
			...
			{
				$FormaCuenta = new app_Cuentas_userclasses_HTML();
				$mensaje="EL CARGO PENDIENTE POR GARGAR FUE ELIMINADO.";
