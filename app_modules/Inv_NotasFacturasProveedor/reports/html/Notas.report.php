<?php
  ...
  IncludeClass("FacturasDespachoSQL","classes","app","FacturasDespacho");
	...
	{ 
	  ...
	  function Notas_report($datos=array())
	  {
			$this->datos=$datos;
      //print_r($datos);
	    return true;
    ...
    */
		...
		function CrearReporte()
	  {
			...
			$parametros_retencion=$sql_2->Parametros_Retencion($this->datos['empresa_id'],$this->datos['anio_factura']);
			...
			$html .= "		<td class=\"label\" colspan=\"2\" style=\"text-indent:10pt;text-align:left\">$".FormatoValor($this->datos['valor_nota'],2)."</td>\n";			
    ...
    foreach($detl as $key=>$dtl)
      ...
      $html .= "      <td class=\"normal_10AN\">$".FormatoValor(($dtl['valor_unitario']),2)."</td>\n";
     /* $html .= "      <td rowspan=\"2\"><input disabled=\"true\" ".$dtl['checkbox']." title=\"Seleccionar Item para La Nota\" type=\"checkbox\" name=\"$i\" id=\"$i\" value=\"".$dtl['codigo_producto']."\"class=\"input-checkbox\"></td>\n";*/
      ...
      $html .= "              </td>";
      $html .= "              <td >";
      $html .= "                  $".FormatoValor($dtl['valor_concepto'],2);
      $html .= "              </td>";
      $html .= "              <td rowspan=\"2\">";
      ...
      $html .= "              </td>";
      $html .= "              <td >";
      $html .= "                  $".FormatoValor($dtl['valor_concepto']/$dtl['cantidad'],2);
      $html .= "              </td>";
      $html .= "						</tr>";
	  $html .= "			<tr>";
	  $html .= "				<td colspan=\"7\">";
	...
	$html .= "			</table>";
      ...
      $i++;
            ...
            //Se calcula reteiva por el total del iva
      if($parametros_retencion['sw_reteiva']=='2' ||$parametros_retencion['sw_reteiva']=='3')
                $total_retiva = $total_iva*($this->datos['porc_rtiva']/100);
        //if($total_iva >= $parametros_retencion['base_reteiva'])
	...
	$html .= "				<tr align=\"center\" >";
	$html .= "						<td>";
	//$html .= "							$".FormatoValor($this->datos['valor_nota'],2);
	$html .= "							$".FormatoValor(($this->datos['valor_nota']),2);
	$html .= "						</td>";
	$html .= "						<td>";
	$html .= "							$".FormatoValor($total_iva,2);
	$html .= "						</td>";
	$html .= "						<td>";
	$html .= "							$".FormatoValor($total_retfuente,2);
	$html .= "						</td>";
	$html .= "						<td>";
	$html .= "							$".FormatoValor($total_retica,2);
	$html .= "						</td>";
	$html .= "						<td>";
	$html .= "							$".FormatoValor($total_retiva,2);
	$html .= "						</td>";
	$html .= "						<td>";
	$html .= "							$".FormatoValor(((($this->datos['valor_nota'])+$total_iva)-($total_retfuente+$total_retiva+$total_retica)),2);
	$html .= "						</td>";
	$html .= "				</tr>";
	$html .= "			</table><br><br>";
