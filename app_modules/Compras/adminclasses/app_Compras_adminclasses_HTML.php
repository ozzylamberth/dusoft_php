...
/**
* app_Compras_adminclasses_HTML.php
**/

class app_Compras_adminclasses_HTML extends app_Soat_admin
{
	function app_Compras_admin_HTML()
	{
		$this->app_Compras_admin(); //Constructor del padre 'modulo'
		$this->salida='';
		return true;
	}
...
*/
	function Menu()//
	{
		$this->salida = ThemeAbrirTabla('MENU ADMINISTRADOR - COMPRAS');
		...
		$this->salida .="   </tr>";
		$this->salida .="   <tr>";
		$this->salida .="   <td class=\"modulo_list_oscuro\" align=\"center\">COMPRAS";
		$this->salida .="   </td>";
		...
		$this->salida .="   </td>";
		$this->salida.= "   </tr>";
		$ac=ModuloGetURL('app','Compras','admin','RetornarPermisos');
		$this->salida.= "   <tr>";
		...
		$action3=ModuloGetURL('app','Compras','admin','Retornar');
