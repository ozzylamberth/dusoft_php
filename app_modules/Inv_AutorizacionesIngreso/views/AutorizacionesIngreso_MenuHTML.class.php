<?php
  ...
  */
  ...
  /**
  * Clase Vista:AutorizacionesIngreso_MenuHTML
  ...
  */
	...
	class AutorizacionesIngreso_MenuHTML
	{
		/**
		* Constructor de la clase
		*/
		function AutorizacionesIngreso_MenuHTML(){}
		 
     
		function Menu($action,$EmpresaId)
		{
		$accion=$action['volver'];
		$html  = ThemeAbrirTabla('FACTURAS DE DESPACHOS');
		...
		$html .= "      <a href=\"". ModuloGetURL('app','Inv_AutorizacionesIngreso','controller','Consultar_AutorizarProductosIngresos')."&datos[empresa_id]=".$EmpresaId."\">CONSULTAS/AUTORIZACIONES</a>";
		$html .= "      </td>";
		$html .= "      </tr>";
