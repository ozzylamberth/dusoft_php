...
/**
 * $Id: SolicitudesDespachosDpto_html.report.php,v 1.1.1.1 2009/09/11 20:36:49 hugo Exp $
...
//*******************************************termino
        ...
        $Salida.="<tr>";
				$Salida.="  <td class=\"normal_10N\" align=\"center\" width=\"100%\">SOLICITUDES DE MEDICAMENTOS E INSUMOS</td>";
				$Salida.="</tr>";
        $Salida.="<tr>";
        ...
        $Salida.="<tr>";
				...
				$Salida.="</table><BR>";
        $marca=0;
        $vector=$this->DatosSolicitudesDepartamento($this->datos['departamento']);
				if($vector){
              ...
              foreach($vector1 as $consecutivoId=>$datos){
                if($paciente!=$pacienteAnt){
                  ...
                  if($solicitudId!=$solicitudIdAnt){
                    ...
                    $Salida.="<tr>";
                    $Salida.="  <td class=\"normal_10N\" align=\"left\" width=\"15%\">No. SOLICITUD</td>";
                    $Salida.="  <td class=\"normal_10\"  align=\"left\" width=\"30%\">$solicitudId</td>";
                    ...
                    $Salida.="  <td class=\"normal_10N\" align=\"left\" width=\"15%\">USUARIO QUE SOLICITA</td>";
                    ...
                    $Salida.="  <td class=\"normal_10\"  align=\"left\" width=\"25%\">".$datos['cant_solicitada']." ".$datos['abreviatura']."</td>";
                    $Salida.="</tr>";
                    if($datos['ubicacion']){
                    $Salida.="<tr>";
...
//*****************************************fin de termino
    ...
    $query = "(SELECT i.tipo_id_paciente||' '||i.paciente_id,a.solicitud_id,det.consecutivo_d,a.estacion_id,a.fecha_solicitud as fecha_solicitud,a.ingreso,d.nombre as usuarioestacion,a.usuario_id,c.descripcion as deptoestacion,
		...
		det.medicamento_id as codigo_producto,invp.descripcion as desmed,det.cant_solicitada,bu.descripcion as ubicacion,u.abreviatura,exis.existencia
    ...
    LEFT JOIN movimientos_habitacion f ON(e.numerodecuenta=f.numerodecuenta AND f.fecha_egreso is NULL)
		...
		l.primer_nombre||' '||l.segundo_nombre||' '||l.primer_apellido||' '||l.segundo_apellido as nombrepac,
		j.cama,j.pieza,a.tipo_solicitud,b.descripcion as nomestacion,
		det.medicamento_id AS codigo_producto,invp.descripcion as desmed,det.cant_solicitada as cant_solicitada,bu.descripcion as ubicacion,u.abreviatura,exis.existencia
		FROM hc_solicitudes_medicamentos a,estaciones_enfermeria b,departamentos c,system_usuarios d,cuentas e
    LEFT JOIN movimientos_habitacion f ON(e.numerodecuenta=f.numerodecuenta AND f.fecha_egreso is NULL)
		LEFT JOIN camas j ON(f.cama=j.cama)
