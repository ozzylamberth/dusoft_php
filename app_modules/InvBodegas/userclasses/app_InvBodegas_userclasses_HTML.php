...
/**
 * $Id: app_InvBodegas_userclasses_HTML.php,v 1.1.1.1 2009/09/11 20:36:49 hugo Exp $
...
*/
	...
	function FormaExistenciasBodegas($codigoProd,$descripcion,$grupo,$NomGrupo,$clasePr,$NomClase,$subclase,$NomSubClase,$codigoProdAlterno){
    ...
    $this->salida .= "		     <tr class=\"modulo_list_oscuro\"><td class=\"label\">CODIGO ALTERNO</td><td><input type=\"text\" class=\"input-text\" name=\"codigoProdAlterno\" value=\"$codigoProdAlterno\"></td></tr>";
    ...
    $this->salida .= "		     </table><BR>";
		...
		$this->salida .= "       </td></tr>";
		$this->salida .= "			 </table>";
		$ExistenciasBodegas=$this->ConsultaExistenciasBodegas($grupo,$clasePr,$subclase,$codigoProd,$descripcion,$filtroEstado=0,$codigoProdAlterno);
		...
		$this->salida .= "			<td class=\"modulo_table_list_title\">LOTE</td>\n";
		$this->salida .= "			<td class=\"modulo_table_list_title\">FEC VENCIMIENTO</td>\n";
		...
		for($i=0;$i<sizeof($ExistenciasBodegas);$i++){
			...
			$Concentracion = "";
			$FormaFarmacologica = "";
			if($ExistenciasBodegas[$i]['concentracion_forma_farmacologica'])
			{
				$Concentracion = " ".$ExistenciasBodegas[$i]['concentracion_forma_farmacologica'];
			}
			if($ExistenciasBodegas[$i]['forma_farmacologica'])
			{
				$FormaFarmacologica = " ".$ExistenciasBodegas[$i]['forma_farmacologica'];
			}
			
			$this->salida .= "	 <td>".$DescripProd."".$Concentracion."".$FormaFarmacologica."</td>";
      ...
      $this->salida .= "     <td align=\"center\">&nbsp;</td>";
			...
			$this->salida .= "	 <td>".$ExistenciasBodegas[$i]['lote']."</td>";
			$this->salida .= "	 <td>".$ExistenciasBodegas[$i]['fecha_vencimiento']."</td>";
...
*/
	...
	function ConfirmacionDespachoPendientes($datos,$CantDespachar,$datos_bodega,$concepto,$Ingreso,$SolicitudId,$TipoSolicitud,$EstacionId,$NombreEstacion,$Fecha,$usuarioestacion,
		...
		SessionDelVar("datosConfirmarDespachoSolicitudes");
		SessionSetVar("datosConfirmarDespachoSolicitudes",$datos);
    ...
    $this->salida .= themeAbrirTabla('CONFIRMACION DE SOLICITUDES DE DESPACHO');
		...
		//"nombrepac"=>$nombrepac,"tipo_id_paciente"=>$tipo_id_paciente,"paciente_id"=>$paciente_id,"cama"=>$cama));
		$action=ModuloGetURL('app','InvBodegas','user','ConfirmarDespachoSolicitudes',array("CantDespachar"=>$CantDespachar,"datos_bodega"=>$datos_bodega,"concepto"=>$concepto,"Ingreso"=>$Ingreso,"SolicitudId"=>$SolicitudId,
		"TipoSolicitud"=>$TipoSolicitud,"EstacionId"=>$EstacionId,"NombreEstacion"=>$NombreEstacion,"Fecha"=>$Fecha,"usuarioestacion"=>$usuarioestacion,
		"nombrepac"=>$nombrepac,"tipo_id_paciente"=>$tipo_id_paciente,"paciente_id"=>$paciente_id,"cama"=>$cama));
