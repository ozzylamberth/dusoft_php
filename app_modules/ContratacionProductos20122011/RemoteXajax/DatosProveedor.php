...
* @return Object $objResponse objeto de respuesta al formulario  
        ...
        if(document.formita.checkseleccionar'.$j.'.checked==true)
        {
            ...
            else
            {
              if(document.getElementById(\'checkpesos'.$j.'\').checked==true)
              {
                  ...
                  {
                      bandera=0;		
                     xajax_InsertarProductoAlContrato(\''.$empresa.'\', \''.$noidcontrato.'\',codigo_producto,valor,valor_pactado,valor_porcentaje,totalporc,bandera);
                  }
              }else
              {
  ...
  */  
		...
		function InsertarProductoAlContrato($empresa,$noidcontrato,$producto,$costo,$vpesos,$vporc,$valortotal,$bandera)
		{
