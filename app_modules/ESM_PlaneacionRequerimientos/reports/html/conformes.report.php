<?php
  ...
  IncludeClass("ListaReportes","classes","app","ReportesInventariosGral");
	...
	{ 
	  ...
	  function conformes_report($datos=array())
	  {
			$this->datos=$datos;			
	    return true;
	  }
    ...
    */
		...
		function CrearReporte()
	  {
			...
			$detl = $nc->ObtenerListadoProveedoresNoConformeDetalle($this->datos);
			...
			$html .= "		<td class=\"label\" colspan=\"2\" style=\"text-indent:10pt;text-align:left\">".$this->datos['fecha_registro']."</td>\n";			
			$html .= "	</tr>\n";
			$html .= "</table>\n";
			$html .= "	<br>\n";
      if(!empty($detl))
      {
          ...
          if($dtl['sw_insumos'] == '1')
            ...
            $tipo_producto = "MED";
  				...
  				$html .= "			<td >".$dtl['lote']."</td>\n";
  				$html .= "			<td align=\"right\">".formatoValor($dtl['numero_unidades_recibidas'])."</td>\n";
  				$html .= "		</tr>\n";
  			}			
  			$html .= "	</table><br><br><br>\n";
			}
