...
function consultar_eps_afiliados($tipo_id_paciente, $paciente_id) {

    //require_once("conexionpg.php");
    global $conexionn;

    $sql = " select * from eps_afiliados a where a.afiliado_tipo_id = '{$tipo_id_paciente}' and a.afiliado_id= '{$paciente_id}' ";
