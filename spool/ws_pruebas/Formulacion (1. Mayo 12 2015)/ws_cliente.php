...
class SincronizacionCosmitet {
    ...
    function sincronizarFormula() {
        ...
        $datos_evoluvion['ingreso'] = "4060454";
        $datos_evoluvion['fecha'] = date('Y-m-d');
        ...
        $datos_evoluvion['fecha_cierre'] = date('Y-m-d');
        ...
        $datos_evoluvion['numero_formula'] = $numero_formula;
        $datos_evoluvion['es_transcripcion'] = "0";


        $datos_medicamentos = array();

        $datos_medicamentos[0]['codigo_producto'] = "FOFOA1602210";
        $datos_medicamentos[0]['cantidad'] = "60";
        ...
        $datos_medicamentos[0]['numero_formula'] = $numero_formula;
        ...
        $datos_medicamentos[1]['codigo_producto'] = "FOFOC1060985";
        ...
        $datos_medicamentos[1]['numero_formula'] = $numero_formula;
        ...
        $datos_antecedentes[0]['codigo_medicamento'] = "FOFOA1602210";
        ...
        $datos_antecedentes[0]['numero_formula'] = $numero_formula;
        
        $datos_antecedentes[1]['tipo_id_paciente'] = "CC";
        $datos_antecedentes[1]['paciente_id'] = "31572931";
        $datos_antecedentes[1]['codigo_medicamento'] = "FOFOC1060985";
        ...
        $datos_antecedentes[1]['numero_formula'] = $numero_formula;
