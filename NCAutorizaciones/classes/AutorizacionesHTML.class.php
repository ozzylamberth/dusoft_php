<?php
	/**************************************************************************************
	* $Id: AutorizacionesHTML.class.php,v 1.2 2009/11/04 19:08:36 hugo Exp $
	...
	***************************************************************************************/
	class AutorizacionesHTML
	{
		...
		function FormaDatosAfiliado($cotizante,$plan,$aut,$unico = false)
	  {
		...
		* @returns $html string cadena que contiene el html de la forma de autorizaciones
		***************************************************************************************/
		function FormaAutorizarPaciente($plan,$idp,$tid,$action,$rango = array(),$externa = array(),$ingreso = null)
		{
			IncludeClass("ClaseHTML");
			IncludeClass('Autorizaciones','','app','NCAutorizaciones');
			$aut = new Autorizaciones();
      ...
      $solicitudes = $aut->ObtenerSolicitudesIngreso($ingreso,$idp,$tid);
      ...
      {
        $html .= "													<tr class=\"modulo_table_list_title\">\n";
        $html .= "														<td colspan=\"5\" >SOLICITUD HECHAS PARA LA AUTORIZACION</td>\n";
        $html .= "													</tr>\n";	
        foreach($solicitudes as $kr1 => $dtr1)
        {
          $html .= "													<tr class=\"modulo_list_claro\">\n";
          $html .= "														<td colspan=\"5\" class=\"label\">\n";
          $html .= "                              <input type=\"radio\" name=\"solicitud_autorizacion\" value=\"".$dtr1['numero_solicitud']."\">SOLICITUD NUMERO: ".$dtr1['numero_solicitud']."\n";
          $html .= "                            </td>\n";
          $html .= "													</tr>\n";	
        }
      }
