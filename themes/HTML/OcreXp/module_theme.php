...
function ThemeAbrirTabla($titulo,$porcentaje,$align){
	...
	if (!$porcentaje){
		...
		$salida .= "				<TR>\n";
		$salida .= "					<TD width=\"4\" bgcolor=\"#C5850A\"><IMG src=\"". GetThemePath() ."/images/punto.png\" width=\"1\" height=\"1\"></TD>\n";
...
function ThemeCerrarTabla(){
	...
	$salida .= "			<TABLE width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n";
	$salida .= "				<TR>\n";
	$salida .= "					<TD width=\"100%\" height=\"4\" bgcolor=\"#C5850A\"><IMG src=\"". GetThemePath() ."/images/punto.png\" width=\"1\" height=\"1\"></TD>\n";
	$salida .= "				</TR>\n";
	$salida .= "			</TABLE>\n";
	$salida .= "		</TD>\n";
	$salida .= "	</TR>\n";
...
function ThemeSubMenuTabla($titulo,$porcentaje){
	...
	$salida .= "					<TD height=\"26\" background=\"". GetThemePath() ."/images/submenu/franja.png\" width=\"100%\" height=\"26\" class='titulo_tabla_submenu'>$titulo</TD>\n";
