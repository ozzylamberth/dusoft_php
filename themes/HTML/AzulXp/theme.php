...
function PrintCabecera()
{
    ...
    $salida .= "<td align='center' valign='center'><img src=\"". GetThemePath() ."/images/curva.png\" width=59 height=100 border=0></td>\n";
 ...
 if(UserLoggedIn())
    {
        if(UserGetVar(UserGetUID(),'sw_admin')){
            $salida .= "        <td align='justify'><a href=\"". ModuloGetURL('system','Administrador','admin','main')."\"$target$alt><img src=\"". GetThemePath() ."/images/menu.png\" width=29 height=29 border=0></a></td>\n";
            $salida .= "        <td align='justify'><a href=\"". ModuloGetURL('system','log','user','logout')."\"$target$alt><img src=\"". GetThemePath() ."/images/logout.png\" width=29 height=29 border=0></a></td>\n";
        }else{
            $mensaje= mensajes();
            
            $salida .= "        <td align='justify'><a href=\"". ModuloGetURL()."\"$target$alt><img src=\"". GetThemePath() ."/images/casa.png\" title=\"P�gina Inicial\" width=29 height=29 border=0></a></td>\n";
            $salida .= "        <td align='justify'><a href=\"". ModuloGetURL('system','Menu','user','main')."\"$target$alt><img src=\"". GetThemePath() ."/images/menu.png\" title=\"Men� del Usuario\" width=29 height=29 border=0></a></td>\n";
            ...
            $salida .= "        <td align='justify'><a href=\"". ModuloGetURL('system','log','user','logout')."\"$target$alt><img src=\"". GetThemePath() ."/images/logout.png\" title=\"Cerrar Sesi�n\" width=29 height=29 border=0></a></td>\n";
            if($mensaje!=''){
             $html ="<tr><td align='center' ><div align='top'><a  style='text-decoration: blink;color:#FFFFFF; font-size:9px' >$mensaje</a></div></td></tr>";
            }            
        }
    }
    else
    {
        $salida .= "        <td align='justify'><a href=\"". ModuloGetURL()."\"$target$alt><img src=\"". GetThemePath() ."/images/casa.png\" title=\"P�gina Inicial\" width=29 height=29 border=0></a></td>\n";
        $salida .= "        <td align='justify'><a href=\"". ModuloGetURL('system','log','user','main')."\"$target$alt><img src=\"". GetThemePath() ."/images/llave.png\" title=\"Iniciar Sesi�n\" width=29 height=29 border=0></a></td>\n";
