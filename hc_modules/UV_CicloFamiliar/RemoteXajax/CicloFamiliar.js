/**************************************************************************************
* $Id: CicloFamiliar.js,v 1.1 2008/09/03 18:50:27 hugo Exp $ 
...
function NoSeleccionarFR(ingreso,tip_pac,id_pac,factor_riesgo_id)
{
	xajax_NoSeleccionarSFR(ingreso,tip_pac,id_pac,factor_riesgo_id);
}

function SeleccionarFR(td,ingreso,tip_pac,id_pac,factor_riesgo_id,act,descripcion,ciclo_vital_individual)
{
	xajax_SeleccionarSFR(td,ingreso,tip_pac,id_pac,factor_riesgo_id,act,descripcion,ciclo_vital_individual);
}
