...
/**
* Submodulo de Obgetivos Iniciales Psicologicos.
*
* Submodulo para manejar los objetivos iniciales de la consulta psicologica del paciente en una evolucion.
* @author Tizziano Perea O.
* @version 1.0
* @package SIIS
* $Id: hc_ObgetivosIniciales.php,v 1.1 2007/11/30 20:55:01 tizziano Exp $
*/
...
class ObgetivosIniciales extends hc_classModules
{
...
*/
    ...
    function GetEstado()
    {
		...
		$query="SELECT count(*)
				FROM hc_psicologia_objetivos_iniciales
    ...
    function InsertDatos()
    {
		...
		if ($_REQUEST[$motivo] == "")
		{
          ...
          else
          {
               if(!$result->EOF)
               {
                    $this->frmError["MensajeError"] = "YA SE REGISTRO UN OBJETIVO EN ESTA EVOLUCION (".$this->evolucion.")";
                    $this->frmForma();
                    return true;
               }
          }
        ...
        if($_REQUEST[$motivo]!="" or $_REQUEST[$enferact]!="")
        {
          ...
          $sql="INSERT INTO hc_psicologia_objetivos_iniciales (descripcion,
                                                               evolucion_id,
                                                               ingreso,
                                                               usuario_id,
                                                               fecha_registro)
     ...
     function ConsultaMotivo()
     {
          ...
          $query= "SELECT A.descripcion, A.fecha_registro,
                   ...
                   FROM hc_psicologia_objetivos_iniciales AS A,
