...
// $Id: hc_ObgetivosIniciales_HTML.php,v 1.1 2007/11/30 20:55:01 tizziano Exp $

class ObgetivosIniciales_HTML extends ObgetivosIniciales
{

	function ObgetivosIniciales_HTML()
	{
          $this->ObgetivosIniciales();//constructor del padre
          return true;
	}
...
//FIN DE IMPLEMENTACION
	...
	function frmReporte()
	{
		...
		if(!empty($motivos))
		{
			...
			$this->salida .="<td align=\"center\" colspan=\"2\">CONSOLIDADO DE LOS OBJETIVOS INICIALES</td>";
			$this->salida .="</tr>";
			$this->salida .="<tr class=\"hc_table_submodulo_list_title\">";
			$this->salida .="<td align=\"center\">FECHA</td>";
			$this->salida .="<td align=\"center\">OBJETIVOS</td>";
			$this->salida .="</tr>";
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[descripcion]))
					{
						...
						$this->salida .="<td width='100%'><b>&nbsp;OBJETIVO :<br></b>".$motivo."</td>";
						$this->salida .="</tr>";
					}
					$this->salida .="<tr>";
				}
		...
		else
		{
			...
			$this->salida.="<tr  align=\"center\"><br><td><label class='label_mark'>NO SE HA REGISTRADO UN OBJETIVO EN ESTA EVOLUCION - ($this->evolucion).</label>";
			$this->salida.="</td></tr>";
			$this->salida.="</table>";
			return false;
		}
	...
	function frmConsulta()
	{
		...
		if(!empty($motivos))
		{
			...
			$this->salida .="<tr class=\"modulo_table_title\">";
			$this->salida .="<td align=\"center\" colspan=\"2\">CONSOLIDADO DE OBJETIVOS INICIALES</td>";
			$this->salida .="</tr>";
			$this->salida .="<tr class=\"hc_table_submodulo_list_title\">";
			$this->salida .="<td align=\"center\">FECHA</td>";
			$this->salida .="<td align=\"center\">OBJETIVOS</td>";
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[descripcion]))
					{
						...
						$this->salida .="<tr class=\"hc_submodulo_list_claro\">";
						$this->salida .="<td class=\"hc_submodulo_list_claro\">&nbsp;</td>";
						$this->salida .="<td width='100%'><b>&nbsp;OBJETIVO :</b>&nbsp;&nbsp;&nbsp;".$motivo."</td>";
						$this->salida .="</tr>";
					}
	...
	function frmHistoria()
	{
		...
		if(!empty($motivos))
		{
			...
			$salida .="<td align=\"center\">OBJETIVOS</td>";
			$salida .="</tr>";
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[descripcion]))
					{
						...
						$salida .="<td width='100%'><b>&nbsp;OBJETIVO :</b>&nbsp;&nbsp;&nbsp;".$motivo."</td>";
						$salida .="</tr>";
					}
	...
	function frmForma()
	{
		...
		{
			$this->salida = ThemeAbrirTablaSubModulo('OBJETIVOS INICIALES (SUGERENCIAS)');
		}
		else
		{
		...
		$this->salida.="<tr class='modulo_table_title'>";
		$this->salida.="<td align='center'>OBJETIVO";
		$this->salida.="</td>";
		$this->salida.="</tr>";
		$this->salida.="<tr>";
