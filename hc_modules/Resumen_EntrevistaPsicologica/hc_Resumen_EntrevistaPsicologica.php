...
/**
* Submodulo de Resumen Entrevista Psicologica.
*
* Submodulo para manejar el resumen de la entrevista psicologica del paciente en una evolucion.
* @author Tizziano Perea O.
* @version 1.0
* @package SIIS
* $Id: hc_Resumen_EntrevistaPsicologica.php,v 1.1 2007/11/30 20:56:01 tizziano Exp $
*/


/**
* Resumen_EntrevistaPsicologica.
*
...
class Resumen_EntrevistaPsicologica extends hc_classModules
{
...
*/
	...
	function Resumen_EntrevistaPsicologica()
	{
		$this->limit=5;
		return true;
	}
...
*/
    ...
    function GetEstado()
    {
		...
		$query="SELECT count(*)
				FROM hc_psicologia_resumen_entrevista
    ...
    function InsertDatos()
    {
		...
		if ($_REQUEST[$motivo] == "")
		{
          ...
          if ($dbconn->ErrorNo() != 0)
          {
               ...
               $this->mensajeDeError = "Ocurrió un error al intentar consultar la tabla \"hc_psicologia_resumen_entrevista\".<br><br>".$dbconn->ErrorMsg()."<br><br>".$query;
               return false;
          }
          else
          {
               if(!$result->EOF)
               {
                    $this->frmError["MensajeError"] = "YA SE REGISTRO UN RESUMEN EN ESTA EVOLUCION (".$this->evolucion.")";
                    $this->frmForma();
                    return true;
               }
          }
        ...
        if($_REQUEST[$motivo]!="" or $_REQUEST[$enferact]!="")
        {
          ...
          $sql="INSERT INTO hc_psicologia_resumen_entrevista (descripcion,
                                                              evolucion_id,
                                                              ingreso,
                                                              usuario_id,
                                                              fecha_registro)
     ...
     function ConsultaMotivo()
     {
          ...
          $query= "SELECT A.descripcion, A.fecha_registro,
                   ...
                   FROM hc_psicologia_resumen_entrevista AS A,
