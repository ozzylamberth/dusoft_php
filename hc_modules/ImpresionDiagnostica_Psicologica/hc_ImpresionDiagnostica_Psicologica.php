...
/**
* Submodulo de Impresiones Daignosticas.
*
* Submodulo para manejar los diagnostico iniciales de la consulta psicologica del paciente en una evolucion.
* @author Tizziano Perea O.
* @version 1.0
* @package SIIS
* $Id: hc_ImpresionDiagnostica_Psicologica.php,v 1.1 2007/11/30 20:46:01 tizziano Exp $
*/


/**
* ImpresionDiagnostica_Psicologica.
*
...
class ImpresionDiagnostica_Psicologica extends hc_classModules
{
...
*/
	...
	function ImpresionDiagnostica_Psicologica()
	{
		$this->limit=5;
		return true;
	}
...
*/
    ...
    function GetEstado()
    {
		...
		$query="SELECT count(*)
				FROM hc_psicologia_impresion_diagnostica
    ...
    function InsertDatos()
    {
		...
		if ($_REQUEST[$motivo] == "")
		{
          ...
          if ($dbconn->ErrorNo() != 0)
          {
               ...
               $this->mensajeDeError = "Ocurrió un error al intentar consultar la tabla \"hc_psicologia_objetivos_iniciales\".<br><br>".$dbconn->ErrorMsg()."<br><br>".$query;
               return false;
          }
          else
          {
               if(!$result->EOF)
               {
                    $this->frmError["MensajeError"] = "YA SE REGISTRO UN DIAGNOSTICO EN ESTA EVOLUCION (".$this->evolucion.")";
                    $this->frmForma();
                    return true;
               }
          }
        ...
        if($_REQUEST[$motivo]!="" or $_REQUEST[$enferact]!="")
        {
          ...
          $sql="INSERT INTO hc_psicologia_impresion_diagnostica (descripcion,
                                                                 evolucion_id,
                                                                 ingreso,
                                                                 usuario_id,
                                                                 fecha_registro)
     ...
     function ConsultaMotivo()
     {
          ...
          $query= "SELECT A.descripcion, A.fecha_registro,
                   ...
                   FROM hc_psicologia_impresion_diagnostica AS A,
