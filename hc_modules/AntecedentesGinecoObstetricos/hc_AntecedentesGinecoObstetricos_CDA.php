...
/**
* $Id: hc_AntecedentesGinecoObstetricos_CDA.php,v 1.1 2005/06/20 22:18:05 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo AntecedentesGinecoObstetricos
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.1 $
* @package SIIS
*/ 
class AntecedentesGinecoObstetricos_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    * @access public    
    */  
    function AntecedentesGinecoObstetricos_CDA()
    {
    ...
    */     
    ...
    {
          $salida.="<caption>ANTECEDENTES GINECOBSTETRICOS</caption>";
