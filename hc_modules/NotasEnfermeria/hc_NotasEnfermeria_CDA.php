...
/**
* $Id: hc_NotasEnfermeria_CDA.php,v 1.2 2005/06/07 16:57:10 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo NotasEnfermeria
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.2 $
* @package SIIS
*/ 
class NotasEnfermeria_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    */     
    ...
    {
          $salida.="<caption>NOTAS DE ENFERMERIA</caption>";
		foreach($XML_Consulta as $k => $v)
          {
               ...
               {
                    $salida.="<br></br>";
               	$salida.="<b>Nota de Enfermeria: </b>".$v[1]."";
               }
               $salida.="</content>";
               $salida.="</paragraph>";
    ...
    function GetConsultaSubmodulo($Paramdatos, $ParamTipo)
    {
          ...
          switch($ParamTipo)
          {
               ...
               while($notas = $resultado->FetchRow())
               {
               	$XML_Consulta[] = $notas;
               }
