...
/**
* Submodulo de DescripcionOperacion.
*
* Submodulo para manejar las notas de las descripciones de la cirugia.
* @author Tizziano Perea <tizzianop@gmail.com>
* @version 1.0
* @package SIIS
* $Id: hc_DescripcionOperacion.php,v 1.4 2006/12/19 21:00:13 jgomez Exp $
*/
...
class DescripcionOperacion extends hc_classModules
{
...
*/
	...
	function DescripcionCirugia_Consulta()
	{
		$pfj=$this->frmPrefijo;
		list($dbconn) = GetDBconn();
		$query= "SELECT A.descripcion_cirugia_id,
