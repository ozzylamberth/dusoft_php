...
/**
* Submodulo de DescripcionOperacion (HTML).
*
* Submodulo para manejar las Descripciones de las Operaciones o cirugias.
* @author Tizziano Perea <tizzianop@gmail.com>.
* @version 1.0
* @package SIIS
* $Id: hc_DescripcionOperacion_HTML.php,v 1.4 2006/12/19 21:00:13 jgomez Exp $
*/

/**
* DescripcionOperacion_HTML
*
* Clase para retornar la presentacion en pantalla en html de los formularios de insercion y de consulta de los datos
* del submodulo DescripcionOperacion, se extiende la clase DescripcionOperacion y asi pueden ser
* utilizados los metodos de esta clase en la anterior.
*/

class DescripcionOperacion_HTML extends DescripcionOperacion
{

	function DescripcionOperacion_HTML()
	{
	    $this->DescripcionOperacion();//constructor del padre
       	return true;
	}
...
//FIN DE IMPLEMENTACION
	...
	{
		$pfj=$this->frmPrefijo;
		$evoluciones=$this->DescripcionCirugia_Consulta();
		if (empty ($evoluciones))
		{
			$this->salida .="<br><table width=\"100%\" border=\"0\" align=\"center\">";
			$this->salida .="<tr class=\"hc_table_submodulo_list_title\">";
			$this->salida .="<div class='label_mark' align='center'><BR>EL PACIENTE AUN NO PRESENTA DESCRIPCIONES DE LA CIRUGIA<br><br>";
			$this->salida .="</tr>";
			$this->salida .="</table>";
		}
		if (!empty ($evoluciones))
  		{
			...
			$this->salida .="<tr class=\"hc_table_submodulo_list_title\">";
			$this->salida .="<td align=\"center\"colspan=\"2\">DESCRIPCIONES DE LA CIRUGIA</td>";
			$this->salida .="</tr>";

			$this->salida .="<tr class=\"hc_table_submodulo_list_title\">";
			$this->salida .="<td>FECHA</td>";
			$this->salida .="<td align=\"center\">DESCRIPCIONES</td>";
			$this->salida .="</tr>";
	...
	function frmHistoria()
	{
		...
		if(!empty($evoluciones))
		{
			...
			$salida .="<td align=\"center\"colspan=\"2\">DESCRIPCIONES DE LA CIRUGIA</td>";
			$salida .="</tr>";
			$salida .="<tr class=\"hc_table_submodulo_list_title\">";
			$salida .="<td align=\"center\">FECHA</td>";
			$salida .="<td align=\"center\">DESCRIPCIONES</td>";
			$salida .="</tr>";
	...
	function frmForma()
	{
		...
		{
			$this->salida = ThemeAbrirTablaSubModulo('DESCRIPCION DE LA CIRUGIA');
		}
		else
		{
