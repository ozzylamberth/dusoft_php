...
/**
* $Id: hc_Interconsulta_CDA.php,v 1.2 2005/06/23 19:05:31 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo Interconsulta
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.2 $
* @package SIIS
*/ 
class Interconsulta_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    */     
    ...
    {
          $salida.="<caption>INTERCONSULTAS REMITIDAS</caption>";
          $xx = 0;
		foreach($XML_Consulta as $k => $v)
          {
               ...
               if($xx != 1)
               {
                    ...
                    $salida.="<TR>";
                    $salida.="<TH>CARGO</TH>";
                    $salida.="<TH>CODIGO Y NOMBRE DE ESPECIALIDAD</TH>";
               ...
               $salida.="<TD width=\"50%\" align=\"justify\"><b>".$v[especialidad]." - ".$v[descripcion]."</b></TD>";
               $salida.="<TD width=\"10%\" align=\"center\">".$v[cantidad]."</TD>";
    ...
    function GetConsultaSubmodulo($Paramdatos, $ParamTipo)
    {
          ...
          switch($ParamTipo)
          {
			...
			if(!empty($Plan)){
               ...
               $query= "SELECT a.hc_os_solicitud_id, a.cantidad, a.evolucion_id,
               			 a.cargo, b.descripcion, d.fecha, e.especialidad, 
                               e.observacion, d.ingreso, g.sw_cantidad
                               $criterio
                         FROM hc_os_solicitudes a 
                         LEFT JOIN hc_os_solicitudes_interconsultas e ON(a.hc_os_solicitud_id = e.hc_os_solicitud_id)
                         LEFT JOIN cups as g ON(a.cargo = g.cargo), especialidades b,
					hc_evoluciones d 
                         WHERE a.evolucion_id = d.evolucion_id 
                         AND d.evolucion_id = ".$Paramdatos[evolucion]."
