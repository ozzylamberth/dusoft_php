...
/**
* $Id: hc_MotivoConsulta_CDA.php,v 1.3 2005/06/07 16:57:54 tizziano Exp $
*/
...
* @package SIIS
*/ 
class MotivoConsulta_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    */     
    ...
    {
          $salida.="<caption>MOTIVOS DE CONSULTA Y ENFERMEDAD ACTUAL</caption>";
		foreach($XML_Consulta as $k => $v)
          {
               ...
               {
                    $salida.="<br></br>";
               	$salida.="<b>Motivo de Consulta: </b>".$v[1]."";
               }
               $salida.="</content>";
               $salida.="</paragraph>";
               ...
               {
               	$salida.="<br></br>";
               	$salida.="<b>Enfermedad Actual: </b>".$v[2]."";
               }
               $salida.="</content>";
               $salida.="</paragraph>";
               $salida.="</section>";
