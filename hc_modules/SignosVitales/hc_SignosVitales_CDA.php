...
/**
* $Id: hc_SignosVitales_CDA.php,v 1.1 2005/07/05 15:33:48 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo SignosVitales
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.1 $
* @package SIIS
*/ 
class SignosVitales_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    function GetXML_Local($XML_Consulta)
    {
		...
		{              
 			$FechaM = $this->FechaStamp($v[fecha_registro]);
               ...
               if($v[talla] == ''){$v[talla] = '--';}
               $salida.="<TD align=\"center\">".$v[talla]."</TD>";
          ...
          switch($ParamTipo)
          {
			...
			return $salida;
               ...
               $query = "SELECT A.taalta, A.tabaja, A.fc,
               			  A.temperatura, A.fr, A.peso,
                                A.talla, A.fecha_registro 
