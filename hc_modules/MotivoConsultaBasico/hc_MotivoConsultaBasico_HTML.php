...
// $Id: hc_MotivoConsultaBasico_HTML.php,v 1.15 2006/12/19 21:00:13 jgomez Exp $

class MotivoConsultaBasico_HTML extends MotivoConsultaBasico
{

	function MotivoConsultaBasico_HTML()
	{
	    $this->MotivoConsultaBasico();//constructor del padre
       	return true;
	}
...
//FIN DE IMPLEMENTACION
	...
	function frmReporte()
	{
		...
		if(!empty($motivos))
		{
			...
			$this->salida .="<td align=\"center\" colspan=\"2\">CONSOLIDADO MOTIVO DE CONSULTA ODONTOLOGICA</td>";
			$this->salida .="</tr>";
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[enfermedadactual]))
					{
						...
						$this->salida .="<tr class=\"hc_submodulo_list_claro\">";
						$this->salida .="<td class=\"hc_submodulo_list_claro\">&nbsp;</td>";
						$this->salida .="<td width='100%'><b>&nbsp;ENFERMEDAD ACTUAL  :</b>&nbsp;&nbsp;&nbsp;".$enfermedad."</td>";
						$this->salida .="</tr>";
					}
					$this->salida .="<tr>";
				}
	...
	function frmHistoria()
	{
		...
		if(!empty($motivos))
		{
			...
			$salida .="<td align=\"center\">MOTIVO DE CONSULTA ODONTOLOGICA</td>";
			$salida .="</tr>";
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[enfermedadactual]))
					{
						...
						$salida .="<tr class=\"hc_submodulo_list_claro\">";
						$salida .="<td class=\"hc_submodulo_list_claro\">&nbsp;</td>";
						$salida .="<td width='100%'><b>&nbsp;ENFERMEDAD ACTUAL  :</b>&nbsp;&nbsp;&nbsp;".$enfermedad."</td>";
						$salida .="</tr>";
					}
					$salida .="<tr>";
				}
	...
	function SetStyle($campo)
	{
     ...
     function Motivo_PrimeraVez()
     {
          $pfj=$this->frmPrefijo;
		$Primer_motivo = $this->GetMotivo_PrimeraVez();
		if($this->primera_Evo != $this->evolucion)
          {
               if(!empty($Primer_motivo))
               {
                    $this->salida .="<br><table width=\"85%\" border=\"0\" align=\"center\">";
                    $this->salida .="<tr class=\"modulo_table_title\">";
                    $this->salida .="<td align=\"center\" colspan=\"2\">CONSOLIDADO MOTIVO CONSULTA ODONTOLOGICA DE PRIMERA VEZ</td>";
                    $this->salida .="</tr>";
                    $this->salida .="<tr class=\"hc_table_submodulo_list_title\">";
                    $this->salida .="<td align=\"center\">FECHA</td>";
                    $this->salida .="<td align=\"center\">MOTIVO DE CONSULTA</td>";
               ...
               {
                    $this->salida.="<table width=\"100%\" border=\"0\" align=\"center\">";
                    $this->salida.="<tr  align=\"center\"><br><td><label class='label_mark'>EL PACIENTE NO TIENE REGISTRO DE MOTIVO DE CONSULTA DE PRIMERA CITA ODONTOLOGICA</label>";
                    $this->salida.="</td></tr>";
                    $this->salida.="</table>";
                    return false;
               }
	...
	function frmForma()
	{
		...
		{
			$this->salida = ThemeAbrirTablaSubModulo('MOTIVO DE CONSULTA ODONTOLOGICA');
		}
		else
		{
