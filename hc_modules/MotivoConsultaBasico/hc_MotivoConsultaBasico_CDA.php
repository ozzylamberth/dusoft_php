...
/**
* $Id: hc_MotivoConsultaBasico_CDA.php,v 1.1 2005/06/08 16:37:23 tizziano Exp $
*/
...
* @package SIIS
*/ 
class MotivoConsultaBasico_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    * @access public    
    */  
    function MotivoConsultaBasico_CDA()
    {
    ...
    */     
    ...
    {
          $salida.="<caption>MOTIVO DE CONSULTA ODONTOLOGICA</caption>";
