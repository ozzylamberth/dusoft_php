...
// $Id: hc_AntecedentesHistoria_HTML.php,v 1.1 2007/11/30 20:35:35 tizziano Exp $

class AntecedentesHistoria_HTML extends AntecedentesHistoria
{

	function AntecedentesHistoria_HTML()
	{
	    $this->AntecedentesHistoria();//constructor del padre
       	return true;
	}
...
//FIN DE IMPLEMENTACION
	...
	function frmReporte()
	{
		...
		if(!empty($motivos))
		{
			...
			$this->salida .="<td align=\"center\" colspan=\"2\">CONSOLIDADO ANTECEDENTES HISTORICOS</td>";
			$this->salida .="</tr>";
			$this->salida .="<tr class=\"hc_table_submodulo_list_title\">";
			$this->salida .="<td align=\"center\">FECHA</td>";
			$this->salida .="<td align=\"center\">ANTECEDENTES</td>";
			$this->salida .="</tr>";
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[descripcion]))
					{
						...
						$this->salida .="<td width='100%'><b>&nbsp;ANTECEDENTES :<br></b>".$motivo."</td>";
						$this->salida .="</tr>";
					}
					$this->salida .="<tr>";
				}
		...
		else
		{
			...
			$this->salida.="<tr  align=\"center\"><br><td><label class='label_mark'>NO SE HA REGISTRADO ANTECEDENTES EN ESTA EVOLUCION - ($this->evolucion).</label>";
			$this->salida.="</td></tr>";
			$this->salida.="</table>";
			return false;
		}
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[descripcion]))
					{
						...
						$this->salida .="<tr class=\"hc_submodulo_list_claro\">";
						$this->salida .="<td class=\"hc_submodulo_list_claro\">&nbsp;</td>";
						$this->salida .="<td width='100%'><b>&nbsp;ANTECEDENTES :</b>&nbsp;&nbsp;&nbsp;".$motivo."</td>";
						$this->salida .="</tr>";
					}
	...
	function frmHistoria()
	{
		...
		if(!empty($motivos))
		{
			...
			$salida .="<td align=\"center\">ANTECEDENTES</td>";
			$salida .="</tr>";
			...
			foreach($motivos as $k=>$v)
			{
				...
				foreach($v as $k2=>$vector){
					...
					if (!empty($vector[descripcion]))
					{
						...
						$salida .="<td width='100%'><b>&nbsp;ANTECEDENTES :</b>&nbsp;&nbsp;&nbsp;".$motivo."</td>";
						$salida .="</tr>";
					}
	...
	function frmForma()
	{
		...
		{
			$this->salida = ThemeAbrirTablaSubModulo('ANTECEDENTES - HISTORIA');
		}
		else
		{
		...
		$this->salida.="<tr class='modulo_table_title'>";
		$this->salida.="<td align='center'>ANTECEDENTES";
		$this->salida.="</td>";
		$this->salida.="</tr>";
		$this->salida.="<tr>";
