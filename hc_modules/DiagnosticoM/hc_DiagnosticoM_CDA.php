...
/**
* $Id: hc_DiagnosticoM_CDA.php,v 1.1 2005/06/09 16:50:56 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo DiagnosticoM
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.1 $
* @package SIIS
*/ 
class DiagnosticoM_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    */     
    ...
    {
          $salida.="<caption>DIAGNOSTICOS DE MUERTE</caption>";
