...
/**
* $Id: hc_AntecedentesPersonales_CDA.php,v 1.1 2005/06/20 22:18:21 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo AntecedentesPersonales
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.1 $
* @package SIIS
*/ 
class AntecedentesPersonales_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    * @access public    
    */  
    function AntecedentesPersonales_CDA()
    {
    ...
    */     
    ...
    {
          $salida.="<caption>ANTECEDENTES PERSONALES</caption>";
    ...
    function GetConsultaSubmodulo($Paramdatos, $ParamTipo)
    {
          ...
          switch($ParamTipo)
          {
               ...
               $query = "SELECT d.nombre_tipo, d.riesgo, c.detalle, c.destacar,
                         ...
                         JOIN hc_antecedentes_personales AS c ON(a.evolucion_id=c.evolucion_id)
                         ...
                         ORDER BY d.hc_tipo_antecedente_personal_id, d.hc_tipo_antecedente_detalle_personal_id;";
