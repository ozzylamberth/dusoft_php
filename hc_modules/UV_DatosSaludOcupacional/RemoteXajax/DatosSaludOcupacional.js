/**************************************************************************************
* $Id: DatosSaludOcupacional.js,v 1.1 2009/06/09 19:13:58 hugo Exp $ 
...
function MostrarDatosEspacio(tipo, identi)
{
    xajax_MostrarDatosEspacio(tipo, identi);
}
...
{ 
    if(ocupaciones=='-1')
    {
        document.getElementById('mensaje').innerHTML="DEBE SELECCIONAR UNA OCUPACION";
        return false;
    }
    else
    {
        xajax_GuardarInfoO(ocupaciones,tipo_id_paciente,paciente_id);
    }
...
{ 
    if(espacios_x=='-1')
    {
        document.getElementById('mensaje').innerHTML="DEBE SELECCIONAR UN ESPACIO";
        return false;
    }
    else
    {
        xajax_GuardarInfoE(espacios_x,tipo_id_paciente,paciente_id);
    }   
}
...
function recogerTeclas(evt)
{
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {
    //alert(":)");
    TablaCuentas(document.jukilo.tip_busq.value,document.jukilo.cuentaups.value,'1');
   } 
}   
