...
/**
* $Id: hc_DiagnosticoE_CDA.php,v 1.1 2005/06/09 16:50:03 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo DiagnosticoE
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.1 $
* @package SIIS
*/ 
class DiagnosticoE_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    */     
    ...
    {
          $salida.="<caption>DIAGNOSTICOS DE EGRESO</caption>";
		foreach($XML_Consulta as $k => $v)
          {
               $User=$this->GetDatosUsuarioSistema($v[5]);
               ...
               if($v[4] == '1'){$salida.="<TD width=\"10%\">ID</TD>";}
               elseif($v[4] == '2'){$salida.="<TD width=\"10%\">CN</TD>";}
