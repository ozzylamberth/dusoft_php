        ...
        $this->salida .= "</center><br>\n";
			...
			for($i=0;$i<sizeof($diag1);$i++)
			{
				...
				else
				{
					...
					$this->salida.="<td align=\"center\" width=\"10%\" colspan=\"2\" align=\"center\"><input type = checkbox name= 'opD".$pfj."[$i]' value = ".$diagnostico_id." onClick='AgregaDiagnostico(this);' title='Click para Agregar Diagnóstico de Egreso'></td>";
					$this->salida .= "</form>";
				}
