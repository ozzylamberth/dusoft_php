...
* @version 1.0
* @package SIIS
* $Id: hc_EvaluacionPreanestesica_Preanestesia.class.php,v 1.1 2007/11/06 15:09:49 tizziano Exp $
*/
...
class Preanestesia
{
     ...
     */
     function GetDatos_EvaluacionCardio()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_cardiovascular_d AS A,
                       hc_preanestesia_tipos_evaluacion_cardiovascular AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
          ...
          while(!$result->EOF)
          {
               $Vector['Detalle'][$result->fields[1]] = $result->GetRowAssoc($toUpper=false);
               $result->MoveNext();
          }
     ...
     */
     function GetDatos_EvaluacionRespiratorio()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_respiratorio_d AS A,
                       hc_preanestesia_tipos_evaluacion_respiratoria AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionMetabolica()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_metabolico_d AS A,
                       hc_preanestesia_tipos_evaluacion_metabolica AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionGastroIntestinal()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_gastro_d AS A,
                       hc_preanestesia_tipos_evaluacion_gastrointestinal AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionRenal()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_renal_d AS A,
                       hc_preanestesia_tipos_evaluacion_renal AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionNeurologica()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_neuro_d AS A,
                       hc_preanestesia_tipos_evaluacion_neurologico AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionEsqueletico()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_esqueletico_d AS A,
                       hc_preanestesia_tipos_evaluacion_esqueletico AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionHematologico()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_hematologico_d AS A,
                       hc_preanestesia_tipos_evaluacion_hematologico AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionHepatico()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_hepatico_d AS A,
                       hc_preanestesia_tipos_evaluacion_hepatico AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionGineco()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_gineco_d AS A,
                       hc_preanestesia_tipos_evaluacion_ginecos AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionIntubacion()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_intubacion_d AS A,
                       hc_preanestesia_tipos_evaluacion_intubacion AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
     ...
     */
     function GetDatos_EvaluacionOtrosFactores()
     {
          ...
          $Sql = "SELECT A.*, B.descripcion AS tipo_descripcion
                  FROM hc_preanestesia_descripciones_otros_d AS A,
                       hc_preanestesia_tipos_evaluacion_otros AS B
                  WHERE ingreso = ".SessionGetVar("Ingreso")."
                  AND A.opcion = B.tipo_evaluacion;";
