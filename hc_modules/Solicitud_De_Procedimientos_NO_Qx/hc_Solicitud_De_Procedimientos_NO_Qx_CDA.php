...
/**
* $Id: hc_Solicitud_De_Procedimientos_NO_Qx_CDA.php,v 1.1 2005/06/23 19:07:27 tizziano Exp $
*/

/**
* Clase para consulta CDA-HL7 del submodulo Solicitud_De_Procedimientos_NO_Qx
*
* @author Tizziano Perea <tperea@ipsoft-sa.com>
* @version $Revision: 1.1 $
* @package SIIS
*/ 
class Solicitud_De_Procedimientos_NO_Qx_CDA extends Extenciones_CDA_HC
{
    /**
    ...
    * @access public    
    */  
    function Solicitud_De_Procedimientos_NO_Qx_CDA()
    {
    ...
    */     
    ...
    {
          $salida.="<caption>SOLICITUD DE PROCEDIMIENTOS NO QUIRURGICOS</caption>";
          $xx = 0;
		foreach($XML_Consulta as $k => $v)
          {
               ...
               $salida.="<TD width=\"8%\" align=\"center\">".$v[cargo]."</TD>";
               $salida.="<TD width=\"46%\" align=\"justify\">".$v[descripcion]."</TD>";
               $salida.="<TD width=\"8%\" align=\"center\">".$v[cantidad]."</TD>";
               $FechaI = $this->FechaStamp($v[fecha]);
               $salida.="<TD width=\"8%\" align=\"center\">".$FechaI."</TD>";
               $salida.="</TR>";
               $salida.="</TBODY>";
               $salida.="</TABLE>";
          ...
          switch($ParamTipo)
          {
			...
			if(!empty($Plan)){
              ...
              $query="SELECT d.evolucion_id, d.ingreso, a.cargo, a.cantidad,
               ...
               while($sol_no_qx = $resultado->FetchRow())
               {
               	$XML_Consulta[] = $sol_no_qx;
               }
