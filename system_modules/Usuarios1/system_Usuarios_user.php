...
*/
    ...
    $consulta='1';
		$action=ModuloGetURL('system','Usuarios','user','ModificarUsuariosSistema',array("uid"=>$uid));
...
*/
	...
	function LlamaConfigUsuarioSistema(){
		$action=ModuloGetURL('system','Usuarios','user','InsertarConfig',array("uid"=>$uid));
...
function LlamaFormaModificarPasswd(){
    $action=ModuloGetURL('system','Usuarios','user','ModificarPasswd',array("uid"=>$uid));
