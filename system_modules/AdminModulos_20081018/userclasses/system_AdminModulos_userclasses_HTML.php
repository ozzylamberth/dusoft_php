<?php
	/********************************************************************************* 
 	* $Id: system_AdminModulos_userclasses_HTML.php,v 1.12 2005/11/09 14:21:51 hugo Exp $ 
 	*
	...
	class system_AdminModulos_userclasses_HTML extends system_AdminModulos_user
	{
		...
		*********************************************************************************/
		function FormaRegistrarModulo()
		{
			...
			$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Nombre Modulo: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\"><input type=\"text\" name=\"nombre_modulo\" class=\"input-text\" maxlength=\"64\" size=\"20\" value =\"".$this->NombreModulo."\"></td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Tipo Modulo: </td>\n";
			...
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Descripción: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			$this->salida .= "					<textarea class=\"textarea\" name=\"descripcion\" cols=\"45\" rows=\"5\">".$this->DescripcionModulo."</textarea>\n";
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Version: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			...
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Información de la Version: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			$this->salida .= "					<textarea class=\"textarea\" name=\"infoVersion\" cols=\"45\" rows=\"5\">".$this->InfoVersionModulo ."</textarea>\n";
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Disponibilidad del Modulo: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			...
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Maneja Funciones de Usuario: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			...
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Maneja Funciones de Administración: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
		...
		*********************************************************************************/
		function FormaIngresarMenu()
		{
			...
			$this->salida .= "		</table>\n";
			$this->salida .= "		<table cellspacing=\"2\"  cellpadding=\"3\"border=\"1\" width=\"60%\" align=\"center\">\n";
			$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Nombre Menu: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\"><input type=\"text\" name=\"nombre_menu\" class=\"input-text\" maxlength=\"32\" size=\"20\" value=\"".$this->NombreMenu."\"></td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Descripción: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			$this->salida .= "					<textarea class=\"textarea\" name=\"descripcion\" cols=\"45\" rows=\"4\">".$this->DescripcionMenu."</textarea>\n";
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Menu de Administración: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
		...
		*********************************************************************************/
		function FormaIngresarMenuItem()
		{
			...
			$this->salida .= "		</table>\n";
			$this->salida .= "		<table cellspacing=\"2\"  cellpadding=\"3\"border=\"1\" width=\"60%\" align=\"center\">\n";
			$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Titulo Menu: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\"><input type=\"text\" name=\"titulo_menu\" class=\"input-text\" maxlength=\"32\" size=\"20\" value=\"".$this->TituloMenu."\"></td></tr>\n";
			if($this->asociado !="NO")
			{
				$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Tipo Modulo: </td>\n";
				$this->salida .= "				<td class=\"modulo_list_claro\"></b>".$this->TipoModulo."<b></td></tr>\n";
				$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Modulo: </td>\n";
			...
			else
			{
				...
				{
					$texto = str_replace("/","--",$modulos[$i]);
					if($this->NombreModulo == $modulos[$i])
						$this->salida .= "					<option value=\"".$modulos[$i]."\" selected >".$texto."</option>\n";
					else
						$this->salida .= "					<option value=\"".$modulos[$i]."\">".$texto."</option>\n";
				}
				$this->salida .= "					</select></td></tr>\n";
			}
			
			$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Tipo: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			...
			$this->salida .= "					</select></td></tr>\n";
			$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Método: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\"><input type=\"text\" name=\"metodoNombre\" class=\"input-text\" maxlength=\"64\" size=\"20\" value=\"".$this->NombreMetodo."\"></td></tr>\n";
			$this->salida .= "			<tr>\n";
			$this->salida .= "				<td class=\"modulo_table_title\" width=\"50%\">Descripción: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\">\n";
			$this->salida .= "					<textarea class=\"textarea\" name=\"descripcion\" cols=\"45\" rows=\"4\">".$this->DescripcionMenuItem."</textarea>\n";
			$this->salida .= "				</td></tr>\n";
			$this->salida .= "			<tr><td class=\"modulo_table_title\" width=\"50%\">Indice de orden: </td>\n";
			$this->salida .= "				<td class=\"modulo_list_claro\"><input type=\"text\" name=\"indice\" class=\"input-text\" maxlength=\"5\" size=\"3\" value=\"".$this->IndiceDeOrden."\" onKeyPress='return acceptNum(event)'></td></tr>\n";			
			$this->salida .= "		</table>\n";
			if($this->asociado !="NO")
			{
				$this->salida .= "		<input type=\"hidden\" name=\"nombre_modulo\" value=\"".$this->NombreModulo."\">\n";
		...
		*********************************************************************************/
		function FormaMostrarMantenimientoMenus()
		{
			...
			$this->salida .= "			<table  align=\"center\" border=\"0\"  width=\"80%\">\n";
			$this->salida .= "				<tr class=\"modulo_table_list_title\">\n";  
			$this->salida .= "					<td align=\"center\" colspan=\"5\">BUSCADOR DE MENÚS</td>\n";
			$this->salida .= "				</tr>\n";
			$this->salida .= "				<tr class=\"hc_table_submodulo_list_title\">\n";
			$this->salida .= "					<td width=\"10%\">NOMBRE MENÜ:</td>\n";
			$this->salida .= "					<td width=\"25%\" align=\"center\">\n";
			$this->salida .= "						<input type=\"text\" class=\"input-text\" name=\"cadena_buscar\" size=\"40\" maxlength=\"40\" value =\"\" onKeyPress=\"document.formaBuscar.nuevaBusqueda.value='1'\">\n";
			$this->salida .= "					</td>\n";
			$this->salida .= "					<td  width=\"6%\" align=\"center\">\n";
            ...
            if(sizeof($Filas) > 0)
            {
				...
				$this->salida .= "				<td width=\"10%\"><b>CANTIDAD ITEMS</b></td>\n";
