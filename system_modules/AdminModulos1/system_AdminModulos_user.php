<?php
	/********************************************************************************* 
 	* $Id: system_AdminModulos_user.php,v 1.16 2005/11/09 15:30:29 hugo Exp $ 
 	* 
	...
	{	
	    ...
	    ********************************************************************************/
	    function EditarMenu()
	    {
			...
			{
				$this->Llamado = '3';
				$this->IdMenu = $result->fields[0];
				$this->NombreMenu = $result->fields[1];
				$this->SwSystemMenu = $result->fields[3];
				$this->DescripcionMenu = $result->fields[2];
	    ...
	    ********************************************************************************/
	    function MostrarItemsMenu()
	    {
	    	...
	    	$this->actionV = ModuloGetURL('system','AdminModulos','user',$this->metodo,
										  $this->ObtenerRequestMenuItem(0));
			$this->actionCrear = ModuloGetURL('system','AdminModulos','user','RegistrarMenuItem',
										  $this->ObtenerRequestMenuItem(1));
