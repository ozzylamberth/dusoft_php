...
/*funcion que visualiza los usuarios segun la identificación de una empresa*/
...
function FormaInsertarUsuarioSistema($nombreUsuario,$loginUsuario,$password,$passwordReal,$tema,$action,$consulta,$descripcion,$spia,$uid){
 ...
 /*	Listado de los modulos del sistema los cuales el Administrador podrá desactivarlos
	*	ó activarlos.
 */
