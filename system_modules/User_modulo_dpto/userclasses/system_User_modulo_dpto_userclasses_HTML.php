...
class system_User_modulo_dpto_userclasses_HTML extends system_User_modulo_dpto_user
{
	/**
  ...
  function system_User_modulo_dpto_user_HTML()
	{
		$this->salida='';
		$this->system_Administrador_user();
		return true;
	}
