...
*/
	...
	function RefrescarPantalla($mensaje='')
  {
    ...
    $this->salida .= "</div><br><br>\n";
		$action = ModuloGetURL('system','Usuario_Config','user','LlamaConfigUsuarioSistema');
		
    $this->salida .=  "\n\n<script language=\"javascript\">setTimeout(\"parent.frames.Cabecera.location ='Cabecera.php' \",1500);</script>\n\n";
    $this->salida .=  "\n\n<script language=\"javascript\">setTimeout(\"parent.frames.Contenido.location ='$action' \",1500);</script>\n\n";
