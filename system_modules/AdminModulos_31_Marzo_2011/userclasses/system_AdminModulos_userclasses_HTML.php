<?php
    ...
    */
      ...
      if(sizeof($Filas) > 0)
      {
				...
				$this->salida .= "			<tr class=\"modulo_table_list_title\">\n";
				$this->salida .= "				<td width=\"25%\"><b>NOMBRE VARIABLE</b></td>\n";
				$this->salida .= "				<td width=\"15%\"><b>VALOR</b></td>\n";
				$this->salida .= "				<td width=\"40%\"><b>DESCRIPCON</b></td>\n";
				$this->salida .= "				<td width=\"20%\" colspan=\"2\"><b>ACCIÓN</b></td>\n";
				$this->salida .= "			</tr>";
				$est = "modulo_list_oscuro";
        $bck = "#CCCCCC";
				foreach($Filas as $key => $detalle)
				{
					($est == "modulo_list_oscuro")? $est = "modulo_list_claro": $est = "modulo_list_oscuro";
					($bck == "#CCCCCC")? $bck = "#DDDDDD": $bck = "#CCCCCC";
		
					$this->salida .= "			<tr class=\"".$est."\" onmouseout=mOut(this,\"".$bck."\"); onmouseover=mOvr(this,'#FFFFFF');>\n";
					
					$actionLinkE = ModuloGetURL('system','AdminModulos','user','EditarVariables',
												 array("nombre_variable"=>$detalle['variable'],"offset"=>$this->paginaActual,"nombre_modulo"=>$_REQUEST['nombre_modulo'],"tipo_modulo"=>$_REQUEST['tipo_modulo'],
													 	   "metodo_retorno"=>$_REQUEST['metodo_retorno']));
					$actionLinkX = ModuloGetURL('system','AdminModulos','user','EliminarVariables',
												 array("nombre_variable"=>$detalle['variable'],"offset"=>$this->paginaActual,"nombre_modulo"=>$_REQUEST['nombre_modulo'],"tipo_modulo"=>$_REQUEST['tipo_modulo'],
													 	   "metodo_retorno"=>$_REQUEST['metodo_retorno']));
					
					$this->salida .= "      <td>".$detalle['variable']."</td>\n";
					$this->salida .= "      <td>".$detalle['valor']."</td>\n";
					$this->salida .= "      <td>".$detalle['descripcion']."</td>\n";
					$this->salida .= "			<td>\n";
					$this->salida .= "				<a href=\"".$actionLinkE."\">\n";
					$this->salida .= "				  <img border=\"0\" src=\"".GetThemePath()."/images/edita.png\">EDITAR\n";
          $this->salida .= "        </a>\n";
					$this->salida .= "			</td>\n";
					$this->salida .= "			<td>\n";
					$this->salida .= "			  <a href=\"".$actionLinkX."\">\n";
					$this->salida .= "					<img border=\"0\" src=\"".GetThemePath()."/images/elimina.png\">ELIMINAR\n";
          $this->salida .= "        </a>\n";
					$this->salida .= "			</td>\n";
					$this->salida .= "		</tr>\n";
				}		
