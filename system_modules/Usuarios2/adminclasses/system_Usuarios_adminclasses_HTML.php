...
*/
    ...
    $this->salida .= "				       <tr><td class=\"modulo_table_list_title\" class=\"label\" width=\"40%\" align=\"left\">NUMERO DE LOGUEOS: </td><td class=\"modulo_list_claro\" align=\"left\">$da</td></tr>";
		...
		$this->salida .= "				       <tr><td class=\"modulo_table_list_title\" class=\"label\" width=\"25%\" align=\"left\">ESTADO DEL USUARIO: </td><td class=\"modulo_list_claro\" align=\"left\">$estado&nbsp&nbsp;<img src=\"".GetThemePath()."/images/$img1\"></td></tr>";
		$datos=$this->ComboEmpresa();
		$this->salida .= "              <tr><td align=\"center\" class=\"modulo_list_claro\" class=\"label\" colspan=\"2\"><a href=\"$action\">$tipoBloqueo</a>&nbsp&nbsp;<img src=\"".GetThemePath()."/images/$img\">&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;<a href=\"$action_mod\">$tipoBlo&nbsp;&nbsp&nbsp;</a><img src=\"".GetThemePath()."/images/$estado_empresa\"></td></tr>";
		$this->salida .= "			         </table>";
		$this->salida .= "		           </fieldset></td></tr>";
		$this->salida .= "            </table><BR><BR>";
		$this->salida .= "			      </form>";
          ...
          $action4=ModuloGetURL('system','Usuarios','admin','AsignarPermisosUserModulo',array("uid"=>$uid,"empresa"=>$empresa,'dato'=>'2','usuario'=>$Usuario,'NombreUsuario'=>urlencode($NombreUsuario),'paso'=>$_REQUEST['paso'],'Of'=>$_REQUEST['Of'],'busqueda'=>$_REQUEST['busqueda']));
					...
					$this->salida.="<table  align=\"center\" border=\"0\"  width=\"70%\">";
					$this->salida.="<tr>";
					$this->salida.="<td align=\"center\" class=\"label_error\"><a href=".$action3.">ASIGNAR DEPARTAMENTOS</a></td><td align=\"center\" class=\"label_error\"><a href=".$action4.">ASIGNAR MODULOS ADMINSTRATIVOS</a></td>";
					$this->salida.="</tr>";
					$this->salida.="</table><br>";
...
/*funcion donde se encuentra todas las opciones del administrador de empresas*/
		function Menu()
 {
      //esta variable es la q ordena por el numero de usuario 'usuario_id'
			...
			unset($_SESSION['USUARIOS']['ORDENAMIENTO']);
			$this->salida.= ThemeAbrirTabla('MENÚ DE ADMINISTRACION SIIS');
      ...
      $this->salida.="<tr>";
			$this->salida .= "<td  colspan=\"2\"  class=\"modulo_list_oscuro\"  align=\"center\"><a href=\"$ax\">CREAR NUEVO USUARIO</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"".GetThemePath()."/images/nuevo_usuario.png\">";
			$this->salida.="</td>";
			$this->salida.="</tr>";
			$this->salida.="<tr>";
			$this->salida .= "<td  colspan=\"2\"  class=\"modulo_list_oscuro\"  align=\"center\"><a href=\"$acc\">PROPIEDADES DE USUARIOS</a>&nbsp;&nbsp;<img src=\"".GetThemePath()."/images/usuarios.png\">";
			$this->salida.="</td>";
			$this->salida.="</tr>";
			...
			$this->salida.="<tr>";
			$this->salida .= "<td   colspan=\"2\"  class=\"modulo_list_claro\"  align=\"center\"><a href=\"$action\">ASIGNAR PERFILES</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"".GetThemePath()."/images/pc.png\">";
			$this->salida.="</td>";
			$this->salida.="</tr>";
			$this->salida.="</table>";
            ...
            if(!empty($descripcion))
              ...
              $this->salida.="  <td></td>";
                  ...
                  //esto es el link de los iconos preguntar esto...despues a ver si asi queda solucionado.
									...
									$this->salida.="  <td class=\"$estilo2\" align=\"left\"><a href=\"".ModuloGetURL('system','Usuarios','admin','InsertarPermisoMenu',array('menu'=>$id,'uid'=>$uid,'usuario'=>$usuario,'nombre'=>$nombre,'descripcion'=>$descripcion,'paso'=>$_REQUEST['paso'],'Of'=>$_REQUEST['Of'],'busqueda'=>$_REQUEST['busqueda']))."\"><font color='black'>$menu</font></a></td>";
