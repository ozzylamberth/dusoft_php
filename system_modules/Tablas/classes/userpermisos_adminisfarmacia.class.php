<?php
  ...
  * @author Hugo F  Manrique
  */
  class userpermisos_adminisfarmacia extends Modelo
  {
    /**
    * Constructor de la clase
    */
    function userpermisos_adminisfarmacia()
    {
      $this->primarykey = array("usuario_id");
      $this->foreignkey = array("empresas"=>
                              array("empresa_id"=>"empresa_id"),
						  "system_usuarios"=>array("usuario_id"=>"usuario_id"),"centros_utilidad"=>array("centro_utilidad"=>"centro_utilidad")
                          );
    }
  }
?>