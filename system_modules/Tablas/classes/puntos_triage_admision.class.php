<?php
  ...
  * @author Hugo F  Manrique
  */
  class puntos_triage_admision extends Modelo
  {
    /**
    * Constructor de la clase
    */
    function puntos_triage_admision()
    { 
      $this->primarykey = array("punto_triage_id","punto_admision_id");
