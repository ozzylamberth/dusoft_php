...
/**
 * $Id: funciones_pagares.inc.php,v 1.12 2006/05/25 22:30:05 carlos Exp $
 ...
 */
	...
	//
		...
		$query = "SELECT SUM(B.total_abono) AS abono
									...
									WHERE A.empresa_id='$empresa'
												...
												AND A.prefijo_pagare=C.prefijo
	...
	function BuscarAbonosPagares($cuenta)
	{ 
		if(empty($cuenta))
		{
			return false;
		...
		$query = "SELECT 	B.recibo_caja,
									...
									WHERE A.empresa_id=C.empresa_id
												...
												AND A.centro_utilidad=B.centro_utilidad
												AND A.recibo_caja=B.recibo_caja
												AND A.prefijo_pagare=B.prefijo
