...
/**
 * $Id: hojacargos.inc.php,v 1.43 2007/09/20 14:03:52 carlos Exp $
...
/*  function InsumosCuentaC($cuenta,$noFacturado,$paquete)
  ...
  function DevolucionesProducto($cuenta,$noFacturado,$paquete)
  {
        ...
        $querys = " SELECT sum(a.cantidad), sum(a.valor_cargo), c.codigo_producto, 
										...
										--g.empresa_id,g.centro_utilidad,a.numerodecuenta, sum(a.valor_nocubierto), sum(a.valor_cubierto) 
                    ...
                    $filPaquete                    
										...
										--GROUP BY g.empresa_id,g.centro_utilidad,a.numerodecuenta,c.codigo_producto";
          ...
          for($i=0; $i<sizeof($ins);)
          {
              ...
              {   
                          ...
                          $precioUnitario=$ins[$h][precio];		
											...
											unset($medDevo[$ins[$k][empresa_id].$ins[$k][centro_utilidad].$ins[$k][idbodega].$ins[$k][codigo_producto]]);
