...
/**
** $Id: hojacargos2_COC.inc.php,v 1.1 2008/06/11 22:05:25 cahenao Exp $ 
**
**/  

/*
	function InsumosCuentaC2($cuenta,$noFacturado,$paquete)
  {
        if($paquete==1){
          if($noFacturado=='1'){
...
/*  
	function DevolucionesInsumosCuentaC2($cuenta,$noFacturado,$paquete)
  {
        if($paquete==1){
          if($noFacturado=='1'){
            $filFacturado=" AND a.sw_paquete_facturado='0'";
...
-- e.descripcion,
	...
	function DatosPrincipales2($cuenta)
	{
        list($dbconn) = GetDBconn();
				$query = "select count(*)
									from cuentas as a,
  ...
  function CargosFacturaHoja2($cuenta,$noFacturado,$paquete)
  {
  ...
  function GenerarHojaCargos2_COC($datos)
  {
      $_SESSION['REPORTES']['VARIABLE']='hoja_cargos';
			$dat=DatosPrincipales2($datos[numerodecuenta]);
      $_SESSION['REPORTES']['HOJACARGOS']['ARREGLO']=$dat;
      //IncludeLib("tarifario");
			IncludeLib("funciones_admision");
			IncludeLib("funciones_facturacion");
      $Dir="cache/hojacargos2_COC".$datos[numerodecuenta].".pdf";
      ...
      $var=CargosFacturaHoja2($datos[numerodecuenta]);
      ...
      for($i=0; $i<sizeof($var);)
      {
									...
									//				AND $var[$i][codigo_agrupamiento_id]==$var[$d][codigo_agrupamiento_id])
										//{
										            ...
										            $valpac=$var[$d][valor_nocubierto];
																$html.="<tr><td width=60>".FechaStamp($var[$d][fecha_cargo])."</td><td width=60 align='CENTER'>".$var[$d][cargo]."</td><td width=50 align=\"CENTER\">&nbsp;</td><td width=50 align=\"CENTER\">".$var[$d][departamento]."</td><td width=180>".substr($var[$x][desccargo],0,37)."</td><td width=20 align=\"CENTER\">&nbsp;</td><td width=40 align=CENTER>".$var[$d][cantidad]."</td><td width=60 align=\"CENTER\">".FormatoValor($var[$d][precio])."</td><td width=60 align=\"CENTER\">".FormatoValor($var[$d][valor_cargo])."</td><td width=60 align=\"CENTER\">".FormatoValor($var[$d][valor_cubierto])."</td><td width=60 align=\"CENTER\">".FormatoValor($valpac)."</td><td width=40 align=\"CENTER\">".$var[$d][transaccion]."</td><td width=40 align=\"CENTER\">".$var[$d][usuario]."</td></tr>";
						...
						elseif(empty($var[$i][codigo_agrupamiento_id]))
						{
								...
								$direc.="<tr><td width=60>".FechaStamp($var[$i][fecha_cargo])."</td><td width=60 align='CENTER'>".$var[$i][cargo]."</td><td width=50 align=\"CENTER\">&nbsp;</td><td width=50 align=\"CENTER\">".$var[$i][departamento]."</td><td width=180>".substr($var[$i][desccargo],0,37)."</td><td width=20 align=\"CENTER\">&nbsp;</td><td width=40 align=CENTER>".$var[$i][cantidad]."</td><td width=60 align=\"CENTER\">".FormatoValor($var[$i][precio])."</td><td width=60 align=\"CENTER\">".FormatoValor($var[$i][valor_cargo])."</td><td width=60 align=\"CENTER\">".FormatoValor($var[$i][valor_cubierto])."</td><td width=60 align=\"CENTER\">".FormatoValor($valpac)."</td><td width=40 align=\"CENTER\">".$var[$i][transaccion]."</td><td width=40 align=\"CENTER\">".$var[$i][usuario]."</td></tr>";
                //Esta parte se desarrollo para la impresion de las cadenas que son muy largas
                //y no se alcanzan a mostrar 
      ...
      //$html.=$direc;
			//-------------------	MEDICAMENTOS-----------------------------			
      $ins=InsumosCuentaC2($datos[numerodecuenta]);
      $totalins=0;
      if(!empty($ins))
      {
           $sub=0;
      ...
      $ins=DevolucionesInsumosCuentaC2($datos[numerodecuenta]);
      ...
      $var=CargosFacturaHoja2($datos[numerodecuenta],0,1);
      $ins=InsumosCuentaC2($datos[numerodecuenta],0,1);
      $totalins=0;
      $total=$descuentos=$pagado=0;
      $direc='';
      $totalcar=$totalins=0;
      ...
      //--------------DEVOLUCIONES MEDICAMENTOS----------------------
      $ins=DevolucionesInsumosCuentaC2($datos[numerodecuenta],0,1);
      $totalins=0;
      if(!empty($ins))
      {
           $devoluciones=0;
      ...
      if(!empty($caja))
      {
          ...
          for($i=0; $i<sizeof($caja); $i++)
          {
			...
			$dev = Devoluciones2($datos[numerodecuenta]);	
			if(!empty($dev))
			{						
      ...
      $html.="<tr><td width=150>CARGO A CUENTA DE: </td><td width=370>".$dat[nombre_tercero]."</td><td width=240 align=\"RIGHT\">".FormatoValor($dat[valor_total_empresa])."</td></tr>";
			...
			$var=CargosFacturaHoja2($datos[numerodecuenta],1);		
			$ins=InsumosCuentaC2($datos[numerodecuenta],1);	
			$insDev=DevolucionesInsumosCuentaC2($datos[numerodecuenta],1);			
			if(!empty($var)){
				$total=$descuentos=$pagado=0;
				$direc='';
				$totalcar=$totalins=0;
            ...
            if(($totalCadenas)>1){
              ...
              $inicioCad=37;                                                                    
              while($cont<($totalCadenas-1)){                                    
                $direc.="<tr><td width=60>&nbsp;</td><td width=60 align='CENTER'>&nbsp;</td><td width=50 align=\"CENTER\">&nbsp;</td><td width=50 align=\"CENTER\">&nbsp;</td><td width=180>".substr($var[$i][desccargo],$inicioCad,37)."</td><td width=20 align=\"CENTER\">&nbsp;</td><td width=40 align=CENTER>&nbps;</td><td width=60 align=\"CENTER\">&nbps;</td><td width=60 align=\"CENTER\">&nbps;</td><td width=60 align=\"CENTER\">&nbps;</td><td width=60 align=\"CENTER\">&nbps;</td><td width=40 align=\"CENTER\">&nbps;</td><td width=40 align=\"CENTER\">&nbps;</td></tr>";
                $cont++;
                $inicioCad+=37;                                    
              }
              $inicioCad=$inicioCad;                                                    
			...
			if($ins){	
				...
				for($i=0; $i<sizeof($ins);){
					...
					while($ins[$i][bodega]==$ins[$d][bodega]){
						...
						while($ins[$k][codigo_agrupamiento_id]==$ins[$d][codigo_agrupamiento_id]){
							$valpac=$ins[$k][valor_nocubierto];
							$html.="<tr><td width=60>".FechaStamp($ins[$k][fecha_cargo])."</td><td width=60 align='CENTER'>".$ins[$k][codigo_producto]."</td><td width=50 align=\"CENTER\">&nbsp;</td><td width=50 align=\"CENTER\">".$ins[$k][departamento]."</td><td width=180>".substr($ins[$k][descripcion],0,37)."</td><td width=20 align=\"CENTER\">&nbsp;</td><td width=40 align=CENTER>".FormatoValor($ins[$k][cantidad])." ".$ins[$k][unidad_venta]."</td><td width=60 align=\"CENTER\">0</td><td width=60 align=\"CENTER\">0</td><td width=60 align=\"CENTER\">0</td><td width=60 align=\"CENTER\">0</td><td width=40 align=\"CENTER\">".$ins[$k][transaccion]."</td><td width=40 align=\"CENTER\">".$ins[$k][usuario]."</td></tr>";
              //Esta parte se desarrollo para la impresion de las cadenas que son muy largas
              //y no se alcanzan a mostrar 
              if(strlen($ins[$k][descripcion])>37){                                                             
              $totalCadenas=(int)(strlen($ins[$k][descripcion])/37);
				...
				for($i=0; $i<sizeof($insDev);){
					...
					while($insDev[$i][bodega]==$insDev[$d][bodega]){
						...
						while($insDev[$k][codigo_agrupamiento_id]==$insDev[$d][codigo_agrupamiento_id]){
							...
							$html.="<tr><td width=60>".FechaStamp($insDev[$k][fecha_cargo])."</td><td width=60 align='CENTER'>".$insDev[$k][codigo_producto]."</td><td width=50 align=\"CENTER\">&nbsp;</td><td width=50 align=\"CENTER\">".$insDev[$k][departamento]."</td><td width=180>".substr($insDev[$k][descripcion],0,37)."</td><td width=20 align=\"CENTER\">&nbsp;</td><td width=40 align=CENTER>".FormatoValor($insDev[$k][cantidad])." ".$insDev[$k][unidad_venta]."</td><td width=60 align=\"CENTER\">0</td><td width=60 align=\"CENTER\">0</td><td width=60 align=\"CENTER\">0</td><td width=60 align=\"CENTER\">0</td><td width=40 align=\"CENTER\">".$insDev[$k][transaccion]."</td><td width=40 align=\"CENTER\">".$insDev[$k][usuario]."</td></tr>";
              //Esta parte se desarrollo para la impresion de las cadenas que son muy largas
              //y no se alcanzan a mostrar 
      ...
      $var=CargosFacturaHoja2($datos[numerodecuenta],1,1);
      $ins=InsumosCuentaC2($datos[numerodecuenta],1,1);
      $totalins=0;
      $total=$descuentos=$pagado=0;
      $direc='';
      $totalcar=$totalins=0;
      ...
      if(!empty($ins))
      {
          ...
          for($i=0; $i<sizeof($ins);)
          {
              ...
              while($ins[$i][bodega]==$ins[$d][bodega])
              {
                  ...
                  {
                      $valpac=$ins[$k][valor_nocubierto];
                      $html.="<tr><td width=60>".FechaStamp($ins[$k][fecha_cargo])."</td><td width=60 align='CENTER'>".$ins[$k][codigo_producto]."</td><td width=50 align=\"CENTER\">&nbsp;</td><td width=50 align=\"CENTER\">".$ins[$k][departamento]."</td><td width=180>".substr($ins[$k][descripcion],0,37)."</td><td width=20 align=\"CENTER\">&nbsp;</td><td width=40 align=CENTER>".FormatoValor($ins[$k][cantidad])." ".$ins[$k][unidad_venta]."</td><td width=60 align=\"CENTER\">".FormatoValor($ins[$k][precio])."</td><td width=60 align=\"CENTER\">".FormatoValor($ins[$k][valor_cargo])."</td><td width=60 align=\"CENTER\">".FormatoValor($ins[$k][valor_cubierto])."</td><td width=60 align=\"CENTER\">".FormatoValor($valpac)."</td><td width=40 align=\"CENTER\">".$ins[$k][transaccion]."</td><td width=40 align=\"CENTER\">".$ins[$k][usuario]."</td></tr>";
                      //Esta parte se desarrollo para la impresion de las cadenas que son muy largas
                      //y no se alcanzan a mostrar 
                      if(strlen($ins[$k][descripcion])>37){                                                             
                      $totalCadenas=(int)(strlen($ins[$k][descripcion])/37);
      ...
      //--------------DEVOLUCIONES MEDICAMENTOS----------------------
      $ins=DevolucionesInsumosCuentaC2($datos[numerodecuenta],1,1);
      $totalins=$devoluciones=0;
      if(!empty($ins))
      {
           $sub=0;
