...
/*		$html.="<TR>";
		...
		//$html.="<FONT SIZE='26'><b>RESOLUCIÓN 01915 28 MAY 2008</b></FONT>";
		//$html.="</TD>";
		//$html.="</TR>";
		//$html.="<TR>";
		//$html.="<TD ALIGN='CENTER' WIDTH='760'><br>";
...
$html.="<TD WIDTH='160' HEIGHT=25>".$datos['tipo_id_propietario']."".' Nro. Documento '."".$datos['propietario_id']."</TD>";
		...
		$html.="</TR>";
		$html.="<TABLE BORDER='1'><TR><PRE>                                                                                                                                                                                                                                                                                     Total Folios:        <TD width='13%' height='13%'>&nbsp;</TD><TD width='13%' height='13%'>&nbsp;</TD><TD width='13%' height='13%'>&nbsp;</TD></PRE></TR></TABLE>";
...
/*		if($datos['tipo_referencia'] == 'R')
		{
			$html.="<TD WIDTH='30' HEIGHT=25 ALIGN='LEFT'>R [X]</TD>";
			$html.="<TD WIDTH='30' HEIGHT=25 ALIGN='LEFT'>OS [ ]</TD>";
			UNSET($datos['fecha_os']);
			UNSET($datos['hora_os']);
			$datos['descentro_r'] = $datos['descentro'];
			UNSET($datos['descentro']);
			$datos['codigo_inscripcion_r'] = $datos['codigo_inscripcion'];
			UNSET($datos['codigo_inscripcion']);
			$datos['nombre_profesional_recibe_r'] = $datos['nombre_profesional_recibe'];
			UNSET($datos['nombre_profesional_recibe_r']);
			$datos['profesional_recibe_cargo_r'] = $datos['profesional_recibe_cargo'];
			UNSET($datos['profesional_recibe_cargo_r']);
			
		}else
		if($datos['tipo_referencia'] == 'OS')
		{
			$html.="<TD WIDTH='30' HEIGHT=25 ALIGN='LEFT'>R [ ]</TD>";
			$html.="<TD WIDTH='30' HEIGHT=25 ALIGN='LEFT'>OS [X]</TD>";
			UNSET($datos['fecha_recepcion_remision']);
			UNSET($datos['hora_recepcion_remision']);
			$datos['descentro_os'] = $datos['descentro'];
			UNSET($datos['descentro']);
			$datos['codigo_inscripcion_os'] = $datos['codigo_inscripcion'];
			UNSET($datos['codigo_inscripcion']);
			$datos['nombre_profesional_recibe_os'] = $datos['nombre_profesional_recibe'];
			UNSET($datos['nombre_profesional_recibe']);
			$datos['profesional_recibe_cargo_os'] = $datos['profesional_recibe_cargo'];
			UNSET($datos['profesional_recibe_cargo']);
		}*/
		$html.="</TR>";
		...
		$html.="<TR>";
		$html.="<TD WIDTH='150' HEIGHT=25><b>GASTOS MEDICO QUIRURGICOS</b></TD>";
...
/*		$html.="<TR>";
		$html.="<TD WIDTH='760' HEIGHT=25><b>----------------------------------------------------------------------------------------------------------------------</b></TD>";
		$html.="</TR>";*/
