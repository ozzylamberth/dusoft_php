...
/**
 * $Id: soat_ambulancia.inc.php,v 1.3 2006/12/15 15:13:49 carlos Exp $
 ...
 */
	...
	function GenerarSoatAmbulancia($datos)
	{
		...
		$html.="<TD ALIGN='CENTER' WIDTH='760'>";
			...
			$html.="</TR>";
			$html.="<TR>";
			$html.="<TD WIDTH='760' HEIGHT=22 ALIGN='LEFT'>(NOMBRE DEL PACIENTE) ".$datos['nombrpa']." CON ".$datos['pacient']." DE: ".$datos['lugar_expedicion_documento']."";
			$html.="</TD>";
			$html.="</TR>";
			$html.="<TR>";
