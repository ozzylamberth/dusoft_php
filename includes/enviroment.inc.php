<?php
/**
 * $Id: enviroment.inc.php,v 1.10 2006/11/29 21:59:50 alex Exp $
...
global $HTML2PS_DIR;
$HTML2PS_DIR = $ConfigAplication['DIR_SIIS'].'/classes/html2ps_pdf/';
//$HTML2PS_DIR = 'c:/Apache/www/public_html/';
...
if (!($dbconn->Connect($ConfigDB['dbhost'], $ConfigDB['dbuser'], $ConfigDB['dbpass'], $ConfigDB['dbname']))) {
    die(MsgOut("Error en la Conexi�n a la Base de Datos",$dbconn->ErrorMsg()));
}
...
//EJECUTAR EL GARBAGE DE LA APLICACION EN EL 10% DE LAS OCACIONES
