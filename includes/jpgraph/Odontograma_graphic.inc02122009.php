...
/**
 * $Id: Odontograma_graphic.inc.php,v 1.3 2009/11/23 14:14:32 hugo Exp $
...
/*  list($dbconn) = GetDBconn();
	...
	{
		$_ROOT='../../';
		include_once $_ROOT."classes/jpgraph-1.14/src/jpgraph.php";
		include_once $_ROOT."classes/jpgraph-1.14/src/jpgraph_line.php";
		include_once $_ROOT."classes/jpgraph-1.14/src/jpgraph_scatter.php";
		include_once $_ROOT."classes/jpgraph-1.14/src/jpgraph_canvas.php";//
		include_once $_ROOT."classes/jpgraph-1.14/src/jpgraph_scatter.php";
		include_once $_ROOT."classes/jpgraph-1.14/src/jpgraph_canvtools.php";//
	}
	else
	{
  ...
  if($tipodont==1)
   ...
   {
     $Dir=$_ROOT."cache/OdontoForense$seq.jpeg";
   }
...
//         $y+=50;
  ...
  function COT_LD($g,$y,$x,$tipo_problema)
  {
	if($tipo_problema=='100')//OBTURACION TEMPORAL
	{
		//arco superior interior
		$g->img->SetColor('red');
		//arco superior INTERIOR
		$g->img->filledArc($y+39,$x+50,25,25,303,-295);
		$g->img->SetColor('white');
		$g->img->filledArc($y+41,$x+49,17,20,310,-310);
	}
	else
	{
		$g->img->SetColor('red');
  ...
  function COT_S($g,$y,$x,$tipo_problema)
  {
	if($tipo_problema=='100')//OBTURACION TEMPORAL
	{
		//arco superior interior
/*		$g->img->SetColor('red');
		...
		*/
		$g->img->SetColor('red');
		$g->img->Ellipse($y+36,$x+30,25,12);
		//$g->img->filledArc($y+38,$x+33,30,13,-160,-15);
		//RELLENO SUPERIOR
		//$g->img->filledArc($y+20,$x+25,23,20,338,-307);
		//$g->img->filledArc($y+53,$x+28,23,20,-235,208);
	}
	else
	{
...
function COT_I($g,$y,$x,$tipo_problema)
{
	if($tipo_problema=='100')//OBTURACION TEMPORAL
	{
		$g->img->SetColor('red');
		$g->img->Ellipse($y+36,$x+69,25,12);
	}
	else
	{
...
function COT_SI($g,$y,$x,$tipo_problema)
{
	if($tipo_problema=='100')//OBTURACION TEMPORAL
	{
		//arco superior interior
		...
		$g->img->SetColor('white');
		$g->img->filledArc($y+35,$x+47,15,24,-125,-35);
	}
	else
	{
		//arco superior interior
...
function  COT_II($g,$y,$x,$tipo_problema)
{
	if($tipo_problema=='100')//OBTURACION TEMPORAL
	{
		//arco superior interior
		...
		$g->img->SetColor('white');
		$g->img->filledArc($y+37,$x+56,20,16,40,140);
	}
	else
	{
...
function Sellada_II($g,$y,$x,$cambiar)
{
 ...
 //SUPERFICIE POR SELLAR
  ...
  /************************************************/
  function COT_LI($g,$y,$x,$tipo_problema)
  {
	if($tipo_problema=='100')//OBTURACION TEMPORAL
	{
		//arco superior interior
		...
		$g->img->SetColor('white');
		$g->img->filledArc($y+28,$x+50,15,24,-262,260);
	}
	else
	{
		$g->img->SetColor('red');
...
/*      $txt="|";
  ...
  function SIO_C($g,$y,$x)//SUPERFICIE EN IONOMERO
  {
	$g->img->SetColor('blue');
	$g->img->Circle($y+35,50+$x,4);
	return $g;
  }
  
  function COT_C($g,$y,$x,$tipo_problema)
  {
	if($tipo_problema=='100')//OBTURACION TEMPORAL
	{
		//arco superior interior
		...
		$g->img->SetColor('white');
		$g->img->filledCircle($y+35,50+$x,3);
	}
	else
	{
...
//       $t->Stroke($g->img);
      $g->img->SetColor("red"); 
      $g->img->filledCircle($y+36,$x+29,4);
    }
    return $g;
  }
...
/*      $txt="///";
      ...
      $t->Stroke($g->img);*/
      $g->img->SetColor("red"); 
      $g->img->filledCircle($y+35,$x+70,4);
    }
    return $g;
  }
...
//       $t->Stroke($g->img);
      $g->img->SetColor("red"); 
      $g->img->filledCircle($y+35,$x+39,4);
    }
    return $g;
  }
...
/*      $txt="//";
      ...
      $t->Stroke($g->img);*/
      $g->img->SetColor("red"); 
      $g->img->filledCircle($y+43,$x+50,4);
    }
...
//       $t->Stroke($g->img);
      $g->img->SetColor("red"); 
      $g->img->filledCircle($y+35,$x+60,4);
    }
    return $g;
  }
...
//       $t->Stroke($g->img);
      $g->img->SetColor("red"); 
      $g->img->filledCircle($y+26,$x+50,4);
    }
    return $g;
  }
...
/*   if ($cambiar == '22' || $cambiar == '30')//PROTESIS FIJA POR CAMBIAR
  ...
  function Endodoncia_Por_Realizar($g,$y,$x,$tipo_problema)
  {
    if($tipo_problema=='6')
    {
     $numero = '1';
    ...
    if($tipo_problema=='101')
    {
     $numero = '2';
    }
    else
    if($tipo_problema=='102')
    {
     $numero = '3';
    }
    else
    if($tipo_problema=='103')
    {
     $numero = '4';
    }    
    
    $txt=$numero;
    $l = new Text($txt,$y+48,$x+5);
    $l->SetColor("red");
...
//     }
    $txt="N";
    $l = new Text($txt,$y+22,$x+33);
     if ($cambiar=='24')//Nucleo o Poste Por Cambiar
	$l->SetColor("red");
     else
	$l->SetColor("blue");
    $l->SetFont(FF_LUXIS,FS_NORMAL,32);
    $l->Stroke($g->img);
    return $g;
  }

  //Endodoncia Realizada
  function Endodoncia_Realizada($g,$y,$x,$Ndiente,$tipo_problema)
  {
    if($tipo_problema=='7')
    {
     $numero = '1';
    ...
    if($tipo_problema=='104')
    {
     $numero = '2';
    }
    else
    if($tipo_problema=='105')
    {
     $numero = '3';
    }
    else
    if($tipo_problema=='106')
    {
     $numero = '4';
    }    
    $txt=$numero;
  ...
  {
    $txt="RX";
    $l = new Text($txt,$y+30,$x+40);
    $l->SetColor("red");
    $l->SetFont(FF_LUXIS,FS_NORMAL,16);
    $l->Stroke($g->img);  
    return $g;
  }
 ...
 function Corona($g,$y,$x,$problema)
 {
  ...
  {
   $g->img->SetColor("red");
   $g->img->Circle($y+35,50+$x,26);
   $g->img->Circle($y+35,50+$x,25.9);
   $g->img->Circle($y+35,50+$x,25.8);
...
/*   $txt="";
 ...
 if ($cuadrante==3 || $cuadrante==7)
    ...
    //CARIES Y/O OBTURACION TEMPORAL O SUPERFICIE FRACTURADA
      if ($val[$x1][$y1+2]=='14' || $val[$x1][$y1+2]=='32' || $val[$x1][$y1+2]=='100')
      {
        $g=COT_S($g,$y,$x,$val[$x1][$y1+2]);
        $g=DibujarSano($g,$y,$x);
      }
      ...
      {
        $g = DibujarSano($g,$y,$x);
        $g = Generico_S($g,$y,$x,$val[$x1][$y1+2]);
      }
    }                                                 //PROBLEMA 30
    ...
    //CARIES Y/O OBTURACION TEMPORAL O SUPERFICIE FRACTURADA
      ...
      {
        $g = DibujarSano($g,$y,$x);
        $g = Generico_SI($g,$y,$x,$val[$x1][$y1+2]);
      }
    }                                                 //PROBLEMA 30
    ...
    if ($val[$x1][$y1+1]==$c4)
    {
      ...
      {
        $g = DibujarSano($g,$y,$x);
        $g = Generico_LD($g,$y,$x,$val[$x1][$y1+2]);
      }
    }                                                 //PROBLEMA 30
    ...
    {	 		//CARIES Y/O OBTURACION TEMPORAL O SUPERFICIE FRACTURADA
      ...
      {
        $g = DibujarSano($g,$y,$x);
        $g = Generico_II($g,$y,$x,$val[$x1][$y1+2]);
      }
    }                                                 //PROBLEMA 30
    ...
    if ($val[$x1][$y1+1]==$c6)
     ...
     if ($val[$x1][$y1+2]=='14' || $val[$x1][$y1+2]=='32' || $val[$x1][$y1+2]=='100')
      ...
      {
        $g = DibujarSano($g,$y,$x);
        $g = Generico_LI($g,$y,$x,$val[$x1][$y1+2]);
      }
    }                                                 //PROBLEMA 30
    ...
    {			//CARIES Y/O OBTURACION TEMPORAL O SUPERFICIE FRACTURADA  Ó SUPERFICIE EN IONÓMERO 
     if ($val[$x1][$y1+2]=='107')//SUPERFICIE EN IONÓMERO 
      {
        $g=SIO_C($g,$y,$x);//SUPERFICIE EN IONÓMERO 
        $g=DibujarSano($g,$y,$x);
      }
     if ($val[$x1][$y1+2]=='14' || $val[$x1][$y1+2]=='32' || $val[$x1][$y1+2]=='100')
      {
        $g=COT_C($g,$y,$x,$val[$x1][$y1+2]);
        $g=DibujarSano($g,$y,$x);
      }
      if ($val[$x1][$y1+2]=='16' || $val[$x1][$y1+2]=='26')//26 RESINA, IONOÓMERO, CERÓMERO por cambiar))
      {
      ...
      {
        $g = DibujarSano($g,$y,$x);
        $g = Generico_C($g,$y,$x,$val[$x1][$y1+2]);
      }
    }                                                //PROBLEMA 30
    ...
    if ($val[$x1][$y1+1]=='11')
    {
      ...
      if ($val[$x1][$y1+2]=='6')
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Por_Realizar($g,$y,$x,$val[$x1][$y1+2]);
        $y+=50;
        }
      ...
      if ($val[$x1][$y1+2]=='7')//ENDODONCIA REALIZADA UNIRRADICULAR
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Realizada($g,$y,$x,$val[$x1][$y1],$val[$x1][$y1+2]);
        $y+=50;
        }
      if ($val[$x1][$y1+2]=='17')
        {
      ...
      if ($val[$x1][$y1+2]=='101')//ENDODONCIA POR REALIZAR BIRRADICUAR
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Por_Realizar($g,$y,$x,$val[$x1][$y1+2]);
        $y+=50;
        }
      if ($val[$x1][$y1+2]=='102')//ENDODONCIA POR REALIZAR MILTIRRADICUAR 3 CONDUCTOS
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Por_Realizar($g,$y,$x,$val[$x1][$y1+2]);
        $y+=50;
        }
      if ($val[$x1][$y1+2]=='103')//ENDODONCIA POR REALIZAR MULTIRRADICUAR 4 CONDUCTOS
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Por_Realizar($g,$y,$x,$val[$x1][$y1+2]);
        $y+=50;
        }
      if ($val[$x1][$y1+2]=='104')//ENDODONCIA REALIZADA BIRRADICULAR
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Realizada($g,$y,$x,$val[$x1][$y1],$val[$x1][$y1+2]);
        $y+=50;
        }
      if ($val[$x1][$y1+2]=='105')//ENDODONCIA REALIZADA MULTIRRADICULAR 3 CONDUCTOS
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Realizada($g,$y,$x,$val[$x1][$y1],$val[$x1][$y1+2]);
        $y+=50;
        }
      if ($val[$x1][$y1+2]=='106')//ENDODONCIA REALIZADA MULTIRRADICULAR 4 CONDUCTOS
        {
        $g=DibujarSano($g,$y,$x);
        $g=Endodoncia_Realizada($g,$y,$x,$val[$x1][$y1],$val[$x1][$y1+2]);
        $y+=50;
        }
      if ($val[$x1][$y1+2]=='108')//RX PERIAPICAL
        {
        $g=DibujarSano($g,$y,$x);
        $g=Rx($g,$y,$x);
        $y+=50;
...
//   $g->img->SetColor('white');
  ...
  /**
  * Funcion donde se pinta un hallazgo generico en la region inferior
  *
  */
  function Generico_I($g,$y,$x,$tipo_problema)
  {
  	$color = "";
  ...
  /**
  * Funcion donde se pinta un hallazgo generico en la region 
  * central
  *
  */
  function Generico_C($g,$y,$x,$tipo_problema)
  {
  	$color = "";
    switch($tipo_problema)
    {
  ...
  *
  */
  function Generico_LD($g,$y,$x,$tipo_problema)
  {
  	$color = "";
    switch($tipo_problema)
    {
  ...
  * lateral izquierda
  */
  function Generico_LI($g,$y,$x,$tipo_problema)
  {
  	$color = "";
    switch($tipo_problema)
    {
  ...
  * inferior interior
  */
  function Generico_II($g,$y,$x,$tipo_problema)
  {
  	$color = "";
    switch($tipo_problema)
    {
  ...
  * superior
  */
  function Generico_S($g,$y,$x,$tipo_problema)
  {
  	$color = "";
    switch($tipo_problema)
    {
  ...
  * superior interior
  */
  function Generico_SI($g,$y,$x,$tipo_problema)
  {
  	$color = "";
    switch($tipo_problema)
    {
