<?php
    ...
    class plan_coomeva_eps extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida='';

        function plan_coomeva_eps($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
