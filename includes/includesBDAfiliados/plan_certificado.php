<?php
    ...
    class plan_certificado extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida='';

        function plan_certificado($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
