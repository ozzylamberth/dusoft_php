...
/**
 * $Id: api.inc.php,v 1.28 2009/10/28 13:30:14 hugo Exp $
    ...
    switch ($contenedor) {
        ...
        case 'system':
            ...
            if (empty($directorio)) {
                ...
                if (strtolower($directorio) != "userclasses")
                    $carpeta = "";
...
function FormatoFecha($estilo) {
    ...
    switch ($estilo) {
        case 1:
            ...
            return $fecha;
            break;
        case 2: return strftime("%B %d de %Y");
            break;
        case 3: return date("d/m/Y");
            break;
        case 4: return date("Y/m/d");
            break;
        case 5: return date("d-m-Y");
            break;
        case 6: return date("Y-m-d");
            break;
    }
}
...
function FormatoValor($valor, $digitos, $punto = true) {
    $separador = ($punto) ? "." : "";
    if (!$digitos)
        $digitos = GetDigitosRedondeo();

    return (number_format($valor, $digitos, ',', $separador));
}
