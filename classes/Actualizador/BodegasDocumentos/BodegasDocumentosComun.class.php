...
class BodegasDocumentosComun
{
 ...
 /**
    ...
    * @access public
    */
    function AddItemDocTemporal($doc_tmp_id, $codigo_producto, $cantidad, $porcentaje_gravamen, $total_costo, $usuario_id=null,$fecha_venc,$lotec,$localizacion,$total_costo_ped,$valor_unitario)
    {
    ...
    */
    function Exec_CrearDocumento($doc_tmp_id, $sql_doc_datos_adicionales=null, $usuario_id=null,$adicionales)
    {
     ...
     // echo "jdoeeeeer";
        ...
        //Para Se movió antes para poder hacer un traslado
