<?php
/**
* $Id: tipo_doc_bodega_E003.class.php,v 1.1 2011/05/30 22:22:34 mauricio Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo E003(EGRESO POR PRESTAMOS)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class tipo_doc_bodega_E003 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_E003($bodegas_doc_id)
    {
    ...
    * @access public
    */
    function NewDocTemporal($observacion='', $coordinador_auxiliar=NULL,$control_interno=NULL,$fecha_selectivo=NULL, $usuario_id=null,$toma_fisica_id=null)
    {
