<?php
/**
* $Id: tipo_doc_bodega_E004.class.php,v 1.1.1.1 2010/08/25 22:28:45 hugo Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo E004(Compras directas)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1.1.1 $
* @package SIIS
*/
class tipo_doc_bodega_E004 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_E004($bodegas_doc_id)
    {
    ...
    */
    ...
    function NewDocTemporal($observacion='', $tipo_id_tercero,$tercero_id, $usuario_id=null,$doc_devolucion)
    {
      ...
      $todo_doc=explode("-",$doc_devolucion);
...
//print_r($sql);
    ...
    */
    function CrearDocumento($doc_tmp_id, $usuario_id=null)
    {
      ...
      $sql = "INSERT INTO inv_bodegas_movimiento_eg_dev_prestamos
              (
                  empresa_id,
                  prefijo,
                  numero,
