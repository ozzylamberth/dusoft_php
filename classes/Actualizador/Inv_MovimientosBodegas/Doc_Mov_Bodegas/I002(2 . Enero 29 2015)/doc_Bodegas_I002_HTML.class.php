...
class doc_bodegas_I002_HTML {
    ...
    function FormaDocNuevo($DATOS) {
        ...
        /*if($datosCabecera['prefijo_fi']=="")
            $salida .= "<script>alert('Este Documento NO tiene parametrizado el Prefijo FI');</script>";*/
        
        $salida .= ThemeAbrirTabla("TIPO DE DOCUMENTO-nuevo");
    ...
    function FormaDocEditar($DATOS) {
        ...
        $salida .= ThemeAbrirTabla("TIPO DE DOCUMENTO-editar");
        $salida .= $this->frmError['MensajeError'];
