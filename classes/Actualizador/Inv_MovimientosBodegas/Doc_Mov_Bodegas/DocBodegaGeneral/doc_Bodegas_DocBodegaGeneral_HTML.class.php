<?php
    /**************************************************************************************
    * $Id: doc_Bodegas_DocBodegaGeneral_HTML.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $
    *
...
class doc_Bodegas_DocBodegaGeneral_HTML
{
 function doc_Bodegas_DocBodegaGeneral_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file = 'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/DocBodegaGeneral/RemoteXajax/definirBodegas_DocBodegaGeneral.php';
     $objeto->SetXajax(array("Subtimit","CrearDocumentoFinalx","BorrarTmpAfirmativo1","MostrarProductox","Borrar","BorrarAjuste","GuardarPT","BuscarProducto2","BuscarProducto1","ObtenerPaginadoPro","GuardarTmpDoc","Cuadrar_ids_terceros","CrearUSA","Buscadorter","ObtenerPaginadoter","BuscarProducto12","Actualizartmp","Devolver","GuardarDevolucion"),$file,"ISO-8859-1");
...
function FormaDocEditar($DATOS)
{
      ...
      //var_dump($datos);
      if($datox['tipo_doc_bodega_id']=="I003")
      {
        $salida .=$this->ColocarProductos($DATOS['bodegas_doc_id'],$datos,$DATOS['doc_tmp_id']);
      }
      elseif($datox['tipo_movimiento']=='E')
      {
        $salida .=$this->ColocarProductos($DATOS['bodegas_doc_id'],$datos,$DATOS['doc_tmp_id']);
      }
      else
      {
        $salida .=$this->ColocarProductos2($DATOS['bodegas_doc_id'],$datos,$DATOS['doc_tmp_id']);
      }
...
***********************************************************************************/
  ...
  $salida .= "                    <tr>\n";
  $salida .= "                       <td rowspan='2' colspan='3' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "<fieldset>";
  ...
  $salida .= "                    </tr>\n";
  $salida .= "                    <tr>\n";
  $salida .= "                       <td  COLSPAN='6' align=\"center\" class=\"modulo_list_claro\">\n";                          //bodegas_doc_id, observacion, tipo_id_tercero,                                                                                                                 tercero_id, documento_compra, fecha_doc_compra
  $salida .="<input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value);\">";//
  $salida .= "                       </td>\n";
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
**********************************************************************************/
    ...
    $salida .= "                          <input type=\"hidden\" id=\"tipos_documentoz\" value=\"".$datos['tipo_movimiento']."\">\n";
    //$salida .= "                 <form name=\"jukilo\" action=\"\" method=\"post\">\n";
    ...
    $salida .= "                          <label id=\"ventanatabla\">DESCRIPCION</label>";
  ...
  $java = "javascript:MostrarCapa('ContenedorBus');Bus_Pro('".$datos['empresa_id']."','".$datos['centro_utilidad']."','".$datos['bodega']."','".$datos['tipo_movimiento']."','0','0','1');Iniciar4('BUSCAR PRODUCTO');Clear3000();\"";
  ...
  elseif($datos['tipo_movimiento']=='E')
  {
  ...
  { 
   ...
   $salida .= "             <input type=\"hidden\"  name=\"token\" id=\"tokenL\"  value=\"0\">\n";
   $salida .= "            </td>\n";
  }
  elseif($datos['tipo_movimiento']=='E')
  {
  ...
  //ECHO $datos['tipo_movimiento'];
  if($datos['tipo_movimiento']=='I')
  {
   //echo "siiiiiiiiiiiii";
   $salida .= "                          <input type=\"button\" id=\"nuevo\" value=\"SELECCIONAR PRODUCTO\" class=\"input-bottom\" onClick=\"javascript:GuardarProductoTemporal('".$bodegas_doc_id."','".$tmp_doc_id."',document.getElementById('codigo').value,document.getElementById('cantidad').value,'I',document.getElementById('costeno_val').value,'".UserGetUID()."',document.getElementById('fecha_venc').value,document.getElementById('lotec').value,'".$fecha_total."','".$datos['tipo_doc_bodega_id']."');\">";
  }
  elseif($datos['tipo_movimiento']=='E')
  {
    //ECHO "NOOOO"; 
    $salida .= "                          <input type=\"button\" id=\"nuevo\" value=\"SELECCIONAR PRODUCTO\" class=\"input-bottom\" onClick=\"javascript:GuardarProductoTemporal('".$bodegas_doc_id."','".$tmp_doc_id."',document.getElementById('codigo').value,document.getElementById('cantidad').value,'0',document.getElementById('costeno_val').value,'".UserGetUID()."',document.getElementById('fecha_venc').value,document.getElementById('lotec').value,'".$fecha_total."','".$datos['tipo_doc_bodega_id']."');\">";
  }
  $salida .= "                       </td>\n";
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
...
function ColocarProductos2($bodegas_doc_id,$datos,$tmp_doc_id)
 {
    $consulta = new MovBodegasSQL();
    $usuariotmp=$consulta->Consultausuaritmp($tmp_doc_id,$bodegas_doc_id);
    $devolucion=$consulta->ConsultaDevolucion_doc($datos['tipo_doc_bodega_id'],$tmp_doc_id);
...
**********************************************************************************/
    ...
    /****************************************************************************/
            ...
            $salida .= "                       <td width=\"35%\" align=\"center\">\n";
            $salida .= "                          TIPO DE BUSQUEDA";
            $salida .= "                          <select id=\"tip_bus\" name=\"tip_bus\" class=\"select\" onchange=\"Aplicar2(this.value)\">";
            $salida .= "                           <option value=\"1\" SELECTED>DESCRIPCION</option> \n";
            $salida .= "                           <option value=\"2\"># CODIGO</option> \n";
             if($parBusqueda['sw_codigobarras']==1)
              $salida .= "                         <option value=\"3\" SELECTED>CODIGO DE BARRAS</option> \n";
            ...
            $salida .= "                          DESCRIPCION";
            $salida .= "                         <input type=\"text\" class=\"input-text\" id=\"criterio\" name=\"criterio\" size=\"30\" onkeypress=\"return acceptm(event);\" onkeydown=\"recogerTeclaBus1(event)\" value=\"\">\n";//
            $salida .= "                       </td>\n";
            $salida .= "                    </tr>\n";
            $salida .= "                </table>\n";
            //$salida .= "                </form>\n";
...
***********************************************************************************/
  ...
  $java = "javascript:MostrarCapa('ContenedorBus');Bus_Pro1('".$datos['empresa_id']."','".$datos['centro_utilidad']."','".$datos['bodega']."','".$datos['tipo_movimiento']."','0','0','1');Iniciar4('BUSCAR PRODUCTO');Clear3000();\"";
  $salida .= "                         <a title='BUSCADOR PRODUCTO' class=\"label_error\" href=\"".$java."\">\n";
  $salida .= "                          BUSCAR PRODUCTO\n";
  $salida .= "                         </a>\n";
  $salida .= "                       </td>\n";
 ...
 $salida .= "      <tr>\n";
  ...
  $salida .= "                       <td  ROWSPAN='3' id='unidad_pro' align=\"left\" class=\"modulo_list_claro\"> \n";
                                  ...
                                  $salida .= "                          <input type=\"text\" style=\"text-align:right\" id=\"op12\" size='12' class=\"input-text\" value=\"\" disabled onkeyup=\"Calcular(document.getElementById('costow').value,document.getElementById('cantidad').value,document.getElementById('gravamen').value,document.getElementById('op12').value);\"   onclick=\"Clear3000();\">\n"; /*onkeypress=\"return acceptNum(event);\"*/
                                  $salida .= "                       </td>\n";
                                  $salida .= "                    </tr>\n";
                                  $salida .= "                    <tr>\n";
                                  $salida .= "                       <td  align=\"left\" class=\"modulo_table_list_title\">\n";
...
//   $salida .= "                       </td>\n";
  ...
  $salida .= "                          <input type=\"button\" id=\"nuevo\" value=\"SELECCIONAR PRODUCTO\" class=\"input-bottom\" onClick=\"javascript:GuardarProductoTemporal2('".$bodegas_doc_id."','".$tmp_doc_id."',document.getElementById('codigo').value,document.getElementById('cantidad').value,document.getElementById('gravamen').value,document.getElementById('op22').value,'".UserGetUID()."',document.getElementById('fecha_venc').value,document.getElementById('lotec').value,'".$fecha_total."','".$datos['tipo_doc_bodega_id']."');\">";//
  $salida .= "                       </td>\n";
  $salida .= "                    </tr>\n";
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
