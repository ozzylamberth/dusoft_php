/**************************************************************************************
* $Id: definirBodegas_DocBodegaGeneral.js,v 1.1 2009/07/17 19:08:17 johanna Exp $
...
function MostrarProductoxjs(bodega_doc,tmp_doc_id,usuario)
{
  xajax_MostrarProductox(bodega_doc,tmp_doc_id,usuario);
}
function Clear3000()
{
...
{  /*alert("aa"+codigo_producto);
  alert(doc_bodega_id);
   ...
   //var fecha_v=new Date(fecha_venc);
  /*$html .= "            f = objeto.fecha_fin_convenio.value.split('/')\n";
   ...
   //document.getElementById('fecha_venc').value
   //alert("Fecha Total:"+fecha_total);
   //alert("Fecha Vencimiento:"+fecha_venc);
 /*  fv=fecha_venc.split('-');
...
//    }
    ...
    xajax_GuardarPT(doc_bodega_id,doc_tmp_id,codigo_producto,cantidad,porcentaje_gravamen,cox,usuario_id,fecha_venc,lotec)
              ...
              //   $doc_tmp_id,                 $codigo_producto,                   $cantidad,                                       $porcentaje_gravamen,                           $total_costo,                   $usuario_id=null
function GuardarProductoTemporal2(doc_bodega_id,doc_tmp_id,codigo_producto,cantidad,porcentaje_gravamen,total_costo,usuario_id,fecha_venc,lotec,fecha_total)
{  /*alert("aa"+codigo_producto);
  alert(doc_bodega_id);
   alert(doc_tmp_id);
   alert("codigo"+codigo_producto);
  ...
  /* else if(fecha_venc < fecha_total)
   {
     document.getElementById('error_doc').innerHTML="FALTA INGRESAR FECHA DE VENCIMIENTO QUE SEA MAYOR";
     return false;
   }*/
...
function recogerTeclaBus(evt)
{
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {
     Bus_Pro(document.getElementById('empresa_idz').value,document.getElementById('centro_utilidadz').value,document.getElementById('bodegaz').value,document.getElementById('tipos_documentoz').value,document.getElementById('tip_bus').value,document.getElementById('criterio').value,1);
   }                                                                               //tipos_documentoz
}
...
function recogerTeclaBus1(evt)
{
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {
     Bus_Pro1(document.getElementById('empresa_idz').value,document.getElementById('centro_utilidadz').value,document.getElementById('bodegaz').value,document.getElementById('tipos_documentoz').value,document.getElementById('tip_bus').value,document.getElementById('criterio').value,1);
   }
}
...
*
******************************************************/
function AsignarPro2(codigo_producto,descripcion,descripcion_unidad)
{
...
function AsignarPro21(codigo_producto,descripcion,descripcion_unidad,fecha_vencimiento,lote)
{
...
function AsignarPro1(codigo_producto,descripcion,descripcion_unidad,costo,existencia,fecha_vencimiento,lote)
{
...
function Bus_Pro(empresa_id,centro_utilidad,bodega,tipo_movimiento,tip_bus,criterio,offset)
{

//alert(tipo_movimiento+'1ghj');
  if(tipo_movimiento=='I')
  {
   //alert("hola ingreso");
    xajax_BuscarProducto2(empresa_id,centro_utilidad,bodega,tipo_movimiento,tip_bus,criterio,offset);
  }
  if(tipo_movimiento=='E')
  {
    //alert("hola primero");
    xajax_BuscarProducto12(empresa_id,centro_utilidad,bodega,tipo_movimiento,tip_bus,criterio,offset);
  }

}

function Bus_Pro1(empresa_id,centro_utilidad,bodega,tipo_movimiento,tip_bus,criterio,offset)
{
//alert(tipo_movimiento);
  ...
  {
    //alert("hola segundo");
    xajax_BuscarProducto21(empresa_id,centro_utilidad,bodega,tipo_movimiento,tip_bus,criterio,offset);
  }
}
...
******************************************************/
  ...
  function Aplicar2(busqueda)
  {
    document.getElementById('criterio').value= "";
  }

/////////////////////////////////////
function GrabarDocumento(bodegas_doc_id, observacion)
{
...
//     alert(fecha_doc_compra);
  ...
  xajax_GuardarTmpDoc(bodegas_doc_id, observacion);
