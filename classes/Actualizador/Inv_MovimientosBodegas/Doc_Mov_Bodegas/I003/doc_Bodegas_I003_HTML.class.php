<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_I003_HTML.class.php,v 1.2 2011/06/14 19:58:06 mauricio Exp $ 
	* 
...
class doc_bodegas_I003_HTML
{
 function doc_bodegas_I003_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file ='app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I003/RemoteXajax/definirBodegas_I003.php';
...
***********************************************************************************/   
  ...
  $java = "javascript:MostrarCapa('ContenedorBus');Bus_Pro('".$datos['empresa_id']."','".$datos['centro_utilidad']."','".$datos['bodega']."','0','0','".$bodegas_doc_id."','".$tmp_doc_id."','1');Iniciar4('BUSCAR PRODUCTO');Clear3000();\"";
  ...
  $salida .= "      <input type=\"text\" readonly=\"true\" class=\"input-text\"  name=\"fecha_venc\" id=\"fecha_venc\" style=\"width:100%;height:100%\" >\n";
  ...
  $salida .= "     <input type=\"text\" class=\"input-text\"  name=\"lotec\" id=\"lotec\" style=\"width:100%;height:100%\" >\n";
