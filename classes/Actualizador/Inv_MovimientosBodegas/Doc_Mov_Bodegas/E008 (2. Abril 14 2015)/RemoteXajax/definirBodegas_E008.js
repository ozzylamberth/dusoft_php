/**************************************************************************************
* $Id: definirBodegas_E008.js,v 1.1.1.1 2010/08/25 22:28:40 hugo Exp $ 
...
function ActuFechayLote(Empresa_id,centro_utilidad,lote,codigo_producto)
{
  //alert(lote);
  xajax_ActualizarFechayLote(Empresa_id,centro_utilidad,lote,codigo_producto);
}
...
function MostrarProductoPedFarmjs(bodegas_doc_id,tmp_doc_id,usuario)
{ 
//alert(bodegas_doc_id);
//alert(tmp_doc_id);
  xajax_MostrarProductoPedFarm(bodegas_doc_id,tmp_doc_id,usuario);
}   
...
//GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('tipo_idfc').value,document.getElementById('pedido_farmacia').value);
function GrabarDocumento(bodegas_doc_id, observacion,tipo_id_farmaClie, pedido_farmacia,tipo_id_tercero, tercero_id,farmacia_id)
{
  ...
  //alert(farmacia_id);
    //alert(bodegas_doc_id+"bodega id");
//alert(observacion+"observacion");
//alert(tipo_id_farmaClie+"tipo_farma");
//alert(pedido_farmacia+"pedido_farmac");
//alert(farmacia_id);
  xajax_GuardarTmpDoc(bodegas_doc_id, observacion,tipo_id_farmaClie, pedido_farmacia,tipo_id_tercero, tercero_id,farmacia_id);
...
function recogerTeclaBus1(evt)
{
   ...
   //alert(xGetElementById('tmp_doc_id1').value);
   //BuscarProductos('1','0','0','".$tmp_doc_id."','".$bodegas_doc_id."','".$datos['empresa_id']."','".$datos['centro_utilidad']."')
		BuscarProductos('1',xGetElementById('tip_bus').value,xGetElementById('criterio').value,xGetElementById('tmp_doc_id1').value,xGetElementById('bodega_doc_id_').value,xGetElementById('empresa_idz').value,xGetElementById('centro_utilidadz').value,xGetElementById('identify').value);
	} 
}
/******************************************************
*
...
function BuscarProductos(pagina,parm1,parm2,doc_tmp_id,bodegas_doc_id,empresa_id,centro_utilidad,identificador)
{
 //alert(xGetElementById('pagina').value);
   //alert(parm1);
   //alert(parm2);  
	xajax_ListadoProductos(pagina,parm1,parm2,doc_tmp_id,bodegas_doc_id,empresa_id,centro_utilidad,identificador);
}
//AgregarItem('$doc_tmp_id','".$valor['codigo_producto']."',xGetElementById('ucantidad$i').value,'".$valor['valor']."','".$valor['porc_iva']."','$bodegas_doc_id','checkear$i',document.getElementById('lote$i').value,document.getElementById('fecha_vencimiento').value,'".$valor['item_id']."')
  function AgregarItem(doc_tmp_id,codigo,can,valor,iva,bodegas_doc_id,capa,lote,fecha_vencimiento,ItemId,existencia_actual,identificador,cantidaSol,sw_requiereautorizacion_despachospedidos)
  {
    xajax_AgregarItem(doc_tmp_id,codigo,can,valor,iva,bodegas_doc_id,capa,lote,fecha_vencimiento,ItemId,existencia_actual,identificador,cantidaSol,sw_requiereautorizacion_despachospedidos);
  }
//('".$valor['codigo_producto']."','".$valor['descripcion']."',xGetElementById('ucantidad$i').value,'".$valor['solicitud_prod_a_bod_ppal_id']."','".$valor['lote']."','".$valor['fecha_vencimiento']."','".$doc_tmp_id."','".$bodegas_doc_id."')
function ActuPendiente(codigo_producto,descripcion,can,num_pedido,lote,fecha_vencimiento,doc_tmp_id,bodegas_doc_id)
{
  //alert(lote);
	//alert(localizacion);
  xajax_ActuPendiente(codigo_producto,descripcion,can,num_pedido,lote,fecha_vencimiento,doc_tmp_id,bodegas_doc_id);
...
function Bus_ter(criterio1,criterio2,criterio,div,forma,pagina)
{  
