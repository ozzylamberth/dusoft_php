<?php
    /**************************************************************************************
    * $Id: definirBodegas_I005.php,v 1.1 2009/07/17 19:08:20 johanna Exp $
...
function GuardarPT($bodegas_doc_id,$doc_tmp_id,$codigo_producto,$cantidad,$porcentaje_gravamen,$total_costo,$usuario_id,$fecha_venc,$lotec)
{
  ...
  $objResponse = new xajaxResponse();
  //$objResponse->alert("fecha_venc");
  $path = SessionGetVar("rutaImagenes");
  $consulta=new doc_bodegas_I005();
//var_dump($fecha_venc."fechasjksjsjd");
...
function BuscarProducto1($empresa_id,$centro_utilidad,$bodega,$tip_bus,$criterio,$offset)
{
   ...
   //echo $tip_bus;
    ...
    elseif($tip_bus==4)
    {
      $aumento2="AND e.descripcion ='".$criterio."'";
    }
    elseif($tip_bus==5)
    {
...
function GuardarTmpDoc($bodegas_doc_id, $observacion, $aprovechamiento,$departamento)
{
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $consulta=new MovBodegasSQL();
    $consulta1=new doc_bodegas_I005();
    $valor=$consulta1->CrearDoc($bodegas_doc_id, $observacion, $aprovechamiento,$departamento);
