<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_I006_HTML.class.php,v 1.1 2009/07/17 19:08:20 johanna Exp $ 
	* 
...
class doc_bodegas_I006_HTML
{
 function doc_bodegas_I006_HTML(){}
...
*********************************************************************************/ 
  ...
  {  //var_dump($DATOS);
     ...
     $file = 'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I006/RemoteXajax/definirBodegas_I006.php';
     $objeto->SetXajax(array("Subtimit","CrearDocumentoFinalx",
                             "BorrarTmpAfirmativo1","MostrarProductox",
                             "Borrar","BorrarAjuste","GuardarPT","ProductosDocumento",
                             "ObtenerPaginadoPro","GuardarTmpDoc","Cuadrar_ids_terceros",
                             "CrearUSA","Buscadorter","ObtenerPaginadoter","Departamento2",
                             "Municipios","Guardar_DYM","GuardarPersona","Actualizartmp",
                             "Devolver","GuardarDevolucion","AgregarItem",
                             "DevolucionprestamoTerce"),$file,"ISO-8859-1");
  ...
  function FormaDocNuevo($DATOS)
  {
    ...
    SessionSetVar("bodega",$DATOS['bodega']);
    
    //$documento_relacionado = $consulta->GetInfoDocTemporal($busqueda['bodegas_doc_id'],$busqueda['doc_tmp_id']);
 ...
 function PintarTabla($busqueda)
 {
   ...
   $salida .= "       <a title='DESCRIPCION DEL DOCUMENTO DEL TERCERO'>DOCUMENTO DEL TERCERO</a>";
   $salida .= "     </td>\n";
   $salida .= "   </tr>\n";
  ...
  // print_r($datos);
   ...
   $salida .= "         <a title='TERCERO'>IDENTIFICACION<a>";
   $salida .= "      </td>\n";
   $salida .= "      <td  align=\"left\" class=\"label_mark\">\n";
   $salida .= "          ".$datos['tipo_id_tercero']."-".$datos['tercero_id'];
   $salida .= "      </td>\n";
   $salida .= "      <td align=\"center\" class=\"modulo_table_list_title\">\n";
   $salida .= "         <a title='TERCERO'>NOMBRE<a>";
   $salida .= "      </td>\n";
   $salida .= "      <td align=\"left\" class=\"label_mark\">\n";
   $salida .= "          ".$datos['nombre_tercero'];
   $salida .= "      </td>\n";
   $salida .= "   </tr>\n";
   $salida .= "   <tr class=\"modulo_list_claro\">\n";
   $salida .= "      <td align=\"center\" class=\"modulo_table_list_title\">\n";
...
***********************************************************************************/   
  ...
  $salida .= "    <tr>\n"; 
  //$salida .= "     <td  width='13%' align=\"left\" class=\"modulo_table_list_title\">\n";
  $inv_devolu=$consulta->InvDevolDocumentos();
  $fecha_actual=date("Y/m/d");  
  $salida .= "      <td  width=\"15%\"COLSPAN='1' align=\"left\" class=\"modulo_table_list_title\">\n";
  $salida .= "       FECHA";
  $salida .= "      </td>\n"; 
  $salida .= "      <td width=\"15%\"COLSPAN='2' align=\"left\" class=\"modulo_list_claro\"> \n";
  $fecha=date("d-m-Y");
  $salida .= "       <input type=\"text\" value=\"".$fecha."\" class=\"input-text\" id=\"fecha1\" name=\"fecha1\" size=\"12\" onkeypress=\"return acceptNum(event)\">\n";
  ...
  $salida .= "      </td>\n";
  $salida .= "      <td width=\"15%\"COLSPAN='2' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                         <select id=\"doc_devolucion\" name=\"doc_devolucion\" class=\"select\" onchange=\"\">\n";
  ...
  $salida .= "    <tr>\n"; 
  $salida .= "     <td width=\"15%\"rowspan='2' colspan='6' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "     <fieldset>";
  ...
  $salida .= "        <input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('doc_devolucion').value,document.getElementById('fecha1').value,document.getElementById('tercerito_tip').value,document.getElementById('tercerito').value,'".$fecha_actual."');\">";//
  $salida .= "      </td>\n"; 
  $salida .= "     </tr>\n";
   $salida .= "     </tr>\n";
  $salida .= "   </table>";
...
*********************************************************************************/ 
  ...
  {      
    ...
    $javaC1.= "    capita.style.display = \"none\";\n";          
    $javaC1.= "}\n";                    
    $javaC1.= "function recargar()\n";
    $javaC1.= "{\n";
    $javaC1.= "    window.location.reload();\n";          
    $javaC1.= "}\n";                    
  ...
  ***********************************************************************************/   
  ...
  $salida .= " <br>";
   ...
   $salida .= "         </td>\n";
   $salida .= "         <td>\n";
   $salida .= "         <input type=\"text\" class=\"input-text\" onkeypress=\"return recogerTeclab(event);\" id=\"codigo_barras\" style=\"width:100%\">";
   $salida .= "         </td>\n";
   $salida .= "         <td class=\"modulo_table_list_title\">\n";
   $salida .= "         DESCRIPCION";
   $salida .= "         </td>\n";
   $salida .= "         <td>\n";
   $salida .= "         <input type=\"text\" class=\"input-text\" onkeypress=\"return recogerTeclab(event);\" id=\"descripcion\" style=\"width:100%\">";
   $salida .= "         </td>\n";
   $salida .= "      </tr>\n";
   $salida .= "     </table>";
    ...
    $salida .= "       </td>\n";
    $salida .= "       <td  ROWSPAN='3' id='unidad_pro' align=\"left\" class=\"modulo_list_claro\"COLSPAN='8'> \n";
  ...
  $salida .= "               </div>";
  /*$salida .= "        <script>";
  $salida .= "           xajax_ProductosDocumento(document.getElementById('empresa_id').value,document.getElementById('prefijo').value,document.getElementById('numero').value,'','','".$datos['bodegas_doc_id']."','".$tmp_doc_id."','1');";
  $salida .= "        </script>";*/
  for($i=0;$i<100;$i++)
