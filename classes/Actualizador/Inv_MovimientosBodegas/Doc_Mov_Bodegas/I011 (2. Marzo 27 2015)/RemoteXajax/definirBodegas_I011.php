...
{                       
    ...
    foreach($Novedades as $key=>$novedad)
      ...
      $salida .= "                  <tr class=\"modulo_table_list_title\">";
      $salida .= "                      <td>CODIGO</td><td>NOMBRE</td><td>CANTIDAD</td><td>LOTE</td><td>FECHA VENCIMIENTO</td><td>CANT. INGRESAR</td><td>NOVEDAD</td><td>OP</td>";
      $salida .= "                  </tr>";
      ...
      $salida .= "                    <input type=\"hidden\" name=\"valor".$producto['movimiento_id']."\" id=\"valor".$producto['movimiento_id']."\" value=\"".($producto['total_costo']/$producto['cantidad'])."\">";
