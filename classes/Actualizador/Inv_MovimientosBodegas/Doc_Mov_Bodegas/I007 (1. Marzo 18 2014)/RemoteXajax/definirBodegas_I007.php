...
{   $path = SessionGetVar("rutaImagenes");
  ...
  //$_REQUEST['DATOS']['prefijo_documento'],$_REQUEST['DATOS']['numero_documento']
  //print_r($_REQUEST);	
...
$salida .= "                  <table width=\"95%\" align=\"center\" class=\"modulo_table_list\">\n";         
               ...
               $salida .= "                    </tr>\n";         
                ...
                {   
                  ...
                  $salida .= "                         </a>\n";  
                  $salida .= "                      </td>\n"; 
                  $salida .= "                      <td align=\"center\" onclick=\"AsignarPro('".$busqueda[$i]['codigo_producto']."','".$busqueda[$i]['descripcion']."','".$busqueda[$i]['descripcion_unidad']."','".$busqueda[$i]['fecha_vencimiento']."','".$busqueda[$i]['lote']."');\">\n";
...
*********************************************************************************/
function Buscadorter($pagina,$criterio1,$criterio2,$criterio,$tipo_doc_general,$div,$Forma)
{ //echo "si";
      $objResponse = new xajaxResponse(); 
