  ...
  function SacarProductosTMP($doc_tmp_id,$usuario_id)//
   {
    ...
    function Productos_Formula($formula_papel,$empresa_id,$codigo_barras,$descripcion)
    {
	if($codigo_barras != "")
       ...
       $sql="select
			*
			from (   
			    ...
			    where
			         efe.formula_papel = '".$formula_papel."'
    ...
    function Formula_Buscada($formula_papel,$empresa_id)
    {
       $sql="    select
			    efe.formula_papel,
			    efe.formula_id,
