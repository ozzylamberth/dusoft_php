<?php
  /******************************************************************************
  * $Id: doc_Bodegas_E001.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $
  ...
  function SacarProductosTMP($doc_tmp_id,$usuario_id)//
   {
    ...
    function CrearDoc($bodegas_doc_id, $observacion,$perdida)
    {
       $ClassDOC= new BodegasDocumentos($bodegas_doc_id);
       $OBJETO=$ClassDOC->GetOBJ();
       $RETORNO=$OBJETO->NewDocTemporal($observacion,$perdida,UserGetUID());
    ...
    function ContarProStip($empresa_id,$centro_utilidad,$bodega,$aumento,$aumento2)
    {
     ...
     function GuardarTemporal($bodegas_doc_id,$doc_tmp_id, $codigo_producto, $cantidad, $porcentaje_gravamen, $total_costo, $usuario_id=null,$fecha_venc,$lotec,$valor_unitario)
     {
       $ClassDOC= new BodegasDocumentos($bodegas_doc_id);
       $OBJETO=$ClassDOC->GetOBJ();
       $RETORNO=$OBJETO->AddItemDocTemporal($doc_tmp_id,$codigo_producto,$cantidad,$porcentaje_gravamen,$total_costo,$usuario_id=null,$fecha_venc,$lotec,$localizacion = null,0,$valor_unitario);
       //var_dump($RETORNO);
       return $RETORNO;
     }
     function llamarhijo()
