/**************************************************************************************
* $Id: definirBodegas_E006.js,v 1.1 2009/07/17 19:08:17 johanna Exp $ 
...
function Activar()
{
 document.getElementById('depar').disabled=false;
...
document.getElementById('op22').value="";
              ...
              //   $doc_tmp_id,                 $codigo_producto,                   $cantidad,                                       $porcentaje_gravamen,                           $total_costo,                   $usuario_id=null
function GuardarProductoTemporal3500(doc_bodega_id,doc_tmp_id,codigo_producto,cantidad,porcentaje_gravamen,total_costo,usuario_id)
{  /*alert("aa"+codigo_producto);
  alert(doc_bodega_id);
   alert(doc_tmp_id);
   alert("codigo"+codigo_producto);
...
//GrabarDocumento(ById('obser').value,document.getElementById('depar').value)
function GrabarDocumento(bodegas_doc_id, observacion,depar,proyecto_id)
{
    ...
    // alert(perdida);
     ...
     if(depar==0)
     {
       document.getElementById('errorcreartmp').innerHTML="SE DEBE ELEGIR UN CENTRO DE UTILIDAD Y UN DEPARTAMENTO";
       return false;
     }
	 if(proyecto_id==0)
     {
       document.getElementById('errorcreartmp').innerHTML="SE DEBE ELEGIR UN PROYECTO";
       return false;
     }
...
//     alert(fecha_doc_compra);
  ...
  xajax_GuardarTmpDoc(bodegas_doc_id,observacion,depar,proyecto_id);
}
///////////////////////////////////////////
