<?php
	/**************************************************************************************
	* $Id: definirBodegas_E006.php,v 1.1 2009/07/17 19:08:17 johanna Exp $
...
********************************************************************************/
   //GuardarTmpDoc(bodegas_doc_id,observacion,depar);
function GuardarTmpDoc($bodegas_doc_id, $observacion,$depar,$proyecto_id)
{
    $objResponse = new xajaxResponse();
    $path = SessionGetVar("rutaImagenes");
    $consulta=new MovBodegasSQL();
    $consulta1=new doc_Bodegas_E006();
    $valor=$consulta1->CrearDoc($bodegas_doc_id, $observacion,$depar,$proyecto_id);
