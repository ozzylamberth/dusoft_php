<?php
    ...
    /*
      ...
      */
      ...
      //$dbconn->debug=true;
			...
			if ($dbconn->ErrorNo() != 0)
			{
				$this->frmError['MensajeError'] = "ERROR DB : " . $dbconn->ErrorMsg();"<b class=\"label\">".$this->frmError['MensajeError']."</b>";
				return false;
			}
			return $rst;
		}
 ...
 /*
  ...
  $sql .= " item_id = ".$ItemId." ";
    ...
    * @return token
    ***************************************************************************************/
    function IngresoAutorizacion($docs,$orden_pedido_id,$codigo_producto,$justificacion_ingreso,
                                       $usuario_id_autorizador,$usuario_id_autorizador_2,$observacion_autorizacion,
                                       $lote,$fecha_vencimiento,$cantidad,
                                       $fecha_ingreso,$porcentaje_gravamen,$valor_unitario_compra,
                                       $valor_unitario_factura,$total_costo,$empresa_id)
