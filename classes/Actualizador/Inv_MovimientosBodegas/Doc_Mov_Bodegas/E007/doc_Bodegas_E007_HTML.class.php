<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_E007_HTML.class.php,v 1.1 2009/07/17 19:08:17 johanna Exp $
	* 
...
include "app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E007/doc_Bodegas_E007.class.php";
...
class doc_bodegas_E007_HTML
{
 function doc_bodegas_E007_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file ='app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/E007/RemoteXajax/definirBodegas_E007.php';
     $objeto->SetXajax(array("PintarDptos","ventanas_tipo_egreso","Subtimit","CrearDocumentoFinalx","BorrarTmpAfirmativo1","MostrarProductox","Borrar","BorrarAjuste","GuardarPT","BuscarProducto1","ObtenerPaginadoPro","GuardarTmpDoc","Cuadrar_ids_terceros","CrearUSA","Buscadorter","ObtenerPaginadoter","Departamento2","Municipios","Guardar_DYM","GuardarPersona","Actualizartmp","Devolver","GuardarDevolucion"),$file,"ISO-8859-1");
     // print_r($DATOS);
...
//       var_dump($datox);
      ...
      $usuariotmp=$consulta1->Consultausuaritmp($datox['doc_tmp_id'],$datox['bodegas_doc_id']);
       ...
       if($estadosEmpresa['sw_estados']==1)
       {
         ...
         for($i=0;$i<$contar;$i++)
         {
          if($documentos[$i]['sw_verifico']==1)
           $k++;
          else
           $m++;
         }
         if($usuariotmp['usuario_id']==UserGetUID()&&$k==$contar)
         {
         ...
         {
          $salida .= "       <td id='MENGANO' align=\"center\"  colspan='7'>\n";
          $salida .= "          <input type=\"hidden\" id='enar' class=\"input-submit\" value=\"CREAR DOCUMENTO\" DISABLED onclick=\"CrearDocuFinal('".$DATOS['bodegas_doc_id']."','".$DATOS['doc_tmp_id']."','".$DATOS['tipo_doc_bodega_id']."');\">\n";
          $salida .= "       </td>\n";
         }
...
***********************************************************************************/   
  ...
  $salida .= "                         TIPO EGRESO";
  $pres=$consulta->Tipos_Egresos();
    if(!empty($pres))
    {
        
          $salida .= "                       <select id=\"egre\" name=\"egre\" class=\"select\" onchange=\"Sw_Ventanas(this.value);\">";
          $salida .= "                           <option value=\"0\" SELECTED>SELECCIONAR</option>\n"; 
          //var_dump($utility);
          for($i=0;$i<count($pres);$i++)
          {
            $datos=$pres[$i]['concepto_egreso_id']."-".$pres[$i]['sw_exige_tercero']."-".$pres[$i]['sw_exige_departamento']."-".$pres[$i]['sw_permite_costo_manual'];
            $salida .= "                      <option value=\"".$datos."\">".$pres[$i]['descripcion']."</option>\n";
          }
          $salida .= "                       </select>\n";
    }
  $salida .= "                       </td>\n";
  $salida .= "                    </tr>\n";
  $salida .= "                    </table>";
  $salida .= "                    <div id='terceros_docu' style=\"display:none;\">\n";
  $salida .= "                    <table width=\"65%\" align=\"center\" class=\"modulo_table_list\">\n";
  $salida .= "                    <tr>\n";
  ...
  $salida .= "                          <input type=\"hidden\" id=\"pide_tercero\" name=\"pide_tercero\" value=\"0\">\n";
  $salida .= "                          <input type=\"hidden\" id=\"pide_depar\" name=\"pide_depar\" value=\"0\">\n";
  $salida .= "                          <input type=\"hidden\" id=\"pide_costo\" name=\"pide_costo\" value=\"0\">\n";
  ...
  $salida .= "                   </table>\n";
  $salida .= "                  </div>\n";
  $salida .= "                    <div id='departamentos' style=\"display:none;\" >\n";
  $salida .= "                    <table width=\"65%\" align=\"center\" class=\"modulo_table_list\">\n";
  /*$salida .= "                      <tr>\n";
  $salida .= "                        <td rowspan='1' colspan='3' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                          CENTRO DE UTILIDAD";
  $perdida=$consulta->ColocarCentro2();
    if(!empty($perdida))
    {
          $salida .= "                       <select id=\"cent\" name=\"cent\" class=\"select\" onchange=\"PonerDptos(this.value);\">";
          $salida .= "                           <option value=\"0\" SELECTED>SELECCIONAR</option>\n"; 
          //var_dump($utility);
          for($i=0;$i<count($perdida);$i++)
          {
            $salida .= "                      <option value=\"".$perdida[$i]['centro_utilidad']."\">".$perdida[$i]['descripcion']."</option>\n";
          }
          $salida .= "                       </select>\n";
    }
  $salida .= "                       </td>\n";
  $salida .= "                      <td rowspan='1' id='deparx' colspan='3' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                    DEPARTAMENTO";
  $salida .= "                       <select id=\"depar\" name=\"depar\" class=\"select\" disabled>";
  $salida .= "                           <option value=\"0\" SELECTED>SELECCIONAR</option>\n";
  $salida .= "                       </select>\n";
  $salida .= "                       </td>\n";
  $salida .= "                    </tr>\n";*/
  ...
  $salida .= "                   </table>\n";
  $salida .= "                  </div>\n";
  $salida .= "                    <div id='manuales' style=\"display:none;\" >\n";
  $salida .= "                    <table width=\"65%\" align=\"center\" class=\"modulo_table_list\">\n";
  $salida .= "                      <tr>\n";
  $salida .= "                        <td rowspan='1' colspan='1' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                          UTILIZAR";

  $salida .= "                       </td>\n";
  $salida .= "                      <td rowspan='1' id='deparx' colspan='3' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                        COSTO PR0MEDIO";
  $salida .= "                        <input type=\"radio\" id=\"costo\" name=\"costo\" value=\"0\">\n";
  $salida .= "                      </td>\n";
  $salida .= "                      <td rowspan='1' id='deparx' colspan='3' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                        COSTO MANUAL";
  $salida .= "                        <input type=\"radio\" id=\"costo\" name=\"costo\" value=\"1\">\n";
  $salida .= "                      </td>\n";
  $salida .= "                    </tr>\n";
  $salida .= "                   </table>\n";
  $salida .= "                  </div>\n";
  ...
  $salida .= "                       </td>\n";
  $salida .= "                      <td rowspan='1' id='deparx1' colspan='1' align=\"left\" class=\"modulo_list_claro\"> \n";
  $salida .= "                       DEPARTAMENTO";
  $salida .= "                       <select id=\"depar\" name=\"depar\" class=\"select\" >";
  $salida .= "                           <option value=\"0\" SELECTED>SELECCIONAR</option>\n";
  $salida .= "                       </select>\n";
  $salida .= "                       </td>\n";
  $salida .= "                    </tr>\n";
  ...
  $salida .= "                         <input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('tipox_id').value,document.getElementById('id_tercerox').value,document.getElementById('egre').value,document.getElementById('depar').value);\">";//
  $salida .= "                       </td>\n"; 
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
***********************************************************************************/   
  ...
  $salida .= "                        COSTO";
  $salida .= "                       </td>\n";
  $sw_manus=$consulta->TraerSW(UserGetUID(), $tmp_doc_id);
  $salida .= "                       <td width='14%' id='costeno' align=\"center\" class=\"modulo_list_claro\">\n";
  if($sw_manus[0]['sw_costo_manual']=='1')
  {
    $salida .= "                          <input type=\"text\" id=\"costo_manual\" size='10' class=\"input-text\" value=\"\" onkeypress=\"return acceptNum(event);\" onclick=\"Clear3000();\">\n";
    $salida .= "                          <input type=\"hidden\" id=\"h_sw_manual\" value=\"1\">\n";
  }
  else
  {
    $salida .= "                         \n";
  ...
  $salida .= "                       </td>\n";
   if($sw_manus[0]['sw_costo_manual']=='0')
   {
     $salida .= "                          <input type=\"hidden\" id=\"h_sw_manual\" value=\"0\">\n";
   }
...
//   $salida .= "                       </td>\n";
  ...
  $salida .= "                       <td  COLSPAN='8' align=\"center\" class=\"modulo_list_claro\">\n";                          //                         $doc_tmp_id,                                            $codigo_producto,                     $cantidad,                                       $porcentaje_gravamen[document.getElementById('gravamen').value],$total_costo[document.getElementById('op22').value],                   $usuario_id=null
    if($sw_manus[0]['sw_costo_manual']=='1')
    {
        $salida .= "                          <input type=\"button\" id=\"nuevo\" value=\"SELECCIONAR PRODUCTO\" class=\"input-bottom\" onClick=\"javascript:GuardarProductoTemporal('".$bodegas_doc_id."','".$tmp_doc_id."',document.getElementById('codigo').value,document.getElementById('cantidad').value,'0',document.getElementById('costo_manual').value,'".UserGetUID()."',document.getElementById('fecha_venc').value,document.getElementById('lotec').value);\">";//

    }
    elseif($sw_manus[0]['sw_costo_manual']=='0')
    {
