<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_I015_HTML.class.php,v 1.1 2009/07/17 19:08:17 mauricio Exp $ 
	* 
...
class doc_bodegas_I015_HTML
{
 function doc_bodegas_I015_HTML(){}
...
{    //var_dump($DATOS);
     ...
     $file ='app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/I015/RemoteXajax/definirBodegas_I015.php';
...
function FormaDocEditar($DATOS)
{
      ...
      $datos = $consulta->TraerDatos($DATOS['bodegas_doc_id']);
      /*
      * Ingreso de Cabecera del Documento de Verificacion de los productos de Farmacia
      */
      /*$consulta ->InsertarCabeceraDocumentoVerificacionTmp($DocTemporal_Auxiliar);*/
...
***********************************************************************************/   
  ...
  $salida .= "                        FARMACIA ORIGEN:";
  $salida .= "                       </td>\n";
  $salida .= "                          <input type=\"hidden\" id=\"htmp_id\" name=\"htmp_id\" value=\"0\">\n";
  $salida .= "                          <input type=\"hidden\" id=\"farmacia_id\" name=\"farmacia_id\" class=\"input-text\" value=\"\">\n";
  $salida .= "                       <td  width='40%'  align=\"left\" class=\"modulo_list_claro\" id=\"farmacia\"> \n";
  $salida .= "                       </td>\n";
  $salida .= "                        <td width='20%' align=\"center\" class=\"modulo_list_claro\" class=\"normal_10AN\" >\n";
  $java = "javascript:MostrarCapa('ContenedorMov1');BuscarProveedor('ContenidoMov1','unocreate');Iniciar2('BUSCAR FARMACIA');\"";//
  $salida .= "                          <a  title=\"SELECIONAR FARMACIA\" class=\"label_error\" href=\"".$java."\">SELECCIONAR FARMACIA ORIGEN</a>\n";
  $salida .= "                        </td>";
  $salida .= "                    </tr>\n";
  $salida .= "                    <tr class=\"modulo_list_claro\">";
  ...
  $salida .= "                        DOCUMENTOS :";
  $salida .= "                    </td>";
  $salida .= "                    <td class=\"modulo_list_claro\" colspan=\"4\">";
  $salida .= "                    <select class=\"select\" id=\"DocumentosFarmacia\">";
  ...
  $salida .="<input type=\"button\" id=\"nuevo\" value=\"GRABAR DOCUMENTO\" class=\"input-bottom\" onClick=\"javascript:GrabarDocumento('".$bodegas_doc_id."',document.getElementById('obser').value,document.getElementById('farmacia_id').value,document.getElementById('DocumentosFarmacia').value);\">";//
  $salida .= "                       </td>\n"; 
  $salida .= "                    </tr>\n";
  $salida .= "                 </table>";
  $salida .= "              </form>";
...
function ColocarProductos($bodegas_doc_id,$datos,$tmp_doc_id,$empresa_id,$DocTemporal_Auxiliar,$DATOS)
 {
    ...
    $salida.= $javaC1;
    $salida .= "  <script>";
    $salida .= "	function ValidarCantidad(campo,valor,cant_sol,capa,capa_error,check)\n";
		$salida .= "	{\n";
		$salida .= "		document.getElementById(campo).style.background='';\n";
		$salida .= "		document.getElementById(capa_error).innerHTML='';\n";
		$salida .= "		document.getElementById(check).disabled=false;\n";
		...
		$salida .= "			document.getElementById(capa_error).innerHTML='<center>CANTIDAD NO VALIDA</center>';\n";
    $salida .= "		  document.getElementById(check).disabled=true;\n";
...
***********************************************************************************/   
  ...
  //print_r($DocTemporal_Auxiliar);
  /*
  Aqui se Ubicarán los Productos que Son Devueltos por la Farmacia
  */
  $salida .= "                 <table width=\"50%\" align=\"center\" class=\"modulo_table_list\">\n";
      $salida .= "                  <tr class=\"modulo_table_list_title\">";
      $salida .= "                      <td>FARMACIA ORIGEN:</TD><td class=\"modulo_list_claro\">".$DocTemporal_Auxiliar['farmacia_id']."-".$DocTemporal_Auxiliar['razon_social']."</td>";
      $salida .= "                  </tr>";
      $salida .= "                  <tr class=\"modulo_table_list_title\">";
      $salida .= "                      <td>PREFIJO :</TD><td class=\"modulo_list_claro\">".$DocTemporal_Auxiliar['prefijo']."</td>";
      $salida .= "                  </tr>";
      $salida .= "                  <tr class=\"modulo_table_list_title\">";
      $salida .= "                      <td>NUMERO :</TD><td class=\"modulo_list_claro\">".$DocTemporal_Auxiliar['numero']."</td>";
      $salida .= "                  </tr>";
      $salida .= "                </table>";
      $salida .= "                <br>";
      $salida .= "                 <table width=\"60%\" align=\"center\" class=\"modulo_table_list\">\n";
      ...
      $salida .= "                <input type=\"hidden\" id=\"farmacia_id\" value=\"".$DocTemporal_Auxiliar['farmacia_id']."\">";
      $salida .= "                <input type=\"hidden\" id=\"prefijo\" value=\"".$DocTemporal_Auxiliar['prefijo']."\">";
      $salida .= "                <input type=\"hidden\" id=\"numero\" value=\"".$DocTemporal_Auxiliar['numero']."\">";
      $salida .= "                <div id=\"ListadoProductos\"></div>";

  $salida .= "     <div id=\"ProductosFarmacia\"></div>";
