/**************************************************************************************
* $Id: definirBodegas_I015.js,v 1.1 2009/07/17 19:08:17 mauricio Exp $ 
...
function recogerTeclaBus(evt)
{
  ...
  if(keyCode==13)  //Si se pulsa enter da directamente el resultado
   {                                                         
     xajax_ListadoProductos_Farmacia_d(document.getElementById('bodegas_doc_id').value,document.getElementById('doc_tmp_id').value,document.getElementById('farmacia_id').value,document.getElementById('prefijo').value,document.getElementById('numero').value,document.getElementById('codigo_barras').value,document.getElementById('descripcion').value);
   }
}   
