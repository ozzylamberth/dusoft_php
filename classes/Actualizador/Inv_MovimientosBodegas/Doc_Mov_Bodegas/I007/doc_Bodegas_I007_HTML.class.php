...
//   $salida .= "                       </td>";
    ...
    <script language=\"javaScript\">
      function mOvr(src,clrOver) 
        ...
        $path = SessionGetVar("rutaImagenes");
        $salida .= "          <br>\n";
        $salida .= "    <div id='error_doc' class='' style=\"text-transform: uppercase; text-align:center;\"></div>\n";
        $salida .= "               <div id=\"ventana1\">\n";
        ...
        $salida .= "                       </td>\n";
        $salida .= "                       <td  align=\"left\" class=\"modulo_list_claro\"> \n";
        $salida .= "                          <input type=\"text\" id=\"cantidad\" size='10' class=\"input-text\" value=\"\" onkeypress=\"return acceptNum(event);\" onclick=\"limpiar200z();Clear3000();\" onkeyup=\"Calcular(document.getElementById('costow').value,document.getElementById('cantidad').value,document.getElementById('gravamen').value,document.getElementById('op11').value);\">\n";
        $salida .= "                       </td>\n";
        ...
        $salida .= "                       </td>\n";
        $salida .= "                       <td  COLSPAN='1' align=\"left\" class=\"modulo_list_claro\"> \n";
        $salida .= "                          <input type=\"text\" id=\"op11\"style=\"text-align:right\"  size='12' disabled  class=\"input-text\" onclick=\"Clear3000();\" value=\"\">\n"; /* onkeypress=\"return acceptNum(event);\" */
        $salida .= "                       </td>\n";
        $salida .= "                       <td  align=\"left\" class=\"modulo_table_list_title\">\n";
        $salida .= "                          <input type=\"radio\" disabled id=\"costow\" name=\"costow\" class=\"input-text\" value=\"12\" onclick=\"pintar(document.getElementById('costow').value);\">\n";
        $salida .= "                       </td>\n";
        ...
        $salida .= "                       </td>\n";
        $salida .= "                       <td  align=\"left\" class=\"modulo_table_list_title\">\n";
        $salida .= "                          <input type=\"radio\" disabled id=\"costow\" name=\"costow\" class=\"input-text\" value=\"21\" onclick=\"pintar(document.getElementById('costow').value);\" >\n";
        $salida .= "                       </td>\n";
        ...
        $salida .= "                       </td>\n";
        $salida .= "                       <td  align=\"left\" class=\"modulo_table_list_title\">\n";
        $salida .= "                          <input type=\"radio\" disabled id=\"costow\" name=\"costow\" class=\"input-text\" value=\"22\" onclick=\"pintar(document.getElementById('costow').value);\">\n";
        $salida .= "                       </td>\n";
        ...
        $salida .= "                       </td>\n";
        $salida .= "                       <td  align=\"left\" class=\"modulo_list_claro\"> \n";
        $salida .= "                          <input type=\"text\" id=\"gravamen\" size='10' disabled class=\"input-text\" value=\"\" onclick=\"limpiar200z();Clear3000();\" onkeypress=\"return acceptNum(event);\">&nbsp;% \n";
        $salida .= "                       </td>\n";
        $salida .= "                    </tr>\n";
