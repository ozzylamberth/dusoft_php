        ...
        //print_r($documentos);
         ...
         else
         {
          ...
          $salida .= "       </td>\n";
            ...
            $salida .= "       <td id='MENGANO' align=\"center\"  colspan='7'>\n";
            $salida .= "          <input type=\"button\" id='devolver' class=\"input-submit\" value=\"DEVOLVER\" onclick=\"Devolver('".$DATOS['tipo_doc_bodega_id'] ."','".$DATOS['doc_tmp_id']."','".$_SESSION['EMPRESAS']['empresa_id']."');\">\n";
            $salida .= "       </td>\n";
