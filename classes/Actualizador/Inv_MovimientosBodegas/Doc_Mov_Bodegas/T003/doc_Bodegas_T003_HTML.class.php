<?php
	/**************************************************************************************  
	* $Id: doc_Bodegas_T003_HTML.class.php,v 1.2 2010/07/07 15:40:25 hugo Exp $ 
	* 
...
class doc_Bodegas_T003_HTML
{
 function doc_Bodegas_T003_HTML(){}
...
*********************************************************************************/ 
    ...
    {    //var_dump($DATOS);
      ...
      $file = 'app_modules/Inv_MovimientosBodegas/Doc_Mov_Bodegas/T003/RemoteXajax/definirBodegas_T003.php';
...
***********************************************************************************/   
  ...
  $salida .= "                   <b>BODEGA DESTINO</b>";
  $utility=$consulta->ColocarCentro1($utilidad);
   // if(!empty($utility) && count($utility)>1)
    //{
          $salida .= "                       <select id=\"cen_des\" name=\"cen_des\" class=\"select\" onchange=\"PrepararBodegas('".$bodega."',this.value);\">";
