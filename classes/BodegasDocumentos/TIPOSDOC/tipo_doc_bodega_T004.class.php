<?php
/**
* $Id: tipo_doc_bodega_T004.class.php,v 1.1.1.1 2010/08/25 22:28:45 hugo Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo T004(TRASLADO DE BODEGA)
*
* @author Mauricio Medina -- mmedina@ipsoft-sa.com
* @version $Revision: 1.1.1.1 $
* @package SIIS
*/
class tipo_doc_bodega_T004 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    */
	var $mensajeDeError;
    function tipo_doc_bodega_T004($bodegas_doc_id)
    {
    ...
    * @access public
    */
    function NewDocTemporal($observacion='', $centro_utilidad_destino, $bodega_destino, $usuario_id=null,$Documento)
    {
        ...
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
            $this->mensajeDeError = "PARAMETROS NECERARIOS [centro_utilidad_destino, bodega_destino, documento] SON REQUERIDOS.";
            return false;
        }
		...
		list($centro,$bodega,$prefijo,$numero) = explode("@",$Documento);	
        //$bdconn->debug=true;
		$sql = "INSERT INTO inv_bodegas_movimiento_tmp
                ...
                INSERT INTO inv_bodegas_movimiento_traslados_esm_despacho_devolucion_tmp
                    (
                        usuario_id,
                        doc_tmp_id,
                        empresa_id,
...
//print_r($sql);
    ...
    function GetDocTemporal($doc_tmp_id, $usuario_id=null)
    {
        ...
        $sql="  SELECT  a.*,
                ...
                FROM
                    ...
                    LEFT JOIN inv_bodegas_movimiento_traslados_esm_despacho_devolucion_tmp as b
    ...
    */
    function CrearDocumento($doc_tmp_id, $usuario_id=null)
    {
		...
		$sql = "  INSERT INTO inv_bodegas_movimiento_traslados_esm_despacho_devolucion
                (
                    empresa_id,
                    prefijo,
                    numero,
                    centro_utilidad_destino,
                    bodega_destino,
                    prefijo_documento_devolucion,
                    numero_documento_devolucion
                )
                VALUES
                (
                    '%empresa_id%',
