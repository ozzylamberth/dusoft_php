<?php
/**
* $Id: tipo_doc_bodega_I007.class.php,v 1.1.1.1 2010/08/25 22:28:45 hugo Exp $
*/
...
class tipo_doc_bodega_I007 extends BodegasDocumentosComun
{
    ...
    * @access public
    */
    function NewDocTemporal($observacion='', $tipo_prestamo_id, $tipo_id_tercero, $tercero_id, $usuario_id=null,$tipo_tercero)
    {
       /*print_r($observacion."OBSERVACION");
        print_r($tipo_prestamo_id."PRESTAMO");
         print_r($tipo_id_tercero."TIPO DE TERCERO");
          print_r($tercero_id."TERCERO ID"); 
          print_r($tipo_tercero."TIPO DEL TERCERO");*/
        ...
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
            $this->mensajeDeError = "PARAMETRO NECERARIOS [ tipo_id_tercero, tercero_id,tipo_prestamo_id] SON REQUERIDOS.";
            return false;
        }
