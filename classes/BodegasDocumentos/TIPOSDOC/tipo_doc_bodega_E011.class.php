<?php
/**
* $Id: tipo_doc_bodega_E011.class.php,v 1.1 2009/07/27 20:47:55 johanna Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo E011(EGRESO POR PRESTAMOS)
*
* @author Mauricio Medina -- mmedina@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class tipo_doc_bodega_E011 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_E011($bodegas_doc_id)
    {
    ...
    */
    function NewDocTemporal($observacion='', $tipo_id_tercero,$tercero_id, $numero_factura,$empresa_id, $usuario_id=null)
    {
        ...
        $sql = "INSERT INTO inv_bodegas_movimiento_tmp
                ...
                INSERT INTO inv_bodegas_movimiento_tmp_devolucion_cliente
                    (
                        usuario_id,
                        doc_tmp_id,
                        tipo_id_tercero,
