...
class report_pos_driver_starSP200
{
    ...
    var $filtro = array ("ñ" => "\xA4",
                         ...
                         "\x7F"=>" ");
    //Constructor
    function report_pos_driver_starSP200($serie='SP200')
    {
        $this->serie = $serie;
        $this->salida = "";
    ...
    function PrintFTexto($text,$bold=false,$align='left',$redColor=false,$size=false,$char_relleno="\x7F")
    {
