...
/*ESTOS SON LOS PROPIOS DE LA APLICACIÓN*/
		elseif($format=='soat')
...
function Header()
{
		...
		if($_SESSION['REPORTES']['VARIABLE']=='factura')
		{
				...
				$html.="<tr><td width=460>".$datos[tipoid].": ".$datos[id]."</td><td width=300>No. ".$datos[prefijo]."".$datos[factura_fiscal]."</td></tr>";
		...
		if($_SESSION['REPORTES']['VARIABLE']=='hoja_cargos')
		{
				...
				$html.="<tr><td width=300>EMPRESA: ".$datos[nombre_tercero]."  ".$datos[tipo_id_tercero].": ".$datos[tercero_id]."</td><td width=30>&nbsp;</td><td width=430>PLAN: (".$datos[plan_id].")  ".  $datos[plan_descripcion]."</td></tr>";
				$html.="<tr><td width=760>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				$html.="<tr><td width=60 align=\"CENTER\">F CARGO</td><td width=60 align=\"CENTER\">CARGO</td><td width=50 align=\"CENTER\">HAB</td><td width=50 align=\"CENTER\">DPTO</td><td width=200 align=\"CENTER\">DESCRIPCION DEL CARGO</td><td width=40 align=\"CENTER\">CANT</td><td width=60 align=\"CENTER\">VALOR</td><td width=60 align=\"CENTER\">VALOR TOT</td><td width=60 align=\"CENTER\">VLR RECO</td><td width=60 align=\"CENTER\">VLR NO CUB</td><td width=60 align=\"CENTER\">TRAN</td></tr>";
				$html.="<tr><td width=760>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				$html.="</table>";
				$this->Ln(1);
				$this->WriteHTML($html);
		...
		if($_SESSION['REPORTES']['VARIABLE']=='hoja_transaccion')
		{
				...
				$html.="<tr><td width=760>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				$html.="<tr><td width=70 align=\"CENTER\">F CARGO</td><td width=70 align=\"CENTER\">CARGO</td><td width=50 align=\"CENTER\">HAB</td><td width=50 align=\"CENTER\">DPTO</td><td width=160 align=\"CENTER\">DESCRIPCION DEL CARGO</td><td width=20 align=\"CENTER\">N</td><td width=40 align=\"CENTER\">CANT</td><td width=60 align=\"CENTER\">VALOR</td><td width=60 align=\"CENTER\">VALOR TOT</td><td width=60 align=\"CENTER\">VLR RECO</td><td width=60 align=\"CENTER\">VLR PACI</td><td width=60 align=\"CENTER\">TRAN</td></tr>";
				$html.="<tr><td width=760>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				$html.="</table>";
				$this->Ln(1);
				$this->WriteHTML($html);
	...
	//caso de claudia liliana val
		...
		if($_SESSION['REPORTES']['VARIABLE']=='cierre_caja')
		{
				...
				$html .= "			<tr>";
				$TITULO='REPORTE DE CIERRE DE CAJA No :'." ".$datos_cierre[cierre_caja_id]."";
				$html.= "				<td width=780 ><font color='black' size=10><b>$TITULO</b></font></td>";
				$html.= "			</tr>";
		...
		if($_SESSION['REPORTES']['VARIABLE']=='solicitudes')
		{
			...
			$html.="<TD WIDTH='100' HEIGHT=25>HC:</TD>";
			...
			$html.="<TD WIDTH='100' HEIGHT=25>SEXO:</TD>";
   		...
   		$html.="<TD WIDTH='110' HEIGHT=25>FECHA SOLICITUD:</TD>";
			$html.="<TD WIDTH='270' HEIGHT=25>".date('d/m/Y')."</TD>";
			$html.="</TR>";
			$html.="<TR>";
		...
		if($_SESSION['REPORTES']['VARIABLE']=='incapacidad')
		{
			...
			/*$html.="<TR>";
			$html.="<TD ALIGN='LEFT' WIDTH='760' HEIGHT=25><b>SOLICITUD DE INCAPACIDADES Y/O LICENCIAS DE MATERNIDAD</b></TD>";
			$html.="</TR>";*/
			$this->WriteHTML($html);
			$html='';
			$this->SetFont('Arial','',8);
			...
			$html.="<TR>";
			$html.="<TD WIDTH='110' HEIGHT=25>PACIENTE: </TD>";
			$html.="<TD WIDTH='270' HEIGHT=25><b>".strtoupper($datos[0]['paciente'])."</b></TD>";
		...
		if ($_SESSION['REPORTES']['VARIABLE']=='orden_servicio')
		{
			...
			$html.="<TD WIDTH='270' HEIGHT=25>".$edad['anos'].' AÑOS'."</TD>";
   		$html.="<TD WIDTH='110' HEIGHT=25>FECHA SOLICITUD:</TD>";
			$html.="<TD WIDTH='270' HEIGHT=25>".$fechaSolicitud."</TD>";
			$html.="</TR>";
			$html.="<TR>";
			$html.="<TD WIDTH='110' HEIGHT=25>CLIENTE:</TD>";
			$cliente = $datos[0]['nombre_tercero'];
...
//darling envios
		...
		if ($_SESSION['REPORTES']['VARIABLE']=='incapacidad')
		{
     	...
     	$this->SetFont('Arial','',6);			
			/*$html.="<TABLE BORDER='0' WIDTH='1520'>";
			$html.="<tr><td WIDTH=760 align=\"CENTER\" HEIGHT=25>NOTA: 1:Documento no válido para descuentos en planillas de autoliquidacion de aportes,favor acerquese a S.O.S para su liquidación.</td></tr>";
			$html.="<tr><td WIDTH=760 align=\"CENTER\" HEIGHT=25>      2:La solicitud de licencia de maternidad requiere el certificado de nacido vivo, favor solicitarlo a su médico y adjuntarlo para su respectivo trámite.</td></tr>";
			$html.="</TABLE>";*/
			$this->WriteHTML($html);
		}
...
/*funcion que genera los rectangulos redondeados funcion añadida*/
function RoundedRect($x, $y, $w, $h,$r, $style = '')
    ...
    function _Arc($x1, $y1, $x2, $y2, $x3, $y3)
    {
        ...
        $this->_out(sprintf('%.2f %.2f %.2f %.2f %.2f %.2f c ', $x1*$this->k, ($h-$y1)*$this->k,
			...
			/*funcion añadida q deja una marca de agua en el formato*/
