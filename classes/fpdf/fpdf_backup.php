<?php
/*******************************************************************************
* $Id: fpdf.php,v 1.8 2010/12/06 22:12:21 hugo Exp $
* Software: FPDF                                                               *
* Version:  1.52                                                               *
* Date:     2003-12-30                                                         *
    ...
    function Header()
    {
    	if($_SESSION['REPORTES']['VARIABLE']=='envios')
      {
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='factura')
        {
				...
				$i=$_REQUEST['identificador']+1;
				
				list($dbconn) = GetDBconn();
				
				$query = "SELECT sw_imp_copia, estado from fac_facturas
					  WHERE prefijo='".$datos[prefijo]."'
        ...
        $estado=$result->fields[1];
                ...
                else
                {
                  ...
                  $factura_fiscal=str_pad($datos[factura_fiscal], $datos[numero_digitos], "0", STR_PAD_LEFT);
				  $this->image('images/logocliente.png',160,15,32);
				  $html.="<tr><td width=260><B>".$datos[razon_social]."</B></td><td width=120 align=\"left\"><B>".$datos[tipoid].": ".$datos[id]."</B></td></tr>";
				  $html.="<tr><td width=760 align=\"left\"><B>".$datos[centro_utilidad]."</B></td></tr>";
				  $html.="<tr><td width=300>&nbsp;</td><td width=210>&nbsp;</td><td width=170><B>FACTURA DE VENTA No. ".$datos[prefijo]."".$factura_fiscal."</B></td></tr>";
                  $html.="<tr><td width=300><B>DIRECCION: ".$datos[direccion]." </B></td><td width=280> <B>TELEFONOS: ".$datos[telefonos]."</B></td><td width=170><B>".$datos[municipio]."-".$datos[departamento]."</B></td></tr>";
                  $html.="<tr><td width=760 colspan=\"2\">".$datos[texto1]."</td></tr>";
                  /*$html.="<tr><td width=260><B>".$datos[razon_social]."</B></td><td width=120 align=\"left\">".$datos[tipoid].": ".$datos[id]."</td><td width=280 align='center'>FACTURA DE VENTAfdsfdsfsdf</td><td width=100>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
				...
				if($imp_copia=='1' AND $i==1 AND ($estado =='0' OR $estado =='1')){
					$this->SetFont('Arial','B',60);
					$this->SetTextColor(203,203,203);
					$this->RotatedText(30,210,'COPIA DE FACTURA',40);
					$this->SetTextColor(203,203,203);
					...
					if ($dbconn->ErrorNo() != 0) {
						$this->error = "Error al actualizar el estado de impresion de la factura";
						$this->mensajeDeError = "Error DB : " . $dbconn->ErrorMsg();
						return false;
					}
					$_REQUEST['identificador']=$i+1;			
				}
				$this->Ln(1);
                $this->WriteHTML($html);
        }
        if($_SESSION['REPORTES']['VARIABLE']=='facturapaciente')
        {
				...
				$html.="<tr><td width=260><B>".$datos[razon_social]."</B></td><td width=120 align=\"left\"><B>".$datos[tipoid].": ".$datos[id]."</B></td></tr>";
				$html.="<tr><td width=760 align=\"left\"><B>".$datos[centro_utilidad]."</B></td></tr>";
				$html.="<tr><td width=300>&nbsp;</td><td width=210>&nbsp;</td><td width=170 align=\"right\"><B>FACTURA DE VENTA No. ".$datos[prefijo]."".$factura_fiscal."</B></td></tr>";
                $html.="<tr><td width=300><B>DIRECCION: ".$datos[direccion]." </B></td><td width=280> <B>TELEFONOS: ".$datos[telefonos]."</B></td><td width=170 align=\"right\"><B>".$datos[municipio]."-".$datos[departamento]."</B></td></tr>";
                $html.="<tr><td width=760 colspan=\"2\">".$datos[texto1]."</td></tr>";
                /*$html.="<tr><td width=200><B>".$datos[razon_social]."</B></td>";
				$html.="<td width=180 align=\"left\">".$datos[tipoid].": ".$datos[id]."</td>";
				//$html.="<td width=280 align='center'>FACTURA DE VENTA</td>";
				$html.="<td width=280 align='center'>&nbsp;</td>";
				$html.="<td width=100>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
                //$html.="<tr><td width=460>".$datos[tipoid].": ".$datos[id]."</td><td width=300>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='facturaconcepto')
        {
                ...
                $html.="<table border=0 width=100 align='center' border=0>";
                $html.="<tr><td width=760><BR><BR></td></tr>";
                $html.="<tr><td width=460><B>".$datos[0][razon_social]."</B></td><td width=300 align='center'>FACTURA DE VENTADDDDD</td></tr>";
                ...
                else
                {
                  ...
                  $factura_fiscal=str_pad($datos[factura_fiscal], $datos[numero_digitos], "0", STR_PAD_LEFT);
                  $html.="<tr><td width=260><B>".$datos[razon_social]."</B></td><td width=120 align=\"left\">".$datos[tipoid].": ".$datos[id]."</td><td width=280 align='center'>FACTURA DE VENTANNN</td><td width=100>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
                  //$html.="<tr><td width=460>".$datos[tipoid].": ".$datos[id]."</td><td width=300>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
                  $html.="<tr><td width=380>DIRECCION: ".$datos[direccion]."</td><td width=210> TELEFONOS: ".$datos[telefonos]."</td><td width=170>".$datos[municipio]."-".$datos[departamento]."</td></tr>";
                  $html.="<tr><td width=760 colspan=\"2\">".substr("$datos[texto1]",0,90)."</td></tr>";
                  $html.="<tr><td width=760 colspan=\"2\" align='center'>".substr("$datos[texto1]",91,256)."</td></tr>";
...
/*              if(empty($_SESSION['TMP']['CONTROL_CIERRE']['DPTO']))
    ...
    //      $html.="<TD WIDTH='110' HEIGHT=25></TD>";
			...
			/*$PtoAtencion=BuscarPuntoAtencion($datos[0][tipo_id_paciente],$datos[0][paciente_id]);
			if(!empty($PtoAtencion))
			{
				$html.="<TR>";
				$html.="<TD ALIGN='LEFT' WIDTH='115' HEIGHT=25>PUNTO ATENCION: ";
				$html.="<TD ALIGN='LEFT' WIDTH='665' HEIGHT=25>".$PtoAtencion." ";
				$html.="</TD>";
				$html.="</TR>";
			}*/
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='formulacio_amb')
        {
            ...
            $html.="</TR>";
            $html.="<TR>";
            $html.="<TD ALIGN='LEFT' HEIGHT=22 WIDTH='90'>Diagnotico(s) : </TD>";
            $diagnostico_ingreso = '';
            $diagnostico_nombre = '';
            ...
            foreach ($datos[0][diagnostico_ingreso] as $k => $v)
            {
                ...
                {  $diagnostico_ingreso.= $v[diagnostico_id]; 
                   $diagnostico_nombre.= $v[diagnostico_nombre];
                }
                else
                {  $diagnostico_ingreso.= ' - '.$v[diagnostico_id]; 
                   $diagnostico_nombre.= $v[diagnostico_nombre];
            ...
            foreach ($datos[0][diagnostico_egreso] as $k => $v)
            {
                ...
                {  $diagnostico_egreso.= $v[diagnostico_id];
                   $diagnostico_nombre2.= $v[diagnostico_nombre];
                }
                else
                {  $diagnostico_egreso.= ' - '.$v[diagnostico_id]; 
                   $diagnostico_nombre2.= $v[diagnostico_nombre];
            ...
            $html.="<TD ALIGN='LEFT' HEIGHT=22 WIDTH='270'>".$diagnostico_ingreso."   ".$diagnostico_egreso." ".$diagnostico_nombre2."</TD>";
            $html.="<TD ALIGN='LEFT' HEIGHT=22 WIDTH='270'>".$diagnostico_nombre."  ".$diagnostico_nombre2."</TD>";
            $html.="</TR>";
            $html.="<TR>";
            ...
            $html.="<TD WIDTH='270' HEIGHT=22>".$edad['anos']." Anos</TD>";
            $html.="</TR>";
            $html.="<TR>";
...
*/
      ...
      if($_SESSION['REPORTES']['VARIABLE']=='factura_agrupada')
      {
		...
		$query = "SELECT  empresa_id 
                    FROM    fac_facturas
                    WHERE   factura_fiscal=".$datos[0][factura_fiscal]."
                    AND     prefijo='".$datos[0][prefijo]."'
                    LIMIT 2 OFFSET 0";
        ...
        $result->Close();
		$empresa_id = $result->fields[0];
		
        $this->SetFont('Arial','',7);
                //$this->Cell(0,2,'Pagina No '.$this->PageNo());
        //$this->image('images/logocliente.png',170,9,20);//$pdf->image('classes/fpdf/clinicaoccidente.gif'
        //$html ="<br><br><br>"; 
        $html.="<table border=0 width=100 align='center' border=0>";
        $html.="<tr><td width=760><BR><BR></td></tr>";
		...
		$this->image('images/logocliente.png',160,15,32);
		$html.="<tr><td width=260><B>".$datos[0][razon_social]."</B></td><td width=120 align=\"left\"><B>".$datos[0][tipoid].": ".$datos[0][id]."</B></td></tr>";
		$html.="<tr><td width=760 align=\"left\"><B>".$datos[0][centro_utilidad]."</B></td></tr>";
		$html.="<tr><td width=300>&nbsp;</td><td width=280>&nbsp;</td><td width=170 align=\"right\"><B>FACTURA DE VENTA No. ".$datos[0][prefijo]."".$factura_fiscal."</B></td></tr>";
        $html.="<tr><td width=300><B>DIRECCION: ".$datos[0][direccion]." </B></td><td width=280> <B>TELEFONOS: ".$datos[0][telefonos]."</B></td><td width=170 align=\"right\"><B>".$datos[0][municipio]."-".$datos[0][departamento]."</B></td></tr>";
        $html.="<tr><td width=760 colspan=\"2\">".$datos[0][texto1]."</td></tr>";
        ...
        $html.="<tr><td width=460>".$datos[0][tipo_id_tercero].": ".$datos[0][tercero_id]."</td></tr>";
		if(ModuloGetVar('','','MuestraPlan_FacturaAgrupada_'.$empresa_id) == '1')
		{
...
//darling envios
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='formulacio_amb')
        {
            ...
            $this->SetFont('Arial','',7);
                ...
                $this->Cell(0,10,'Caducidad Tres (3) dias calendario',0,0,"C");
