...
/*
	@package xajax
	@version $Id: xajaxResponse.inc.php,v 1.4 2007/09/20 15:06:30 jgomez Exp $
	...
	*/
	function _encodeArray(&$mData) {
		...
		return $aData;
            ...
            /**
    * Codificacion de las tildes
    *
    * @params string $string cadena a evaluar
    * @returns string cadena con las tildes codificadas
    **/
    function setTildes($string)
    {
        /*$array = array(   "� => "&#225;", "� => "&#233;", 
                                        "� => "&#237;", "� => "&#243;", 
                                        "" => "&#250;", "" => "&#252;", 
        ...
        {
            $string = str_replace ( utf8_encode($aguja_vieja), $aguja_nueva, $string );
        }*/
