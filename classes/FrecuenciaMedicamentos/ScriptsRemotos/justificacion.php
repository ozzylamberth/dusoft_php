<?php
	/**************************************************************************************
	* $Id: justificacion.php,v 1.4 2011/02/17 13:21:27 hugo Exp $ 
	...
	class procesos_admin extends rs_server
	{
		...
		*********************************************************************************/
		function BuscarDiagnosticos($arreglo)
		{
			...
			else
			{
				...
				$html .= $this->ObtenerPaginado($arreglo[2],$action,$path,1,10);
		...
		*********************************************************************************/
	    ...
	    $sql  = "SELECT diagnostico_id,";
			...
			$sql .= $where;
			$sql .= "ORDER BY diagnostico_nombre ";
		...
		*
		*********************************************************************************/
		function ObtenerPaginado($pagina,$action,$path,$op,$limite = null)
		{
