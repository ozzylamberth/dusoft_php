<?php
/*******************************************************************************
* $Id: fpdf.php,v 1.79 2008/07/18 15:13:24 julian Exp $
* Software: FPDF                                                               *
* Version:  1.52                                                               *
* Date:     2003-12-30                                                         *
...
function Header()
{
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='factura')
        {
                ...
                else
                {
                  ...
                  $html.="<tr><td width=260><B>".$razon_social."</B></td><td width=120 align=\"left\">".$datos[tipoid].": ".$datos[id]."</td><td width=280 align='center'>FACTURA CAMBIARIA DE COMPRAVENTA</td><td width=100>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
