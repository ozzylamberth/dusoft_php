<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: zipArchive.class.php,v 1.1 2009/02/03 16:04:40 hugo Exp $
  */
  /**
  * Clase: zipArchive
  *
  * ***** AlfaZoneSoft PHP program *****
	* [program]
	*   Function or script name: Zip Library
	*   Project:	Xerowon
	*   Maked: 2005 September - 2006 May
	*   Wrote: AlfaZonesoft, Szegedi Zoltán (Alias: Mágus, PHPMagus)
  ...
  *   http://www.pkware.com/business_and_developers/developer/popups/appnote.txt - .ZIP File Format Specification
	* [accessible]
	*   E-mail: magus@mailpont.hu, magus@root.hu, phpmagus@gmail.com
	*   Website: http://alfazonesoft.ath.cx
	*   MSN: magus@mailpont.hu
	* **** AlfaZoneSoft PHP program *****  
  *
  * @package IPSOFT-SIIS
  ...
  {  
    ...
    */
  	function downloadZip($filename) 
    {
      ...
      {
  			echo "<html><title>Archivo no encontrado</title><body><b>Error::</b> El archivo no fue encontrado.".$filename."</body></html>";
  			exit;
  		}
