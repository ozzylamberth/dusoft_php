<?php
	/********************************************************************************* 
 	* $Id: ClaseHTML.class.php,v 1.2 2010/06/03 20:44:31 hugo Exp $ 
 	*
	...
	* Clase en la que se ha implementado un paginador 
	...
	class ClaseHTML
	{
		...
		***********************************************************************/
		function ObtenerPaginado($TotalRegistros,$pagina,$action,$limite=null)
		{
		  if($action != "")
		  {
			  ...
			  if ($TotalRegistros > 0)
			  {
					...
					$aux = $TotalRegistros/$LimitRow - $NumeroPaginas;
					if($aux > 0) $NumeroPaginas++;
				  ...
				  if($Inicio <= 0)
				  {
					...
					if($NumeroPaginas > 1)
					{
						...
						for($i=$Inicio; $i< $Fin ; $i++)
						{
							...
							{
									$TablaPaginado .="		<td class=\"modulo_list_claro\" $estilo align=\"center\"><a href=\"".$action."&offset=".$i."\">".$i."</a></td>\n";
							}
							$columnas++;
						}
					}
					...
					$TablaPaginado .= "			P&aacute;gina&nbsp;".$pagina." de ".$NumeroPaginas."</td>\n";
		...
		/**
		* Funcion que realiza un paginado de los resultados de la consulta, para datos 
		* que se consultan por medio de un xajax
		* 
		* @param  TotalRegistros Numero de registros totales que hay 
		* @param  pagina 	Numero de pagina en la que esta actualmente 
		* @param  action 	funcion java script sin terminar 
		*									(ejem BuscarDatos(<param_1>,...<param_n> ),al final de esta 
		*									funcion se adicionara un ultimo parametro que representara el
		*									numero de la pagina siguiente y cerrara la funcion javascript
		* @param  limite	Limite del usuario
		* @param  $nombrecapa Nombre de la capa en la que se muestran los resultados, si la hay
		*
    * @return string 
		*/
		function ObtenerPaginadoXajax($TotalRegistros,$pagina,$action,$op,$limite = null,$nombrecapa)
		{
			$TablaPaginado = "";
        ...
        if($flag[1] != "") $action .= ",";
				...
				if($NumeroPaginas > 1)
				{
					...
					{
						$TablaPaginado .= "		<td class=\"label\" bgcolor=\"#D3DCE3\">\n";
						$TablaPaginado .= "			<a href=\"#".$nombrecapa."\" onclick=\"".$action."'1')\" title=\"primero\">\n";
						$TablaPaginado .= "			  <img src=\"".GetThemePath()."/images/primero.png\" border=\"0\" width=\"15\" height=\"15\">\n";
						$TablaPaginado .= "			</a>\n";
						$TablaPaginado .= "		</td>\n";
						$TablaPaginado .= "	  <td class=\"label\" bgcolor=\"#D3DCE3\">\n";
						$TablaPaginado .= "			<a href=\"#".$nombrecapa."\" onclick=\"".$action."".($pagina-1).")\" title=\"anterior\">\n";
						$TablaPaginado .= "			  <img src=\"".GetThemePath()."/images/anterior.png\" border=\"0\" width=\"15\" height=\"15\">\n";
						$TablaPaginado .= "			</a>\n";
						$TablaPaginado .= "		</td>\n";
						$columnas +=2;
					}
					...
					for($i=$Inicio; $i< $Fin ; $i++)
					{
						...
						{
							$TablaPaginado .= "		<td class=\"modulo_list_claro\" $estilo align=\"center\">\n";
              $TablaPaginado .= "     <a href=\"#".$nombrecapa."\" onclick=\"".$action." '".$i."')\">".$i."</a>\n";
              $TablaPaginado .= "   </td>\n";
						}
						$columnas++;
					}
				...
				{
					$TablaPaginado .= "		<td class=\"label\" bgcolor=\"#D3DCE3\">\n";
					$TablaPaginado .= "			<a href=\"#".$nombrecapa."\" onclick=\"".$action." '".($pagina+1)."')\" title=\"siguiente\">\n";
          $TablaPaginado .= "       <img src=\"".GetThemePath()."/images/siguiente.png\" border=\"0\" width=\"15\" height=\"15\">\n";
          $TablaPaginado .= "     </a>\n";
					$TablaPaginado .= "		</td>\n";
          $TablaPaginado .= "   <td class=\"label\" bgcolor=\"#D3DCE3\">\n";
					$TablaPaginado .= "			<a href=\"#".$nombrecapa."\" onclick=\"".$action." ".$NumeroPaginas.")\" title=\"ultimo\">\n";
          $TablaPaginado .= "       <img src=\"".GetThemePath()."/images/ultimo.png\" border=\"0\" width=\"15\" height=\"15\">\n";
          $TablaPaginado .= "     </a>\n";
					$TablaPaginado .= "		</td>\n";
					$columnas +=2;
				}
				$aviso .= "		<tr>\n";
        $aviso .= "     <td class=\"label\"  colspan=".$columnas." align=\"center\">\n";
				$aviso .= "			  P&aacute;gina&nbsp;".$pagina." de ".$NumeroPaginas."\n";
        $aviso .= "     </td>\n";
				$aviso .= "		</tr>\n";
