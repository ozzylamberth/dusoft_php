<?php
/*******************************************************************************
* $Id: fpdf.php,v 1.71 2007/07/17 16:40:15 carlos Exp $
* Software: FPDF                                                               *
* Version:  1.52                                                               *
* Date:     2003-12-30                                                         *
...
function Header()
{
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='factura')
        {
                ...
                else
                {
                  ...
                  $factura_fiscal=str_pad($datos[factura_fiscal], $datos[numero_digitos], "0", STR_PAD_LEFT);
                  $html.="<tr><td width=260><B>".$datos[razon_social]."</B></td><td width=120 align=\"left\">".$datos[tipoid].": ".$datos[id]."</td><td width=280 align='center'>FACTURA CAMBIARIA DE COMPRAVENTA</td><td width=100>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
                  //$html.="<tr><td width=460>".$datos[tipoid].": ".$datos[id]."</td><td width=300>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
                  $html.="<tr><td width=380>DIRECCION: ".$datos[direccion]."</td><td width=160> TELEFONOS: ".$datos[telefonos]."</td><td width=220>".$datos[municipio]."-".$datos[departamento]."</td></tr>";
                  ...
                  $html.="<tr><td width=760>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
                  $html.="<tr><td width=300><B>CLIENTE: ".$datos[nombre_tercero]."</B></td><td width=280>".$datos[tipo_id_tercero].": ".$datos[tercero_id]."</td><td width=180>DIRECCION: ".substr("$datos[direccion_tercero]",0,17)."</td></tr>";
		  $tmp_dir_tercero = substr("$datos[direccion_tercero]",17,45);
		  if(!empty($tmp_dir_tercero))
		  {
                  $html.="<tr><td width=300>&nbsp;</td><td width=280>&nbsp;</td><td width=180>".$tmp_dir_tercero."</td></tr>";
		  }
                  ...
                  $html.="<tr><td width=300>TELEFONOS: ".$datos[telefono_tercero]."</td><td width=280>PLAN: ".$datos[plan_descripcion]."</td><td width=180>DPTO: ".$datos[descripcion]."</td></tr>";
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='facturapaciente')
        {
                ...
                $factura_fiscal=str_pad($datos[factura_fiscal], $datos[numero_digitos], "0", STR_PAD_LEFT);
                $html.="<tr><td width=200><B>".$datos[razon_social]."</B></td><td width=180 align=\"left\">".$datos[tipoid].": ".$datos[id]."</td><td width=280 align='center'>FACTURA CAMBIARIA DE COMPRAVENTA</td><td width=100>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
                //$html.="<tr><td width=460>".$datos[tipoid].": ".$datos[id]."</td><td width=300>No. ".$datos[prefijo]."".$factura_fiscal."</td></tr>";
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='facturaconcepto')
        {
                ...
                $html.="<table border=0 width=100 align='center' border=0>";
                $html.="<tr><td width=760><BR><BR></td></tr>";
                $html.="<tr><td width=460><B>".$datos[0][razon_social]."</B></td><td width=300 align='center'>FACTURA CAMBIARIA DE COMPRAVENTA</td></tr>";
