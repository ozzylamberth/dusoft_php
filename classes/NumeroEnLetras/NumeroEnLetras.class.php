<?php
/**
 * $Id: NumeroEnLetras.class.php,v 1.4 2007/07/31 22:20:39 luis Exp $
 *
...
class NumeroEnLetras{
    ...
    function CargarArreglosEquivalencias()
    {
        ...
        $this->NumerosCentenas[16] = "diez y seis";
        $this->NumerosCentenas[17] = "diez y siete";
        $this->NumerosCentenas[18] = "diez y ocho";
        $this->NumerosCentenas[19] = "diez y nueve";
        $this->NumerosCentenas[20] = "veinte";
        $this->NumerosCentenas[21] = "veinte y un";
        $this->NumerosCentenas[22] = "veinte y dos";
        $this->NumerosCentenas[23] = "veinte y tres";
        $this->NumerosCentenas[24] = "veinte y cuatro";
        $this->NumerosCentenas[25] = "veinte y cinco";
        $this->NumerosCentenas[26] = "veinte y seis";
        $this->NumerosCentenas[27] = "veinte y siete";
        $this->NumerosCentenas[28] = "veinte y ocho";
        $this->NumerosCentenas[29] = "veinte y nueve";
        $this->NumerosCentenas[30] = "treinta";
        $this->NumerosCentenas[31] = "treinta y un";
        $this->NumerosCentenas[32] = "treinta y dos";
        $this->NumerosCentenas[33] = "treinta y tres";
        $this->NumerosCentenas[34] = "treinta y cuatro";
        $this->NumerosCentenas[35] = "treinta y cinco";
        $this->NumerosCentenas[36] = "treinta y seis";
        $this->NumerosCentenas[37] = "treinta y siete";
        $this->NumerosCentenas[38] = "treinta y ocho";
        $this->NumerosCentenas[39] = "treinta y nueve";
        $this->NumerosCentenas[40] = "cuarenta";
        $this->NumerosCentenas[41] = "cuarenta y un";
        $this->NumerosCentenas[42] = "cuarenta y dos";
        $this->NumerosCentenas[43] = "cuarenta y tres";
        $this->NumerosCentenas[44] = "cuarenta y cuatro";
        $this->NumerosCentenas[45] = "cuarenta y cinco";
        $this->NumerosCentenas[46] = "cuarenta y seis";
        $this->NumerosCentenas[47] = "cuarenta y siete";
        $this->NumerosCentenas[48] = "cuarenta y ocho";
        $this->NumerosCentenas[49] = "cuarenta y nueve";
        $this->NumerosCentenas[50] = "cincuenta";
        $this->NumerosCentenas[51] = "cincuenta y un";
        $this->NumerosCentenas[52] = "cincuenta y dos";
        $this->NumerosCentenas[53] = "cincuenta y tres";
        $this->NumerosCentenas[54] = "cincuenta y cuatro";
        $this->NumerosCentenas[55] = "cincuenta y cinco";
        $this->NumerosCentenas[56] = "cincuenta y seis";
        $this->NumerosCentenas[57] = "cincuenta y siete";
        $this->NumerosCentenas[58] = "cincuenta y ocho";
        $this->NumerosCentenas[59] = "cincuenta y nueve";
    ...
    function NumerosALetras($Numero)
    {
        ...
        while ($Numero != 0)
        {
            ...
            {
                If (Intval($Numero / 1000000) < 60)//16
                {
                    //$tempo = $this->Decenas(Intval($Numero / 10000000)*10);
