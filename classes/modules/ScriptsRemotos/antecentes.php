<?php
	/**************************************************************************************
	* $Id: antecentes.php,v 1.1.1.1 2010/03/30 15:15:44 hugo Exp $ 
	...
	**************************************************************************************/
	...
	class procesos_admin extends rs_server
	{
      ...
      $this->RegistrarSubmoduloAlterno("AntecedentesPersonales");
      ...
      $this->RegistrarSubmoduloAlterno("AntecedentesFamiliares");
    ...
    *
    */
		function RegistrarSubmoduloAlterno($nombre,$DatosVersion=array('version'=>'1','subversion'=>'0'))
    {
      $sql  = "DELETE FROM hc_evoluciones_submodulos ";
      $sql .= "WHERE  evolucion_id = ".SessionGetVar("EvolucionHc")." ";
      $sql .= "AND    submodulo = '".$nombre."'; ";
