<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: procesos.php,v 1.6 2011/03/04 14:13:17 hugo Exp $
  ...
  */
	...
	class procesos_admin extends rs_server
	{
		/**
    * @var string $vias_id
    * Variable donde se almancenan los datos de las vias de administracion
    */
    var $vias_id = "";
    /**
    * Metodo para activar el menu de la historia clinica
    *
    * @param array $datoshc Arreglo pasado por el api del script remoto
    *
    * @return string
    */
    ...
    /**
    * Metodo para crear la tabla de solicitud de formulacion de medicamentos
    *
    * @param array $arreglo Arreglo pasado por el api del script remoto
    *
    * @return string
    */
		function CrearTabla($arreglo)
		{
			...
			SessionSetVar("MedicamentosFormulados1",$medica);
			...
			SessionSetVar("CodigosSeleccionados1",$codigos);
      ...
      $ventana = "0";
			...
			else
			{
				...
				$html .= "  		<td align=\"center\" colspan=\"7\" height=\"16\">FORMULACIÓN DE MEDICAMENTOS</td>\n";
				$html .= "		</tr>\n";
				$html .= "		<tr class=\"modulo_table_list_title\" >\n";
				$html .= "			<td colspan=\"2\"  align=\"center\" >PRODUCTO</td>\n";
				$html .= "			<td align=\"center\" >PRINCIPIO ACTIVO</td>\n";
				$html .= "			<td width=\"12%\" style=\"text-indent:0pt;\" align=\"center\" >CONCENTRACIÓN</td>\n";
				...
				{
          $prtl = $this->ObtenereProtocoloMedicamento($datos[$key]['codigo_medicamento']);
          ...
          $html .= "		<tr class=\"hc_table_submodulo_list_title\" >\n";
					...
					$html .= "					<tr >\n";
					$html .= "						<td width=\"30%\">VIA DE ADMINISTRACIÓN: </td>\n";
					$html .= "						<td colspan=\"3\"><b class=\"label_mark\">".$this->ObtenerVias($key)."</b></td>\n";
					$html .= "						<td >\n";
          if(!empty($prtl))
          {
            $ventana = $datos[$key]['codigo_medicamento'];
            $html .= "						  <a href=\"javascript:ProtocolosFormulacion('".$datos[$key]['codigo_medicamento']."')\" title=\"Protocolos Formulacion\" >\n";
            $html .= "        	      <img src=\"".$path."/images/informacion.png\" border=\"0\">PROTOCOLO DE FORMULACION\n";
            $html .= "              <a>\n";
          }
          $html .= "            </td>\n";
					$html .= "					</tr>\n";
					...
					$html .= "							<textarea rows=\"2\" class=\"textarea\" style=\"width:100%\" id=\"Tfrecuenciadosis0".$key."\" name=\"Tfrecuenciadosis0".$key."\" readonly></textarea>";
					$html .= "							<input type=\"hidden\" id=\"frecuenciadosis0".$key."\" name=\"frecuenciadosis0".$key."\">\n";
					$html .= "							<input type=\"hidden\" id=\"frecuencia_Numero".$key."\" name=\"frecuencia_Numero".$key."\">\n";
					$html .= "							<input type=\"hidden\" id=\"frecuencia_Intensidad".$key."\" name=\"frecuencia_Intensidad".$key."\">\n";
					$html .= "						</td>\n";
					$html .= "					</tr>\n";
					$html .= "					<tr >\n";
					$html .= "						<td >DIAS TRATAMIENTO:</td>\n";
					$html .= "						<td colspan=\"4\">\n";
					$html .= "							<input type=\"text\" class='input-text' size=\"5\" id=\"tratamiento".$key."\" name=\"tratamiento".$key."\" onkeypress=\"return acceptNum(event);\" >\n";
					$html .= "						</td>\n";
					$html .= "					</tr>\n";
					$html .= "				</table>\n";
					$html .= "			</td>\n";
          ...
          $conversiones = $this->ObtenerFactorConversion($datos[$key]['codigo_medicamento'], $datos[$key]['ummi']);
          $arr_js = "new Array(";
          $fl = "";
          foreach($conversiones as $k1 => $dtl1)
          {
            $arr_js .= $fl." new Array('".$dtl1['unidad_dosificacion']."','".$dtl1['factor_conversion']."' )";
            $fl = ",";
          }
          $arr_js .= ")";
					...
					$prfsn = '1';
					if(SessionGetVar("SolicitudAutorizacion") == '3' && $datos[$key]['sw_solicita_autorizacion'] == '1')
					{
						$prfsn = SessionGetVar("SolicitudAutorizacion");
						$html .= "		<tr class=\"hc_table_submodulo_list_title\" >\n";
						$html .= "			<td align=\"left\" colspan=\"6\">\n";
						$html .= "				<table class=\"label\">\n";
						$html .= "					<tr >\n";
					...
					$html .= "				<a href=\"javascript:EvaluarFormulacion('$key','$path','".$prfsn."',".$arr_js.");\">\n";
					$html .= "					<img src=\"".$path."/images/pcopiar.png\" border=\"0\" >GUARDAR\n";
					$html .= "				</a>\n";
					$html .= "			</td>\n";
					$html .= "			<td align=\"center\" colspan=\"6\">\n";
					$html .= "			  <input type=\"hidden\" name=\"sw_pos\" id=\"sw_pos\" value=\"".$datos[$key]['sw_pos']."\">\n";
    ...
    * @return string
    */
		function CrearTabla1($arreglo)
		{
			$medica = SessionGetVar("MedicamentosFormulados1");
			
			$codigo = $arreglo[0];
			$opcion = $arreglo[1];
			$path = $arreglo[2];

			$codigos = SessionGetVar("CodigosSeleccionados1");
...
/*					$html .= "					<tr >\n";
					...
					$html .= "		<tr class=\"hc_table_submodulo_list_title\" >\n";
					$html .= "			<td class=\"modulo_list_oscuro\" style=\"$estilo\">\n";
					$html .= "				<a href=\"javascript:EvaluarFormulacion('$key','$path','".$prfsn."','".$datos[$key]['item']."');\">\n";
					$html .= "					<img src=\"".$path."/images/pcopiar.png\" border=\"0\" >GUARDAR\n";
					$html .= "				</a>\n";
					$html .= "			</td>\n";
					$html .= "			<td align=\"center\" colspan=\"6\">\n";
		...
		/**
    * Metodo donde se obtiene el protocolo de formulacion para el medicamente
    * solicitado
    *
    ...
    */
    ...
    /**
		* Metodo psra hacer el ingreso de los medicmanetos
    *
    * @param array $arreglo Arreglo pasado por el api del script remoto
    *
    * @return boolean
      ...
      $usuario = UserGetUID();
			...
			$html = "";
      if($arreglo[13] != 1 && $arreglo[9] == "N")
      {
        SessionSetVar("MedicamentoAJustificar",$arreglo);
        return "0*".$html."**".$arreglo[0];
      }
    ...
    */
		...
		/**
		* Metodo para la crecion de la tabla que muestra la informacion de los medicamentos
    * formulados
    *
    * @param array $arreglo Arreglo pasado por el api del script remoto
    *
    * @return string
      ...
      $codigo = "";
          ...
          $html .= "								</tr>\n";
					...
					{
						$html .= "								<tr>\n";
						$html .= "									<td id=\"justificacion".$datos['codigo_producto']."\" align=\"center\"><a href=\"javascript:Justificar('".$datos['codigo_producto']."','".$datos['justificacion_no_pos_id']."')\" class=\"normal_10AN\">JUSTIFICACIÓN PENDIENTE</a></td>\n";
						$html .= "								</tr>\n";
            //if(!$codigo) $codigo = $datos['codigo_producto'];
					}
		...
		/**
    * Metodo que actualiza el estado del medicamento, ingresando un nuevo registro en
    * la tabla hc_formulacion_medicamentos_eventos con el nuevo estado, a su vez
    * finaliza el tratamiento del medicamento
    *
    * @param array $arreglo Arreglo con los datos del medicamento 
    *
		* @return boolean
		*/
      ...
      $pt_texto = $this->PlanTerapeuticoActual(SessionGetVar("EvolucionHc"));
			...
			$sql .= "				'".$arreglo[0]."', ";
			$sql .= "				 ".UserGetUID().", ";
      $sql .= "				 ".$datos[$arreglo[1]]['dias_tratamiento']." ";
			$sql .= "				) ";
      ...
      $sql  = "UPDATE solicitudes_tratamiento ";
			...
			$sql .= "AND    codigo_medicamento = '".$arreglo[1]."' ";
      ...
      if($profesional == 1 || $profesional == 2)
      {
        $texto = ""; 
        if($arreglo[2] == '2')
          $texto .= "MEDICAMENTO SUSPENDIDO: ".$datos[$arreglo[1]]['producto'];
        else if($arreglo[2] == '1')
          $texto .= "MEDICAMENTO REFORMULADO: ".$datos[$arreglo[1]]['producto'];
        else if($arreglo[2] == '0')
          $texto .= "MEDICAMENTO FINALIZADO: ".$datos[$arreglo[1]]['producto'];
        $texto .= "	".$datos[$arreglo[1]]['dosis']." ".$datos[$arreglo[1]]['unidad_dosificacion']." ".$datos[$arreglo[1]]['frecuencia']." , VIA: ".$datos[$arreglo[1]]['nombre'];
        $texto .= ", DIAS DE TRATAMIENTO: ".$datos[$arreglo[1]]['dias_tratamiento'];
        
        if($datos[$arreglo[1]]['observacion'])
          $texto .= " \nOBSERVACIONES: ".$datos[$arreglo[1]]['observacion'];
      ...
      if($arreglo[2] == '1')
      {
        $aux = explode(" ",$datos[$arreglo[1]]['frecuencia']);
        if($aux[0] != "Cada")
        {
          $aux[2] = "Dia(s)";
          $aux[1] = "1";
        ...
        $fecha_fin = date("Y-m-d", mktime(0, 0, 0,date("m"),(date("d")+$datos[$arreglo[1]]['dias_tratamiento']-1),date("Y")));
      ...
      $cxn->Commit();
		...
		/**
    * Metodo que actualiza informacion de la solucion, ingresando un nuevo registro en
    * la tabla hc_formulacion_mezclas_eventos con la informacion de la misma
    *
    * @param array $param Arreglo con los datos de la solucion
    *
		* @return boolean
		*/
      ...
      $this->RegistrarSubmoduloAlterno();
		...
		/**
		* Metodo donde se consulta la informacion de las soluciones
    *
    * @param integer $numero Identificador de la formulacion de la mezcla
    * @param string $estado Estado de la formulacion de la mezcla
		*
    * @return boolean
    */
		...
		/**
		* Metodo para hacer la finalizacion de los medicamentos
	  *
    * @param array $arreglo Arreglo con los datos del medicamento
    *
		* @return string
    */
		function FinalizarMedicamento($arreglo)
		{
			...
			$html .= "				<b class=\"label_mark\">EL MEDICAMENTO <font class=\"label_error\">".$datos[$arreglo[1]]['producto']."</font>, HA SIDO FINALIZADO</b>\n";
			$html .= "			</td>\n";
			$html .= "		</tr>\n";
			$html .= "	</table><br>\n";
		...
		/**
		* Metodo para hacer la finalizacion de las soluciones
	  *
    * @param array $arreglo Arreglo con los datos de la solucion
    *
		* @return string
    */
    ...
    /**
		* Metodo psra hacer el ingreso de las soluciones
    *
    * @param array $param Arreglo con los datos pasados por el script remoto
    * @param array $solucion Arreglo con los datos de la solucion
    *
    * @return boolean
		*/
      ...
      $this->RegistrarSubmoduloAlterno();
		...
		/**
		* Metodo donde se crea el cmbo para la seleccon de las unidades
		* 
    * @param string $key Identificador del medicamento para el combo
    * @param string $unidad Identifica la unidad cuando es unica para el medicamento
    *
    * @return string
    */
		...
		/**
		* Metodo donde se obtienen las vias de administracion de medicmanetos
    *
    * @param string $codigo Codigo del medicamento
    *
    * @return mixed
		*/
		...
		/**
    * Metodo para crear la forma para la formulacion de las soluciones
		*
    * @param array $param Arreglo con la informacion de la formulacion
    *
    * @return string
		*/
		...
		/**
		* Metodo donde se crea la forma, donde se ve la informacion de las soluciones
    * formuladas
    *
    * @param array $param Arreglo con la informacion de la formulacion
    *
    ...
    */
		...
		/**
		* Metodo para hacer la forma donde se muestran los profesionales
    *
    * @return string
		*/
		...
		/**
		* Metodo donde se actualiza la formulacion de la mezcla, mediante el registro de
    * eventos sucedidos en la misma
    *
    * @param array $param Arreglo con los datos pasados por el script remoto
    * @param array $solucion Arreglo con los datos de la solucion
    *
    * @return boolean
      ...
      return true;
		...
		/**
    * Metodo para obtener la informacion de los profesionales
    *
    ...
    */
		...
		/**
		* Metodo para realizar la confirmacion de formulacion del medicamento
    *
    * @param array $param Arreglo con la informacion de la formulacion
		*
    * @return string
    */
		...
		/**
		* Metodo donde se verifica si este submodulo fue utilizado para la atencion 
		* de un paciente.
		*
		* @access private
    *
    * @param array $param Arreglo con la informacion del submodulo
    *
		* @return string
		*/
		...
		/**
		* Metodo que permite realizar la conexion a la base de datos y ejecutar la
		* consulta sql
		*
    ...
    */
    ...
    /**
    * Metodo para obtener el factor de conversion de un medicmaneto
    * 
    * @param string $medicamento identificador del medicamento
    * @param string $umm_id identificador de la unidad de medida
    *
    * @return mixed
    */
    function ObtenerFactorConversion($medicamento, $umm_id)
    {
	  ...
	  /**
		* Metodo que retorna los datos de concernientes a la version del 
    * submodulo
    *
		* @return array
		*/
