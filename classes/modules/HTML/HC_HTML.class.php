...
// $Id: HC_HTML.class.php,v 1.1.1.1 2010/03/30 15:15:44 hugo Exp $
// ----------------------------------------------------------------------
...
class HC_HTML extends ManejadorDeHC
{
     ...
     */
     function Inicializar()
     {
          ...
          if(is_numeric($this->paso) && $this->paso <= ($this->numPasos[0]+$this->numPasos[1]))
          {
            $html = $this->IncludePasoHC();
          ...
          {            
               ...
               if(!$submodulo_obj->GetEstado())
               {
                    ...
                    if($submodulo_obj->GetEstado())
                    {
                         ...
                         $salida_submodulo.="<input type='submit' value='Continuar Cierre de la Atenci�' name='cerrar' class='input-submit'>";
					...
					{
						$_SESSION['HC']['CIERRE'][$this->datosEvolucion['evolucion_id']][$submodulo['submodulo']]=0;
					}
               ...
               if(!empty($_SESSION['HC']['CIERRE'][$this->datosEvolucion['evolucion_id']][$submodulo['submodulo']]))
               {
                    ...
                    if($submodulo_obj->GetEstado())
                    {
                         ...
                         $salida_submodulo.="<input type='submit' value='Continuar Cierre1 de la Atenci�' name='cerrar' class='input-submit'>";
                         $salida_submodulo.="</form>";
                         $salida_submodulo.="</td>";
                         $salida_submodulo.="</tr>";
                         $salida_submodulo.="</table>";
    ...
    /**
    * Funcion para la creacion de la cabecera estatica de la HC
    *
    * @return void
    */
    ...
    {  
      ...
      $this->IncludeJS("Jsgraphics");
      
      $posicion = "position:fixed;width:100%";
      if(eregi("MSIE",$_SERVER["HTTP_USER_AGENT"]))	
      {
        $posicion = "position:absolute;width:104%";
      }
      //Nueva Version
      $this->salida .= "<script>\n";
      ...
      $this->salida .= "<script>\n";
      $this->salida .= "  function AbrirProtocolos(tipo_id_paciente,paciente_id)\n";
      $this->salida .= "  {\n";
      $this->salida .= "    var url = \"classes/ProtocoloAtencion/ProtocoloAtencion.class.php?paciente[tipo_id_paciente]=\"+tipo_id_paciente+\"&paciente[paciente_id]=\"+paciente_id;\n";
      $this->salida .= "    var str =\"width=700 ,height=400,resizable=no,location=yes,toolbar=1,status=no,scrollbars=yes\";\n";
      $this->salida .= "    window.open(url,'PROTOCOLOS DE ATENCION',str).focus();\n";
      $this->salida .= "  }\n";
      $this->salida .= "</script>\n";
      $this->salida .= "<!--Barra principal de historia clinica-->\n";
      $this->salida .= "<div class=\"cabecera_hc\" id=\"cabecera_hc\" style=\"$posicion\" $width>\n";
      $this->salida .= "	<table width=\"100%\" class=\"TablaHc\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n";
      $this->salida .= "    <tr valign=\"middle\">\n";
      ...
      $this->salida .= "      </td>\n";          
      $this->salida .= "      <td height=\"40\" width=\"5%\" align=\"center\">\n";
      $this->salida .= "      	<a href=\"javascript:AbrirProtocolos('".$this->datosPaciente['tipo_id_paciente']."','".$this->datosPaciente['paciente_id']."')\" title=\"Protocolos\" >\n";
      $this->salida .= "        	<img src=\"".$this->directorioImagenesHC."informacion.png\"  name=\"ImgApoyosDiagnosticos\" border=\"0\">\n";
      $this->salida .= "        <a>\n";
      $this->salida .= "      </td>\n";
      $width = 75 - $ancho;
      ...
      $this->salida .= "        </table>\n";
      $this->salida .= "			</td>\n";
      $this->salida .= "      <td height=\"40\" width=\"5%\" class=\"hcPaciente\" align=\"center\" valign=\"middle\">\n";
      $this->salida .= "        <div class=\"hcTexto\">\n";
     ...
     /**
     * M�odo que calcula cual es el paso anterior y cual es el paso siguiente de la HC
          ...
          foreach($this->hc_secciones as $key => $seccionHC)
          {
               ...
               foreach($SubmodulosMostrar as $KeyMostrar=>$VectorSeccion)
               {
                    foreach($VectorSeccion[$key] as $KeySubmodulo=>$DatosSubmodulo)
                    {
                         ...
                         $accion = ModuloHCGetURL($this->datosEvolucion['evolucion_id'],$DatosSubmodulo['PASO'],0,'',false,array('estacion'=>$this->estacion_id));
     ...
     */
     function ListadoInicioHC()
     {
	     ...
	     $salida .= "	</tr>\n";
          ...
          {
               $salida .= "	<tr class=\"modulo_table_list_title\">\n";
               $salida .= "		<td $est width=\"20%\">OCUPACI�</td>";
          ...
          if($info_ingreso['tabla'] != "CEXT")
          {
               ...
               switch($info_ingreso['tabla'])
               {
                    case 'URG': 
                         ...
                         $salida .= "		</tr>\n";
                         $salida .= "		<tr class=\"modulo_table_list_title\">\n";
                         $salida .= "			<td $est width=\"20%\">ESTACI�</td>\n";
                    ...
                    case 'MVH':	
                         ...
                         $salida .= "		</tr>\n";
                         $salida .= "		<tr class=\"modulo_table_list_title\">\n";
                         $salida .= "			<td $est width=\"20%\">UBICACI�</td>\n";
                         $salida .= "			<td $est width=\"80%\" colspan=\"3\" class=\"modulo_list_claro\">".$info_ingreso['estacion']."</td>\n";
                         $salida .= "		</tr>\n";
                         $salida .= "		<tr class=\"modulo_table_list_title\">\n";
                         $salida .= "			<td $est width=\"20%\">HABITACI�</td>\n";
               ...
               foreach($v as $x=>$s)
               {
                    for($b=0; $b<sizeof($s); $b++)
                    {
                         ...
                         if($y != 2)
                         {
                              ...
                              {
                                   $salida.='<b>Descripci� Ingreso :</b>&nbsp;'.$s[$b]['comentario'].'<br>';
                              }
                              if(!empty($s[$b]['dpto']))
                              {
                         ...
                         if($s[$b]['evolucion_id'] != $s[$b-1]['evolucion_id'])
                         {
                              ...
                              $salida.="<a href='$accion'><b>Evoluci� No.:</b>&nbsp;".$s[$b]['evolucion_id']." - ".$s[$b]['fecha_evolucion']." - <b>Profesional:</b> ".$s[$b]['nombre_medico']." - ".$s[$b]['descipcion_medico']."</a>";
                              $salida .= "</td>\n";
                              $salida .= "</tr>\n";
                              $salida .= "</table>\n";
...
echo $accion;
     ...
     */
     function VolverListado($contenedor,$modulo,$tipo,$metodo,$ingreso,$evolucion)
     {
          ...
          $salida .= "    <tr>\n";
					...
					$salida .= "    </tr>   \n";
					$salida .= "    <tr>\n";
          $salida .= "    <td align='center'><A href='$accion1'>Ir al modulo de Impresi�</A></td>\n";
          $salida .= "    </tr>\n";
          $salida .= "    <tr>\n";
          $salida .= "    <td align='center'><A href='$accion2'>Listado de pacientes para atenci�</A></td>\n";
          $salida .= "    </tr>    \n";
          $salida .= "  </TABLE>\n";
          $salida .= "</FORM>\n";
          $salida .= themeCerrarTabla();
     ...
     */
     ...
     /**
     * Funci� que pinta la flechas de navegaci�
     */
    ...
    {   
      ...
      IF(eregi("MSIE",$_SERVER["HTTP_USER_AGENT"]))	
        $posicion = "position:absolute;width:104%";
			...
			if($this->datosPaciente['edad_paciente']['anos']!="")
			{
			 $edad = $this->datosPaciente['edad_paciente']['anos'] .' a�s, ';
			}
			if($this->datosPaciente['edad_paciente']['meses']!="")
			{
			 $edad .= $this->datosPaciente['edad_paciente']['meses'].' meses, ';
			...
			$this->salida .= "        </table>\n";
			$this->salida .= "			</td>\n";
			$this->salida .= "      <td height=\"40\" width=\"30%\" align=\"center\">\n";
      $this->salida .= "        <div class=\"hcTexto\" style=\"width : 150;\">\n";
			$this->salida .= "          <a href=\"{$acciones[3]}\" title=\"Volver\">\n";
			$this->salida .= "        	  Lista de pacientes\n";
			//$this->salida .= "        	<img src=\"".$this->directorioImagenesHC."volver_claro.gif\" name=\"ImgVolver\" border=\"0\">\n";
			$this->salida .= "          </a>\n";
			$this->salida .= "        </DIV>\n";
			$this->salida .= "      </td>\n";
