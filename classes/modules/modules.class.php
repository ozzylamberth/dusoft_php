<?php
  /**
  * @package IPSOFT-SIIS
  * @version $Id: modules.class.php,v 1.1.1.1 2010/03/30 15:15:44 hugo Exp $
  ...
  class ManejadorDeModulos extends classModules
  {
      ...
      if(empty($modulo))
      {
        if(empty($_REQUEST['modulo']))
        {
          if($contenedor == 'app')
          {
            ...
            $sql = "SELECT  modulo,parametros 
                    FROM    system_modulos_default
                    WHERE   ip_host = '".GetIPAddress()."'
                    AND     modulo_tipo = 'app'
                    AND     activo = '1'
            ...
            if($resultado->EOF)
            {
              ...
              else
              {
                ...
                $_REQUEST['_system_modulos_default']=true;
                $resultado->Close();
              }
            }
            else
    ...
    */
    ...
    { 
      ...
      $fileName  = $this->contenedor . "_modules/" . $this->modulo . "/" . $this->contenedor  . "_" . $this->modulo . "_controller.php";
      if(IncludeFile($fileName))
      {
        $className = $this->contenedor  . "_" . $this->modulo  . "_controller";
