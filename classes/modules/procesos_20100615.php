<?php
	/**************************************************************************************
	* $Id: procesos.php,v 1.2 2010/03/31 19:26:06 hugo Exp $
    ...
    */
      ...
      $ventana = "0";
          ...
          $html .= "						<td >\n";
          $html .= "              CANTIDAD\n";
          $html .= "							<input type=\"button\" class='input-submit' name=\"calcular\" value=\"Calcular Cantidad\" onclick=\"CalcularCantidad('".$key."')\" >\n";
          $html .= "            </td>\n";
					$html .= "						<td >\n";
					$html .= "							<div id=\"valor_cantidad".$key."\" class=\"normal_10AN\"></div>\n";
					$html .= "							<input type=\"hidden\" id=\"cantidad".$key."\" name=\"cantidad".$key."\" value=\"\">\n";
					$html .= "						</td>\n";
...
/*					$html .= "					<tr >\n";
    ...
    */
    ...
    /**
      ...
      $cxn->ConexionTransaccion();
			...
			$sql .= "				 ".UserGetUID().", ";
			$sql .= "				 '".$arreglo[9]."', ";
			$sql .= "				  ".(($arreglo[10])? $arreglo[10] :"NULL")." ";
			$sql .= "				) ";
      ...
      $sql .= "				  ".SessionGetVar("IngresoHc").", ";
      $sql .= "			   '".$arreglo[0]."', ";
      $sql .= "				  ".(($arreglo[10])? $arreglo[10] :"5000").", ";
      $sql .= "				  ".$arreglo[3].", ";
      $sql .= "				  ".$arreglo[11].", ";
      $sql .= "				 '".$arreglo[12]."', ";
      $sql .= "				  ".$add_dias.", ";
      ...
      $cl1 = array(	"formulacion_table_list","modulo_list_claro","formulacion_table_list_oscuro",
		...
		/**
    * Actualiza el estado del medicamento, ingresando un nuevo registro en
    ...
    *
    */
		function RegistrarSubmoduloAlterno($DatosVersion=array('version'=>'1','subversion'=>'0'))
    {
      ...
      $sql .= "      ".SessionGetVar("IngresoHc").",";
      $sql .= "      ".SessionGetVar("EvolucionHc").",";
      $sql .= "      'PlanTerapeuticoHospitalizacion',";
	  ...
	  /**
		* Esta función retorna los datos de concernientes a la version del 
    * submodulo
    *
		* @access private
		*/
