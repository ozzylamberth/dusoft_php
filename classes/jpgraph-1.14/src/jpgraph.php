...
// Ver:        $Id: jpgraph.php,v 1.1.1.1 2005/02/03 21:47:44 ehudes Exp $
//
...
if (!defined('TTF_DIR')) {
    if (strstr( PHP_OS, 'WIN') ) {
      ...
      DEFINE('TTF_DIR', $_SERVER['SystemRoot'] . '/fonts/');
        ...
        $ruta=GetVarConfigAplication('DIR_SIIS');
        //$ruta='/var/www/html/SIIS/';
    //DEFINE('TTF_DIR','/usr/X11R6/lib/X11/fonts/truetype/');
    DEFINE('TTF_DIR',$ruta.'fuentes/TTF/');//   /usr/X11R6/lib/X11/fonts/TTF/  direccionamiento actual.
    }
}
...
// CONSTRUCTOR
    ...
    $this->font_files=array(
        ...
        FF_LUXIS => array(FS_NORMAL=>'luximb.ttf', FS_BOLD=>'luximb.ttf', FS_ITALIC=>'luximbi.ttf', FS_BOLDITALIC=>'luximri.ttf' )
);
    }
