<?php
  ...
  *
    ...
    */
    ...
    /**
    * Función Cambio de estado o cambio del parámetro estado de un registro
    ...
    */
    ...
    /**
    * Función Borrar Registro de una sola llave primaria
    * @param String $tabla Nombre de la Tabla
    * @param String $id Identificacion del Registro a Modificar
    * @param String $campo_id Es el Campo o nombre de la llave Primaria
    *
    ...
    */
    ...
    /**
    * Función donde se obtiene el nombre del producto segun parametros de configuracion
    *
    ...
    */
    function NombreProducto($producto,$empresa)
      ...
      if(trim($nombre) == "")
		...
		/**
		* Funcion Para Calcular el Numero de días del Mes.
		* @param String $Mes
		* @param String $Año
		*
		* Return String
		...
		* El Arreglo que retorna es [#]['final']: Indica el dìa final del corte semanal
		* El Arreglo que retorna es [#]['siguiente']: Indica el dìa que empieza el corte Semanal siguiente
		...
		*/
		...
		return $periodos_semanales;
		  ...
		  /**
    * Función Javascript para la comparacion de fechas
