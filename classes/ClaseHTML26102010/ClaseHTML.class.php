<?php
	/********************************************************************************* 
 	* $Id: ClaseHTML.class.php,v 1.10 2007/09/20 16:08:00 hugo Exp $ 
 	*
	...
	* Clase en la que se ha implementado un paginador 
	...
	class ClaseHTML
	{
		...
		* @return string 
		*********************************************************************************/
		function ObtenerPaginadoXajax($TotalRegistros,$pagina,$action,$op,$limite = null)
		{
			$TablaPaginado = "";
			...
			if ($TotalRegistros > 0)
			{
				...
				if($NumeroPaginas > 1)
				{
					...
					{
						$TablaPaginado .= "		<td class=\"label\" bgcolor=\"#D3DCE3\">\n";
						$TablaPaginado .= "			<a href=\"javascript:".$action.",'1')\" title=\"primero\"><img src=\"".GetThemePath()."/images/primero.png\" border=\"0\" width=\"15\" height=\"15\"></a>\n";
						$TablaPaginado .= "		</td><td class=\"label\" bgcolor=\"#D3DCE3\">\n";
						$TablaPaginado .= "			<a href=\"javascript:".$action.",".($pagina-1).")\" title=\"anterior\"><img src=\"".GetThemePath()."/images/anterior.png\" border=\"0\" width=\"15\" height=\"15\"></a>\n";
						$TablaPaginado .= "		</td>\n";
						$columnas +=2;
					}
					$Fin = $NumeroPaginas + 1;
					...
					for($i=$Inicio; $i< $Fin ; $i++)
					{
						...
						{
							$TablaPaginado .="		<td class=\"modulo_list_claro\" $estilo align=\"center\"><a href=\"javascript:".$action.",'".$i."')\">".$i."</a></td>\n";
						}
						$columnas++;
					}
				}
				...
				{
					$TablaPaginado .= "		<td class=\"label\" bgcolor=\"#D3DCE3\">\n";
					$TablaPaginado .= "			<a href=\"javascript:".$action.",'".($pagina+1)."')\" title=\"siguiente\"><img src=\"".GetThemePath()."/images/siguiente.png\" border=\"0\" width=\"15\" height=\"15\"></a>\n";
					$TablaPaginado .= "		</td><td class=\"label\" bgcolor=\"#D3DCE3\">\n";
					$TablaPaginado .= "			<a href=\"javascript:".$action.",".$NumeroPaginas.")\" title=\"ultimo\"><img src=\"".GetThemePath()."/images/ultimo.png\" border=\"0\" width=\"15\" height=\"15\"></a>\n";
					$TablaPaginado .= "		</td>\n";
					$columnas +=2;
				}
