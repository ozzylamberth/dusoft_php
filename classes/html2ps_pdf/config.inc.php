<?php
// $Header: /var/cvs/SIIS/classes/html2ps_pdf/config.inc.php,v 1.1 2006/11/27 22:27:48 hugo Exp $
...
define('OUTPUT_FILE_DIRECTORY', $ConfigAplication['DIR_SIIS'].'cache/');
...
define('WRITER_TEMPDIR', $ConfigAplication['DIR_SIIS'].'cache/');
