...
/**
 * $Id: fpdf_reporte_soat.class.php,v 1.11 2007/02/05 20:41:37 carlos Exp $
            ...
            //$vect[2][5][1]=$var['fecha_accidente'];
                ...
                $query = "SELECT A.ingreso AS ingreso_id,
                        ...
                        FROM ingresos_soat AS A,
                                                        ...
                                                        (
                                                        B.ingreso=E.ingreso AND E.estado IN ('0')
                                                        )
...
//DATOS DIAGNOSTICOS
                                ...
                                $vect[56][0]=56;
                                $vect[56][1]=325;
                                $vect[56][2].=$var2['egreso'];//56,227 desc_diagnostico_de _EGRESO
