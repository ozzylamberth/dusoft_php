<?php
/**
 * $Id: FuRips.class.php,v 1.2 2009/05/14 21:40:32 hugo Exp $
 *
...
//echo 1;print_r($this->arrayContenido2); echo 2; exit;
  ...
  * @return string
  */
	function _formatoCadenaII($str,$long = 0)
	{
		$str = trim($str);
		if($str == "" || $str == null)
			return "";
	...
	{
		$f = explode(".",$fecha);
    return date('d/m/Y',strtotime($f[0]));
	}//Fin _formatoFecha
  /**
	* Formatea una fecha
	* 
	...
	* @return date 
	*/
	function _formatoNumero($numero)
	{
		$n = explode(".",$numero);
    return $n[0];
	}//Fin _formatoFecha
