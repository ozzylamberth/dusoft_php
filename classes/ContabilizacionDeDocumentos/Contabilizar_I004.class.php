...
/**
* $Id: Contabilizar_I004.class.php,v 1.1 2009/07/27 20:50:37 johanna Exp $
*/

/**
* Clase para la contabilizacion y consulta de la misma de documentos de tipo I004(INGRESOS INVENTARIO POR COMPRA)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class Contabilizar_I004 extends ContabilizarDocumento
{
    ...
    */
    function Contabilizar_DocInv()
    {
        ...
        while($fila = $result->FetchRow())
        {
            ...
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "INGRESO POR (MOTIVOS VARIOS) I004";
            ...
            $INFO_CTA = $this->GetParametizacionDoc('CRUCE_INGRESO_C','I004');
