<?php
/**
* $Id: Contabilizar_FV01_02.class.php,v 1.4 2007/10/04 20:19:52 alexgiraldo Exp $
*/
...
* @package SIIS
*/
class Contabilizar_FV01_02 extends ContabilizarDocumento
{
...
//         }
    ...
    */
    function Contabilizar_cheques()
    {
        ...
        if($total_cheques != $this->DatosFactura['total_cheques'])
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
