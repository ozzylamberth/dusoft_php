...
/**
* $Id: Contabilizar_I006.class.php,v 1.1 2009/07/27 20:50:37 johanna Exp $
*/

/**
* Clase para la contabilizacion y consulta de la misma de documentos de tipo I006(INGRESOS INVENTARIO POR COMPRA)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class Contabilizar_I006 extends ContabilizarDocumento
{
      ...
      //$this->exige_tercero = false;
       ...
       // $dbconn->debug=true;
        $sql = "SELECT  a.*,
                        ...
                        'I006' as tipo_doc_general_id
                FROM   inv_bodegas_movimiento as a,
                       inv_bodegas_movimiento_devoluciones as b,
                       empresas c
    ...
    */
    function Contabilizar_DocInv()
    {
        ...
        while($fila = $result->FetchRow())
        {
            ...
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "INGRESO POR DEVOLUCION I006";
            ...
            $INFO_CTA = $this->GetParametizacionDoc('CRUCE_INGRESO_C','I006');
