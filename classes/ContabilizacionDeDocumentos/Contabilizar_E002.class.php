...
/**
* $Id: Contabilizar_E002.class.php,v 1.1 2009/07/27 20:50:37 johanna Exp $
*/

/**
* Clase para la contabilizacion y consulta de la misma de documentos de tipo E002(EGRESO POR AJUSTE)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class Contabilizar_E002 extends ContabilizarDocumento
{
...
//             }
            ...
            $Datos['tipo_id_tercero']    = "";
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "EGRESO POR AJUSTE";
