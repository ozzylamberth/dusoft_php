...
/**
* $Id: Contabilizar_HMNC.class.php,v 1.3 2007/03/06 00:06:59 jgomez Exp $
*/
...
* @package SIIS
*/
class Contabilizar_HMNC extends ContabilizarDocumento
{
    ...
    */
    function ContabilizarDoc($empresa_id,$prefijo,$numero,$actualizar=false)
    {
        ...
        $sql = "SELECT
                ...
                FROM    voucher_honorarios_nc as a,
        ...
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
            $this->mensajeDeError = "NO SE ENCONTRARON REGISTROS PARA LA NOTA CREDITO DE VOUCHER HONORARIOS MEDICOS (empresa_id=$empresa_id, prefijo=$prefijo, numero=$numero)";
            return false;
        }
        ...
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
            $this->mensajeDeError = "El valor de la nota credito del voucher no es valido [".$this->DatosVoucher['valor_honorario']."]";
            return false;
        }
        ...
        switch($this->DatosVoucher['estado'])
        {
            ...
            default: //ESTADOS INVALIDOS DEL PAGARE
                ...
                $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
                $this->mensajeDeError = "El estado de la nota credito del voucher no es valido [".$this->DatosVoucher['estado']."].";
                return false;
        }
