...
/**
* $Id: Contabilizar_I005.class.php,v 1.1 2009/07/27 20:50:37 johanna Exp $
*/

/**
* Clase para la contabilizacion y consulta de la misma de documentos de tipo I005(INGRESOS INVENTARIO POR COMPRA)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class Contabilizar_I005 extends ContabilizarDocumento
{
    ...
    function ContabilizarDoc($empresa_id,$prefijo,$numero,$actualizar=false)
    {
      //$this->exige_tercero = false;
        ...
        $sql = "SELECT  a.*,
                        ...
                        'I005' as tipo_doc_general_id

                FROM   inv_bodegas_movimiento as a,
                       inv_bodegas_movimiento_aprovechamientos as b,
                       empresas as c
    ...
    */
    function Contabilizar_DocInv()
    {
        ...
        while($fila = $result->FetchRow())
        {
            ...
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "INGRESO POR APROVECHAMIENTO I005";
            ...
            $INFO_CTA = $this->GetParametizacionDoc('CRUCE_INGRESO_C','I005');
    ...
    */
    function GetCuentaContableInvProducto($grupo_id,$clase_id,$subclase_id,$codigo_producto)
    {
        ...
        if(empty($InfoContableProductos[$this->DatosDocumento['empresa_id']][$codigo_producto]) && empty($InfoContableGrupos[$this->DatosDocumento['empresa_id']][$grupo_id][$clase_id][$subclase_id]))
        {
            ...
            $sql = "SELECT cuenta 
                    FROM   cg_conf.doc_inv_parametros_excepciones
            ...
            {
                $sql = "SELECT  cuenta 
                        FROM    cg_conf.doc_inv_parametros
                        WHERE   empresa_id = '".$this->DatosDocumento['empresa_id']."'
