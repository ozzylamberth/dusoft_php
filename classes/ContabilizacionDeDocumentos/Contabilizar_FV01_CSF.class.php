<?php
/**
* $Id: Contabilizar_FV01_CSF.class.php,v 1.1 2007/12/03 15:02:10 carlos Exp $
*/

/**
* Clase para la contabilizacion de documentos de tipo general FV (Facturas - fac_facturas - CSF)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class Contabilizar_FV01_CSF extends ContabilizarDocumento
{
    ...
    * @access public
    */
    function Contabilizar_FV01_CSF()
    {
...
//         }
        ...
        $TOTAL_DOC = $this->DatosFactura['total_factura'];
...
{
	$DatosTransaccion['valor'] -= $DatosTransaccion['valor_honorario'];
}
        //DATOS DEL MOVIMIENTO
        ...
        $Datos['tercero_id']         = "";
        $Datos['detalle']            = "";
/*if($DatosTransaccion['transaccion'] == '3081019')
{print_r($Datos); exit;}*/
...
if($DatosTransaccion['porcentaje_honorario'])
{
   $this->Contabilizar_honorario($DatosTransaccion);
}       
        return true;
    }
    ...
    */
    ...
    {
/*		if($DatosTransaccion[cargo] == 'DIMD' )
		{
		echo '<br><br><pre>';
...
//echo $sql; 
    ...
    */
    ...
    /**
    * Metodo para contabilizar el honorarios medicos.
    *
    * @return
    * @access private
    */
    function Contabilizar_honorario($DatosTransaccion)
    {

        if($this->GetExcepcionHonorario($DatosTransaccion))
        {
         $parametro = 'HONORARIOS_COMET';
        }
        else
        {
         $parametro = 'HONORARIOS_MEDICOS';
        }
//echo '<br><br>'.$parametro.'<br><br>';
//CONTABILIZACION DEL HONORARIO
        $INFO_CTA = $this->GetParametizacionDoc($parametro,'FV01');
//print_r($INFO_CTA);exit;
         if($INFO_CTA === false)
        {
            if(empty($this->error))
            {
        ...
        //DATOS DEL MOVIMIENTO HONORARIO
        $Datos['cuenta']             = $INFO_CTA['cuenta'];
        $Datos['naturaleza']         = 'C';
        $Datos['valor']              = $DatosTransaccion['valor_honorario'];
        $Datos['centro_de_costo_id'] = $INFO_CTA['ARGUMENTOS']['CENTRO_DE_COSTO'];
        $Datos['documento_cruce_id'] = -1;
        $Datos['base_rtf']           = 0;
        $Datos['porcentaje_rtf']     = 0;
    ...
    /**
    * Metodo para contabilizar el honorarios medicos excepciones.
    *
    * @return
    * @access private
    */
    function GetExcepcionHonorario($DatosTransaccion)
    {
        $sql="SELECT COUNT(*)
              FROM cg_conf.cg_honorarios_profesionales_excepciones 
              WHERE tipo_id_tercero = '".$DatosTransaccion['tipo_tercero_id']."'
              AND tercero_id = ".$DatosTransaccion['tercero_id']."";
        list($dbconn) = GetDBconn();
        $resultado = $dbconn->Execute($sql);
