...
/**
* $Id: Contabilizar_E007.class.php,v 1.1 2009/07/27 20:50:37 johanna Exp $
*/

/**
* Clase para la contabilizacion y consulta de la misma de documentos de tipo E007(EGRESO POR CONSUMO)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class Contabilizar_E007 extends ContabilizarDocumento
{
    ...
    */
    function ContabilizarDoc($empresa_id,$prefijo,$numero,$actualizar=false)
    {
        ...
        $sql = "SELECT
                    ...
                    b.departamento,
                    'E007' as tipo_doc_general_id

                FROM
                    inv_bodegas_movimiento as a,
                    inv_bodegas_movimiento_conceptos_egresos b
...
//             }
            ...
            $Datos['tipo_id_tercero']    = "";
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "DEVOLUCION A PROVEEDORES";
