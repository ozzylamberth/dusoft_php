...
class SincronizacionCosmitet {
    ...
    function sincronizarFormula() {
		...
		$url_servicio = "http://10.0.2.237/APP/PRUEBAS_CRISTIAN/ws/Formulacion/ws_formulacion.php?wsdl";
       ...
       // $funcionWs = "sincronizarFormula";
		...
		$numeroFormula = "77772004";
		$tipoFormula = "1";   
		$paciente = "66834572"; //10023260 10002898 66834572  1061989010
		$modificacion = "0";  
       ...
       /* $datos_medicamentos[0]['codigo_producto'] = "FOFOA0311259";
		...
		$datos_medicamentos[4]['codigo_producto'] = $codigoProducto;
        $datos_medicamentos[4]['cantidad'] = "90";
