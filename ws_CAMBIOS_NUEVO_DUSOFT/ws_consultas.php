...
//Registro de funcion, Input y Output
$server->register('datosTerceroRecibosCaja', array('prefijo' => 'xsd:string', 'reciboCajaId' => 'xsd:string', 'centroUtilidad' => 'xsd:string', 'empresaId' => 'xsd:string'), array('return' => 'tns:WSResultadoTerceroReciboCaja'), "urn:consultas_ws", "urn:consultas_ws#datosTerceroRecibosCaja", "rpc", "encoded", "Metodo-Funcion para para confirmar si el recibo existe o no");
