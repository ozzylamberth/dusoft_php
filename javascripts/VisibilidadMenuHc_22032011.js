	/**************************************************************************************
	* $Id: VisibilidadMenuHc.js,v 1.3 2011/03/04 14:16:27 hugo Exp $ 
...
function pintarTabla(retorno)
{
  ...
  if(cadena[3] != undefined && cadena[3] != "" && cadena[3] != "0")
  {
    JustificarII(cadena[3]);
    return;
  }
...
function EvaluarFormulacion(codigo,ruta,profesional,conversion)
{
	...
	formulacion[13] = document.getElementById('sw_pos').value;;
