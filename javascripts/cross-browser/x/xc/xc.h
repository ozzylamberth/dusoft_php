...
#define XC_HDR_STR "\nX Library Compiler %s. Distributed by GNU LGPL\n"
#define X_HDR_STR "/* %s compiled from X %s with XC %s. Distributed by GNU LGPL. For copyrights, license, documentation and more visit Cross-Browser.com */\n"
#define HELP_STR \
  "\nUsage:\n\nxc prj_name\n" \
