<?php
/**
* $Id: tipo_doc_bodega_T001.class.php,v 1.3 2007/06/07 21:05:35 alexgiraldo Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo T001(TRASLADO DE BODEGA)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.3 $
* @package SIIS
*/
class tipo_doc_bodega_T001 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_T001($bodegas_doc_id)
    {
    ...
    function GetDocTemporal($doc_tmp_id, $usuario_id=null)
    {
        ...
        $sql="  SELECT  a.*,
                ...
                FROM
                    ...
                    LEFT JOIN inv_bodegas_movimiento_tmp_traslados as b
