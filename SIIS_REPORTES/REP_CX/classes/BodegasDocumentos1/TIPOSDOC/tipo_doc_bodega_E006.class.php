<?php
/**
* $Id: tipo_doc_bodega_E006.class.php,v 1.1 2007/06/09 16:10:35 alexgiraldo Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo E006(EGRESO POR CONSUMO)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class tipo_doc_bodega_E006 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_E006($bodegas_doc_id)
    {
    ...
    * @access public
    */
    function NewDocTemporal($observacion='', $departamento, $usuario_id=null)
    {
        ...
        $sql = "INSERT INTO inv_bodegas_movimiento_tmp
                ...
                INSERT INTO inv_bodegas_movimiento_tmp_consumo
                    (
                        usuario_id,
                        doc_tmp_id,
                        departamento
    ...
    function GetDocTemporal($doc_tmp_id, $usuario_id=null)
    {
        ...
        $sql="  SELECT  a.*,
                ...
                FROM
                    ...
                    LEFT JOIN inv_bodegas_movimiento_tmp_consumo as b
    ...
    */
    function CrearDocumento($doc_tmp_id, $usuario_id=null)
    {
        ...
        $sql = "INSERT INTO inv_bodegas_movimiento_consumo
                (
                    empresa_id,
                    prefijo,
                    numero,
