<?php
	/**************************************************************************************
	* $Id: medicamentos.php,v 1.12 2007/01/29 16:04:26 tizziano Exp $ 
	...
	class procesos_admin extends rs_server
	{
		...
		*********************************************************************************/
		function ConexionBaseDatos($sql)
		{
          ...
          {
               list($dbconn) = GetDBconn();
               $sql  = "DELETE FROM hc_evoluciones_submodulos WHERE evolucion_id = ".SessionGetVar("EvolucionHc")." AND submodulo = 'PlanTerapeuticoHospitalizacion'; ";
               echo $sql .= "INSERT INTO hc_evoluciones_submodulos(ingreso,evolucion_id,submodulo,version,subversion)
                              VALUES(".SessionGetVar("IngresoHc").",".SessionGetVar("EvolucionHc").",'PlanTerapeuticoHospitalizacion','$DatosVersion[version]','$DatosVersion[subversion]')";
