<?php
/**
* $Id: tipo_doc_bodega_E002.class.php,v 1.2 2007/06/08 16:03:38 alexgiraldo Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo E002(EGRESO POR PRESTAMOS)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.2 $
* @package SIIS
*/
class tipo_doc_bodega_E002 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_E002($bodegas_doc_id)
    {
