<?php
/**
* $Id: CGUNO85.class.php,v 1.9 2007/06/27 21:33:33 alexgiraldo Exp $
*/
    ...
    */
    function GetInterfaceDocumentoLapso($empresa_id, $prefijo, $lapso, $dia_inicial=null, $dia_final=null, $directorio=null, $nombre_archivo=null)
    {
        ...
        $sql = "SELECT
                ...
                LEFT JOIN  $SHEMA.$TBL_MOV as c ON (c.documento_contable_id = b.documento_cruce_id)
                LEFT JOIN  $SHEMA.$TBL_MOV as d ON (d.documento_contable_id = b.documento_cxc)
                LEFT JOIN  $SHEMA.$TBL_MOV as e ON (e.documento_contable_id = b.documento_cxp)
