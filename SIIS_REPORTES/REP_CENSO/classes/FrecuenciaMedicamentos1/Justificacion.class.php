<?php
	/**************************************************************************************
	* $Id: Justificacion.class.php,v 1.2 2006/08/30 13:48:33 hugo Exp $ 
	...
	**************************************************************************************/	
		...
		function JustificacionMedicamentos()
    {
      ...
      $this->salida .= "		</tr>";
      $this->salida .= "		<tr class=\"hc_table_submodulo_list_title\">\n";
      $this->salida .= "			<td align=\"center\" class=\"normal_10AN\" >".$medica['producto']."</td>\n";
      $this->salida .= "			<td align=\"center\" class=\"normal_10AN\" >".$medica['principio_activo']."</td>\n";
      $this->salida .= "			<td align=\"center\" class=\"normal_10AN\" >".$medica['cff']."</td>\n";
      $this->salida .= "			<td align=\"center\" class=\"normal_10AN\" >".$medica['forma']."</td>\n";
      $this->salida .= "		</tr>";
      ...
      $this->salida .= "									<td width=\"60%\" align='center' ><textarea style = \"width:100%\" class='textarea' name = 'riesgo_inminente' rows = '2'>".$datos['riesgo_inminente']."</textarea></td>" ;
		...
		*
		*********************************************************************************/
		function ObtenerAlternativas($medicamento)
		{
			$sql .= "SELECT	justificacion_no_pos_id,"; 	 	
			$sql .= "				alternativa_pos_id,";
			$sql .= "				medicamento_pos,";
