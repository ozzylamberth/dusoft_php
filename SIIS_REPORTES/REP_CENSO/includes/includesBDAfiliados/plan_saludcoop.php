...
/**
 * $Id: plan_saludcoop.php,v 1.5 2005/06/07 19:13:17 leydi Exp $
 ...
 */
    ...
    class plan_saludcoop extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida=array();

        function plan_saludcoop($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
