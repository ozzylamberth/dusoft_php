...
function ThemeAbrirTabla($titulo,$porcentaje,$align){
    ...
    if (!$porcentaje){
        ...
        $salida .= "                <TR>\n";
        $salida .= "                    <TD width=\"4\" bgcolor=\"#00A19C\"><IMG src=\"". GetThemePath() ."/images/punto.png\" width=\"1\" height=\"1\"></TD>\n";
...
function ThemeCerrarTabla(){
    ...
    $salida .= "            <TABLE width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n";
    $salida .= "                <TR>\n";
    $salida .= "                    <TD width=\"100%\" height=\"4\" bgcolor=\"#00A19C\"><IMG src=\"". GetThemePath() ."/images/punto.png\" width=\"1\" height=\"1\"></TD>\n";
    $salida .= "                </TR>\n";
    $salida .= "            </TABLE>\n";
    $salida .= "        </TD>\n";
    $salida .= "    </TR>\n";
