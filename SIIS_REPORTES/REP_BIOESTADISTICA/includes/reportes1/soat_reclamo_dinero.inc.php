...
/**
 * $Id: soat_reclamo_dinero.inc.php,v 1.2 2005/06/07 18:40:58 leydi Exp $
 ...
 */
	...
	function GenerarSoatReclamoDinero($datos)
	{
		...
		$html.="<TD WIDTH='460' HEIGHT=25>".substr($datos['informe_accidente'],0,110)."</TD>";
		$html.="</TR>";
		$html.="<TR>";
		$html.="<TD WIDTH='760' HEIGHT=25>".'  '."".substr($datos['informe_accidente'],110,175)."</TD>";
		$html.="</TR>";
		$html.="<TR>";
		$html.="<TD WIDTH='760' HEIGHT=25>".'  '."".substr($datos['informe_accidente'],285,175)."</TD>";
		$html.="</TR>";
		$html.="<TR>";
		...
		$html.="<TD WIDTH='380' HEIGHT=25>****</TD>";
