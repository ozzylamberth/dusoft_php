<?php
/*******************************************************************************
* $Id: fpdf.php,v 1.69 2007/05/17 23:02:18 carlos Exp $
* Software: FPDF                                                               *
* Version:  1.52                                                               *
* Date:     2003-12-30                                                         *
...
function Header()
{
        ...
        if($_SESSION['REPORTES']['VARIABLE']=='factura')
        {
                ...
                {
                  $html="".$this->image('images/logocliente.png',190,4,18)."";//$pdf->image('classes/fpdf/clinicaoccidente.gif'
                  //$html.="<br><br><br>"; 
                  ...
                  $html.="<tr><td width=300>DIRECCION: ".$datos[direccion]."</td><td width=160> TELEFONOS: ".$datos[telefonos]."</td><td width=300>".$datos[municipio]."-".$datos[departamento]."</td></tr>";
                  $html.="<tr><td width=760 colspan=\"3\">".$datos[texto1]."</td></tr>";
                  $html.="<tr><td width=760>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
                  $html.="<tr><td width=460><B>CLIENTE: ".$datos[nombre_tercero]."</B></td><td width=300><B>".$datos[tipo_id_tercero].": ".$datos[tercero_id]."</B></td></tr>";
                  ...
                  $html.="<tr><td width=460><B>PLAN: ".$datos[plan_descripcion]."</B></td><td width=300>DPTO: ".$datos[descripcion]."</td></tr>";
                  $html.="<tr><td width=460>PACIENTE: ".$datos[nombre]."</td><td width=300>HIS/CLI: ".$datos[tipo_id_paciente]." ".$datos[paciente_id]."</td></tr>";
