<?php
/**
* $Id: tipo_doc_bodega_I005.class.php,v 1.4 2007/06/08 15:55:12 alexgiraldo Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo I005(INGRESO POR APROVECHAMIENTO)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.4 $
* @package SIIS
*/
class tipo_doc_bodega_I005 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_I005($bodegas_doc_id)
    {
    ...
    * @access public
    */
    function NewDocTemporal($observacion='', $tipo_aprovechamiento_id, $usuario_id=null)
    {
        ...
        if(empty($tipo_aprovechamiento_id))
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
            $this->mensajeDeError = "PARAMETRO NECERARIO [tipo_aprovechamiento_id] ES REQUERIDO.";
            return false;
        }
        ...
        $sql = "INSERT INTO inv_bodegas_movimiento_tmp
                ...
                INSERT INTO inv_bodegas_movimiento_tmp_aprovechamientos
                    (
                        usuario_id,
                        doc_tmp_id,
    ...
    function GetDocTemporal($doc_tmp_id, $usuario_id=null)
    {
        ...
        $sql="  SELECT  a.*,
                ...
                FROM
                    ...
                    LEFT JOIN inv_bodegas_movimiento_tmp_aprovechamientos as b
    ...
    */
    function CrearDocumento($doc_tmp_id, $usuario_id=null)
    {
        ...
        if(empty($DATOS['tipo_aprovechamiento_id']))
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
        ...
        $sql = "INSERT INTO inv_bodegas_movimiento_aprovechamientos
                (
                    empresa_id,
                    prefijo,
                    numero,
