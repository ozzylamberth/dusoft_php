...
function Header()
{
		...
		if($_SESSION['REPORTES']['VARIABLE']=='estacion_enf')
		{
			...
			$html.= "				<TD WIDTH='140' ><font color='white'><b>INGRESO</b></font></TD>";
			$html.= "				<TD WIDTH='120' ><font color='white'><b>PLAN</b></font></TD>";
			$html.= "				<TD WIDTH='83'><font color='white'><b>CUENTA</b></font></TD></TR>";
			$html.="</TR>";
			$this->Ln(1);
			$this->WriteHTML($html);
		}
		...
		if($_SESSION['REPORTES']['VARIABLE']=='censo')
		{
				...
				$html = "		<br><TABLE WIDTH=\"100\" border=\"1\" align=\"center\" >";
				$html .= "			<TR>";
				$html.= "				<TD align='center' WIDTH=738 ><font color='black'><b>".$_SESSION['ESTACION_ENFERMERIA']['EMP']."</b></font></TD>";
				$html.= "			</TR>";
				$html .= "			<TR>";
				$TITULO='CENSO DIARIO DE PACIENTES INTERNOS - HOSPITALIZADOS DE LA ESTACION :'." ".$_SESSION['ESTACION_ENFERMERIA']['NOM'];
				$html.= "				<TD WIDTH=738 ><font color='black' size=10><b>$TITULO</b></font></TD>";
				$html.= "			</TR>";
				$html.="<TABLE>";
				...
				$html.= "				<TD WIDTH='125' ><font color='white'><b>INGRESO</b></font></TD>";
				$html.= "				<TD WIDTH='103' ><font color='white'><b>PLAN</b></font></TD>";
				$html.= "				<TD WIDTH='58'><font color='white'><b>CUENTA</b></font></TD>";
				$html.= "				<TD WIDTH='67'><font color='white'><b>DIAS HOSP.</b></font></TD></TR>";
				$html.="</TR>";
				$html.="<TR>";
				$this->Ln(1);
				$this->WriteHTML($html);
		...
		if($_SESSION['REPORTES']['VARIABLE']=='cierre_caja')
		{
				...
				$html .= "		<br><br><table width=\"100\" border=\"1\" align=\"center\" >";
				$html .= "			<tr>";
				$datos=DatosEncabezadoEmpresa();
				$html.= "				<td align='center' width=780 ><font color='black'><b>".$datos['razon_social']."</b></font></td>";
				$html.= "			</tr>";
				$html .= "			<tr>";
				$html.= "				<td align='center' width=780 ><font color='black'><b>".$datos['descripcion']."</b></font></td>";
				$html.= "			</tr>";
				$html .= "			<tr>";
				$TITULO='REPORTE DE CIERRE DE CAJA :'." ".strtoupper($datos['descuenta'])." "."[".date("Y-m-d")."]";
				$html.= "				<td width=780 ><font color='black' size=10><b>$TITULO</b></font></td>";
				$html.= "			</tr>";
				$html.="<table>";
				$html .= "		<table width=100% border=\"1\" align=\"center\" >";
				$html.= "				<tr><td  width='68' ><font color='white'><b>RECIBO</b></font></td>";
				$html.= "				<td width='90' ><font color='white'><b>FECHA</b></font></td>";
				$html.= "				<td  width='168'   ><font color='white'><b>CAJA</b></font></td>";
				$html.= "				<td width='91' ><font color='white'><b>T. EFECTIVO</b></font></td>";
				$html.= "				<td width='91' ><font color='white'><b>T. CHEQUE</b></font></td>";
				$html.= "				<td width='91'><font color='white'><b>T. TARJETAS</b></font></td>";
				$html.= "				<td width='91'><font color='white'><b>T. BONOS</b></font></td>";
				$html.= "				<td width='91'><font color='white'><b>SUBTOTAL</b></font></td></tr>";
				$html.="</tr>";
				$html.="<tr>";
				$this->Ln(1);
				$this->WriteHTML($html);
