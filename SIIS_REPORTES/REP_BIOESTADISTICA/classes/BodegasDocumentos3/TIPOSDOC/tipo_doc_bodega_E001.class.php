<?php
/**
* $Id: tipo_doc_bodega_E001.class.php,v 1.2 2007/06/08 16:03:38 alexgiraldo Exp $
*/

/**
* Clase que implenta metodos de BodegasDocumentosComun
*
* Implementa metodos para documentos de bodega del tipo E001(EGRESO POR PERDIDAS, DAÑOS Y DETERIORO)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.2 $
* @package SIIS
*/
class tipo_doc_bodega_E001 extends BodegasDocumentosComun
{
    /**
    * Constructor
    *
    ...
    * @access public
    */
    function tipo_doc_bodega_E001($bodegas_doc_id)
    {
    ...
    * @access public
    */
    function NewDocTemporal($observacion='', $tipo_perdida_id, $usuario_id=null)
    {
        ...
        if(empty($tipo_perdida_id))
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
            $this->mensajeDeError = "PARAMETRO NECERARIO [tipo_perdida_id] ES REQUERIDO.";
            return false;
        }
        ...
        $sql = "INSERT INTO inv_bodegas_movimiento_tmp
                ...
                INSERT INTO inv_bodegas_movimiento_tmp_perdidas
                    (
                        usuario_id,
                        doc_tmp_id,
                        tipo_perdida_id
    ...
    function GetDocTemporal($doc_tmp_id, $usuario_id=null)
    {
        ...
        $sql="  SELECT  a.*,
                ...
                FROM
                    ...
                    LEFT JOIN inv_bodegas_movimiento_tmp_perdidas as b
    ...
    */
    function CrearDocumento($doc_tmp_id, $usuario_id=null)
    {
        ...
        if(empty($DATOS['tipo_perdida_id']))
        {
            $this->error = "[" . get_class($this) . "][" . __LINE__ . "]";
        ...
        $sql = "INSERT INTO inv_bodegas_movimiento_perdidas
                (
                    empresa_id,
                    prefijo,
                    numero,
