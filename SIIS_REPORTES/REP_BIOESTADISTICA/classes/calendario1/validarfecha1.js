...
var errDate="El formato de la fecha es   [dd/mm/aaaa]";
var errDateLen="La longitud de la fecha es incorrecto.";
var errDateFormat="El formato de la fecha es incorrecto.";
var errNotNumeric="Los caracteres de fecha deben ser numericos.";
var errYear="El año es incorrecto.";
var errMonth="El mes es incorrecto.";
var errDay="El día es incorrecto.";
...
function IsValidDate(objDate,sFormat)
{
   ...
   { sLang = "DE8601"; }
   else if ( sFormat == "dd/mm/YYYY" ) /* english */
   { sLang = "EN"; }
   else
   {// if (bDebug)
     { //alert("wrong sFormat");
