<?php
/**
* $Id: InterfacesContables.class.php,v 1.9 2007/04/26 16:08:36 alexgiraldo Exp $
*/
    ...
    function GetInformacionDocumentosLapso($empresa_id,$lapso,$dia_inicial=null,$dia_final=null)
    {
        ...
        while($fila = $result->FetchRow())
        {
            $sql = "
                    ...
                    WHERE prefijo IN (SELECT DISTINCT prefijo FROM public.documentos WHERE tipo_doc_general_id = '".$fila['tipo_doc_general_id']."')
                    AND lapso = '$lapso'
                    $filtro_dias
                    GROUP BY prefijo
            ";
