...
/**
* $Id: Contabilizar_I001.class.php,v 1.4 2007/06/26 21:27:17 alexgiraldo Exp $
*/

/**
* Clase para la contabilizacion y consulta de la misma de documentos de tipo I001(INGRESOS INVENTARIO POR COMPRA)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.4 $
* @package SIIS
*/
class Contabilizar_I001 extends ContabilizarDocumento
{
    ...
    */
    function ContabilizarDoc($empresa_id,$prefijo,$numero,$actualizar=false)
    {
        ...
        $sql = "SELECT
                    ...
                    'I001' as tipo_doc_general_id

                FROM
                    inv_bodegas_movimiento as a,
                    inv_bodegas_movimiento_compras_directas as b
    ...
    */
    function Contabilizar_DocInv()
    {
        ...
        while($fila = $result->FetchRow())
        {
            ...
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "INGRESO POR COMPRA I001";
            ...
            $Datos['tipo_id_tercero']    = "";
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "INGRESO POR COMPRA CxP I001";
