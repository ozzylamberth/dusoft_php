...
/**
* $Id: Contabilizar_I007.class.php,v 1.1 2007/07/09 15:23:54 alexgiraldo Exp $
*/

/**
* Clase para la contabilizacion y consulta de la misma de documentos de tipo I007(INGRESOS POR CONSIGNACION O PRESTAMOS)
*
* @author Alexander Giraldo -- alexgiraldo@ipsoft-sa.com
* @version $Revision: 1.1 $
* @package SIIS
*/
class Contabilizar_I007 extends ContabilizarDocumento
{
    ...
    */
    function ContabilizarDoc($empresa_id,$prefijo,$numero,$actualizar=false)
    {
        ...
        $sql = "SELECT
                    ...
                    d.descripcion as descripcion_prestamo,
                    'I007' as tipo_doc_general_id

                FROM
                    inv_bodegas_movimiento as a,
                    inv_bodegas_movimiento_prestamos as b,
                    terceros as c,
                    inv_bodegas_tipos_prestamos as d
                ...
                WHERE
                    ...
                    AND d.tipo_prestamo_id = b.tipo_prestamo_id;
        ";
    ...
    */
    function Contabilizar_DocInv()
    {
        ...
        while($fila = $result->FetchRow())
        {
            ...
            $Datos['tercero_id']         = "";
            $Datos['detalle']            = "INGRESO POR : " . $this->DatosDocInv['descripcion_prestamo'];
