...
/**
 * $Id: app_CajaGeneral_adminclasses_HTML.php,v 1.5 2010/11/18 14:18:05 hugo Exp $
...
class app_CajaGeneral_adminclasses_HTML extends app_CajaGeneral_admin
{
	/**
  ...
  function app_CajaGeneral_admin_HTML()
	{
		$this->salida='';
		$this->app_CajaGeneral_admin();
		return true;
	}
