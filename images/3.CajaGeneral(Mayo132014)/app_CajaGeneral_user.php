    ...
    function InsertarConceptos() {
       ...
       $resultadoFI = UpdateImpuestosFacFacturas($_SESSION['CAJA']['EMPRESA'], $prefijo, $factura);*/
        ...
        if($resultadoFI['crearInformacionContableResult']['estado']==FALSE){
            $mensajeFI  = "INTEGRACIÓN FI "."<BR>";
            $mensajeFI .=  $resultadoFI['crearInformacionContableResult']['descripcion']." Factura Número: ".$resultadoFI['crearInformacionContableResult']['numerodoc']."<BR>";
        }
