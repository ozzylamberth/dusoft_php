...
/**
 * $Id: Devolucion.report.php,v 1.5 2010/11/18 14:18:05 hugo Exp $
...
class Devolucion_report extends pos_reports_class
{
    ...
    function CrearReporte()
    {
        ...
        $total=0;
     		...
     		$reporte->SaltoDeLinea();	
				...
				$reporte->PrintFTextoValor('TOTAL DEVOLUCION',$datos[total_devolucion],0,true,11,true,'right');
				$reporte->SaltoDeLinea();
				$reporte->SaltoDeLinea();
