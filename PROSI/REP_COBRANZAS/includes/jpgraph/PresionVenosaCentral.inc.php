...
/**
 * $Id: PresionVenosaCentral.inc.php,v 1.2 2005/06/07 18:28:18 leydi Exp $
...
function GraficarPresionVenosaCentral($Vmax,$Vmin,$DatosF,$todos,$fechaE,$DatosH)
{
	...
	$seq=$result->fields[0];
	$Dir="cache/PVC$seq.png";

	if(!$todos){
		foreach($DatosH as $key =>$value){
			$ydata[count($ydata)]=$value['pvc'];
...
*/
		...
		$graph->title->Set("PRESION VENOSA CENTRAL");
