...
echo "<table border=1>\n";
echo "<tr>\n";
echo "<td  background='WHITE' colspan='12' bgcolor='#EEEEEE'><div align='center'><strong><font color='BLACK' size='2'>Pacientes Ingresados entre $input9 y $input10</font></strong></div></td>\n";
echo "</tr>\n";
echo "<tr>\n";
...
echo "<td bgcolor='$color_body'><div align='left'>$fetch_max[4]"." "."$fetch_max[5]</div></td>\n";
echo "<td bgcolor='$color_body'><div align='left'>$fetch_max[6]"." "."$fetch_max[7]"." "."$fetch_max[8]"." "."$fetch_max[9]</div></td>\n";
...
echo "<tr>\n";
echo "<td  background='WHITE' colspan='12' bgcolor='#EEEEEE'><div align='center'><strong><font color='BLACK' size='2'>Pacientes Hospitalizados</font></strong></div></td>\n";
echo "</tr>\n";
...
echo "<td bgcolor='$color_body'><div align='left'>$fetch_max1[4]"." "."$fetch_max1[5]</div></td>\n";
echo "<td bgcolor='$color_body'><div align='left'>$fetch_max1[6]"." "."$fetch_max[7]"." "."$fetch_max1[8]"." "."$fetch_max1[9]</div></td>\n";
