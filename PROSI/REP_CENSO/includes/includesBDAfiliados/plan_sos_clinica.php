...
/**
 * $Id: plan_sos_clinica.php,v 1.5 2005/06/07 19:13:17 leydi Exp $
 ...
 */
    ...
    class plan_sos_clinica extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida=array();

        function plan_sos_clinica($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
