...
/**
 * $Id: Factura_Agrupada.inc.php,v 1.3 2007/05/18 19:12:06 carlos Exp $
 ...
 */
  ...
  */
  ...
  function GenerarFactura_Agrupada($datos)
  {
	...
	$html.="<tr><td width=685 colspan=\"2\" align='LEFT'>".$datos[0][concepto]."</td><td width=100>".$datos[0][total_factura]."</td></tr>";
	$html.="<tr><td width=402>&nbsp;</td><td width=153>TOTAL FACTURADO</td><td width=130>&nbsp;</td>".$datos[0][total_factura]."</td></tr>";
	$html.="<tr><td width=402>&nbsp;</td><td width=153>TOTAL IVA</td><td width=130>&nbsp;</td>".FormatoValor($datos[0][gravamen])."</td></tr>";
	$total=FormatoValor($datos[0][total_factura]);

	$totall=str_replace(".","",$total);
	$html.="<tr><td width=112>SON :"." ".convertir_a_letras($totall)."</td><td width=290>&nbsp;</td><td width=133>TOTAL A PAGAR</td><td width=150>&nbsp;</td><td>".FormatoValor($datos[0][total_factura])."</td></tr>";
