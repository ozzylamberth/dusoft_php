...
/**
 * $Id: facturaconceptos_COC.inc.php,v 1.7 2007/07/03 18:45:11 carlos Exp $
...
/*      $pro=DatosHonorariosVariasCuentas($cuentas);
      ...
      $valpagarcliente=$datos[valor_total_empresa];      
			...
			$html.="<tr><td width=80>&nbsp;</td><td width=680 align=''>2. Código CIIU 307-08 tarifa 6.6 X 1000 por conceptos diferentes a los del numeral 1.</td></tr>";
			...
			if($datos['facturaAnulada'])
			{
				...
				$pdf->RotatedText(80,175,'ANULADA',40);
				$pdf->SetTextColor(203,203,203);
