...
/**
 * $Id: factura_COC_DESCUENTO.inc.php,v 1.3 2006/07/19 14:29:05 lorena Exp $
...
/*		$pro=DatosHonorariosVariasCuentas($cuentas);
  ...
  //fin cambio  
	...
	$html.="<tr><td width=760>&nbsp;</td></tr>";
	$html.="<tr><td width=760>&nbsp;</td></tr>";
	$descuento=$valpagarcliente*0.1;
	$neto=$valpagarcliente-($valpagarcliente*0.1);
	$html.="<tr><td width=560>DESCUENTO ESPECIAL UNICAMENTE POR PAGO ANTES DE 30 DIAS  --------------------------------------------------------------------------------------------------------------</td><td width=200 align=RIGHT>".FormatoValor($descuento)."</td></tr>";
	$html.="<tr><td width=560>VALOR NETO CON DESCUENTO  --------------------------------------------------------------------------------------------------------------------------------------------------------------------</td><td width=200 align=RIGHT>".FormatoValor($neto)."</td></tr>";
	$html.="</table>";
