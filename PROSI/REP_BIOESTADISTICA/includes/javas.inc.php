...
/**
 * $Id: javas.inc.php,v 1.16 2007/01/22 14:33:37 jgomez Exp $
    ...
    */
    ...
    function ReturnJava($Java)
    {
        ...
        switch($Java){
                                ...
                                case 'DetalleCamas':{
                                    $salida ="<script>\n";
                                    $salida .="function DetalleCamas(Ingreso)\n";
                                    $salida .="{\n";
                                    $salida .="var url='reports/$VISTA/movimientoscamas.php?ingreso='+Ingreso;\n";
