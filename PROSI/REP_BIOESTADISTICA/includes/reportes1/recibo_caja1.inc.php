...
/**
 * $Id: recibo_caja.inc.php,v 1.9 2005/11/16 15:20:59 carlos Exp $
...
//GENERAR RECIBO DE CIERRE CONFIRMADO
 			function GenerarReciboCajaCierre($datos)
			{ 
//print_r($datos); exit;
					unset($_SESSION['REPORTES']['VARIABLE']);
					//IncludeLib("tarifario");
...
//RECIBO CONCEPTOS
 			function GenerarReciboConceptos($datos)
			{
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					$nom.=$datos['nombre'];
					$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>RECIBO DE CAJA</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['factura_fiscal'].$datos['prefijo']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>EMPRESA:</TD><TD WIDTH='380' HEIGHT=22>".$datos['razon_social']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>CENTRO DE UTILIDAD:</TD><TD WIDTH='380' HEIGHT=22>".$datos['descripcion']."</TD></TR>";
...
//FIN RECIBO CONCEPTOS
 			...
 			function GenerarReciboDevolucion($datos)
			{
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					$nom.=$datos['nombre'];
					$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>DEVOLUCIÓN DE CAJA</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['recibo_caja'].$datos['prefijo']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>EMPRESA:</TD><TD WIDTH='380' HEIGHT=22>".$datos['razon_social']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>CENTRO DE UTILIDAD:</TD><TD WIDTH='380' HEIGHT=22>".$datos['descripcion']."</TD></TR>";
