...
/**
 * $Id: plan_sisben.php,v 1.3 2005/06/07 19:13:17 leydi Exp $
 ...
 */
    ...
    class plan_sisben extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida='';

        function plan_sisben($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
            ...
            return $tipoafiliado;
				...
				function SqlGetPacientesConNombres($nombres,$apellidos)
				{
					...
					else
					{
						...
						$sql="select ".$this->campo_tipodocumento." as tipodocumento, ".$this->campo_documento." as documento, $nombre as nombre, ".$this->campo_estado_bd." as estado from \"".$this->campo_nombre_tabla."\"
