...
/**
 * $Id: plan_coomeva_pre.php,v 1.5 2005/06/07 19:13:17 leydi Exp $
 ...
 */
    ...
    class plan_1 extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida=array();

        function plan_1($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
