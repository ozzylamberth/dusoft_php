...
/**
 * $Id: plan_riofrio.php,v 1.5 2005/06/07 19:13:17 leydi Exp $
 ...
 */
    ...
    class plan_riofrio extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida=array();

        function plan_riofrio($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
            ...
            return $tipoafiliado;
				...
				function SqlGetPacientesConNombres($nombres,$apellidos)
				{
					...
					else
					{
						...
						$sql="select ".$this->campo_tipodocumento." as tipodocumento, ".$this->campo_documento." as documento, $nombre as nombre, 'ACTIVO' as estado from \"".$this->campo_nombre_tabla."\"
