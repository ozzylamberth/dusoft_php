...
/**
 * $Id: malla_validadora.inc.php,v 1.22 2005/07/28 19:53:56 darling Exp $
...
function MallaValidadora($evolucion)
{
    ...
    $query = "SELECT cargo,hc_os_solicitud_id,cantidad,sw_estado  FROM hc_os_solicitudes
                WHERE evolucion_id = $evolucion
    ...
    {
        $cargo_autorizado = MallaValidadoraValidarCargo($cargo_solicitud[cargo],$datosCuenta[plan_id],$servicio_evolucion,$cargo_solicitud[hc_os_solicitud_id],$cargo_solicitud[cantidad],$cargo_solicitud[sw_estado]);
...
//OJO REVISAR AQUI
   ...
   /* $query="SELECT departamento
    ...
    if(!empty($departamento)){
        ...
        return array('cargo_cups'=>$cargo_base,'cargos'=>array('0'=>array('tarifario'=>$tarifario,'cargo'=>$cargo)),'departamento'=>$departamento,'cantidad'=>$cantidad,'hc_os_solicitud_id'=>$hc_os_solicitud_id,'sw_estado_solicitud'=>$estado_solicitud);
    }
