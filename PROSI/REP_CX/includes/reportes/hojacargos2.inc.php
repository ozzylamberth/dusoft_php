...
/**
 * $Id: hojacargos2.inc.php,v 1.23 2007/06/06 16:36:27 carlos Exp $
...
//      $totalins=$devoluciones=0;
      if(!empty($ins))
      {
         $totalins=$devoluciones=0;
          ...
          $html.="<tr><td width=520><B>0  TOTAL ".$ins[0][desagru]."-----------------------------------------------------------------------------------------------------</B></td><td width=60 align=\"CENTER\"><B>".FormatoValor($sub)."</B></td></tr>";
          $devoluciones=$sub;
      }
      if(!empty($medicamentos))
      {
          $html.="<tr><td width=520><B>1  TOTAL MEDICAMENTOS E INSUMOS ---------------------------------------------------------------------------------------------------------</B></td><td width=60 align=\"CENTER\"><B>".FormatoValor($medicamentos+$devoluciones)."</B></td></tr>";
      }
      
      $html.=$ha;
      $html.=$direc;
      $html.="<tr><td width=520><B>TOTAL DE CARGOS: </B></td><td width=240 align=\"RIGHT\"><B>".FormatoValor($totalcar)."</B></td></tr>";
      $html.="<tr><td width=520><B>2TOTAL DE MEDICAMENTOS E INSUMOS: </B></td><td width=240 align=\"RIGHT\"><B>".FormatoValor($medicamentos+$devoluciones)."</B></td></tr>";
      if(!empty($var) || !empty($ins)){
