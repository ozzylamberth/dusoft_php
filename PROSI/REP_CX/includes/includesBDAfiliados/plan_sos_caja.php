...
/**
 * $Id: plan_sos_caja.php,v 1.5 2005/06/07 19:13:17 leydi Exp $
 ...
 */
    ...
    class plan_sos_caja extends BDAfiliadosMC
    {
				var $error="";
				var $mensajeDeError="";
        var $salida=array();

        function plan_sos_caja($tipoidpaciente,$paciente,$dbtype,$dbhost,$dbuser,$dbpass,$dbname,$dbtabla,$fecha_radicacion,$fecha_vencimiento,$datos)
        {
