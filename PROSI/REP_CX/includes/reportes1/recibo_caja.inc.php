...
/**
 * $Id: recibo_caja.inc.php,v 1.13 2006/02/09 21:34:34 carlos Exp $
 ...
 */
	...
	function DetallesDevolucion($recibo,$prefijo)
	{
			list($dbconn) = GetDBconn();

			$query = "SELECT numerodecuenta as cuenta
								FROM  rc_devoluciones WHERE recibo_caja=$recibo
								AND prefijo='$prefijo'";
  		$result = $dbconn->Execute($query);
			...
			{ 
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					$nom.=$datos['nombre'];
					$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>RECIBO DE CAJA</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['prefijo'].$datos['recibo_caja']."</TD></TR>";
...
//GENERAR RECIBO DE CIERRE CONFIRMADO
 			function GenerarReciboCajaCierre($datos,$sw)
			{ 
//print_r($datos); 
//echo '>>'.$sw; exit;
					unset($_SESSION['REPORTES']['VARIABLE']);
					...
					include("classes/fpdf/conversor.php");
					if($sw)
						$Dir="cache/ReciboCajaRapida".UserGetUID().".pdf";
					else
						$Dir="cache/Recibo".UserGetUID().".pdf";
					//$Dir="cache/Recibo.pdf";
					require("classes/fpdf/html_class.php");
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					*/$html.="<TR>";
					if($sw)
						$html.="<TD WIDTH='180' HEIGHT='22'><b>NUMERO DE CAJA :"." ".$datos['caja_id']." </b></TD><TD WIDTH='180' HEIGHT='22'><b> USUARIO :"." ".$datos['usuario']."</b></TD>";
					else
						$html.="<TD WIDTH='150' HEIGHT='22'><b>NUMERO DE CAJA :"." ".$datos['caja_id']." </b></TD><TD WIDTH='150' HEIGHT='22'><b> USUARIO :"." ".$datos['usuario']."</b></TD>";
					$html.="</TR>";
					$html.="<TR>";
...
//FIN GENERAR RECIBO DE CIERRE CONFIRMADO

//RECIBO CONCEPTOS
 			function GenerarReciboConceptos($datos)
			{
					//print_r($datos);
					unset($_SESSION['REPORTES']['VARIABLE']);
					IncludeLib("tarifario");
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					$nom.=$datos['nombre'];
					$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>RECIBO DE CAJA</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['prefijo'].$datos['factura_fiscal']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>EMPRESA:</TD><TD WIDTH='380' HEIGHT=22>".$datos['razon_social']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>CENTRO DE UTILIDAD:</TD><TD WIDTH='380' HEIGHT=22>".$datos['descripcion']."</TD></TR>";

					$fe=explode(" ",$datos['fecha_registro']);
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>FECHA :</TD><TD WIDTH='380' HEIGHT=22>".$fe[0]."</TD></TR>";

						$html.="<TR><TD WIDTH='380' HEIGHT='22'>CLEINTE:</TD><TD WIDTH='380' HEIGHT='22'><b>".$nom."   CON ".$datos['id']."</b></TD></TR>";
...
//FIN RECIBO CONCEPTOS

 			function GenerarReciboDevolucion($datos)
			{
					//print_r($datos);EXIT;
					unset($_SESSION['REPORTES']['VARIABLE']);
					//IncludeLib("tarifario");
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					if($_SESSION['CAJA']['TIPOCUENTA']=='01')
					{
							$dat=DetallesDevolucion($datos['recibo_caja'],$datos['prefijo']);
							$info='Devolución de caja a la cuenta'." ".$dat['cuenta']." "." Hospitalaria";
					}

					if($_SESSION['CAJA']['TIPOCUENTA']=='02')
					{
							$dat=DetallesDevolucion($datos['recibo_caja'],$datos['prefijo']);
							$info='Devolución de caja a la cuenta'." ".$dat['cuenta']." "."de punto de venta";
					}
					...
					$nom.=$datos['nombre'];
					$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>DEVOLUCIÓN DE CAJA</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['prefijo'].$datos['recibo_caja']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>EMPRESA:</TD><TD WIDTH='380' HEIGHT=22>".$datos['razon_social']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>CENTRO DE UTILIDAD:</TD><TD WIDTH='380' HEIGHT=22>".$datos['descripcion']."</TD></TR>";
					...
					$html.="<TABLE WIDTH='1520' ALIGN='CENTER' border='1'>";
					$html.="<TR>";
					$html.="<TD WIDTH='200' HEIGHT='22'>TOTAL EFECTIVO:</TD><TD WIDTH='560' HEIGHT='22' ALIGN='RIGHT'>".FormatoValor($datos['total_devolucion'])."</TD>";
					$html.="</TR>";
/*					$html.="<TR>";
					$html.="<TD WIDTH='200' HEIGHT='22'>TOTAL CHEQUES:</TD><TD WIDTH='560' HEIGHT='22' ALIGN='RIGHT'>".FormatoValor($datos['total_cheques'])."</TD>";
					$html.="</TR>";
					...
					$html.="</TR>";*/
					$html.="<TR>";
					$totalpagar=$datos['total_devolucion'];
					$html.="<TD WIDTH='200' HEIGHT='22'>TOTAL DEVOLUCIÓN:</TD><TD WIDTH='560' HEIGHT='22' ALIGN='RIGHT'><b>".FormatoValor($totalpagar)."</b></TD>";
					$html.="</TR>";
					$html.="</TABLE>";
					$html.="<TABLE WIDTH='1520' ALIGN='RIGHT' border='0'>";
					/*$html.="<TR>";
					...
					*/
					...
					//$html.="<BR>";
					$html.="<TR>";
					$html.="<TD WIDTH='150' HEIGHT='22'><b>FIRMA BENEFICIARIO_________________________</b></TD>";
					$html.="</TR>";
					$html.="<TR>";
					$html.="<TD WIDTH='150' HEIGHT='22'><b>DOCUMENTO BENEFICIARIO_____________________</b></TD>";
					$html.="</TR>";
					$html.="<TR>";
					$html.="<TD WIDTH='150' HEIGHT='22'><b>TELEFONO_____________________</b></TD>";
					$html.="</TR>";
					$html.="<TR>";
					$html.="<TD ALIGN='RIGHT' WIDTH='760'>";
					$html.="<FONT SIZE='6'>"._SIIS_APLICATION_TITLE."</FONT>";
 			...
 			function GenerarReciboDevolucionControlCierre($datos)
			{
					//print_r($datos); exit;
					unset($_SESSION['REPORTES']['VARIABLE']);
					IncludeLib("tarifario");
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					$nom.=$datos['nombre'];
					$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>DEVOLUCIÓN DE CAJA</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['prefijo'].$datos['devolucion_id']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>EMPRESA:</TD><TD WIDTH='380' HEIGHT=22>".$datos['razon_social']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>CENTRO DE UTILIDAD:</TD><TD WIDTH='380' HEIGHT=22>".$datos['descripcion']."</TD></TR>";
			...
			function	GenerarReciboAbonoPagare($datos)
			{
					unset($_SESSION['REPORTES']['VARIABLE']);
					IncludeLib("tarifario");
					include("classes/fpdf/conversor.php");
     			...
     			$pdf=new PDF('P','mm','recibo');
					...
					$info='Abonos a cuentas pagares.';
					$nom.=$datos['nombre'];
					//$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>ABONO PAGARÉ</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['prefijo']." "."-"." ".$datos['recibo_caja']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=30 WIDTH='380'><font size='24'><b>ABONO PAGARÉ</b></font></TD><TD WIDTH='380' HEIGHT=30>".$datos['prefijo'].$datos['recibo_caja']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>EMPRESA:</TD><TD WIDTH='380' HEIGHT=22>".$datos['razon_social']."</TD></TR>";
					$html.="<TR><font color='#000000'><TD HEIGHT=22 WIDTH='380'>CENTRO DE UTILIDAD:</TD><TD WIDTH='380' HEIGHT=22>".$datos['descripcion']."</TD></TR>";
					...
					$html.="<TR><TD WIDTH='380' HEIGHT='22'>PACIENTE:</TD><TD WIDTH='380' HEIGHT='22'><b>".$datos['nombre']."   CON ".$datos['id']."</b></TD></TR>";
					...
					$html.="<TR>";
					$totalpagar=$datos['total_abono'];
					$html.="<TD WIDTH='200' HEIGHT='22'>TOTAL ABONO:</TD><TD WIDTH='560' HEIGHT='22' ALIGN='RIGHT'><b>".FormatoValor($totalpagar)."</b></TD>";
					$html.="</TR>";
					$html.="</TABLE>";
					$html.="<TABLE WIDTH='1520' ALIGN='RIGHT' border='0'>";
					/*$html.="<TR>";
