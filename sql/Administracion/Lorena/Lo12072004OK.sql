CREATE TABLE pacientes_grupo_sanguineo(
  tipo_id_paciente character varying(3),
	...
	observaciones text,
	fecha_examen date,
	tipo_id_bacteriologo character varying(3),
	bacteriologo_id character varying(32),
	usuario_id integer,
	fecha_registro timestamp without time zone
);
ALTER TABLE pacientes_grupo_sanguineo ADD COLUMN estado character (1);
ALTER TABLE pacientes_grupo_sanguineo ALTER COLUMN estado SET NOT NULL;
ALTER TABLE pacientes_grupo_sanguineo ALTER COLUMN estado SET DEFAULT 1;
ALTER TABLE pacientes_grupo_sanguineo ADD FOREIGN KEY (tipo_id_paciente,paciente_id) REFERENCES pacientes(tipo_id_paciente,paciente_id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE pacientes_grupo_sanguineo ADD FOREIGN KEY (grupo_sanguineo,rh) REFERENCES hc_tipos_sanguineos(grupo_sanguineo,rh) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE pacientes_grupo_sanguineo ADD FOREIGN KEY (tipo_id_bacteriologo,bacteriologo_id) REFERENCES profesionales(tipo_id_tercero,tercero_id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE pacientes_grupo_sanguineo ADD FOREIGN KEY (usuario_id) REFERENCES system_usuarios(usuario_id) ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE ONLY banco_sangre_reserva ALTER COLUMN grupo_sanguineo DROP NOT NULL;
ALTER TABLE ONLY banco_sangre_reserva ALTER COLUMN rh DROP NOT NULL;


--*********************************NUEVOS*********************************


ALTER TABLE  hc_tipos_sanguineos ADD COLUMN indice_de_orden character (1);
UPDATE hc_tipos_sanguineos SET indice_de_orden='0';
ALTER TABLE  hc_tipos_sanguineos ALTER COLUMN indice_de_orden SET NOT NULL;
ALTER TABLE  hc_tipos_sanguineos ALTER COLUMN indice_de_orden SET DEFAULT '0';

CREATE TABLE hc_tipos_rh(
  rh character(1),
	descripcion character(50)
);
ALTER TABLE hc_tipos_rh ADD PRIMARY KEY(rh);
INSERT INTO hc_tipos_rh(rh,descripcion)VALUES('+','POSITIVO');
INSERT INTO hc_tipos_rh(rh,descripcion)VALUES('-','NEGATIVO');
ALTER TABLE hc_tipos_sanguineos ADD FOREIGN KEY(rh) REFERENCES hc_tipos_rh(rh) ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE hc_tipos_componentes ADD COLUMN dias_calculo_fecha_extraccion smallint;

ALTER TABLE banco_sangre_bolsas_incineradas DROP CONSTRAINT banco_sangre_bolsas_incineradas_pkey;
ALTER TABLE banco_sangre_bolsas_incineradas ADD PRIMARY KEY(ingreso_bolsa_id,numero_alicuota);
...
CREATE TABLE banco_sangre_cruzes_sanguineos(
    ...
    interpretacion_grupo_manual character varying(2),
    interpretacion_rh_manual character(1),
    tipo_id_profesional_manual character varying(3),
    profesional_manual_id character varying(32),
    ...
    celulas_0 character(1),
		interpretacion_grupo_gel character varying(2),
    interpretacion_rh_gel character(1),
    tipo_id_profesional_gel character varying(3),
    profesional_gel_id character varying(32),
...
/*ALTER TABLE banco_sangre_cruzes_sanguineos DROP COLUMN interpretacion_grupo_cruze;
ALTER TABLE banco_sangre_cruzes_sanguineos DROP COLUMN interpretacion_rh_cruze;
ALTER TABLE banco_sangre_cruzes_sanguineos DROP COLUMN tipo_id_profesional_cruze;
ALTER TABLE banco_sangre_cruzes_sanguineos DROP COLUMN profesional_cruze_id;
*/
