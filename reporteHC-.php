...
// 	$resultado->Close();
	...
	function PrinterVerReporte($report_html,$report_pdf)
	{
		...
		$Salida.="<TD align='center' class='modulo_list_claro' ><input type=\"button\" value=\"HTML\" onclick=\"javascript:VerReporteHTML()\"></TD>\n";
		$Salida.="<TD align='center' class='modulo_list_claro' ><input type=\"button\" value=\"PDF\" onclick=\"javascript:VerReportePDF()\"></TD>\n";
		$Salida.="</TR>\n";
		$Salida.="</TABLE><BR>\n";
