...
$server->register('sincronizarFormula', array('datos_evolucion' => 'tns:WS_datos_evolucion',
    ...
    'datos_medico' => 'tns:WS_datos_medico'),
...
$server->register('sincronizarTranscripcion', array('datos_evolucion' => 'tns:WS_datos_evolucion',
    ...
    'formulacion_antecedentes' => 'tns:WS_listado_formulacion_antecedentes',
    'datos_medico' => 'tns:WS_datos_medico'),
        array('return' => 'tns:WS_resultado'), "urn:formulacion_ws", "urn:formulacion_ws#sincronizarFormula", "rpc", "encoded", "Webservice: Permite la Sincronizacion de las Transcripciones de COSMITET - DUANA para el proceso de DISPENSACION");
...
//////////////////////////////////AMG////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$server->register('verficarMedico', array('terceros' => 'tns:WS_medico'),
    array('return' => 'tns:WS_resultado'), "urn:formulacion_ws", "urn:formulacion_ws#sincronizarFormula", "rpc", "encoded", "Webservice: Consulta si un Medico esta registrado en Duana");
/////////////////////////////////////////////////////////////////////
//////////////////////////////////AMG///////////////////////////////
// agregar tercero
$server->register('agregarMedico', array('terceros' => 'tns:WS_terceros','profesional' => 'tns:WS_profesional','especialidad' => 'tns:WS_profesionales_especialidad'),//,'especialidad' => 'tns:WS_profesionales_especialidad'
    array('return' => 'tns:WS_resultado'), "urn:formulacion_ws", "urn:formulacion_ws#sincronizarFormula", "rpc", "encoded", "Webservice: Permite insertar Medico en Duana");
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
...
$server->register('consultar_dispensacion_formula', array('numero_formula' => 'xsd:string',
    'tipo_formula' => 'xsd:string',
	'numero_entrega' => 'xsd:string',
	'no_validar_fecha' => 'xsd:string'), 
	array('return' => 'tns:WS_resultado_dispensacion_formula'), "urn:formulacion_ws", "urn:formulacion_ws#sincronizarFormula", "rpc", "encoded", "Webservice: Permite consultar si la formula ya tiene medicamentos despachados");
...
/////////////////////////////////////////////////TERCEROS////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$server->wsdl->addComplexType('WS_terceros', 'complexType', 'struct', 'all', '', array(     
    
    'tercero_id' => array('name' => 'tercero_id', 'type' => 'xsd:string'),
    'tipo_id_tercero' => array('name' => 'tipo_id_tercero', 'type' => 'xsd:string'),
    'tipo_pais_id' => array('name' => 'tipo_pais_id', 'type' => 'xsd:string'), 
    'tipo_dpto_id' => array('name' => 'tipo_dpto_id', 'type' => 'xsd:string'), 
    'tipo_mpio_id' => array('name' => 'tipo_mpio_id', 'type' => 'xsd:string'), 
    'direccion' => array('name' => 'direccion', 'type' => 'xsd:string'), 
    'telefono' => array('name' => 'telefono', 'type' => 'xsd:string'), 
    'fax' => array('name' => 'fax', 'type' => 'xsd:string'), 
    'email' => array('name' => 'email', 'type' => 'xsd:string'), 
    'celular' => array('name' => 'celular', 'type' => 'xsd:string'), 
    'sw_persona_juridica' => array('name' => 'sw_persona_juridica', 'type' => 'xsd:string'), 
    'cal_cli' => array('name' => 'cal_cli', 'type' => 'xsd:string'), 
    'usuario_id' => array('name' => 'usuario_id', 'type' => 'xsd:string'), 
    'fecha_registro' => array('name' => 'fecha_registro', 'type' => 'xsd:string'), 
    'busca_persona' => array('name' => 'busca_persona', 'type' => 'xsd:string'), 
    'nombre_tercero' => array('name' => 'nombre_tercero', 'type' => 'xsd:string'), 
    ...
    'cod_entidad' => array('name' => 'cod_entidad', 'type' => 'xsd:string'), 
    'cod_ciu' => array('name' => 'cod_ciu', 'type' => 'xsd:string'), 
    'tipo_tercero' => array('name' => 'tipo_tercero', 'type' => 'xsd:string'), 
    'tipo_contribuyente' => array('name' => 'tipo_contribuyente', 'type' => 'xsd:string'), 
    'retencion' => array('name' => 'retencion', 'type' => 'xsd:string'), 
    'porc_ica' => array('name' => 'porc_ica', 'type' => 'xsd:string'), 
    'valor_tope' => array('name' => 'valor_tope', 'type' => 'xsd:string'), 
    'porc_reteiva' => array('name' => 'porc_reteiva', 'type' => 'xsd:string'), 
    'cod_pais_residencia' => array('name' => 'cod_pais_residencia', 'type' => 'xsd:string'), 
    'man_ica' => array('name' => 'man_ica', 'type' => 'xsd:string'), 
    'man_tope' => array('name' => 'man_tope', 'type' => 'xsd:string'), 
    'tipo_bloqueo_id' => array('name' => 'tipo_bloqueo_id', 'type' => 'xsd:string'), 
    'empresa_id_dllo' => array('name' => 'empresa_id_dllo', 'type' => 'xsd:string'), 
    'empresa_id' => array('name' => 'empresa_id', 'type' => 'xsd:string')
));
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////PROFESIONALES////////////////////////
$server->wsdl->addComplexType('WS_profesional', 'complexType', 'struct', 'all', '', array(     
    'tipo_id_tercero' => array('name' => 'tipo_id_tercero', 'type' => 'xsd:string'),
    'tercero_id' => array('name' => 'tercero_id', 'type' => 'xsd:string'), 
    'nombre' => array('name' => 'nombre', 'type' => 'xsd:string'), 
    'tipo_profesional' => array('name' => 'tipo_profesional', 'type' => 'xsd:string'), 
    'tarjeta_profesional' => array('name' => 'tarjeta_profesional', 'type' => 'xsd:string'), 
    'estado' => array('name' => 'estado', 'type' => 'xsd:string'), 
    'sexo_id' => array('name' => 'sexo_id', 'type' => 'xsd:string'), 
    'universidad' => array('name' => 'universidad', 'type' => 'xsd:string'), 
    'sw_registro_defuncion' => array('name' => 'sw_registro_defuncion', 'type' => 'xsd:string'), 
    'fecha_registro' => array('name' => 'fecha_registro', 'type' => 'xsd:string'), 
    'usuario_id' => array('name' => 'usuario_id', 'type' => 'xsd:string'), 
    'observacion' => array('name' => 'observacion', 'type' => 'xsd:string'), 
    'registro_salud_departamental' => array('name' => 'registro_salud_departamental', 'type' => 'xsd:string'), 
    'sw_profesional_formula' => array('name' => 'sw_profesional_formula', 'type' => 'xsd:string'), 
    'tipo_clase_profesional_id' => array('name' => 'tipo_clase_profesional_id', 'type' => 'xsd:string'), 
    'furips_tipo_id_tercero' => array('name' => 'furips_tipo_id_tercero', 'type' => 'xsd:string'), 
    'furips_tercero_id' => array('name' => 'furips_tercero_id', 'type' => 'xsd:string'), 
    'firma' => array('name' => 'firma', 'type' => 'xsd:string'), 
    'sw_prioritario' => array('name' => 'sw_prioritario', 'type' => 'xsd:string')
));
////////////////////////////////////////////////////////////////////////////////
//Relacion Formula y medico
$server->wsdl->addComplexType('WS_datos_medico', 'complexType', 'struct', 'all', '', 
array(     
    'tipo_id_tercero' => array('name' => 'tipo_id_paciente', 'type' => 'xsd:string'),
    'tercero_id' => array('name' => 'tercero_id', 'type' => 'xsd:string'), 
    'nombre' => array('name' => 'nombre', 'type' => 'xsd:string'), 
    'codigo_especialidad' => array('name' => 'codigo_especialidad', 'type' => 'xsd:string'), 
    'nombre_especialidad' => array('name' => 'nombre_especialidad', 'type' => 'xsd:string'), 
    'evolucion_id' => array('name' => 'evolucion_id', 'type' => 'xsd:string')
));

//////////////////////////////PROFESIONALES ESPECIALIDAD////////////////////////

$server->wsdl->addComplexType('WS_profesionales_especialidad','complexType','array','','SOAP-ENC:Array', array(),
      array(array('ref'=>'SOAP-ENC:arrayType','wsdl:arrayType'=>'tns:especialidad[]')) ,'tns:especialidad'
);

$server->wsdl->addComplexType('especialidad', 'complexType', 'struct', 'all', '', 
array(     
    'tipo_id_tercero' => array('name' => 'tipo_id_paciente', 'type' => 'xsd:string'),
    'tercero_id' => array('name' => 'tercero_id', 'type' => 'xsd:string'), 
    'especialidad' => array('name' => 'especialidad', 'type' => 'xsd:string'), 
    'universidad' => array('name' => 'universidad', 'type' => 'xsd:string'), 
    'sub_especialidad' => array('name' => 'sub_especialidad', 'type' => 'xsd:string'), 
));
//////////////////////////////MEDICO////////////////////////
$server->wsdl->addComplexType('WS_medico', 'complexType', 'struct', 'all', '', array(     
    'tipo_id_tercero' => array('name' => 'tipo_id_tercero', 'type' => 'xsd:string'),
    'tercero_id' => array('name' => 'tercero_id', 'type' => 'xsd:string') 
));
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$server->wsdl->addComplexType('WS_datos_formulacion_antecedentes', 'complexType', 'struct', 'all', '', array(
    ...
    'tipo_id_paciente' => array('name' => 'tipo_id_paciente', 'type' => 'xsd:string'),
    'paciente_id' => array('name' => 'paciente_id', 'type' => 'xsd:string'),
    'medico_id' => array('name' => 'medico_id', 'type' => 'xsd:string'),
...
// AMG - se inserta otro parametro datos medico
function sincronizarFormula($datos_evolucion, $medicamentos_recetados, $formulacion_antecedentes,$datos_medico) {
     ...
     if($bandera=='true'){
       ...
       $datosMedico .= "tipo_id_tercero : ".$datos_medico['tipo_id_tercero']." - ". 
                       "tercero_id : ".$datos_medico['tercero_id']." - " .
                       "nombre : ".$datos_medico['nombre']." - " .
                       "codigo_especialidad : ".$datos_medico['codigo_especialidad']." - " .
                       "nombre_especialidad : ".$datos_medico['nombre_especialidad']." - " .
                       "evolucion_id : ".$datos_medico['evolucion_id'];
     ...
     registrar_logs('000085', '0000',"datosPrincipales >>> ".$datosPrincipales,2);
     registrar_logs('000090', '0000',"datosMedico >>> ".$datosMedico,2);////////////////////////////////////
    ...
    //////////////AMG///////////////
    $validacion_medico_formula = validacion_medico_formula($datos_medico);  //AMG se crea la validacion de medicos//////////////
   ////////////////////////////
    ...
    $validar_dispensacion = consultar_dispensacion_formula($datos_evolucion['numero_formula'],$datos_evolucion['tipo_formula'],null,1);


    $msjs = array_merge($validacion_evolucion['msj'], $validacion_medicamentos_recetados['msj'], $validacion_formulacion_antecedentes['msj'], $validar_formula['msj'], $validar_dispensacion['msj'],$validacion_medico_formula['msj']);
    
	//AMG se cea la validacion de medicos -- se agrega validacion
    if ($validacion_evolucion['continuar'] && $validacion_medicamentos_recetados['continuar'] && $validacion_formulacion_antecedentes['continuar'] && $validar_formula['continuar'] && $validar_dispensacion['continuar'] && $validacion_medico_formula['continuar']) {
	 ...
	 registrar_logs('000091', '0000',"antes is_null >>> ".print_r($validacion_medico_formula,true),2);	
        if (!is_null($resultado_insertar_evolucion['evolucion_id'])) {
registrar_logs('000091', '0000',"despues is_null >>> ".print_r($validacion_medico_formula,true),2);
...
registrar_logs('000091', '0000',"antes resultado_insertar_medicamentos_recetados >>> ".print_r($resultado_insertar_medicamentos_recetados,true),2);
                ...
                $datos_medico['evolucion_id']=$resultado_insertar_evolucion['evolucion_id'];
                $insertar_medico = insertar_formula_medicos($datos_medico);
                registrar_logs('000091', '0000',"despues insertar_medico >>> ".print_r($insertar_medico,true),2);
				...
				**/
				$insertarDispensacionEstados = insertarDispensacionEstado($evolucion_id,$formulacion_antecedentes[0],$datos_evolucion['tipo_formula']);
                     //AMG validacion de medicos
                if ($resultado_insertar_formulacion_antecedentes['continuar'] && $insertar_medico['continuar'] && $insertarDispensacionEstados['continuar']) {
                    ...
                    registrar_logs($evolucion_id, $datos_evolucion['numero_formula'], $resultado_insertar_formulacion_antecedentes['msj']." ".$insertar_medico['msj']);
...
function sincronizarTranscripcion($datos_evolucion, $medicamentos_recetados, $formulacion_antecedentes,$datos_medico) {
    ...
    if ($validacion_evolucion['continuar'] && $validacion_medicamentos_recetados['continuar'] && $validacion_formulacion_antecedentes['continuar'] && $validar_formula['continuar'] && $validar_dispensacion['continuar'] && $validacion_medico_formula['continuar']) {
		...
		$datos_medico['evolucion_id']=$resultado_insertar_evolucion['evolucion_id'];
				...
				**/
                ...
                if ($resultado_insertar_formulacion_antecedentes['continuar'] && $insertarDispensacionEstados['continuar']&& $insertar_medico['continuar']) {
...
/////////////AMG validacion de medicos formula////////////////
function validacion_medico_formula($datos_medico) {
    $msj = array();
    $continuar = true;
   if (empty($datos_medico)) {
        $continuar = false;
        array_push($msj, "Los datos del Medico Formula estan vacios * ".print_r($datos_medico,true)." ))))");
    }
     if (trim($datos_medico['tipo_id_tercero']) == "") {
            $continuar = false;
            array_push($msj, "tipo_id_tercero invalida");
        }
     if (trim($datos_medico['tercero_id']) == "") {
            $continuar = false;
            array_push($msj, "tercero_id invalida");
        }
     if (trim($datos_medico['nombre']) == "") {
            $continuar = false;
            array_push($msj, "nombre invalido");
        }
     if (trim($datos_medico['codigo_especialidad']) == "") {
            $continuar = false;
            array_push($msj, "codigo_especialidad invalida");
        }
     if (trim($datos_medico['nombre_especialidad']) == "") {
            $continuar = false;
            array_push($msj, "nombre_especialidad invalida");
        }
     if (trim($datos_medico['evolucion_id']) == "") {
            $continuar = false;
            array_push($msj, "evolucion_id invalida");
        }
      return array("continuar" => $continuar, "msj" => $msj);
}
////////////////////////////////////////////////////////////////////////
...
*/
function consultar_dispensacion_formula($numero_formula,$tipo_formula,$numero_entrega = null, $no_validar_fecha = null) {
    ...
    $continuar = false;
    $tipoEstado = 0;
	$fechaDate = date("Y-m-d"); //"2017-01-23";
    // Consultar No. Evolucion
    $sql = "select a.evolucion_id, a.fecha_formulacion from hc_formulacion_antecedentes a where a.numero_formula ='{$numero_formula}' AND a.transcripcion_medica ='{$tipo_formula}' group by 1,2";
    registrar_logs($evolucion_id,$evolucion_id.'000', $sql,'1');
    $result = pg_query($conexion, $sql);
    ...
    if ($result) { 
		...
		*/
        if (pg_num_rows($result) > 0) {
			...
			$fechaFormulacion = $arr->fecha_formulacion;			 			
			$intervaloFechaFormulacion=intervaloFechaformula($fechaFormulacion,'3',"+"); 
			$fechaFormulacionDiasHabiles = SumarDiasHabiles($fechaFormulacion,$intervaloFechaFormulacion,'3');
	 		
			if($no_validar_fecha == null){
				$fechaDate = null;
			}
			
			if($fechaDate > $fechaFormulacionDiasHabiles){
		
			$continuar = false;
			$msj = "La Formula No.{$numero_formula} no puede ser modificada ya que han pasado 3 dias habilies desde que se formulo " . $fechaFormulacion;
			$tipoEstado = 5;
		//return array("msj" => "LA FORMULA NO PUEDE SER MODIFICADA YA QUE HAN PASADO 3 DIAS HABILES DESDE QUE SE FORMULO", "continuar" => $continuar, "evolucion_id" => $evolucion_id, "tipoEstado" => $tipoEstado); 
			}else{
		
			 
			$sqlPendientes = "SELECT * FROM hc_pendientes_por_dispensar WHERE evolucion_id={$evolucion_id} and bodegas_doc_id is null and numeracion is null and todo_pendiente = 1 ";        
          ...
          $sql = "SELECT b.*, c.numero_entregas
					...
					SELECT  sum(dispensados.numero_entregas)as numero_entregas, dispensados.evolucion_id 
						...
						FROM (
                            ...
                            WHERE desp.evolucion_id = {$evolucion_id} AND pend.todo_pendiente = 1  GROUP BY desp.evolucion_id
         ...
         registrar_logs($evolucion_id,$evolucion_id.'000', $sql,'9');
            ...
            if ($result) {
                ...
                $tipoEstado = 2;
					...
					$msj = "La formula No.{$numero_formula} tiene pendientes (no puede ser modificada)";
					$tipoEstado = 1;
				
				}
			
        } else {
                $msj = "Se ha genereado un error consultado hc_pendientes_por_dispensar (" . pg_last_error($conexion) . " )";
                $tipoEstado = 2;
            }
...
function insertar_evolucion($datos_evolucion, $es_transcripcion = false) {
    ...
    global $conexion;
    /*De cosmitet en el campo usuario_id se envia el tercero_id en Duana se guarda en el campo tercero_id
     * usuario_id no se almacena ya que es un consecutivo tanto en duana y cosmitet y no se podrian tener los mismos 
     * usuario_id, no se borrar este campo para mantener la tabla original 
     */
...
///////////AMG insert medico_formula///////////////////
function insertar_formula_medicos($datos_medicos) {

    global $conexion;

       $sql = " ";
   
        $sql .= "   INSERT INTO medico_formula(
                    tipo_id_tercero, tercero_id, nombre_medico, codigo_especialidad, 
                    nombre_especialidad, evolucion_id)
                        VALUES (
                        '".$datos_medicos['tipo_id_tercero']."', 
                        {$datos_medicos['tercero_id']}, 
                        '".$datos_medicos['nombre']."', 
                        {$datos_medicos['codigo_especialidad']}, 
                        '".$datos_medicos['nombre_especialidad']."', 
                        {$datos_medicos['evolucion_id']});
                     ";
    
//echo ""
    registrar_logs('000091', '0000',"sql insertar_medico >>> ".$sql,2);
    $result = pg_query($conexion, $sql);

    if ($result) {
        $continuar = true;
        $msj = "Datos Ingresados Correctamente en medico_formula".$sql;
    } else {
        $continuar = false;
        $msj = "Se ha generado un error insertando en medico_formula ( " . pg_last_error($conexion) . " ) ".$sql;
    }
...
function modificar_medicamentos_recetados($evolucion_id, $medicamentos_recetados, $es_transcripcion = false) {
    ...
    foreach ($medicamentos_recetados as $key => $value) {
        ...
        $sql .="UPDATE hc_medicamentos_recetados_amb SET                                     
                ...
                dias_tratamiento = {$value['dias_tratamiento']},
                bloqueo = '{$value['bloqueo']}',
                tercero_id = {$value['usuario_id']},
                tercero_id_modifica = {$value['usuario_id_modifica']},
                cantidad_dia = {$value['cantidad_dia']},
...
function eliminar_formulacion($evolucion_id) {
    ...
    $sql = "DELETE FROM dispensacion_estados WHERE evolucion_id = {$evolucion_id} ; 
			DELETE FROM hc_formulacion_antecedentes_historia WHERE evolucion_id = {$evolucion_id} ;            
            ...
            DELETE FROM medico_formula WHERE evolucion_id = {$evolucion_id}; ";
         registrar_logs($evolucion_id,$evolucion_id.'000', $sql,'1');
    $result = pg_query($conexion, $sql);
 ...
 *+Descripcion Metodo encargado de consultar la existencia del medico
 * parametros: tipo_id_tercero, tercero_id
 * @fecha 2016-10-27 (YYYY-MM-DD)
 */
function verficarMedico($cabecera){
//   $Services_JSON = new Services_JSON;
    ...
    $sql = " select * 
            from
            terceros
            where tipo_id_tercero='".strtoupper($cabecera['tipo_id_tercero'])."' AND tercero_id='".$cabecera['tercero_id']."' 
            ;";
    ...
    */
        if (pg_num_rows($result) > 0) {
            $continuar = true;
            $msj = "El tercero {$cabecera['tipo_id_tercero']} {$cabecera['tercero_id']} ya existe en Duana";            
        }else{
           $continuar = false;
           $msj = "El tercero {$cabecera['tipo_id_tercero']} {$cabecera['tercero_id']} no se encuentra en Duana";
        }
    } else {
        $continuar = false;
        $msj = "Se ha genereado un error consultando la tabla terceros (" . pg_last_error($conexion) . " ) ".$sql;        
    } 

    return array('msj' => $msj, 'estado' => $continuar , 'datos' => '');
}
 ...
 * @fecha 2016-10-27 (YYYY-MM-DD)
 */
function verficarProfesionales($cabecera){
//   $Services_JSON = new Services_JSON;
    global $conexion;
    ...
    */
        if (pg_num_rows($result) > 0) {
            $continuar = true;
            $msj = "El profesionales {$cabecera['tipo_id_tercero']} {$cabecera['tercero_id']} ya existe en Duana";            
        }else{
           $continuar = false;
           $msj = "El profesionales {$cabecera['tipo_id_tercero']} {$cabecera['tercero_id']} no se encuentra en Duana";
        }
    } else {
        $continuar = false;
        $msj = "Se ha genereado un error consultando la tabla profesionales (" . pg_last_error($conexion) . " ) ".$sql;        
    } 
...
/*
 * @author Andres Mauricio Tascon 
 *+Descripcion Metodo encargado de consultar la especialidad del profesional
 * parametros: tipo_id_tercero, tercero_id
 * @fecha 2016-10-27 (YYYY-MM-DD)
 */
function verficarProfesionalesEspecialidades($cabecera){
//   $Services_JSON = new Services_JSON;
    global $conexion;
    ...
    $sql = " select * 
            ...
            where tipo_id_tercero='".strtoupper($cabecera['tipo_id_tercero'])."' AND tercero_id='".$cabecera['tercero_id']."' AND  especialidad = '".$cabecera['especialidad']."' 
            ;";
    ...
    */
        if (pg_num_rows($result) > 0) {
            $continuar = true;
            $msj = "El ProfesionalesEspecialidades {$cabecera['tipo_id_tercero']} {$cabecera['tercero_id']} ya existe en Duana";            
        }else{
           $continuar = false;
           $msj = "El ProfesionalesEspecialidades {$cabecera['tipo_id_tercero']} {$cabecera['tercero_id']} no se encuentra en Duana";
        }
    } else {
        $continuar = false;
        $msj = "Se ha genereado un error consultando la tabla ProfesionalesEspecialidades (" . pg_last_error($conexion) . " ) ".$sql;        
    } 

    return array('msj' => $msj, 'estado' =>  $continuar , 'datos' => '');
}

function agregarMedico($terceros,$profesional,$especialidades){//
 
    $tercero=insertarTercero($terceros);
    $profesional=insertarProfesionales($profesional);
    $especialdad=insertarProfesionalesEspecialidades($especialidades);
    
    registrar_logs($terceros[tercero_id],'0008',print_r($terceros,true),'1');
    registrar_logs($profesional[tercero_id],'0009',print_r($profesional,true),'1');
    registrar_logs($especialidades[tercero_id],'0010',print_r($especialidades,true),'1');
    $continuar='1';
    
    if($tercero['continuar']==false){
      $msj = $tercero['msj'];  
      $continuar='0';
    } 
    if($profesional['continuar']==false){
      $msj .= $profesional['msj'];    
      $continuar='0';
    } 
    if($especialdad['continuar']==false){
      $msj .= $especialdad['msj'];  
      $continuar='0';
    }
    
    if($continuar=='1'){
        $msj="SE INGRESO CORRECTAMENTE EN LA BD DE DUANA";
    }   
     return array('msj' => $msj, 'estado' => (bool)$continuar, 'datos' => '');
}

function insertarProfesionalesEspecialidades($especialidad) {

  global $conexion;
  foreach($especialidad as $especialidades){ 
      
        $verificaProfesionales=verficarProfesionalesEspecialidades($especialidades);  
       
        if($verificaProfesionales['estado']==false){
        $sql.=" INSERT INTO profesionales_especialidades(
                 tipo_id_tercero, tercero_id, especialidad, universidad, sub_especialidad)
                 VALUES ('{$especialidades[tipo_id_tercero]}','{$especialidades[tercero_id]}', '{$especialidades[especialidad]}', '{$especialidades[universidad]}', '{$especialidades[sub_especialidad]}'); ";
         }else{
        $sql.=" UPDATE profesionales_especialidades
                SET especialidad='{$especialidades[especialidad]}', universidad='{$especialidades[universidad]}', 
                    sub_especialidad='{$especialidades[sub_especialidad]}'
                WHERE tipo_id_tercero='{$especialidades[tipo_id_tercero]}' and tercero_id='{$especialidades[tercero_id]}' AND  especialidad = '{$especialidades['especialidad']}'; ";
         }
        ...
        registrar_logs($especialidades['tercero_id'],'0018', $sql,'1');
        if ($result) {
            $continuar = true;
            $msj = "ProfesionalesEspecialidades";
        } else {
            $continuar = false;
            $msj = "Se ha generado un error insertando ProfesionalesEspecialidades ( " . pg_last_error($conexion) . " ) ".$sql."<br>";
        }
...
function insertarProfesionales($profesionales) {

    global $conexion;
    $verificaProfesionales=verficarProfesionales($profesionales);  
    
    $tarjeta_profesional = (empty($profesionales[tarjeta_profesional])||is_null($profesionales[tarjeta_profesional])) ? NULL : $profesionales[tarjeta_profesional];
    $universidad = (empty($profesionales[universidad])||is_null($profesionales[universidad])) ? NULL : $profesionales[universidad];
    $observacion = (empty($profesionales[observacion])||is_null($profesionales[observacion])) ? NULL : $profesionales[observacion];
    $tipo_clase_profesional_id= (empty($profesionales[tipo_clase_profesional_id])||is_null($profesionales[tipo_clase_profesional_id])) ? NULL : $profesionales[tipo_clase_profesional_id];
    $registro_salud_departamental= (empty($profesionales['registro_salud_departamental'])||is_null($profesionales[registro_salud_departamental])) ? NULL : $profesionales['registro_salud_departamental'];
    $furips_tipo_id_tercero= (empty($profesionales['furips_tipo_id_tercero'])|| $profesionales[furips_tipo_id_tercero]=='NULL') ? NULL : $profesionales['furips_tipo_id_tercero'];
    $furips_tercero_id= (empty($profesionales['furips_tercero_id'])||is_null($profesionales[furips_tercero_id])) ? NULL : $profesionales['furips_tercero_id'];
    $firma= (empty($profesionales['firma'])||is_null($profesionales[firma])) ? NULL : $profesionales['firma'];
    
    
    if($verificaProfesionales['estado']==false){
        $sql = "INSERT INTO profesionales(
                tipo_id_tercero, tercero_id, nombre, tipo_profesional, tarjeta_profesional, 
                estado, sexo_id, universidad, sw_registro_defuncion, fecha_registro, 
                usuario_id, observacion, registro_salud_departamental, sw_profesional_formula, 
                tipo_clase_profesional_id, furips_tipo_id_tercero, furips_tercero_id, 
                firma)
                VALUES ('{$profesionales[tipo_id_tercero]}','{$profesionales[tercero_id]}', '{$profesionales[nombre]}', '{$profesionales[tipo_profesional]}', '{$tarjeta_profesional}', 
                        '{$profesionales[estado]}','{$profesionales[sexo_id]}', '{$universidad}', '{$profesionales[sw_registro_defuncion]}', '{$profesionales[fecha_registro]}',   
                        '0','{$observacion}', '{$registro_salud_departamental}', '{$profesionales[sw_profesional_formula]}',  
                        {$tipo_clase_profesional_id},'{$furips_tipo_id_tercero}', {$furips_tercero_id}, '{$firma}'); ";
    }else{
        $sql="UPDATE profesionales
                SET  nombre='{$profesionales[nombre]}', tipo_profesional='{$profesionales[tipo_profesional]}', 
                    tarjeta_profesional='{$tarjeta_profesional}', estado='{$profesionales[estado]}', sexo_id='{$profesionales[sexo_id]}', universidad='{$universidad}', sw_registro_defuncion='{$profesionales[sw_registro_defuncion]}', 
                    fecha_registro='{$profesionales[fecha_registro]}', usuario_id='0', observacion='{$observacion}', registro_salud_departamental='{$registro_salud_departamental}', 
                    sw_profesional_formula= '{$profesionales[sw_profesional_formula]}', tipo_clase_profesional_id={$tipo_clase_profesional_id}, furips_tipo_id_tercero='{$furips_tipo_id_tercero}', 
                    furips_tercero_id={$furips_tercero_id}, firma= '{$firma}'
              WHERE  tipo_id_tercero='{$profesionales[tipo_id_tercero]}' and tercero_id='{$profesionales[tercero_id]}'";
    }
      
        registrar_logs($profesionales[tercero_id],'777', $sql,'1');
        $result = pg_query($conexion, $sql);

        if ($result) {
            $continuar = true;
            $msj = "profesionales OK";
        } else {
            $continuar = false;
            $msj = "Se ha generado un error insertando profesionales ( " . pg_last_error($conexion) . " ) ".$sql."<br>";
        }
   
    return array("msj" => $msj, "continuar" => $continuar);
}

function insertarTercero($tercero) {

    global $conexion;
    
    $tercero[dv]=$tercero[dv]=='NULL'?NULL:$tercero[dv];
    $verificaTercero=verficarMedico($tercero);  
   
    if($verificaTercero['estado']==''){
    
        $sql = " INSERT INTO terceros(
                    tipo_id_tercero, tercero_id, tipo_pais_id, tipo_dpto_id, tipo_mpio_id, 
                    direccion, telefono, fax, email, celular, sw_persona_juridica, 
                    cal_cli, usuario_id, fecha_registro, busca_persona, nombre_tercero, 
                    dv, nombre1, nombre2, apellido1, apellido2, nacionalidad, cod_entidad, 
                    cod_ciu, tipo_tercero, tipo_contribuyente, retencion, porc_ica, 
                    valor_tope, porc_reteiva, cod_pais_residencia, man_ica, man_tope, 
                    tipo_bloqueo_id)
                VALUES ('{$tercero[tipo_id_tercero]}','{$tercero[tercero_id]}', '{$tercero[tipo_pais_id]}', '{$tercero[tipo_dpto_id]}', '{$tercero[tipo_mpio_id]}', 
                        '{$tercero[direccion]}','{$tercero[telefono]}', '{$tercero[fax]}', '{$tercero[email]}', '{$tercero[celular]}', '{$tercero[sw_persona_juridica]}',   
                        '{$tercero[cal_cli]}',{$tercero[usuario_id]}, '{$tercero[fecha_registro]}', '{$tercero[busca_persona]}', '{$tercero[nombre_tercero]}',  
                        '{$tercero[dv]}','{$tercero[nombre1]}', '{$tercero[nombre2]}', '{$tercero[apellido1]}', '{$tercero[apellido2]}', {$tercero[nacionalidad]}, {$tercero[cod_entidad]},   
                        '{$tercero[cod_ciu]}',{$tercero[tipo_tercero]}, {$tercero[tipo_contribuyente]}, {$tercero[retencion]}, {$tercero[porc_ica]},    
                        {$tercero[valor_tope]},{$tercero[porc_reteiva]}, '{$tercero[cod_pais_residencia]}', {$tercero[man_ica]}, {$tercero[man_tope]},    
                        '{$tercero[tipo_bloqueo_id]}'); ";
    }else{
        $sql="UPDATE terceros
              SET   tipo_pais_id='{$tercero[tipo_pais_id]}', tipo_dpto_id='{$tercero[tipo_dpto_id]}', 
                    tipo_mpio_id='{$tercero[tipo_mpio_id]}', direccion='{$tercero[direccion]}', telefono='{$tercero[telefono]}', fax='{$tercero[fax]}', email='{$tercero[email]}', celular='{$tercero[celular]}', 
                    sw_persona_juridica='{$tercero[sw_persona_juridica]}', cal_cli='{$tercero[cal_cli]}', usuario_id={$tercero[usuario_id]}, fecha_registro='{$tercero[fecha_registro]}', 
                    busca_persona= '{$tercero[busca_persona]}', nombre_tercero='{$tercero[nombre_tercero]}', dv='{$tercero[dv]}', nombre1='{$tercero[nombre1]}', nombre2='{$tercero[nombre2]}', 
                    apellido1='{$tercero[apellido1]}', apellido2='{$tercero[apellido2]}', nacionalidad={$tercero[nacionalidad]}, cod_entidad={$tercero[cod_entidad]}, cod_ciu='{$tercero[cod_ciu]}', 
                    tipo_tercero={$tercero[tipo_tercero]}, tipo_contribuyente={$tercero[tipo_contribuyente]}, retencion={$tercero[retencion]}, porc_ica={$tercero[porc_ica]}, 
                    valor_tope={$tercero[valor_tope]}, porc_reteiva={$tercero[porc_reteiva]}, cod_pais_residencia='{$tercero[cod_pais_residencia]}', man_ica={$tercero[man_ica]}, 
                    man_tope={$tercero[man_tope]}, tipo_bloqueo_id='{$tercero[tipo_bloqueo_id]}'
              WHERE tipo_id_tercero='{$tercero[tipo_id_tercero]}' and tercero_id='{$tercero[tercero_id]}';";
    }
        $result = pg_query($conexion, $sql);
        registrar_logs($tercero[tercero_id],'777', $sql,'1');
        if ($result) {
            $continuar = true;
            $msj = "Tercero";
        } else {
            $continuar = false;
            $msj = "Se ha generado un error insertando Tercero ( " . pg_last_error($conexion) . " ) ".$sql."<br>";
        }
