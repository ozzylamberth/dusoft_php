...
class SincronizacionCosmitet {
    ...
    function sincronizarFormula() {
        ...
        $datos_evoluvion['fecha'] = "2014-12-22 15:14:34.413187  ";
        ...
        $datos_medicamentos[1]['numero_formula'] = "1503";
        ...
        $datos_antecedentes[0]['paciente_id'] = "25148584";
        $datos_antecedentes[0]['codigo_medicamento'] = "FOFOA0031250";
        $datos_antecedentes[0]['medico_id'] = "928";
        ...
        $datos_antecedentes[0]['fecha_registro'] = "2014-12-22";
        $datos_antecedentes[0]['fecha_finalizacion'] = "2014-12-23";
        $datos_antecedentes[0]['fecha_formulacion'] = "2014-12-22";
        $datos_antecedentes[0]['fecha_modificacion'] = "NULL";
        
        $datos_antecedentes[1]['tipo_id_paciente'] = "CC";
        $datos_antecedentes[1]['paciente_id'] = "25148584";
        $datos_antecedentes[1]['codigo_medicamento'] = "FOFOA0031251";
        $datos_antecedentes[1]['medico_id'] = "928";
        ...
        $datos_antecedentes[1]['fecha_registro'] = "2014-12-22";
        $datos_antecedentes[1]['fecha_finalizacion'] = "2014-12-23";
        $datos_antecedentes[1]['fecha_formulacion'] = "2014-12-22";
