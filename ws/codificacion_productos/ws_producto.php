...
$ns="http://10.0.0.44/dusoft/ws/codificacion_productos/ws_producto.php"; //Cambiar URL
//$ns="http://10.0.2.170/Pruebas_DUSOFT_DUANA_/ws/codificacion_productos/ws_producto_2015_12_21.php"; //Cambiar URL
...
function insertarFactorConversion($CodigoUnidadDosificacion, $CodigoMedicamento, $UnidadDosificacion, $CantidadFactorConversion) {
    ...
    if (!$rst) {
        return 'Error al insertar o actualizar el factor de conversion';
    }
    return '1';
}
...
function eliminarFactorConversion($CodigoUnidadDosificacion, $CodigoMedicamento, $UnidadDosificacion) 
{
    ...
    if (!$resultado) {
        return 'Error, el factor de conversion no pudo ser eliminado';
    }
    return '1';
}
...
function asignar($Tabla, $Valor, $CodigoProducto, $Campos)
{
    ...
    if (!$resultado) {
        return 'Error, el nivel de uso o nivel de atencion no se ha podido insertar';
    }
    return true;    
}
...
function borrar($Tabla, $Valor, $CodigoProducto, $Campo)
{
    ...
    $resultado = @pg_query($conexionn, $sql);
    if (!$resultado) {
        return 'Error, el nivel de uso o nivel de atencion no se ha podido borrar';
    }
    return true;
}
...
function InsertarViadxProd($via_administracion_id, $CodigoProducto)
{
    ...
    $resultado = @pg_query($conexionn, $sql);
    if (!$resultado) {
        return 'Error, la via de administracion no se ha podido insertar';
    }
    return true;
}
...
function BorrarViadxProd($via_administracion_id, $CodigoProducto)
{
    ...
    $resultado = @pg_query($conexionn, $sql);
    if (!$resultado) {
        return 'Error, la via de administracion no se ha podido borrar';
    }
    return true;
}
...
function existenciaProducto($codigoProducto)
{
    ...
    $resultado = @pg_query($conexionn, $sql);
    if (!$resultado) {
        return 'Error al consultar la existencia del medicamento';
    }
...
function actualizarViasAdmin($codigoProducto, $niveles)
{
    ...
    $sql = "BEGIN; DELETE FROM inv_medicamentos_vias_administracion WHERE codigo_medicamento = '$codigoProducto';";
    ...
    if (!$rst) {
        return 'Error al insertar o actualizar las vias de administracion';
    }
    return true;
} 
...
function actualizarNivelesAtencion($codigoProducto, $niveles)
{
    ...
    if (!$rst) {
        return 'Error al insertar o actualizar los niveles de atencion';
    }
    return true;
}
...
function actualizarNivelesUso($codigoProducto, $niveles) 
{
    ...
    if (!$rst) {
        return 'Error al insertar o actualizar los niveles de uso';
    }
    return true;
}
