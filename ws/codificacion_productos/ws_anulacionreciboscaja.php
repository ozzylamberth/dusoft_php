...
function anularReciboCaja($empresaId, $centroUtilidad, $reciboCajaId, $prefijoReciboCaja)
{
    ...
    {
        return array('descripcion' => "El tipo tercero no se encontro.1" ,
            'estado' => (bool) '0');
    }
    ...
    $sql = " ";
    $sql .= " BEGIN; " . $sqlUpdateEstadoReciboCaja . " " . $sqlUpdateSaldoRcControlAnticipos . " COMMIT; ";
...
{
    $url = "http://10.0.2.237/APP/DUSOFT_DUANA/ws/ws_consultas.php?wsdl";
...
{
    $url = "http://10.0.2.237/APP/DUSOFT_DUANA_/ws/ws_consultas.php?wsdl";
    $soapClient = new nusoap_client($url, true);
