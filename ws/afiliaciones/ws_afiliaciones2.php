...
$server->register('consultar_eps_afiliados_datos', array('tipo_id_paciente' => 'xsd:string',
    'paciente_id' => 'xsd:string'
        ), array('return' => 'tns:WS_resultado_eps_afiliados_datos'),
        "urn:afiliaciones_ws", 
        "urn:afiliaciones_ws#consultar",
        "rpc", 
        "encoded", 
        "Webservice: Permite consultar si existe un paciente en afiliacion eps");

$server->wsdl->addComplexType('WS_resultado_eps_afiliados_datos', 'complexType', 'struct', 'all', '', 
        array('msj' => array('name' => 'msj', 'type' => 'xsd:string'),
...
function insertar_epsafiliadosdatos($primer_apellido, $segundo_apellido, $primer_nombre, $segundo_nombre, $fecha_nacimiento, $fecha_afiliacion_sgss, $tipo_sexo_id, $ciuo_88_grupo_primario, $tipo_pais_id, $tipo_dpto_id, $tipo_mpio_id, $zona_residencia, $direccion_residencia, $telefono_residencia, $telefono_movil, $usuario_registro, $usuario_ultima_actualizacion, $afiliado_tipo_id, $afiliado_id) {
    ...
    insertar_personas($primer_apellido, $segundo_apellido, $primer_nombre, $segundo_nombre, 
                      $fecha_nacimiento, $fecha_afiliacion_sgss, $tipo_sexo_id, $ciuo_88_grupo_primario, 
                      $tipo_pais_id, $tipo_dpto_id, $tipo_mpio_id, $zona_residencia, $direccion_residencia, 
                      $telefono_residencia, $telefono_movil, $usuario_registro, $usuario_ultima_actualizacion, 
                      $afiliado_tipo_id, $afiliado_id);
...
function insertar_personas($primer_apellido, $segundo_apellido, $primer_nombre, $segundo_nombre, $fecha_nacimiento, $fecha_afiliacion_sgss, $tipo_sexo_id, $ciuo_88_grupo_primario, $tipo_pais_id, $tipo_dpto_id, $tipo_mpio_id, $zona_residencia, $direccion_residencia, $telefono_residencia, $telefono_movil, $usuario_registro, $usuario_ultima_actualizacion, $afiliado_tipo_id, $afiliado_id) {
...
//    $sql = "insert into logs_pacientes_ws (query, resultado, sw_error) values ('asdsad', 'asdasd', 'sadasdas' ) ;";
    ...
    if ($result) {
        ...
        return $sql." Error en el insert de los datos: -" . pg_last_error();
    }
}
